...
#
translater.translate_file(r".\resource\互联网认证授权机制.md",
                          formula=True,
                          code=True,
                          # refine=True,
                          to_lang="英文",
...
# translater.read_file(r".\resource\regex.md",formula=True,code=True,save=True,refine=False,save_format="markdown")
