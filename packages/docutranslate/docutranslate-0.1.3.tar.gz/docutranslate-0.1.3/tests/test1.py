...
translater.translate_file(r"C:\Users\jxgm\Desktop\FileTranslate\tests\resource\互联网认证授权机制.md",
                          formula=True,
                          code=True,
                          # refine=True,
                          to_lang="中文",
...
# translater.read_file(r"C:\Users\jxgm\Desktop\FileTranslate\tests\resource\互联网认证授权机制.md",formula=True,code=True,save=True,refine=False,save_format="html")