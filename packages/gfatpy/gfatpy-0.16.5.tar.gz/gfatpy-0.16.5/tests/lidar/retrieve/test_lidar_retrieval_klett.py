...
def test_retrieve_klett():
    ...
    assert np.allclose(klett_beta_gfatpy, params["particle_beta"], atol=1e-4)
...
def test_get_calibration_synthetic():
    ...
    assert np.allclose(mean_calib, 9569693709.54703, atol=1e-2)
    assert np.allclose(std_calib, 5024.831048009668, atol=1e-2)
