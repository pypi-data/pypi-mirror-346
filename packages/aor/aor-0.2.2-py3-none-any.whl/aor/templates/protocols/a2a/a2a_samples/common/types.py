...
from typing import Annotated, Any, Dict, Literal, List, Optional, Union
...
# Additional types needed by the a2a template
...
class Capability(BaseModel):
    name: str
    description: str
    input_types: List[MediaType]
    output_types: List[MediaType]
    version: str = "1.0.0"
