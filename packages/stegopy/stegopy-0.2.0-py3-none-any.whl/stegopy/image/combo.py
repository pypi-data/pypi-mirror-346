...
def encode(image_path: str, output_path: str, payload: str, region: Optional[str] = None, channel: Optional[str] = None, alpha: Optional[bool] = False) -> None:
    """
    ...
    """
    _core.encode(image_path, output_path, payload, region=region, channel=channel, alpha=alpha)
