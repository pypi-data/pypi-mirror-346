...
class TestPerformanceMetricsV1:
    ...
    def test_cost_invalid_model_type(
        ...
        # Pydantic raises ValidationError, but to avoid import, just check Exception and error message
    ...
    def test_cost_missing_required_fields_llm(
        ...
        # Should raise TypeError before HTTP call
    ...
    def test_cost_invalid_fields_openai(
        ...
        # Should raise ValidationError before HTTP call
        with pytest.raises(Exception) as excinfo:
            sdk.performance.v1.cost.evaluate(
                model_name="gpt-3.5-turbo",
                model_type="LLM",
    ...
    def test_cost_api_error_detail(self, mock_post: Any, sdk: TrustwiseSDK) -> None:
        ...
        mock_post.return_value = {"detail": ["Invalid input: missing required fields."]}
        with pytest.raises(Exception) as excinfo:
            sdk.performance.v1.cost.evaluate(
                model_name="gpt-3.5-turbo",
                model_type="LLM",
