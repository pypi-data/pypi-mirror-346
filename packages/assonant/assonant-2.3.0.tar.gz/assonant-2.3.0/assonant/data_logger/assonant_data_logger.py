...
class AssonantDataLogger:
    ...
    def __init__(
        ...
        data_schema_file_path: str,
        data_schema_file_name: str,
        log_file_path: str,
        ...
        Args:
            ...
            data_schema_file_path (str): Path to configuration file.
            data_schema_file_name (str): Name of the configuration file.
        ...
        self.metadata_retriever = AssonantMetadataRetriever(os.path.join(data_schema_file_path, data_schema_file_name))
        self.hierarchizer = Hierarchizer(
            os.path.join(data_schema_file_path, data_schema_file_name), self.metadata_retriever
        )
        self.pv_names = {}
        self.pv_collectors = {}
