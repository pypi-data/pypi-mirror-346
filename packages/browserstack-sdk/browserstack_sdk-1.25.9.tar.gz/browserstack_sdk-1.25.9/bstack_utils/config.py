...
conf = {
    bstack11lll_opy_ (u"ࠧࡢࡲࡳࡣࡦࡻࡴࡰ࡯ࡤࡸࡪ࠭ᙳ"): False,
    bstack11lll_opy_ (u"ࠨࡤࡶࡸࡦࡩ࡫ࡠࡵࡨࡷࡸ࡯࡯࡯ࠩᙴ"): True,
    bstack11lll_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᙵ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    @classmethod
    def bstack1l1l1l1ll1_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11lll11111l_opy_=None):
        return self._11lll1111ll_opy_.get(property_name, bstack11lll11111l_opy_)
    def bstack1llllll1l1_opy_(self, property_name, bstack11lll1111l1_opy_):
        self._11lll1111ll_opy_[property_name] = bstack11lll1111l1_opy_
    def bstack11lll11111_opy_(self, val):
        self._11lll1111ll_opy_[bstack11lll_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩᙶ")] = bool(val)
    def bstack1111ll11ll_opy_(self):
        return self._11lll1111ll_opy_.get(bstack11lll_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪᙷ"), False)