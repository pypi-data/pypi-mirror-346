...
def convert_falcon_h1_to_hf(input_model_path, output_path, max_position_embeddings=131072):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max_position_embeddings", type=int, help="Maximum sequence length the model has been trained with"
    )
