...
class TreasuryEnhancerSemantic(SemanticEnhancer):
    ...
    def _initialize_patterns(self):
        ...
        self.negative_indicators = [
            ...
            # Government treasury department references (should be GOVT not TREA)
            ...
            # Government payment indicators
            'government payment', 'payment for public services', 'payment for government services',
            'government services payment', 'public services payment'
        ]
