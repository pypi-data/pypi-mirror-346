...
from purpose_classifier.domain_enhancers.charitable_donation_enhancer_semantic import CharitableDonationEnhancerSemantic as CharitableDonationEnhancer
...
class EnhancerManager:
    ...
    def __init__(self, matcher=None):
        ...
        self.enhancers = {
            ...
            'charitable_donation': CharitableDonationEnhancer(matcher=matcher),
...
#            'software_services': SoftwareServicesEnhancer(matcher=matcher),
        ...
        self.priorities = {
            ...
            'government_payment': {'level': 'highest', 'weight': 0.99},  # Highest priority for government payments
            ...
            'charitable_donation': {'level': 'high', 'weight': 0.99},
    ...
    def select_enhancers_by_context(self, narration, message_type=None):
        ...
        # Check for charitable donation context
        if any(term in narration_lower for term in ['donation', 'donate', 'donating', 'charitable', 'charity', 'charities', 'foundation', 'fundraiser', 'relief fund', 'disaster relief', 'humanitarian', 'red cross', 'unicef']):
            logger.info(f"DONATION DEBUG: Detected donation context in narration: {narration}")
            relevant_enhancers.append('charitable_donation')
