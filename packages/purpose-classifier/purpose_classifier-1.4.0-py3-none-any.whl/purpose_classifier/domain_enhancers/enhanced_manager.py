...
class EnhancedManager(EnhancerManager):
    ...
    def _calculate_enhancer_relevance(self, narration, enhancer_names):
        ...
        enhancer_keywords = {
            ...
            'charitable_donation': ['donation', 'donate', 'donating', 'charitable', 'charity', 'charities', 'nonprofit', 'non-profit', 'foundation', 'fundraiser', 'relief fund', 'disaster relief', 'humanitarian', 'philanthropy', 'red cross', 'unicef', 'salvation army', 'donor', 'donr'],
