...
class TemplateParser:
    ...
    def _process_response_format(self, response_format, template_dir=None) -> Dict[str, Any]:
        ...
        # 确定文件路径 - 如果提供了模板目录，则使用它，否则使用当前目录
        base_dir = Path(template_dir) if template_dir else Path.cwd()
        file_path = base_dir / response_format
    ...
    def parse(self, content: str, template_dir: str = None) -> PromptTemplate:
