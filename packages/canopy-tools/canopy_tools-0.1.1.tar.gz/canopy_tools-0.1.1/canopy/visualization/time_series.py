...
def make_time_series(fields: cp.Field | List[cp.Field], output_file: Optional[str] = None, layers: Optional[List[str] | str] = None, redop: Optional[str] = 'av',
    ...
    """
    Create a time series plot from the given line data and save it to a file.
    ...
    legend_style : str, optional
        Style of the legend ('default', 'highlighted', 'end-of-line' or False). Default is 'default'.
    ...
    baseline : bool, optional
        Option to add a y=0 line. Default is False.
