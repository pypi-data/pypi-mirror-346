...
class VoucherService:
    ...
    def make_voucher(
        ...
        # Convert to dict and add sendToLedger parameter
        # This is necessary because sendToLedger is not part of the VoucherCreate model
        # but is a valid API parameter
        voucher_dict = voucher_data.model_dump(by_alias=True)
        voucher_dict["sendToLedger"] = send_to_ledger

        # Create the voucher using the dictionary with sendToLedger parameter
