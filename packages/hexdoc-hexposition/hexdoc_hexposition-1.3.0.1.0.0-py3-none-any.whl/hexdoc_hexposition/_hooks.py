...
import hexdoc_hexposition

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexpositionPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexpositionModPlugin(branch=branch)


class HexpositionModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexposition"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexposition, "_templates"
