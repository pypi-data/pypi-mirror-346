...
from autoai_libs.utils.exportable_utils import compress_str_column
...
class CompressStrings(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        if self.activate_flag:
            ...
            if len(self.dtypes_list) != num_columns or len(self.misslist_list) != num_columns:
                raise ValueError("dtypes_list or misslist_list column shape mismatch")
