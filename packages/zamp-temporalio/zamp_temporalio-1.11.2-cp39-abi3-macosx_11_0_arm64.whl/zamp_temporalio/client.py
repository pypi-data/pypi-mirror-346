...
import zamp_temporalio.api.common.v1
import zamp_temporalio.api.enums.v1
import zamp_temporalio.api.errordetails.v1
import zamp_temporalio.api.failure.v1
import zamp_temporalio.api.history.v1
import zamp_temporalio.api.schedule.v1
import zamp_temporalio.api.sdk.v1
import zamp_temporalio.api.taskqueue.v1
import zamp_temporalio.api.update.v1
import zamp_temporalio.api.workflow.v1
import zamp_temporalio.api.workflowservice.v1
import zamp_temporalio.common
import zamp_temporalio.converter
import zamp_temporalio.exceptions
import zamp_temporalio.runtime
import zamp_temporalio.service
import zamp_temporalio.workflow
from zamp_temporalio.service import (
...
class Client:
    ...
    async def connect(
        ...
        *,
        ...
        data_converter: zamp_temporalio.converter.DataConverter = zamp_temporalio.converter.DataConverter.default,
        interceptors: Sequence[Interceptor] = [],
        default_workflow_query_reject_condition: Optional[
            zamp_temporalio.common.QueryRejectCondition
        ] = None,
        ...
        lazy: bool = False,
        runtime: Optional[zamp_temporalio.runtime.Runtime] = None,
        ...
        Args:
            ...
            interceptors: Set of interceptors that are chained together to allow
                ...
                :py:class:`zamp_temporalio.worker.Interceptor` will be used as worker
        ...
        """
        connect_config = zamp_temporalio.service.ConnectConfig(
        ...
        return Client(
            await zamp_temporalio.service.ServiceClient.connect(connect_config),
            namespace=namespace,
    ...
    def __init__(
        self,
        service_client: zamp_temporalio.service.ServiceClient,
        *,
        namespace: str = "default",
        data_converter: zamp_temporalio.converter.DataConverter = zamp_temporalio.converter.DataConverter.default,
        interceptors: Sequence[Interceptor] = [],
    ...
    @property
    def service_client(self) -> zamp_temporalio.service.ServiceClient:
        """Raw gRPC service client."""
        return self._config["service_client"]

    @property
    def workflow_service(self) -> zamp_temporalio.service.WorkflowService:
        """Raw gRPC workflow service client."""
        return self._config["service_client"].workflow_service

    @property
    def operator_service(self) -> zamp_temporalio.service.OperatorService:
        """Raw gRPC operator service client."""
        return self._config["service_client"].operator_service

    @property
    def test_service(self) -> zamp_temporalio.service.TestService:
    ...
    @property
    def data_converter(self) -> zamp_temporalio.converter.DataConverter:
    ...
    async def start_workflow(
        ...
        *,
        ...
        id_reuse_policy: zamp_temporalio.common.WorkflowIDReusePolicy = zamp_temporalio.common.WorkflowIDReusePolicy.ALLOW_DUPLICATE,
        id_conflict_policy: zamp_temporalio.common.WorkflowIDConflictPolicy = zamp_temporalio.common.WorkflowIDConflictPolicy.UNSPECIFIED,
        retry_policy: Optional[zamp_temporalio.common.RetryPolicy] = None,
        cron_schedule: str = "",
        memo: Optional[Mapping[str, Any]] = None,
        search_attributes: Optional[
            Union[
                zamp_temporalio.common.TypedSearchAttributes,
                zamp_temporalio.common.SearchAttributes,
            ]
        ] = None,
        ...
        priority: zamp_temporalio.common.Priority = zamp_temporalio.common.Priority.default,
    ...
    async def start_workflow(
        self,
        workflow: str,
        arg: Any = zamp_temporalio.common._arg_unset,
        *,
        args: Sequence[Any] = [],
        id: str,
        task_queue: str,
        ...
        *,
        ...
        Args:
            ...
            search_attributes: Search attributes for the workflow. The
                ...
                :py:class:`zamp_temporalio.common.TypedSearchAttributes`.
            ...
            static_details: General fixed details for this workflow execution that may appear in
                ...
                updated, use :py:meth:`zamp_temporalio.workflow.get_current_details` within the workflow.
        ...
        Raises:
            zamp_temporalio.exceptions.WorkflowAlreadyStartedError: Workflow has
                already been started.
            RPCError: Workflow could not be started for some other reason.
        """
        zamp_temporalio.common._warn_on_deprecated_search_attributes(
            search_attributes, stack_level=stack_level
        )
        name, result_type_from_type_hint = (
            zamp_temporalio.workflow._Definition.get_name_and_result_type(workflow)
        )

        return await self._impl.start_workflow(
            StartWorkflowInput(
                workflow=name,
                args=zamp_temporalio.common._arg_or_args(arg, args),
                id=id,
    ...
    def get_workflow_handle_for(
        ...
        *,
        ...
        Returns:
            The workflow handle.
        """
        defn = zamp_temporalio.workflow._Definition.must_from_run_fn(workflow)
    ...
    async def execute_update_with_start_workflow(
        self,
        update: zamp_temporalio.workflow.UpdateMethodMultiParam[[SelfType], LocalReturnType],
        *,
    ...
    async def execute_update_with_start_workflow(
        self,
        update: zamp_temporalio.workflow.UpdateMethodMultiParam[
    ...
    async def _start_update_with_start(
        ...
        *,
        ...
        update_name, result_type_from_type_hint = (
            zamp_temporalio.workflow._UpdateDefinition.get_name_and_result_type(update)
        )
        ...
        def on_start(
            start_response: zamp_temporalio.api.workflowservice.v1.StartWorkflowExecutionResponse,
        ):
        ...
        *,
        ...
        Raises:
            ScheduleAlreadyRunningError: If a schedule with this ID is already
                running.
        """
        zamp_temporalio.common._warn_on_deprecated_search_attributes(search_attributes)
...
class ClientConfig(TypedDict, total=False):
    ...
    service_client: Required[zamp_temporalio.service.ServiceClient]
    namespace: Required[str]
    data_converter: Required[zamp_temporalio.converter.DataConverter]
    interceptors: Required[Sequence[Interceptor]]
    default_workflow_query_reject_condition: Required[
        Optional[zamp_temporalio.common.QueryRejectCondition]
    ]
...
class WorkflowHistoryEventFilterType(IntEnum):
    ...
    See :py:class:`zamp_temporalio.api.enums.v1.HistoryEventFilterType`.
    """

    ALL_EVENT = int(
        zamp_temporalio.api.enums.v1.HistoryEventFilterType.HISTORY_EVENT_FILTER_TYPE_ALL_EVENT
    )
    CLOSE_EVENT = int(
        zamp_temporalio.api.enums.v1.HistoryEventFilterType.HISTORY_EVENT_FILTER_TYPE_CLOSE_EVENT
    )
...
class WorkflowHandle(Generic[SelfType, ReturnType]):
        ...
        while True:
            async for event in self._fetch_history_events_for_run(
                ...
                if event.HasField("workflow_execution_completed_event_attributes"):
                    ...
                    raise WorkflowFailureError(
                        cause=zamp_temporalio.exceptions.CancelledError(
                            "Workflow cancelled",
                            *(
                    ...
                    raise WorkflowFailureError(
                        cause=zamp_temporalio.exceptions.TerminatedError(
                    ...
                    if follow_runs and time_attr.new_execution_run_id:
                        ...
                        break
                    raise WorkflowFailureError(
                        cause=zamp_temporalio.exceptions.TimeoutError(
                            "Workflow timed out",
                            type=zamp_temporalio.exceptions.TimeoutType.START_TO_CLOSE,
    ...
    async def query(
        ...
        *,
        reject_condition: Optional[zamp_temporalio.common.QueryRejectCondition] = None,
        rpc_metadata: Mapping[str, str] = {},
        rpc_timeout: Optional[timedelta] = None,
    ) -> LocalReturnType: ...
    ...
    async def query(
        ...
        *,
        ...
        if callable(query):
            defn = zamp_temporalio.workflow._QueryDefinition.from_fn(query)
            if not defn:
                raise RuntimeError(
        ...
        *,
        ...
        await self._client._impl.signal_workflow(
            SignalWorkflowInput(
                id=self._id,
                run_id=self._run_id,
                signal=zamp_temporalio.workflow._SignalDefinition.must_name_from_fn_or_str(
                    signal
                ),
                args=zamp_temporalio.common._arg_or_args(arg, args),
                headers={},
    ...
    def get_update_handle_for(
        self,
        update: zamp_temporalio.workflow.UpdateMethodMultiParam[Any, LocalReturnType],
        id: str,
        *,
        workflow_run_id: Optional[str] = None,
    ) -> WorkflowUpdateHandle[LocalReturnType]:
...
class WithStartWorkflowOperation(Generic[SelfType, ReturnType]):
    ...
    def __init__(
        ...
        *,
        id: str,
        task_queue: str,
        id_conflict_policy: zamp_temporalio.common.WorkflowIDConflictPolicy,
        execution_timeout: Optional[timedelta] = None,
        run_timeout: Optional[timedelta] = None,
        task_timeout: Optional[timedelta] = None,
        id_reuse_policy: zamp_temporalio.common.WorkflowIDReusePolicy = zamp_temporalio.common.WorkflowIDReusePolicy.ALLOW_DUPLICATE,
    ...
    def __init__(
        ...
        *,
        ...
        See :py:meth:`zamp_temporalio.client.Client.start_workflow` for documentation of the
        arguments.
        """
        zamp_temporalio.common._warn_on_deprecated_search_attributes(
            search_attributes, stack_level=stack_level
        ...
        if id_conflict_policy == zamp_temporalio.common.WorkflowIDConflictPolicy.UNSPECIFIED:
...
class AsyncActivityHandle:
    ...
    async def complete(
        self,
        result: Optional[Any] = zamp_temporalio.common._arg_unset,
        *,
        rpc_metadata: Mapping[str, str] = {},
        rpc_timeout: Optional[timedelta] = None,
    ) -> None:
...
class WorkflowExecution:
    ...
    data_converter: zamp_temporalio.converter.DataConverter
    ...
    raw_info: zamp_temporalio.api.workflow.v1.WorkflowExecutionInfo
    """Underlying protobuf info."""

    run_id: str
    """Run ID for this workflow run."""

    search_attributes: zamp_temporalio.common.SearchAttributes
    ...
    typed_search_attributes: zamp_temporalio.common.TypedSearchAttributes
    """Current set of search attributes if any."""
    ...
    def _from_raw_info(
        cls,
        info: zamp_temporalio.api.workflow.v1.WorkflowExecutionInfo,
        converter: zamp_temporalio.converter.DataConverter,
        **additional_fields,
    ) -> WorkflowExecution:
        return cls(
            ...
            search_attributes=zamp_temporalio.converter.decode_search_attributes(
            ...
            typed_search_attributes=zamp_temporalio.converter.decode_typed_search_attributes(
                info.search_attributes
            ),
    ...
    async def memo_value(
        self, key: str, default: Any = zamp_temporalio.common._arg_unset
    ) -> Any: ...
    ...
    async def memo_value(
        self,
        key: str,
        default: Any = zamp_temporalio.common._arg_unset,
        *,
        ...
        if not payload:
            if default is zamp_temporalio.common._arg_unset:
...
class WorkflowExecutionDescription(WorkflowExecution):
    ...
    raw_description: zamp_temporalio.api.workflowservice.v1.DescribeWorkflowExecutionResponse
    ...
    async def _from_raw_description(
        description: zamp_temporalio.api.workflowservice.v1.DescribeWorkflowExecutionResponse,
        converter: zamp_temporalio.converter.DataConverter,
    ) -> WorkflowExecutionDescription:
...
class WorkflowExecutionStatus(IntEnum):
    ...
    See :py:class:`zamp_temporalio.api.enums.v1.WorkflowExecutionStatus`.
    """

    RUNNING = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_RUNNING
    )
    COMPLETED = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_COMPLETED
    )
    FAILED = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_FAILED
    )
    CANCELED = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_CANCELED
    )
    TERMINATED = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_TERMINATED
    )
    CONTINUED_AS_NEW = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_CONTINUED_AS_NEW
    )
    TIMED_OUT = int(
        zamp_temporalio.api.enums.v1.WorkflowExecutionStatus.WORKFLOW_EXECUTION_STATUS_TIMED_OUT
    )
...
class WorkflowExecutionCount:
    ...
    @staticmethod
    def _from_raw(
        raw: zamp_temporalio.api.workflowservice.v1.CountWorkflowExecutionsResponse,
    ) -> WorkflowExecutionCount:
...
class WorkflowExecutionCountAggregationGroup:
    ...
    group_values: Sequence[zamp_temporalio.common.SearchAttributeValue]
    """Search attribute values for this group."""

    @staticmethod
    def _from_raw(
        raw: zamp_temporalio.api.workflowservice.v1.CountWorkflowExecutionsResponse.AggregationGroup,
    ) -> WorkflowExecutionCountAggregationGroup:
        return WorkflowExecutionCountAggregationGroup(
            count=raw.count,
            group_values=[
                zamp_temporalio.converter._decode_search_attribute_value(v)
...
class WorkflowExecutionAsyncIterator:
    ...
    async def fetch_next_page(self, *, page_size: Optional[int] = None) -> None:
        ...
        resp = await self._client.workflow_service.list_workflow_executions(
            zamp_temporalio.api.workflowservice.v1.ListWorkflowExecutionsRequest(
...
class WorkflowHistory:
    ...
    events: Sequence[zamp_temporalio.api.history.v1.HistoryEvent]
    ...
    def to_json(self) -> str:
        ...
        return google.protobuf.json_format.MessageToJson(
            zamp_temporalio.api.history.v1.History(events=self.events)
        )
...
class WorkflowHistoryEventAsyncIterator:
    ...
    def __init__(
        ...
        self._current_page: Optional[
            Sequence[zamp_temporalio.api.history.v1.HistoryEvent]
        ] = None
        self._current_page_index = 0
    ...
    def current_page(
        self,
    ) -> Optional[Sequence[zamp_temporalio.api.history.v1.HistoryEvent]]:
        """Current page, if it has been fetched yet."""
        return self._current_page
    ...
    async def fetch_next_page(self, *, page_size: Optional[int] = None) -> None:
        ...
        resp = await self._client.workflow_service.get_workflow_execution_history(
            zamp_temporalio.api.workflowservice.v1.GetWorkflowExecutionHistoryRequest(
                namespace=self._client.namespace,
                execution=zamp_temporalio.api.common.v1.WorkflowExecution(
                ...
                history_event_filter_type=zamp_temporalio.api.enums.v1.HistoryEventFilterType.ValueType(
    ...
    async def __anext__(self) -> zamp_temporalio.api.history.v1.HistoryEvent:
        """Get the next execution on this iterator, fetching next page if
        necessary.
        """
        while True:
...
class ScheduleSpec:
    ...
    @staticmethod
    def _from_proto(spec: zamp_temporalio.api.schedule.v1.ScheduleSpec) -> ScheduleSpec:
        return ScheduleSpec(
            calendars=[
    ...
    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.ScheduleSpec:
        ...
        return zamp_temporalio.api.schedule.v1.ScheduleSpec(
...
class ScheduleRange:
    ...
    @staticmethod
    def _from_protos(
        ranges: Sequence[zamp_temporalio.api.schedule.v1.Range],
    ) -> Sequence[ScheduleRange]:
        return tuple(ScheduleRange._from_proto(r) for r in ranges)

    @staticmethod
    def _from_proto(range: zamp_temporalio.api.schedule.v1.Range) -> ScheduleRange:
        return ScheduleRange(start=range.start, end=range.end, step=range.step)

    @staticmethod
    def _to_protos(
        ranges: Sequence[ScheduleRange],
    ) -> Sequence[zamp_temporalio.api.schedule.v1.Range]:
        return tuple(r._to_proto() for r in ranges)

    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.Range:
        return zamp_temporalio.api.schedule.v1.Range(
...
class ScheduleCalendarSpec:
    ...
    @staticmethod
    def _from_proto(
        spec: zamp_temporalio.api.schedule.v1.StructuredCalendarSpec,
    ...
    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.StructuredCalendarSpec:
        return zamp_temporalio.api.schedule.v1.StructuredCalendarSpec(
...
class ScheduleIntervalSpec:
    ...
    @staticmethod
    def _from_proto(
        spec: zamp_temporalio.api.schedule.v1.IntervalSpec,
    ...
    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.IntervalSpec:
        ...
        return zamp_temporalio.api.schedule.v1.IntervalSpec(interval=interval, phase=phase)
...
class ScheduleAction(ABC):
    ...
    @staticmethod
    def _from_proto(
        action: zamp_temporalio.api.schedule.v1.ScheduleAction,
    ) -> ScheduleAction:
    ...
    async def _to_proto(
        self, client: Client
    ) -> zamp_temporalio.api.schedule.v1.ScheduleAction: ...
...
class ScheduleActionStartWorkflow(ScheduleAction):
    ...
    workflow: str
    args: Union[Sequence[Any], Sequence[zamp_temporalio.api.common.v1.Payload]]
    id: str
    task_queue: str
    execution_timeout: Optional[timedelta]
    run_timeout: Optional[timedelta]
    task_timeout: Optional[timedelta]
    retry_policy: Optional[zamp_temporalio.common.RetryPolicy]
    memo: Optional[
        Union[Mapping[str, Any], Mapping[str, zamp_temporalio.api.common.v1.Payload]]
    ]
    typed_search_attributes: zamp_temporalio.common.TypedSearchAttributes
    untyped_search_attributes: zamp_temporalio.common.SearchAttributes
    ...
    creating."""
    static_summary: Optional[Union[str, zamp_temporalio.api.common.v1.Payload]]
    static_details: Optional[Union[str, zamp_temporalio.api.common.v1.Payload]]
    priority: zamp_temporalio.common.Priority

    headers: Optional[Mapping[str, zamp_temporalio.api.common.v1.Payload]]

    @staticmethod
    def _from_proto(  # pyright: ignore
        info: zamp_temporalio.api.workflow.v1.NewWorkflowExecutionInfo,  # type: ignore[override]
    ...
    def __init__(
        ...
        *,
        ...
        retry_policy: Optional[zamp_temporalio.common.RetryPolicy] = None,
        memo: Optional[Mapping[str, Any]] = None,
        typed_search_attributes: zamp_temporalio.common.TypedSearchAttributes = zamp_temporalio.common.TypedSearchAttributes.empty,
        static_summary: Optional[str] = None,
        static_details: Optional[str] = None,
        priority: zamp_temporalio.common.Priority = zamp_temporalio.common.Priority.default,
    ) -> None: ...
    ...
    def __init__(
        ...
        workflow: str,
        *,
        raw_info: zamp_temporalio.api.workflow.v1.NewWorkflowExecutionInfo,
    ) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        static_summary: Optional[str] = None,
        static_details: Optional[str] = None,
        headers: Optional[Mapping[str, zamp_temporalio.api.common.v1.Payload]] = None,
        raw_info: Optional[zamp_temporalio.api.workflow.v1.NewWorkflowExecutionInfo] = None,
        priority: zamp_temporalio.common.Priority = zamp_temporalio.common.Priority.default,
    ) -> None:
        ...
        if raw_info:
            ...
            self.retry_policy = (
                zamp_temporalio.common.RetryPolicy.from_proto(raw_info.retry_policy)
            ...
            self.typed_search_attributes = (
                zamp_temporalio.converter.decode_typed_search_attributes(
            ...
            self.untyped_search_attributes = (
                zamp_temporalio.converter.decode_search_attributes(
                    raw_info.search_attributes
                )
            )
            ...
            self.priority = (
                zamp_temporalio.common.Priority._from_proto(raw_info.priority)
                if raw_info.HasField("priority") and raw_info.priority
                else zamp_temporalio.common.Priority.default
            )
        else:
            if not id:
            ...
            self.args = zamp_temporalio.common._arg_or_args(arg, args)
            self.id = id
    ...
    async def _to_proto(
        ...
        retry_policy: Optional[zamp_temporalio.api.common.v1.RetryPolicy] = None
        if self.retry_policy:
            retry_policy = zamp_temporalio.api.common.v1.RetryPolicy()
            self.retry_policy.apply_to_proto(retry_policy)
        priority: Optional[zamp_temporalio.api.common.v1.Priority] = None
        if self.priority:
            priority = self.priority._to_proto()
        action = zamp_temporalio.api.schedule.v1.ScheduleAction(
            start_workflow=zamp_temporalio.api.workflow.v1.NewWorkflowExecutionInfo(
                workflow_id=self.id,
                workflow_type=zamp_temporalio.api.common.v1.WorkflowType(name=self.workflow),
                task_queue=zamp_temporalio.api.taskqueue.v1.TaskQueue(name=self.task_queue),
                input=None
                if not self.args
                else zamp_temporalio.api.common.v1.Payloads(
                    payloads=[
                        a
                        if isinstance(a, zamp_temporalio.api.common.v1.Payload)
                ...
                memo=None
                if not self.memo
                else zamp_temporalio.api.common.v1.Memo(
                    fields={
                        k: v
                        if isinstance(v, zamp_temporalio.api.common.v1.Payload)
        ...
        if untyped_not_in_typed:
            zamp_temporalio.converter.encode_search_attributes(
        ...
        if self.headers:
            zamp_temporalio.common._apply_headers(
...
class ScheduleOverlapPolicy(IntEnum):
    ...
    SKIP = int(
        zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_SKIP
    )
    ...
    BUFFER_ONE = int(
        zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_BUFFER_ONE
    )
    ...
    BUFFER_ALL = int(
        zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_BUFFER_ALL
    )
    """Buffer up any number of starts to all happen sequentially, immediately
    after the running workflow completes."""

    CANCEL_OTHER = int(
        zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_CANCEL_OTHER
    )
    """If there is another workflow running, cancel it, and start the new one
    after the old one completes cancellation."""

    TERMINATE_OTHER = int(
        zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_TERMINATE_OTHER
    )
    """If there is another workflow running, terminate it and start the new one
    immediately."""

    ALLOW_ALL = int(
        zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_ALLOW_ALL
    )
...
class ScheduleBackfill:
    ...
    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.BackfillRequest:
        start_time = google.protobuf.timestamp_pb2.Timestamp()
        start_time.FromDatetime(self.start_at)
        end_time = google.protobuf.timestamp_pb2.Timestamp()
        end_time.FromDatetime(self.end_at)
        overlap_policy = zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.SCHEDULE_OVERLAP_POLICY_UNSPECIFIED
        if self.overlap:
            overlap_policy = zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.ValueType(
                self.overlap
            )
        return zamp_temporalio.api.schedule.v1.BackfillRequest(
            start_time=start_time,
            end_time=end_time,
...
class SchedulePolicy:
    ...
    @staticmethod
    def _from_proto(pol: zamp_temporalio.api.schedule.v1.SchedulePolicies) -> SchedulePolicy:
    ...
    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.SchedulePolicies:
        catchup_window = google.protobuf.duration_pb2.Duration()
        catchup_window.FromTimedelta(self.catchup_window)
        return zamp_temporalio.api.schedule.v1.SchedulePolicies(
            overlap_policy=zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.ValueType(
                self.overlap
            ),
...
class ScheduleState:
    ...
    @staticmethod
    def _from_proto(state: zamp_temporalio.api.schedule.v1.ScheduleState) -> ScheduleState:
    ...
    def _to_proto(self) -> zamp_temporalio.api.schedule.v1.ScheduleState:
        return zamp_temporalio.api.schedule.v1.ScheduleState(
            notes=self.note or "",
            paused=self.paused,
...
class Schedule:
    ...
    @staticmethod
    def _from_proto(sched: zamp_temporalio.api.schedule.v1.Schedule) -> Schedule:
        return Schedule(
    ...
    async def _to_proto(self, client: Client) -> zamp_temporalio.api.schedule.v1.Schedule:
        catchup_window = google.protobuf.duration_pb2.Duration()
        catchup_window.FromTimedelta(self.policy.catchup_window)
        return zamp_temporalio.api.schedule.v1.Schedule(
...
class ScheduleDescription:
    ...
    raw_description: zamp_temporalio.api.workflowservice.v1.DescribeScheduleResponse
    """Raw description of the schedule."""

    @staticmethod
    def _from_proto(
        id: str,
        desc: zamp_temporalio.api.workflowservice.v1.DescribeScheduleResponse,
        converter: zamp_temporalio.converter.DataConverter,
    ) -> ScheduleDescription:
...
class ScheduleInfo:
    ...
    @staticmethod
    def _from_proto(info: zamp_temporalio.api.schedule.v1.ScheduleInfo) -> ScheduleInfo:
        return ScheduleInfo(
...
class ScheduleActionExecutionStartWorkflow(ScheduleActionExecution):
    ...
    @staticmethod
    def _from_proto(
        exec: zamp_temporalio.api.common.v1.WorkflowExecution,
...
class ScheduleActionResult:
    ...
    @staticmethod
    def _from_proto(
        res: zamp_temporalio.api.schedule.v1.ScheduleActionResult,
...
class ScheduleUpdate:
    ...
    search_attributes: Optional[zamp_temporalio.common.TypedSearchAttributes] = None
...
class ScheduleListDescription:
    ...
    raw_entry: zamp_temporalio.api.schedule.v1.ScheduleListEntry
    """Raw description of the schedule."""

    @staticmethod
    def _from_proto(
        entry: zamp_temporalio.api.schedule.v1.ScheduleListEntry,
        converter: zamp_temporalio.converter.DataConverter,
...
class ScheduleListSchedule:
    ...
    @staticmethod
    def _from_proto(
        info: zamp_temporalio.api.schedule.v1.ScheduleListInfo,
...
class ScheduleAsyncIterator:
    ...
    async def fetch_next_page(self, *, page_size: Optional[int] = None) -> None:
        ...
        resp = await self._client.workflow_service.list_schedules(
            zamp_temporalio.api.workflowservice.v1.ListSchedulesRequest(
                namespace=self._client.namespace,
...
class WorkflowUpdateHandle(Generic[LocalReturnType]):
    ...
    def __init__(
        ...
        *,
        workflow_run_id: Optional[str] = None,
        result_type: Optional[Type] = None,
        known_outcome: Optional[zamp_temporalio.api.update.v1.Outcome] = None,
    ):
    ...
    async def _poll_until_outcome(
        ...
        if self._known_outcome:
            return
        req = zamp_temporalio.api.workflowservice.v1.PollWorkflowExecutionUpdateRequest(
            namespace=self._client.namespace,
            update_ref=zamp_temporalio.api.update.v1.UpdateRef(
                workflow_execution=zamp_temporalio.api.common.v1.WorkflowExecution(
            ...
            wait_policy=zamp_temporalio.api.update.v1.WaitPolicy(
                lifecycle_stage=zamp_temporalio.api.enums.v1.UpdateWorkflowExecutionLifecycleStage.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED
            ),
        )
...
class WorkflowUpdateStage(IntEnum):
    ...
    ADMITTED = int(
        zamp_temporalio.api.enums.v1.UpdateWorkflowExecutionLifecycleStage.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_ADMITTED
    )
    ACCEPTED = int(
        zamp_temporalio.api.enums.v1.UpdateWorkflowExecutionLifecycleStage.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_ACCEPTED
    )
    COMPLETED = int(
        zamp_temporalio.api.enums.v1.UpdateWorkflowExecutionLifecycleStage.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED
    )


class WorkflowFailureError(zamp_temporalio.exceptions.TemporalError):
...
class WorkflowContinuedAsNewError(zamp_temporalio.exceptions.TemporalError):
...
class WorkflowQueryRejectedError(zamp_temporalio.exceptions.TemporalError):
...
class WorkflowQueryFailedError(zamp_temporalio.exceptions.TemporalError):
...
class WorkflowUpdateFailedError(zamp_temporalio.exceptions.TemporalError):
...
class RPCTimeoutOrCancelledError(zamp_temporalio.exceptions.TemporalError):
...
class AsyncActivityCancelledError(zamp_temporalio.exceptions.TemporalError):
...
class ScheduleAlreadyRunningError(zamp_temporalio.exceptions.TemporalError):
...
class StartWorkflowInput:
    ...
    run_timeout: Optional[timedelta]
    task_timeout: Optional[timedelta]
    id_reuse_policy: zamp_temporalio.common.WorkflowIDReusePolicy
    id_conflict_policy: zamp_temporalio.common.WorkflowIDConflictPolicy
    retry_policy: Optional[zamp_temporalio.common.RetryPolicy]
    cron_schedule: str
    ...
    search_attributes: Optional[
        Union[
            zamp_temporalio.common.SearchAttributes, zamp_temporalio.common.TypedSearchAttributes
        ]
    ]
    start_delay: Optional[timedelta]
    headers: Mapping[str, zamp_temporalio.api.common.v1.Payload]
...
class QueryWorkflowInput:
    ...
    query: str
    args: Sequence[Any]
    reject_condition: Optional[zamp_temporalio.common.QueryRejectCondition]
    headers: Mapping[str, zamp_temporalio.api.common.v1.Payload]
    # Type may be absent
    ret_type: Optional[Type]
    rpc_metadata: Mapping[str, str]
...
class StartWorkflowUpdateWithStartInput:
    ...
    _on_start: Callable[
        [zamp_temporalio.api.workflowservice.v1.StartWorkflowExecutionResponse], None
    ]
...
class _ClientImpl(OutboundInterceptor):
    ...
    async def start_workflow(
        ...
        req: Union[
            zamp_temporalio.api.workflowservice.v1.StartWorkflowExecutionRequest,
            zamp_temporalio.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest,
        ]
        ...
        resp: Union[
            zamp_temporalio.api.workflowservice.v1.StartWorkflowExecutionResponse,
            zamp_temporalio.api.workflowservice.v1.SignalWithStartWorkflowExecutionResponse,
        ]
        ...
        try:
            ...
            if err.status == RPCStatusCode.ALREADY_EXISTS and err.grpc_status.details:
                details = zamp_temporalio.api.errordetails.v1.WorkflowExecutionAlreadyStartedFailure()
                if err.grpc_status.details[0].Unpack(details):
                    raise zamp_temporalio.exceptions.WorkflowAlreadyStartedError(
    ...
    async def _build_start_workflow_execution_request(
        ...
        req = zamp_temporalio.api.workflowservice.v1.StartWorkflowExecutionRequest()
    ...
    async def _build_signal_with_start_workflow_execution_request(
        ...
        req = zamp_temporalio.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest(
    ...
    async def _populate_start_workflow_execution_request(
        ...
        req.workflow_id_reuse_policy = cast(
            "zamp_temporalio.api.enums.v1.WorkflowIdReusePolicy.ValueType",
            int(input.id_reuse_policy),
        )
        req.workflow_id_conflict_policy = cast(
            "zamp_temporalio.api.enums.v1.WorkflowIdConflictPolicy.ValueType",
        ...
        if input.headers is not None:
            zamp_temporalio.common._apply_headers(input.headers, req.header.fields)
        if input.priority is not None:
            req.priority.CopyFrom(input.priority._to_proto())

    async def cancel_workflow(self, input: CancelWorkflowInput) -> None:
        await self._client.workflow_service.request_cancel_workflow_execution(
            zamp_temporalio.api.workflowservice.v1.RequestCancelWorkflowExecutionRequest(
                namespace=self._client.namespace,
                workflow_execution=zamp_temporalio.api.common.v1.WorkflowExecution(
    ...
    async def describe_workflow(
        ...
        return await WorkflowExecutionDescription._from_raw_description(
            await self._client.workflow_service.describe_workflow_execution(
                zamp_temporalio.api.workflowservice.v1.DescribeWorkflowExecutionRequest(
                    namespace=self._client.namespace,
                    execution=zamp_temporalio.api.common.v1.WorkflowExecution(
                        workflow_id=input.id,
                        run_id=input.run_id or "",
    ...
    async def count_workflows(
        ...
        return WorkflowExecutionCount._from_raw(
            await self._client.workflow_service.count_workflow_executions(
                zamp_temporalio.api.workflowservice.v1.CountWorkflowExecutionsRequest(
                    namespace=self._client.namespace,
    ...
    async def query_workflow(self, input: QueryWorkflowInput) -> Any:
        req = zamp_temporalio.api.workflowservice.v1.QueryWorkflowRequest(
            namespace=self._client.namespace,
            execution=zamp_temporalio.api.common.v1.WorkflowExecution(
                workflow_id=input.id,
                run_id=input.run_id or "",
        ...
        if input.reject_condition:
            req.query_reject_condition = cast(
                "zamp_temporalio.api.enums.v1.QueryRejectCondition.ValueType",
        ...
        if input.headers is not None:
            zamp_temporalio.common._apply_headers(input.headers, req.query.header.fields)
        try:
    ...
    async def signal_workflow(self, input: SignalWorkflowInput) -> None:
        req = zamp_temporalio.api.workflowservice.v1.SignalWorkflowExecutionRequest(
            namespace=self._client.namespace,
            workflow_execution=zamp_temporalio.api.common.v1.WorkflowExecution(
                workflow_id=input.id,
                run_id=input.run_id or "",
    ...
    async def terminate_workflow(self, input: TerminateWorkflowInput) -> None:
        req = zamp_temporalio.api.workflowservice.v1.TerminateWorkflowExecutionRequest(
            namespace=self._client.namespace,
            workflow_execution=zamp_temporalio.api.common.v1.WorkflowExecution(
                workflow_id=input.id,
                run_id=input.run_id or "",
    ...
    async def start_workflow_update(
        ...
        resp: zamp_temporalio.api.workflowservice.v1.UpdateWorkflowExecutionResponse
        while True:
            try:
    ...
    async def _build_update_workflow_execution_request(
        ...
        workflow_id: str,
    ) -> zamp_temporalio.api.workflowservice.v1.UpdateWorkflowExecutionRequest:
        ...
        req = zamp_temporalio.api.workflowservice.v1.UpdateWorkflowExecutionRequest(
            namespace=self._client.namespace,
            workflow_execution=zamp_temporalio.api.common.v1.WorkflowExecution(
                workflow_id=workflow_id,
                run_id=run_id or "",
            ...
            request=zamp_temporalio.api.update.v1.Request(
                meta=zamp_temporalio.api.update.v1.Meta(
                    update_id=input.update_id or str(uuid.uuid4()),
                    identity=self._client.identity,
                ),
                input=zamp_temporalio.api.update.v1.Input(
                    name=input.update,
                ),
            ),
            wait_policy=zamp_temporalio.api.update.v1.WaitPolicy(
                lifecycle_stage=zamp_temporalio.api.enums.v1.UpdateWorkflowExecutionLifecycleStage.ValueType(
    ...
    async def start_update_with_start_workflow(
        ...
        try:
            ...
            if err.status in [
                ...
                multiop_failure = (
                    zamp_temporalio.api.errordetails.v1.MultiOperationExecutionFailure()
                )
                        ...
                        (
                            ...
                            if (
                                ...
                                and not (
                                    st.details
                                    and st.details[0].Is(
                                        zamp_temporalio.api.failure.v1.MultiOperationExecutionAborted.DESCRIPTOR
                                    )
                                )
                            )
                        ),
                    ...
                    if status and status.code in list(RPCStatusCode):
                        if (
                            ...
                            if status.details[0].Unpack(details):
                                err = zamp_temporalio.exceptions.WorkflowAlreadyStartedError(
    ...
    async def _start_workflow_update_with_start(
        ...
        multiop_req = zamp_temporalio.api.workflowservice.v1.ExecuteMultiOperationRequest(
            namespace=self._client.namespace,
            operations=[
                zamp_temporalio.api.workflowservice.v1.ExecuteMultiOperationRequest.Operation(
    ...
    async def heartbeat_async_activity(
        ...
        if isinstance(input.id_or_token, AsyncActivityIDReference):
            resp_by_id = await self._client.workflow_service.record_activity_task_heartbeat_by_id(
                zamp_temporalio.api.workflowservice.v1.RecordActivityTaskHeartbeatByIdRequest(
            ...
            resp = await self._client.workflow_service.record_activity_task_heartbeat(
                zamp_temporalio.api.workflowservice.v1.RecordActivityTaskHeartbeatRequest(
    ...
    async def complete_async_activity(self, input: CompleteAsyncActivityInput) -> None:
        result = (
            None
            if input.result is zamp_temporalio.common._arg_unset
        ...
        if isinstance(input.id_or_token, AsyncActivityIDReference):
            await self._client.workflow_service.respond_activity_task_completed_by_id(
                zamp_temporalio.api.workflowservice.v1.RespondActivityTaskCompletedByIdRequest(
                    workflow_id=input.id_or_token.workflow_id,
                    run_id=input.id_or_token.run_id or "",
                    activity_id=input.id_or_token.activity_id,
                    namespace=self._client.namespace,
            ...
            await self._client.workflow_service.respond_activity_task_completed(
                zamp_temporalio.api.workflowservice.v1.RespondActivityTaskCompletedRequest(
                    task_token=input.id_or_token,
                    namespace=self._client.namespace,
                    identity=self._client.identity,
                    result=result,
    ...
    async def fail_async_activity(self, input: FailAsyncActivityInput) -> None:
        failure = zamp_temporalio.api.failure.v1.Failure()
        ...
        if isinstance(input.id_or_token, AsyncActivityIDReference):
            await self._client.workflow_service.respond_activity_task_failed_by_id(
                zamp_temporalio.api.workflowservice.v1.RespondActivityTaskFailedByIdRequest(
                    workflow_id=input.id_or_token.workflow_id,
                    run_id=input.id_or_token.run_id or "",
                    activity_id=input.id_or_token.activity_id,
                    namespace=self._client.namespace,
            ...
            await self._client.workflow_service.respond_activity_task_failed(
                zamp_temporalio.api.workflowservice.v1.RespondActivityTaskFailedRequest(
                    task_token=input.id_or_token,
                    namespace=self._client.namespace,
                    identity=self._client.identity,
                    failure=failure,
    ...
    async def report_cancellation_async_activity(
        ...
        if isinstance(input.id_or_token, AsyncActivityIDReference):
            await self._client.workflow_service.respond_activity_task_canceled_by_id(
                zamp_temporalio.api.workflowservice.v1.RespondActivityTaskCanceledByIdRequest(
                    workflow_id=input.id_or_token.workflow_id,
                    run_id=input.id_or_token.run_id or "",
                    activity_id=input.id_or_token.activity_id,
                    namespace=self._client.namespace,
            ...
            await self._client.workflow_service.respond_activity_task_canceled(
                zamp_temporalio.api.workflowservice.v1.RespondActivityTaskCanceledRequest(
                    task_token=input.id_or_token,
                    namespace=self._client.namespace,
                    identity=self._client.identity,
                    details=details,
    ...
    async def create_schedule(self, input: CreateScheduleInput) -> ScheduleHandle:
        ...
        initial_patch: Optional[zamp_temporalio.api.schedule.v1.SchedulePatch] = None
        if input.trigger_immediately or input.backfill:
            initial_patch = zamp_temporalio.api.schedule.v1.SchedulePatch(
                trigger_immediately=zamp_temporalio.api.schedule.v1.TriggerImmediatelyRequest(
                    overlap_policy=zamp_temporalio.api.enums.v1.ScheduleOverlapPolicy.ValueType(
        ...
        try:
            request = zamp_temporalio.api.workflowservice.v1.CreateScheduleRequest(
                namespace=self._client.namespace,
            ...
            already_started = (
                ...
                and err.grpc_status.details[0].Is(
                    zamp_temporalio.api.errordetails.v1.WorkflowExecutionAlreadyStartedFailure.DESCRIPTOR
                )
            )
            if already_started:
    ...
    async def backfill_schedule(self, input: BackfillScheduleInput) -> None:
        await self._client.workflow_service.patch_schedule(
            zamp_temporalio.api.workflowservice.v1.PatchScheduleRequest(
                namespace=self._client.namespace,
                schedule_id=input.id,
                patch=zamp_temporalio.api.schedule.v1.SchedulePatch(
    ...
    async def delete_schedule(self, input: DeleteScheduleInput) -> None:
        await self._client.workflow_service.delete_schedule(
            zamp_temporalio.api.workflowservice.v1.DeleteScheduleRequest(
                namespace=self._client.namespace,
                schedule_id=input.id,
                identity=self._client.identity,
            ),
    ...
    async def describe_schedule(
        ...
        return ScheduleDescription._from_proto(
            ...
            await self._client.workflow_service.describe_schedule(
                zamp_temporalio.api.workflowservice.v1.DescribeScheduleRequest(
                    namespace=self._client.namespace,
                    schedule_id=input.id,
                ),
                retry=True,
    ...
    async def update_schedule(self, input: UpdateScheduleInput) -> None:
        ...
        request = zamp_temporalio.api.workflowservice.v1.UpdateScheduleRequest(
            namespace=self._client.namespace,
            schedule_id=input.id,
    ...
    async def get_worker_build_id_compatibility(
        ...
        req = zamp_temporalio.api.workflowservice.v1.GetWorkerBuildIdCompatibilityRequest(
            namespace=self._client.namespace,
    ...
    async def get_worker_task_reachability(
        ...
        req = zamp_temporalio.api.workflowservice.v1.GetWorkerTaskReachabilityRequest(
            namespace=self._client.namespace,
            build_ids=input.build_ids,
            task_queues=input.task_queues,
            reachability=input.reachability._to_proto()
            if input.reachability
            else zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_UNSPECIFIED,
        )
...
def _history_from_json(
...
) -> zamp_temporalio.api.history.v1.History:
    ...
    return google.protobuf.json_format.ParseDict(
        history, zamp_temporalio.api.history.v1.History(), ignore_unknown_fields=True
    )
...
class WorkerBuildIdVersionSets:
    ...
    @staticmethod
    def _from_proto(
        resp: zamp_temporalio.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse,
    ) -> WorkerBuildIdVersionSets:
...
class BuildIdOp(ABC):
    ...
    def _as_partial_proto(
        self,
    ) -> zamp_temporalio.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest:
...
class BuildIdOpAddNewCompatible(BuildIdOp):
    ...
    def _as_partial_proto(
        ...
        return zamp_temporalio.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest(
            add_new_compatible_build_id=zamp_temporalio.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.AddNewCompatibleVersion(
...
class BuildIdOpMergeSets(BuildIdOp):
    ...
    def _as_partial_proto(
        ...
        return zamp_temporalio.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest(
            merge_sets=zamp_temporalio.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.MergeSets(
...
class WorkerTaskReachability:
    ...
    @staticmethod
    def _from_proto(
        resp: zamp_temporalio.api.workflowservice.v1.GetWorkerTaskReachabilityResponse,
    ) -> WorkerTaskReachability:
        mapping = dict()
        for bid_reach in resp.build_id_reachability:
            ...
            for tq_reach in bid_reach.task_queue_reachability:
                if tq_reach.reachability == [
                    zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_UNSPECIFIED
                ]:
...
class TaskReachabilityType(Enum):
    ...
    @staticmethod
    def _from_proto(
        reachability: zamp_temporalio.api.enums.v1.TaskReachability.ValueType,
    ) -> TaskReachabilityType:
        if (
            reachability
            == zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_NEW_WORKFLOWS
        ):
            return TaskReachabilityType.NEW_WORKFLOWS
        elif (
            reachability
            == zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_EXISTING_WORKFLOWS
        ):
            return TaskReachabilityType.EXISTING_WORKFLOWS
        elif (
            reachability
            == zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_OPEN_WORKFLOWS
        ):
            return TaskReachabilityType.OPEN_WORKFLOWS
        elif (
            reachability
            == zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_CLOSED_WORKFLOWS
        ):
            return TaskReachabilityType.CLOSED_WORKFLOWS
        else:
            raise ValueError(f"Cannot convert reachability type: {reachability}")

    def _to_proto(self) -> zamp_temporalio.api.enums.v1.TaskReachability.ValueType:
        if self == TaskReachabilityType.NEW_WORKFLOWS:
            return (
                zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_NEW_WORKFLOWS
            )
        elif self == TaskReachabilityType.EXISTING_WORKFLOWS:
            return zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_EXISTING_WORKFLOWS
        elif self == TaskReachabilityType.OPEN_WORKFLOWS:
            return zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_OPEN_WORKFLOWS
        elif self == TaskReachabilityType.CLOSED_WORKFLOWS:
            return zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_CLOSED_WORKFLOWS
        else:
            return (
                zamp_temporalio.api.enums.v1.TaskReachability.TASK_REACHABILITY_UNSPECIFIED
            )
...
class CloudOperationsClient:
    ...
    @property
    def cloud_service(self) -> zamp_temporalio.service.CloudService:
...
async def _encode_user_metadata(
    converter: zamp_temporalio.converter.DataConverter,
    summary: Optional[Union[str, zamp_temporalio.api.common.v1.Payload]],
    details: Optional[Union[str, zamp_temporalio.api.common.v1.Payload]],
) -> Optional[zamp_temporalio.api.sdk.v1.UserMetadata]:
    ...
    if details is not None:
        if isinstance(details, str):
            ...
            enc_details = details
    return zamp_temporalio.api.sdk.v1.UserMetadata(summary=enc_summary, details=enc_details)


async def _decode_user_metadata(
    converter: zamp_temporalio.converter.DataConverter,
    metadata: Optional[zamp_temporalio.api.sdk.v1.UserMetadata],
