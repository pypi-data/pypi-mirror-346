...
import zamp_temporalio.api.cloud.cloudservice.v1
import zamp_temporalio.api.common.v1
import zamp_temporalio.api.operatorservice.v1
...
import zamp_temporalio.bridge.proto.health.v1
...
class TLSConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.client.ClientTlsConfig:
        return zamp_temporalio.bridge.client.ClientTlsConfig(
...
class RetryConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.client.ClientRetryConfig:
        return zamp_temporalio.bridge.client.ClientRetryConfig(
...
class KeepAliveConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.client.ClientKeepAliveConfig:
        return zamp_temporalio.bridge.client.ClientKeepAliveConfig(
...
class HttpConnectProxyConfig:
    ...
    def _to_bridge_config(
        self,
    ) -> zamp_temporalio.bridge.client.ClientHttpConnectProxyConfig:
        return zamp_temporalio.bridge.client.ClientHttpConnectProxyConfig(
...
class ConnectConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.client.ClientConfig:
        ...
        target_url: str
        tls_config: Optional[zamp_temporalio.bridge.client.ClientTlsConfig]
        ...
        return zamp_temporalio.bridge.client.ClientConfig(
...
class ServiceClient(ABC):
    ...
    def __init__(self, config: ConnectConfig) -> None:
        ...
        self._check_health_call = self._new_call(
            "check",
            zamp_temporalio.bridge.proto.health.v1.HealthCheckRequest,
            zamp_temporalio.bridge.proto.health.v1.HealthCheckResponse,
            service="health",
        )
    ...
    async def check_health(
        ...
        *,
        ...
        resp = await self._check_health_call(
            zamp_temporalio.bridge.proto.health.v1.HealthCheckRequest(service=service),
            retry=retry,
            metadata=metadata,
            timeout=timeout,
        )
        return (
            resp.status
            == zamp_temporalio.bridge.proto.health.v1.HealthCheckResponse.ServingStatus.SERVING
        )
...
class WorkflowService:
    ...
    def __init__(self, client: ServiceClient) -> None:
        ...
        wsv1 = zamp_temporalio.api.workflowservice.v1
...
class OperatorService:
    ...
    def __init__(self, client: ServiceClient) -> None:
        ...
        osv1 = zamp_temporalio.api.operatorservice.v1
...
class CloudService:
    ...
    def __init__(self, client: ServiceClient) -> None:
        ...
        clv1 = zamp_temporalio.api.cloud.cloudservice.v1
...
class TestService:
    ...
    def __init__(self, client: ServiceClient) -> None:
        ...
        tsv1 = zamp_temporalio.api.testservice.v1
...
class _BridgeServiceClient(ServiceClient):
    ...
    def __init__(self, config: ConnectConfig) -> None:
        ...
        self._bridge_client: Optional[zamp_temporalio.bridge.client.Client] = None
        self._bridge_client_connect_lock = asyncio.Lock()

    async def _connected_client(self) -> zamp_temporalio.bridge.client.Client:
        async with self._bridge_client_connect_lock:
            if not self._bridge_client:
                runtime = self.config.runtime or zamp_temporalio.runtime.Runtime.default()
                self._bridge_client = await zamp_temporalio.bridge.client.Client.connect(
    ...
    async def _rpc_call(
        ...
        *,
        ...
        try:
            ...
            return resp
        except zamp_temporalio.bridge.client.RPCError as err:
...
class RPCError(zamp_temporalio.exceptions.TemporalError):
    ...
    def __init__(
        ...
        self._grpc_status: Optional[zamp_temporalio.api.common.v1.GrpcStatus] = None
    ...
    @property
    def grpc_status(self) -> zamp_temporalio.api.common.v1.GrpcStatus:
        """Status of the gRPC call with details."""
        if self._grpc_status is None:
            status = zamp_temporalio.api.common.v1.GrpcStatus()
