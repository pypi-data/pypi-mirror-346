...
import zamp_temporalio.bridge.proto.workflow_commands.workflow_commands_pb2
...
class Success(google.protobuf.message.Message):
    ...
    def commands(
        ...
        zamp_temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.WorkflowCommand
    ]:
...
class Failure(google.protobuf.message.Message):
    ...
    force_cause: (
        zamp_temporalio.api.enums.v1.failed_cause_pb2.WorkflowTaskFailedCause.ValueType
    )
    ...
    def __init__(
        ...
        *,
        ...
        force_cause: zamp_temporalio.api.enums.v1.failed_cause_pb2.WorkflowTaskFailedCause.ValueType = ...,
    ) -> None: ...
    def HasField(
