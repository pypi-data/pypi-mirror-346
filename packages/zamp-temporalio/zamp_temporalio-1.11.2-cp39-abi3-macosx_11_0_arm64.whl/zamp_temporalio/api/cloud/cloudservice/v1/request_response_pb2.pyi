...
import zamp_temporalio.api.cloud.account.v1.message_pb2
import zamp_temporalio.api.cloud.identity.v1.message_pb2
import zamp_temporalio.api.cloud.namespace.v1.message_pb2
import zamp_temporalio.api.cloud.nexus.v1.message_pb2
import zamp_temporalio.api.cloud.operation.v1.message_pb2
import zamp_temporalio.api.cloud.region.v1.message_pb2
import zamp_temporalio.api.cloud.usage.v1.message_pb2
...
class GetUsersResponse(google.protobuf.message.Message):
    ...
    def users(
        ...
        zamp_temporalio.api.cloud.identity.v1.message_pb2.User
    ]:
...
class GetUserResponse(google.protobuf.message.Message):
    ...
    @property
    def user(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.User:
        """The user"""
    def __init__(
        self,
        *,
        user: zamp_temporalio.api.cloud.identity.v1.message_pb2.User | None = ...,
    ) -> None: ...
    def HasField(
...
class CreateUserRequest(google.protobuf.message.Message):
    ...
    @property
    def spec(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.UserSpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.identity.v1.message_pb2.UserSpec | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
...
class CreateUserResponse(google.protobuf.message.Message):
    ...
    def async_operation(
        self,
    ) -> zamp_temporalio.api.cloud.operation.v1.message_pb2.AsyncOperation:
        """The async operation"""
    def __init__(
        self,
        *,
        user_id: builtins.str = ...,
        async_operation: zamp_temporalio.api.cloud.operation.v1.message_pb2.AsyncOperation
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class SetUserNamespaceAccessRequest(google.protobuf.message.Message):
    ...
    @property
    def access(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.NamespaceAccess:
    ...
    def __init__(
        ...
        *,
        namespace: builtins.str = ...,
        user_id: builtins.str = ...,
        access: zamp_temporalio.api.cloud.identity.v1.message_pb2.NamespaceAccess
        | None = ...,
        resource_version: builtins.str = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
...
class CreateNamespaceRequest(google.protobuf.message.Message):
    ...
    ASYNC_OPERATION_ID_FIELD_NUMBER: builtins.int
    @property
    def spec(self) -> zamp_temporalio.api.cloud.namespace.v1.message_pb2.NamespaceSpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.namespace.v1.message_pb2.NamespaceSpec | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["spec", b"spec"]
...
class GetNamespacesResponse(google.protobuf.message.Message):
    ...
    def namespaces(
        ...
        zamp_temporalio.api.cloud.namespace.v1.message_pb2.Namespace
    ]:
...
class GetNamespaceResponse(google.protobuf.message.Message):
    ...
    NAMESPACE_FIELD_NUMBER: builtins.int
    @property
    def namespace(self) -> zamp_temporalio.api.cloud.namespace.v1.message_pb2.Namespace:
        """The namespace."""
    def __init__(
        self,
        *,
        namespace: zamp_temporalio.api.cloud.namespace.v1.message_pb2.Namespace | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["namespace", b"namespace"]
    ) -> builtins.bool: ...
...
class GetRegionsResponse(google.protobuf.message.Message):
    ...
    def regions(
        ...
        zamp_temporalio.api.cloud.region.v1.message_pb2.Region
    ]:
...
class GetRegionResponse(google.protobuf.message.Message):
    ...
    REGION_FIELD_NUMBER: builtins.int
    @property
    def region(self) -> zamp_temporalio.api.cloud.region.v1.message_pb2.Region:
        """The temporal cloud region."""
    def __init__(
        self,
        *,
        region: zamp_temporalio.api.cloud.region.v1.message_pb2.Region | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["region", b"region"]
    ) -> builtins.bool: ...
...
class GetApiKeysRequest(google.protobuf.message.Message):
    ...
    """
    owner_type: zamp_temporalio.api.cloud.identity.v1.message_pb2.OwnerType.ValueType
    """Filter api keys by owner type - optional.
...
class GetApiKeysResponse(google.protobuf.message.Message):
    ...
    def api_keys(
        ...
        zamp_temporalio.api.cloud.identity.v1.message_pb2.ApiKey
    ]:
...
class GetApiKeyResponse(google.protobuf.message.Message):
    ...
    @property
    def api_key(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.ApiKey:
        """The api key."""
    def __init__(
        self,
        *,
        api_key: zamp_temporalio.api.cloud.identity.v1.message_pb2.ApiKey | None = ...,
    ) -> None: ...
    def HasField(
...
class CreateApiKeyRequest(google.protobuf.message.Message):
    ...
    ASYNC_OPERATION_ID_FIELD_NUMBER: builtins.int
    @property
    def spec(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.ApiKeySpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.identity.v1.message_pb2.ApiKeySpec | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["spec", b"spec"]
...
class GetNexusEndpointsResponse(google.protobuf.message.Message):
    ...
    def endpoints(
        ...
        zamp_temporalio.api.cloud.nexus.v1.message_pb2.Endpoint
    ]:
...
class GetNexusEndpointResponse(google.protobuf.message.Message):
    ...
    @property
    def endpoint(self) -> zamp_temporalio.api.cloud.nexus.v1.message_pb2.Endpoint:
        """The nexus endpoint."""
    def __init__(
        self,
        *,
        endpoint: zamp_temporalio.api.cloud.nexus.v1.message_pb2.Endpoint | None = ...,
    ) -> None: ...
    def HasField(
...
class CreateNexusEndpointRequest(google.protobuf.message.Message):
    ...
    ASYNC_OPERATION_ID_FIELD_NUMBER: builtins.int
    @property
    def spec(self) -> zamp_temporalio.api.cloud.nexus.v1.message_pb2.EndpointSpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.nexus.v1.message_pb2.EndpointSpec | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["spec", b"spec"]
...
class GetUserGroupsResponse(google.protobuf.message.Message):
    ...
    def groups(
        ...
        zamp_temporalio.api.cloud.identity.v1.message_pb2.UserGroup
    ]:
...
class GetUserGroupResponse(google.protobuf.message.Message):
    ...
    @property
    def group(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.UserGroup:
        """The group."""
    def __init__(
        self,
        *,
        group: zamp_temporalio.api.cloud.identity.v1.message_pb2.UserGroup | None = ...,
    ) -> None: ...
    def HasField(
...
class CreateUserGroupRequest(google.protobuf.message.Message):
    ...
    ASYNC_OPERATION_ID_FIELD_NUMBER: builtins.int
    @property
    def spec(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.UserGroupSpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.identity.v1.message_pb2.UserGroupSpec | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["spec", b"spec"]
...
class CreateServiceAccountRequest(google.protobuf.message.Message):
    ...
    ASYNC_OPERATION_ID_FIELD_NUMBER: builtins.int
    @property
    def spec(self) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.ServiceAccountSpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.identity.v1.message_pb2.ServiceAccountSpec
        | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
...
class GetServiceAccountResponse(google.protobuf.message.Message):
    ...
    def service_account(
        self,
    ) -> zamp_temporalio.api.cloud.identity.v1.message_pb2.ServiceAccount:
        """The service account retrieved."""
    def __init__(
        self,
        *,
        service_account: zamp_temporalio.api.cloud.identity.v1.message_pb2.ServiceAccount
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class GetUsageResponse(google.protobuf.message.Message):
    ...
    def summaries(
        ...
        zamp_temporalio.api.cloud.usage.v1.message_pb2.Summary
    ]:
...
class GetAccountResponse(google.protobuf.message.Message):
    ...
    @property
    def account(self) -> zamp_temporalio.api.cloud.account.v1.message_pb2.Account:
        """The account."""
    def __init__(
        self,
        *,
        account: zamp_temporalio.api.cloud.account.v1.message_pb2.Account | None = ...,
    ) -> None: ...
    def HasField(
...
class UpdateAccountRequest(google.protobuf.message.Message):
    ...
    ASYNC_OPERATION_ID_FIELD_NUMBER: builtins.int
    @property
    def spec(self) -> zamp_temporalio.api.cloud.account.v1.message_pb2.AccountSpec:
    ...
    def __init__(
        self,
        *,
        spec: zamp_temporalio.api.cloud.account.v1.message_pb2.AccountSpec | None = ...,
        resource_version: builtins.str = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
...
class CreateNamespaceExportSinkRequest(google.protobuf.message.Message):
    ...
    @property
    def spec(self) -> zamp_temporalio.api.cloud.namespace.v1.message_pb2.ExportSinkSpec:
    ...
    def __init__(
        ...
        *,
        namespace: builtins.str = ...,
        spec: zamp_temporalio.api.cloud.namespace.v1.message_pb2.ExportSinkSpec | None = ...,
        async_operation_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["spec", b"spec"]
...
class GetNamespaceExportSinkResponse(google.protobuf.message.Message):
    ...
    @property
    def sink(self) -> zamp_temporalio.api.cloud.namespace.v1.message_pb2.ExportSink:
        """The export sink retrieved."""
    def __init__(
        self,
        *,
        sink: zamp_temporalio.api.cloud.namespace.v1.message_pb2.ExportSink | None = ...,
    ) -> None: ...
    def HasField(
...
class GetNamespaceExportSinksResponse(google.protobuf.message.Message):
    ...
    def sinks(
        ...
        zamp_temporalio.api.cloud.namespace.v1.message_pb2.ExportSink
    ]:
