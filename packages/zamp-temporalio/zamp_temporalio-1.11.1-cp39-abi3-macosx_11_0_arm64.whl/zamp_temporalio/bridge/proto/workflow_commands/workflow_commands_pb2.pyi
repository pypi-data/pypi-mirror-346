...
class ScheduleActivity(google.protobuf.message.Message):
    ...
    """
    versioning_intent: (
        zamp_temporalio.bridge.proto.common.common_pb2.VersioningIntent.ValueType
    )
    ...
    def __init__(
        ...
        *,
        ...
        cancellation_type: global___ActivityCancellationType.ValueType = ...,
        do_not_eagerly_execute: builtins.bool = ...,
        versioning_intent: zamp_temporalio.bridge.proto.common.common_pb2.VersioningIntent.ValueType = ...,
...
class QueryResult(google.protobuf.message.Message):
    ...
    @property
    def failed(self) -> zamp_temporalio.api.failure.v1.message_pb2.Failure: ...
    def __init__(
        self,
        *,
        query_id: builtins.str = ...,
        succeeded: global___QuerySuccess | None = ...,
        failed: zamp_temporalio.api.failure.v1.message_pb2.Failure | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class QuerySuccess(google.protobuf.message.Message):
    ...
    @property
    def response(self) -> zamp_temporalio.api.common.v1.message_pb2.Payload: ...
    def __init__(
        self,
        *,
        response: zamp_temporalio.api.common.v1.message_pb2.Payload | None = ...,
    ) -> None: ...
    def HasField(
...
class StartChildWorkflowExecution(google.protobuf.message.Message):
    ...
    parent_close_policy: zamp_temporalio.bridge.proto.child_workflow.child_workflow_pb2.ParentClosePolicy.ValueType
    ...
    def search_attributes(
        ...
        """Search attributes"""
    cancellation_type: zamp_temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowCancellationType.ValueType
...
class RequestCancelExternalWorkflowExecution(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        seq: builtins.int = ...,
        workflow_execution: zamp_temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution
        | None = ...,
        reason: builtins.str = ...,
    ) -> None: ...
    def HasField(
...
class SignalExternalWorkflowExecution(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        child_workflow_id: builtins.str = ...,
        signal_name: builtins.str = ...,
        args: collections.abc.Iterable[zamp_temporalio.api.common.v1.message_pb2.Payload]
        | None = ...,
        headers: collections.abc.Mapping[
            builtins.str, zamp_temporalio.api.common.v1.message_pb2.Payload
        ]
...
class UpdateResponse(google.protobuf.message.Message):
    ...
    def accepted(self) -> google.protobuf.empty_pb2.Empty:
        ...
        """
    @property
    def rejected(self) -> zamp_temporalio.api.failure.v1.message_pb2.Failure:
        """Must be sent if the update's validator does not pass, or after acceptance if the update
        handler fails.
        """
    @property
    def completed(self) -> zamp_temporalio.api.common.v1.message_pb2.Payload:
    ...
    def __init__(
        ...
        *,
        ...
        rejected: zamp_temporalio.api.failure.v1.message_pb2.Failure | None = ...,
        completed: zamp_temporalio.api.common.v1.message_pb2.Payload | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
