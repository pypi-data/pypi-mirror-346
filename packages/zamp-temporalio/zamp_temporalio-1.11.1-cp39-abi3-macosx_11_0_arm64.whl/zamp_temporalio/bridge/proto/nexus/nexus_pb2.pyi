...
import zamp_temporalio.api.nexus.v1.message_pb2
...
class NexusOperationResult(google.protobuf.message.Message):
    ...
    @property
    def cancelled(self) -> zamp_temporalio.api.failure.v1.message_pb2.Failure: ...
    @property
    def timed_out(self) -> zamp_temporalio.api.failure.v1.message_pb2.Failure: ...
    def __init__(
        self,
        *,
        ...
        cancelled: zamp_temporalio.api.failure.v1.message_pb2.Failure | None = ...,
        timed_out: zamp_temporalio.api.failure.v1.message_pb2.Failure | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class NexusTaskCompletion(google.protobuf.message.Message):
    ...
    @property
    def completed(self) -> zamp_temporalio.api.nexus.v1.message_pb2.Response:
        """The handler completed (successfully or not). Note that the response kind must match the
        request kind (start or cancel).
        """
    @property
    def error(self) -> zamp_temporalio.api.nexus.v1.message_pb2.HandlerError:
    ...
    def __init__(
        ...
        *,
        task_token: builtins.bytes = ...,
        completed: zamp_temporalio.api.nexus.v1.message_pb2.Response | None = ...,
        error: zamp_temporalio.api.nexus.v1.message_pb2.HandlerError | None = ...,
        ack_cancel: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self,
...
class NexusTask(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        task: zamp_temporalio.api.workflowservice.v1.request_response_pb2.PollNexusTaskQueueResponse
        | None = ...,
