...
class ActivityHeartbeat(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        task_token: builtins.bytes = ...,
        details: collections.abc.Iterable[zamp_temporalio.api.common.v1.message_pb2.Payload]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class ActivityTaskCompletion(google.protobuf.message.Message):
    ...
    def result(
        self,
    ) -> zamp_temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityExecutionResult: ...
    def __init__(
        self,
        *,
        task_token: builtins.bytes = ...,
        result: zamp_temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityExecutionResult
        | None = ...,
    ) -> None: ...
    def HasField(
