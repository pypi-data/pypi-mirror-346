...
- [TypeScript SDK](https://github.com/zamp_temporalio/sdk-typescript/)
- [Python SDK](https://github.com/zamp_temporalio/sdk-python/)
- [.NET SDK](https://github.com/zamp_temporalio/sdk-dotnet/)
- [Ruby SDK](https://github.com/zamp_temporalio/sdk-ruby/)
...
`git pull --squash --rebase=false -s subtree ssh://git@github.com/zamp_temporalio/api.git master --allow-unrelated-histories`
...
git remote add -f -t master --no-tags testsrv-protos git@github.com:zamp_temporalio/sdk-java.git
