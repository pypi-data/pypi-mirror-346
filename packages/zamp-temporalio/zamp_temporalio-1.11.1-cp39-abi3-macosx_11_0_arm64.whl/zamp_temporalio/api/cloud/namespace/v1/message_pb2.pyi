...
import zamp_temporalio.api.cloud.resource.v1.message_pb2
import zamp_temporalio.api.cloud.sink.v1.message_pb2
...
class Namespace(google.protobuf.message.Message):
    ...
    temporal:versioning:max_version=2024-10-01-00
    """
    state: zamp_temporalio.api.cloud.resource.v1.message_pb2.ResourceState.ValueType
    """The current state of the namespace.
...
class ExportSinkSpec(google.protobuf.message.Message):
    ...
    @property
    def s3(self) -> zamp_temporalio.api.cloud.sink.v1.message_pb2.S3Spec:
        """The S3 configuration details when destination_type is S3."""
    @property
    def gcs(self) -> zamp_temporalio.api.cloud.sink.v1.message_pb2.GCSSpec:
    ...
    def __init__(
        ...
        *,
        name: builtins.str = ...,
        enabled: builtins.bool = ...,
        s3: zamp_temporalio.api.cloud.sink.v1.message_pb2.S3Spec | None = ...,
        gcs: zamp_temporalio.api.cloud.sink.v1.message_pb2.GCSSpec | None = ...,
    ) -> None: ...
    def HasField(
