...
class InSandbox:
    ...
    def __init__(
        self,
        instance_details: zamp_temporalio.worker._workflow_instance.WorkflowInstanceDetails,
        runner_class: Type[zamp_temporalio.worker._workflow_instance.WorkflowRunner],
        workflow_class: Type,
    ) -> None:
        ...
        new_defn = zamp_temporalio.workflow._Definition.must_from_class(workflow_class)
