...
class _Context:
    ...
    _payload_converter: Optional[zamp_temporalio.converter.PayloadConverter] = None
    _metric_meter: Optional[zamp_temporalio.common.MetricMeter] = None
    ...
    @property
    def payload_converter(self) -> zamp_temporalio.converter.PayloadConverter:
...
def shield_thread_cancel_exception() -> Iterator[None]:
    ...
    Raises:
        zamp_temporalio.exceptions.CancelledError: If a cancellation occurs anytime
    ...
    def __post_init__(self) -> None:
        if self.arg_types is None and self.ret_type is None:
            ...
            if dynamic and (
                ...
                raise TypeError(
                    "Dynamic activity must accept a single Sequence[zamp_temporalio.common.RawValue]"
                )
