...
class RetryPolicy:
    ...
    @staticmethod
    def from_proto(proto: zamp_temporalio.api.common.v1.RetryPolicy) -> RetryPolicy:
    ...
    def apply_to_proto(self, proto: zamp_temporalio.api.common.v1.RetryPolicy) -> None:
...
class WorkflowIDReusePolicy(IntEnum):
    ...
    See :py:class:`zamp_temporalio.api.enums.v1.WorkflowIdReusePolicy`.
    """

    ALLOW_DUPLICATE = int(
        zamp_temporalio.api.enums.v1.WorkflowIdReusePolicy.WORKFLOW_ID_REUSE_POLICY_ALLOW_DUPLICATE
    )
    ALLOW_DUPLICATE_FAILED_ONLY = int(
        zamp_temporalio.api.enums.v1.WorkflowIdReusePolicy.WORKFLOW_ID_REUSE_POLICY_ALLOW_DUPLICATE_FAILED_ONLY
    )
    REJECT_DUPLICATE = int(
        zamp_temporalio.api.enums.v1.WorkflowIdReusePolicy.WORKFLOW_ID_REUSE_POLICY_REJECT_DUPLICATE
    )
    TERMINATE_IF_RUNNING = int(
        zamp_temporalio.api.enums.v1.WorkflowIdReusePolicy.WORKFLOW_ID_REUSE_POLICY_TERMINATE_IF_RUNNING
    )
...
class WorkflowIDConflictPolicy(IntEnum):
    ...
    See :py:class:`zamp_temporalio.api.enums.v1.WorkflowIdConflictPolicy`.
    """

    UNSPECIFIED = int(
        zamp_temporalio.api.enums.v1.WorkflowIdConflictPolicy.WORKFLOW_ID_CONFLICT_POLICY_UNSPECIFIED
    )
    FAIL = int(
        zamp_temporalio.api.enums.v1.WorkflowIdConflictPolicy.WORKFLOW_ID_CONFLICT_POLICY_FAIL
    )
    USE_EXISTING = int(
        zamp_temporalio.api.enums.v1.WorkflowIdConflictPolicy.WORKFLOW_ID_CONFLICT_POLICY_USE_EXISTING
    )
    TERMINATE_EXISTING = int(
        zamp_temporalio.api.enums.v1.WorkflowIdConflictPolicy.WORKFLOW_ID_CONFLICT_POLICY_TERMINATE_EXISTING
    )
...
class QueryRejectCondition(IntEnum):
    ...
    See :py:class:`zamp_temporalio.api.enums.v1.QueryRejectCondition`.
    """

    NONE = int(zamp_temporalio.api.enums.v1.QueryRejectCondition.QUERY_REJECT_CONDITION_NONE)
    NOT_OPEN = int(
        zamp_temporalio.api.enums.v1.QueryRejectCondition.QUERY_REJECT_CONDITION_NOT_OPEN
    )
    NOT_COMPLETED_CLEANLY = int(
        zamp_temporalio.api.enums.v1.QueryRejectCondition.QUERY_REJECT_CONDITION_NOT_COMPLETED_CLEANLY
    )
...
class RawValue:
    ...
    def __setstate__(self, state: object) -> None:
        ...
        object.__setattr__(
            self, "payload", zamp_temporalio.api.common.v1.Payload.FromString(state[1:])
        )
...
class SearchAttributeIndexedValueType(IntEnum):
    ...
    TEXT = int(zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_TEXT)
    KEYWORD = int(zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_KEYWORD)
    INT = int(zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_INT)
    DOUBLE = int(zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_DOUBLE)
    BOOL = int(zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_BOOL)
    DATETIME = int(zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_DATETIME)
    KEYWORD_LIST = int(
        zamp_temporalio.api.enums.v1.IndexedValueType.INDEXED_VALUE_TYPE_KEYWORD_LIST
    )
...
class TypedSearchAttributes(Collection[SearchAttributePair]):
    ...
    def get(
        self,
        key: SearchAttributeKey[SearchAttributeValueType],
        default: zamp_temporalio.types.AnyType,
    ) -> Union[SearchAttributeValueType, zamp_temporalio.types.AnyType]: ...
...
class Priority:
    ...
    @staticmethod
    def _from_proto(proto: zamp_temporalio.api.common.v1.Priority) -> Priority:
    ...
    def _to_proto(self) -> zamp_temporalio.api.common.v1.Priority:
        return zamp_temporalio.api.common.v1.Priority(
...
class VersioningBehavior(IntEnum):
    ...
    UNSPECIFIED = (
        zamp_temporalio.api.enums.v1.VersioningBehavior.VERSIONING_BEHAVIOR_UNSPECIFIED
    )
    """ An unspecified versioning behavior. By default, workers opting into worker versioning will
    be required to specify a behavior. See :py:class:`zamp_temporalio.worker.WorkerDeploymentOptions`."""
    PINNED = zamp_temporalio.api.enums.v1.VersioningBehavior.VERSIONING_BEHAVIOR_PINNED
    """The workflow will be pinned to the current Build ID unless manually moved."""
    AUTO_UPGRADE = (
        zamp_temporalio.api.enums.v1.VersioningBehavior.VERSIONING_BEHAVIOR_AUTO_UPGRADE
    )
...
def _apply_headers(
    source: Optional[Mapping[str, zamp_temporalio.api.common.v1.Payload]],
    dest: google.protobuf.internal.containers.MessageMap[
        Text, zamp_temporalio.api.common.v1.Payload
    ],
) -> None:
    if source is None:
        return
