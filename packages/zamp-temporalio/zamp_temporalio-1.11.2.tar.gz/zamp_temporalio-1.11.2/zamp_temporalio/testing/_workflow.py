...
import zamp_temporalio.api.testservice.v1
import zamp_temporalio.bridge.testing
...
class WorkflowEnvironment:
    ...
    @staticmethod
    def from_client(client: zamp_temporalio.client.Client) -> WorkflowEnvironment:
    ...
    async def start_local(
        *,
        ...
        interceptors: Sequence[zamp_temporalio.client.Interceptor] = [],
        default_workflow_query_reject_condition: Optional[
            zamp_temporalio.common.QueryRejectCondition
        ] = None,
        retry_config: Optional[zamp_temporalio.client.RetryConfig] = None,
        rpc_metadata: Mapping[str, str] = {},
        identity: Optional[str] = None,
        tls: bool | zamp_temporalio.client.TLSConfig = False,
        ip: str = "127.0.0.1",
        port: Optional[int] = None,
        download_dest_dir: Optional[str] = None,
        ui: bool = False,
        runtime: Optional[zamp_temporalio.runtime.Runtime] = None,
        search_attributes: Sequence[zamp_temporalio.common.SearchAttributeKey] = (),
        ...
        https://github.com/zamp_temporalio/cli. This is a self-contained binary for
        ...
        runtime = runtime or zamp_temporalio.runtime.Runtime.default()
        download_ttl_ms = None
        if dev_server_download_ttl is not None:
            download_ttl_ms = int(dev_server_download_ttl.total_seconds() * 1000)
        server = await zamp_temporalio.bridge.testing.EphemeralServer.start_dev_server(
            runtime._core_runtime,
            zamp_temporalio.bridge.testing.DevServerConfig(
                existing_path=dev_server_existing_path,
                sdk_name="sdk-python",
                sdk_version=zamp_temporalio.service.__version__,
        ...
        try:
            return _EphemeralServerWorkflowEnvironment(
                await zamp_temporalio.client.Client.connect(
                    server.target,
                    namespace=namespace,
    ...
    async def start_time_skipping(
        *,
        ...
        :py:meth:`zamp_temporalio.client.WorkflowHandle.result` is awaited on (which
        includes :py:meth:`zamp_temporalio.client.Client.execute_workflow`). Before
        ...
        server = await zamp_temporalio.bridge.testing.EphemeralServer.start_test_server(
            runtime._core_runtime,
            zamp_temporalio.bridge.testing.TestServerConfig(
    ...
    def __init__(self, client: zamp_temporalio.client.Client) -> None:
    ...
    @property
    def client(self) -> zamp_temporalio.client.Client:
...
class _EphemeralServerWorkflowEnvironment(WorkflowEnvironment):
    def __init__(
        self,
        client: zamp_temporalio.client.Client,
        server: zamp_temporalio.bridge.testing.EphemeralServer,
    ) -> None:
        ...
        interceptors: List[zamp_temporalio.client.Interceptor] = [
    ...
    async def sleep(self, duration: Union[timedelta, float]) -> None:
        ...
        req = zamp_temporalio.api.testservice.v1.SleepRequest()
    ...
    async def time_skipping_unlocked(self) -> AsyncIterator[None]:
        ...
        await self.client.test_service.unlock_time_skipping(
            zamp_temporalio.api.testservice.v1.UnlockTimeSkippingRequest()
        )
        try:
            yield None
            # Lock it back, throwing on error
            await self.client.test_service.lock_time_skipping(
                zamp_temporalio.api.testservice.v1.LockTimeSkippingRequest()
            )
        except:
...
class _AssertionErrorInterceptor(
    zamp_temporalio.client.Interceptor, zamp_temporalio.worker.Interceptor
):
    def workflow_interceptor_class(
        self, input: zamp_temporalio.worker.WorkflowInterceptorClassInput
    ) -> Optional[Type[zamp_temporalio.worker.WorkflowInboundInterceptor]]:
        return _AssertionErrorWorkflowInboundInterceptor


class _AssertionErrorWorkflowInboundInterceptor(
    zamp_temporalio.worker.WorkflowInboundInterceptor
):
    ...
    def assert_error_as_app_error(self) -> Iterator[None]:
        try:
            ...
            app_err = zamp_temporalio.exceptions.ApplicationError(
...
class _TimeSkippingClientInterceptor(zamp_temporalio.client.Interceptor):
...
class _TimeSkippingClientOutboundInterceptor(zamp_temporalio.client.OutboundInterceptor):
    def __init__(
        self,
        next: zamp_temporalio.client.OutboundInterceptor,
...
class _TimeSkippingWorkflowHandle(zamp_temporalio.client.WorkflowHandle):
    env: _EphemeralServerWorkflowEnvironment
...
def _client_with_interceptors(
    client: zamp_temporalio.client.Client, *interceptors: zamp_temporalio.client.Interceptor
) -> zamp_temporalio.client.Client:
    ...
    return zamp_temporalio.client.Client(**config)
