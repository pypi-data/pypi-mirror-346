...
from zamp_temporalio.workflow import VersioningIntent
...
class ActivityOutboundInterceptor:
    ...
    def info(self) -> zamp_temporalio.activity.Info:
        """Called for every :py:func:`zamp_temporalio.activity.info` call."""
        return self.next.info()

    def heartbeat(self, *details: Any) -> None:
        """Called for every :py:func:`zamp_temporalio.activity.heartbeat` call."""
...
class WorkflowOutboundInterceptor:
    ...
    def continue_as_new(self, input: ContinueAsNewInput) -> NoReturn:
        """Called for every :py:func:`zamp_temporalio.workflow.continue_as_new` call."""
        self.next.continue_as_new(input)

    def info(self) -> zamp_temporalio.workflow.Info:
        """Called for every :py:func:`zamp_temporalio.workflow.info` call."""
        return self.next.info()

    async def signal_child_workflow(self, input: SignalChildWorkflowInput) -> None:
        """Called for every
        :py:meth:`zamp_temporalio.workflow.ChildWorkflowHandle.signal` call.
        """
    ...
    async def signal_external_workflow(
        ...
        """Called for every
        :py:meth:`zamp_temporalio.workflow.ExternalWorkflowHandle.signal` call.
        """
    ...
    def start_activity(
        ...
        """Called for every :py:func:`zamp_temporalio.workflow.start_activity` and
        :py:func:`zamp_temporalio.workflow.execute_activity` call.
        """
    ...
    async def start_child_workflow(
        ...
        """Called for every :py:func:`zamp_temporalio.workflow.start_child_workflow`
        and :py:func:`zamp_temporalio.workflow.execute_child_workflow` call.
        """
    ...
    def start_local_activity(
        ...
        """Called for every :py:func:`zamp_temporalio.workflow.start_local_activity`
        and :py:func:`zamp_temporalio.workflow.execute_local_activity` call.
        """
