...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b"\n%io.temporal.api.cloud.cloudservice.v1B\024RequestResponseProtoP\001Z5go.temporal.io/api/cloud/cloudservice/v1;cloudservice\252\002$zamp_temporalio.Api.Cloud.CloudService.V1\352\002(zamp_temporalio::Api::Cloud::CloudService::V1"
