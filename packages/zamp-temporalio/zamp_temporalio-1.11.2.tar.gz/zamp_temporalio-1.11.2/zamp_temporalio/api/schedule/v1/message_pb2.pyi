...
import zamp_temporalio.api.enums.v1.schedule_pb2
...
class SchedulePolicies(google.protobuf.message.Message):
    ...
    overlap_policy: zamp_temporalio.api.enums.v1.schedule_pb2.ScheduleOverlapPolicy.ValueType
    """Policy for overlaps.
...
class ScheduleAction(google.protobuf.message.Message):
    ...
    def start_workflow(
        self,
    ) -> zamp_temporalio.api.workflow.v1.message_pb2.NewWorkflowExecutionInfo:
    ...
    def __init__(
        self,
        *,
        start_workflow: zamp_temporalio.api.workflow.v1.message_pb2.NewWorkflowExecutionInfo
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class ScheduleActionResult(google.protobuf.message.Message):
    ...
    start_workflow_status: (
        zamp_temporalio.api.enums.v1.workflow_pb2.WorkflowExecutionStatus.ValueType
    )
    ...
    def __init__(
        ...
        *,
        ...
        start_workflow_result: zamp_temporalio.api.common.v1.message_pb2.WorkflowExecution
        | None = ...,
        start_workflow_status: zamp_temporalio.api.enums.v1.workflow_pb2.WorkflowExecutionStatus.ValueType = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
