...
from zamp_temporalio.bridge.temporal_sdk_bridge import RPCError
...
class Client:
    ...
    @staticmethod
    async def connect(
        runtime: zamp_temporalio.bridge.runtime.Runtime, config: ClientConfig
    ) -> Client:
        """Establish connection with server."""
        return Client(
            runtime,
            await zamp_temporalio.bridge.temporal_sdk_bridge.connect_client(
                runtime._ref, config
            ),
        )
    ...
    def __init__(
        ...
        ref: zamp_temporalio.bridge.temporal_sdk_bridge.ClientRef,
    ):
