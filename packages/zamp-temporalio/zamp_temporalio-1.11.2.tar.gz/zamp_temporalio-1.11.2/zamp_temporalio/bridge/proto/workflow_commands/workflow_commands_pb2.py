...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = (
        b"\352\0023zamp_temporalio::Internal::Bridge::Api::WorkflowCommands"
    )
