...
import zamp_temporalio.bridge.proto.activity_task.activity_task_pb2
import zamp_temporalio.bridge.proto.core_interface_pb2
import zamp_temporalio.bridge.proto.workflow_activation.workflow_activation_pb2
import zamp_temporalio.bridge.proto.workflow_completion.workflow_completion_pb2
...
class PollWorkflowActivationResponse(google.protobuf.message.Message):
    ...
    def activation(
        self,
    ) -> zamp_temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.WorkflowActivation: ...
    @property
    def error(self) -> global___PollWorkflowActivationResponse.Error: ...
    def __init__(
        self,
        *,
        activation: zamp_temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.WorkflowActivation
        | None = ...,
...
class PollActivityTaskResponse(google.protobuf.message.Message):
    ...
    def task(
        self,
    ) -> zamp_temporalio.bridge.proto.activity_task.activity_task_pb2.ActivityTask: ...
    @property
    def error(self) -> global___PollActivityTaskResponse.Error: ...
    def __init__(
        self,
        *,
        task: zamp_temporalio.bridge.proto.activity_task.activity_task_pb2.ActivityTask
        | None = ...,
...
class CompleteWorkflowActivationRequest(google.protobuf.message.Message):
    ...
    def completion(
        self,
    ) -> zamp_temporalio.bridge.proto.workflow_completion.workflow_completion_pb2.WorkflowActivationCompletion: ...
    def __init__(
        self,
        *,
        completion: zamp_temporalio.bridge.proto.workflow_completion.workflow_completion_pb2.WorkflowActivationCompletion
        | None = ...,
    ) -> None: ...
    def HasField(
...
class CompleteActivityTaskRequest(google.protobuf.message.Message):
    ...
    def completion(
        self,
    ) -> zamp_temporalio.bridge.proto.core_interface_pb2.ActivityTaskCompletion: ...
    def __init__(
        self,
        *,
        completion: zamp_temporalio.bridge.proto.core_interface_pb2.ActivityTaskCompletion
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["completion", b"completion"]
...
class RecordActivityHeartbeatRequest(google.protobuf.message.Message):
    ...
    def heartbeat(
        self,
    ) -> zamp_temporalio.bridge.proto.core_interface_pb2.ActivityHeartbeat: ...
    def __init__(
        self,
        *,
        heartbeat: zamp_temporalio.bridge.proto.core_interface_pb2.ActivityHeartbeat
        | None = ...,
    ) -> None: ...
    def HasField(
