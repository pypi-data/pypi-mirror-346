...
class FailureError(TemporalError):
    ...
    def __init__(
        ...
        message: str,
        *,
        failure: Optional[zamp_temporalio.api.failure.v1.Failure] = None,
    ...
    @property
    def failure(self) -> Optional[zamp_temporalio.api.failure.v1.Failure]:
...
class TimeoutType(IntEnum):
    ...
    START_TO_CLOSE = int(
        zamp_temporalio.api.enums.v1.TimeoutType.TIMEOUT_TYPE_START_TO_CLOSE
    )
    SCHEDULE_TO_START = int(
        zamp_temporalio.api.enums.v1.TimeoutType.TIMEOUT_TYPE_SCHEDULE_TO_START
    )
    SCHEDULE_TO_CLOSE = int(
        zamp_temporalio.api.enums.v1.TimeoutType.TIMEOUT_TYPE_SCHEDULE_TO_CLOSE
    )
    HEARTBEAT = int(zamp_temporalio.api.enums.v1.TimeoutType.TIMEOUT_TYPE_HEARTBEAT)
...
class RetryState(IntEnum):
    ...
    IN_PROGRESS = int(zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_IN_PROGRESS)
    NON_RETRYABLE_FAILURE = int(
        zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_NON_RETRYABLE_FAILURE
    )
    TIMEOUT = int(zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_TIMEOUT)
    MAXIMUM_ATTEMPTS_REACHED = int(
        zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_MAXIMUM_ATTEMPTS_REACHED
    )
    RETRY_POLICY_NOT_SET = int(
        zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_RETRY_POLICY_NOT_SET
    )
    INTERNAL_SERVER_ERROR = int(
        zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_INTERNAL_SERVER_ERROR
    )
    CANCEL_REQUESTED = int(
        zamp_temporalio.api.enums.v1.RetryState.RETRY_STATE_CANCEL_REQUESTED
    )
