...
import zamp_temporalio.api.enums.v1.namespace_pb2
...
class NamespaceInvalidStateFailure(google.protobuf.message.Message):
    ...
    namespace: builtins.str
    state: zamp_temporalio.api.enums.v1.namespace_pb2.NamespaceState.ValueType
    """Current state of the requested namespace."""
    @property
    def allowed_states(
        self,
    ) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[
        zamp_temporalio.api.enums.v1.namespace_pb2.NamespaceState.ValueType
    ]:
...
class ResourceExhaustedFailure(google.protobuf.message.Message):
    ...
    cause: zamp_temporalio.api.enums.v1.failed_cause_pb2.ResourceExhaustedCause.ValueType
    scope: zamp_temporalio.api.enums.v1.failed_cause_pb2.ResourceExhaustedScope.ValueType
    def __init__(
        self,
        *,
        cause: zamp_temporalio.api.enums.v1.failed_cause_pb2.ResourceExhaustedCause.ValueType = ...,
