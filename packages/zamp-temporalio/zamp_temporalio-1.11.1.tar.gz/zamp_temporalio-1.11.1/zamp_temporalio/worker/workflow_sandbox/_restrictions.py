...
class RestrictedWorkflowAccessError(zamp_temporalio.workflow.NondeterminismError):
...
SandboxRestrictions.passthrough_modules_minimum = {
    ...
    "zamp_temporalio.bridge.temporal_sdk_bridge",
}
...
class _RestrictionState:
    ...
    def assert_child_not_restricted(self, name: str) -> None:
        if zamp_temporalio.workflow.unsafe.is_sandbox_unrestricted():
            return
