...
class MetricMeter:
    ...
    @staticmethod
    def create(runtime: zamp_temporalio.bridge.runtime.Runtime) -> Optional[MetricMeter]:
        """Create optional metric meter."""
        ref = zamp_temporalio.bridge.temporal_sdk_bridge.new_metric_meter(runtime._ref)
        if not ref:
            return None
        return MetricMeter(ref)

    def __init__(
        self, ref: zamp_temporalio.bridge.temporal_sdk_bridge.MetricMeterRef
    ) -> None:
...
class MetricAttributes:
    ...
    def __init__(
        self,
        meter: MetricMeter,
        ref: zamp_temporalio.bridge.temporal_sdk_bridge.MetricAttributesRef,
    ) -> None:
