...
import zamp_temporalio.bridge.proto.activity_result.activity_result_pb2
import zamp_temporalio.bridge.proto.child_workflow.child_workflow_pb2
import zamp_temporalio.bridge.proto.common.common_pb2
import zamp_temporalio.bridge.proto.nexus.nexus_pb2
...
class WorkflowActivation(google.protobuf.message.Message):
    ...
    * Evictions also always come in their own activation
    ...
    def deployment_version_for_current_task(
        self,
    ) -> zamp_temporalio.bridge.proto.common.common_pb2.WorkerDeploymentVersion:
    ...
    def __init__(
        ...
        *,
        ...
        history_size_bytes: builtins.int = ...,
        continue_as_new_suggested: builtins.bool = ...,
        deployment_version_for_current_task: zamp_temporalio.bridge.proto.common.common_pb2.WorkerDeploymentVersion
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class InitializeWorkflow(google.protobuf.message.Message):
    ...
    class HeadersEntry(google.protobuf.message.Message):
        ...
        key: builtins.str
        @property
        def value(self) -> zamp_temporalio.api.common.v1.message_pb2.Payload: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: zamp_temporalio.api.common.v1.message_pb2.Payload | None = ...,
        ) -> None: ...
        def HasField(
    ...
    def arguments(
        ...
        zamp_temporalio.api.common.v1.message_pb2.Payload
    ]:
    ...
    def headers(
        ...
        builtins.str, zamp_temporalio.api.common.v1.message_pb2.Payload
    ]:
    ...
    def parent_workflow_info(
        self,
    ) -> zamp_temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution:
    ...
    """
    continued_initiator: (
        zamp_temporalio.api.enums.v1.workflow_pb2.ContinueAsNewInitiator.ValueType
    )
    ...
    @property
    def root_workflow(self) -> zamp_temporalio.api.common.v1.message_pb2.WorkflowExecution:
    ...
    def __init__(
        ...
        *,
        ...
        | None = ...,
        identity: builtins.str = ...,
        parent_workflow_info: zamp_temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution
        | None = ...,
        ...
        continued_from_execution_run_id: builtins.str = ...,
        continued_initiator: zamp_temporalio.api.enums.v1.workflow_pb2.ContinueAsNewInitiator.ValueType = ...,
        ...
        root_workflow: zamp_temporalio.api.common.v1.message_pb2.WorkflowExecution
        | None = ...,
...
class ResolveActivity(google.protobuf.message.Message):
    ...
    def result(
        ...
        zamp_temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityResolution
    ): ...
    ...
    def __init__(
        ...
        *,
        seq: builtins.int = ...,
        result: zamp_temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityResolution
        | None = ...,
        is_local: builtins.bool = ...,
    ) -> None: ...
    def HasField(
...
class ResolveChildWorkflowExecutionStartFailure(google.protobuf.message.Message):
    ...
    """
    workflow_type: builtins.str
    cause: zamp_temporalio.bridge.proto.child_workflow.child_workflow_pb2.StartChildWorkflowExecutionFailedCause.ValueType
    def __init__(
        self,
        *,
        workflow_id: builtins.str = ...,
...
class ResolveChildWorkflowExecution(google.protobuf.message.Message):
    ...
    def result(
        ...
        zamp_temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowResult
    ): ...
    def __init__(
        self,
        *,
        seq: builtins.int = ...,
        result: zamp_temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowResult
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["result", b"result"]
...
class SignalWorkflow(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        signal_name: builtins.str = ...,
        input: collections.abc.Iterable[zamp_temporalio.api.common.v1.message_pb2.Payload]
        | None = ...,
        identity: builtins.str = ...,
        headers: collections.abc.Mapping[
            builtins.str, zamp_temporalio.api.common.v1.message_pb2.Payload
...
class ResolveNexusOperationStart(google.protobuf.message.Message):
    ...
    """
    @property
    def cancelled_before_start(self) -> zamp_temporalio.api.failure.v1.message_pb2.Failure:
    ...
    def __init__(
        ...
        *,
        ...
        operation_id: builtins.str = ...,
        started_sync: builtins.bool = ...,
        cancelled_before_start: zamp_temporalio.api.failure.v1.message_pb2.Failure
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class ResolveNexusOperation(google.protobuf.message.Message):
    ...
    def result(
        self,
    ) -> zamp_temporalio.bridge.proto.nexus.nexus_pb2.NexusOperationResult: ...
    def __init__(
        self,
        *,
        seq: builtins.int = ...,
        result: zamp_temporalio.bridge.proto.nexus.nexus_pb2.NexusOperationResult
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["result", b"result"]
