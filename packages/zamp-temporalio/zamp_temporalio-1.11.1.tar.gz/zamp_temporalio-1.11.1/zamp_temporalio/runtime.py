...
import zamp_temporalio.bridge.metric
...
class Runtime:
    ...
    def __init__(self, *, telemetry: TelemetryConfig) -> None:
        ...
        """
        self._core_runtime = zamp_temporalio.bridge.runtime.Runtime(
            telemetry=telemetry._to_bridge_config()
        )
        if isinstance(telemetry.metrics, MetricBuffer):
            telemetry.metrics._runtime = self
        core_meter = zamp_temporalio.bridge.metric.MetricMeter.create(self._core_runtime)
        if not core_meter:
            self._metric_meter = zamp_temporalio.common.MetricMeter.noop
        else:
            self._metric_meter = _MetricMeter(core_meter, core_meter.default_attributes)

    @property
    def metric_meter(self) -> zamp_temporalio.common.MetricMeter:
...
class LoggingConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.runtime.LoggingConfig:
        return zamp_temporalio.bridge.runtime.LoggingConfig(
            filter=self.filter
...
class LogForwardingConfig:
    ...
    def _on_logs(
        self, logs: Sequence[zamp_temporalio.bridge.runtime.BufferedLogEntry]
    ) -> None:
        for log in logs:
...
class OpenTelemetryConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.runtime.OpenTelemetryConfig:
        return zamp_temporalio.bridge.runtime.OpenTelemetryConfig(
            url=self.url,
...
class PrometheusConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.runtime.PrometheusConfig:
        return zamp_temporalio.bridge.runtime.PrometheusConfig(
...
class TelemetryConfig:
    ...
    def _to_bridge_config(self) -> zamp_temporalio.bridge.runtime.TelemetryConfig:
        return zamp_temporalio.bridge.runtime.TelemetryConfig(
            logging=None if not self.logging else self.logging._to_bridge_config(),
            metrics=None
            if not self.metrics
            else zamp_temporalio.bridge.runtime.MetricsConfig(
                opentelemetry=None
...
class BufferedMetricUpdate(Protocol):
    ...
    @property
    def attributes(self) -> zamp_temporalio.common.MetricAttributes:
...
class _MetricMeter(zamp_temporalio.common.MetricMeter):
    def __init__(
        self,
        core_meter: zamp_temporalio.bridge.metric.MetricMeter,
        core_attrs: zamp_temporalio.bridge.metric.MetricAttributes,
    ) -> None:
    ...
    def create_counter(
        ...
        return _MetricCounter(
            ...
            description,
            unit,
            zamp_temporalio.bridge.metric.MetricCounter(
    ...
    def create_histogram(
        ...
        return _MetricHistogram(
            ...
            description,
            unit,
            zamp_temporalio.bridge.metric.MetricHistogram(
                self._core_meter, name, description, unit
            ),
            self._core_attrs,
        )
    ...
    def create_histogram_float(
        ...
        return _MetricHistogramFloat(
            ...
            description,
            unit,
            zamp_temporalio.bridge.metric.MetricHistogramFloat(
                self._core_meter, name, description, unit
            ),
            self._core_attrs,
        )
    ...
    def create_histogram_timedelta(
        ...
        return _MetricHistogramTimedelta(
            ...
            description,
            unit,
            zamp_temporalio.bridge.metric.MetricHistogramDuration(
                self._core_meter, name, description, unit
            ),
            self._core_attrs,
        )
    ...
    def create_gauge(
        ...
        return _MetricGauge(
            ...
            description,
            unit,
            zamp_temporalio.bridge.metric.MetricGauge(
                self._core_meter, name, description, unit
            ),
            self._core_attrs,
        )
    ...
    def create_gauge_float(
        ...
        return _MetricGaugeFloat(
            ...
            description,
            unit,
            zamp_temporalio.bridge.metric.MetricGaugeFloat(
                self._core_meter, name, description, unit
            ),
            self._core_attrs,
        )
...
class _MetricCommon(zamp_temporalio.common.MetricCommon, Generic[_CoreMetricType]):
    def __init__(
        self,
        name: str,
...
class _MetricCounter(
    zamp_temporalio.common.MetricCounter,
    _MetricCommon[zamp_temporalio.bridge.metric.MetricCounter],
):
    def add(
        self,
        value: int,
...
class _MetricHistogram(
    zamp_temporalio.common.MetricHistogram,
    _MetricCommon[zamp_temporalio.bridge.metric.MetricHistogram],
):
    def record(
        self,
        value: int,
...
class _MetricHistogramFloat(
    zamp_temporalio.common.MetricHistogramFloat,
    _MetricCommon[zamp_temporalio.bridge.metric.MetricHistogramFloat],
):
    def record(
        self,
        value: float,
...
class _MetricHistogramTimedelta(
    zamp_temporalio.common.MetricHistogramTimedelta,
    _MetricCommon[zamp_temporalio.bridge.metric.MetricHistogramDuration],
):
    def record(
        self,
        value: timedelta,
...
class _MetricGauge(
    zamp_temporalio.common.MetricGauge, _MetricCommon[zamp_temporalio.bridge.metric.MetricGauge]
):
    def set(
        self,
        value: int,
...
class _MetricGaugeFloat(
    zamp_temporalio.common.MetricGaugeFloat,
    _MetricCommon[zamp_temporalio.bridge.metric.MetricGaugeFloat],
):
    def set(
        self,
        value: float,
