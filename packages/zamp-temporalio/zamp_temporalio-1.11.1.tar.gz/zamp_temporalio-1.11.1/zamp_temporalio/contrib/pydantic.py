...
:py:class:`zamp_temporalio.client.Client`:
...
from zamp_temporalio.converter import (
...
To use, pass as the ``data_converter`` argument of :py:class:`zamp_temporalio.client.Client`
"""
