...
class PySmtTermVector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _maude.PySmtTermVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _maude.PySmtTermVector___nonzero__(self)

    def __bool__(self):
        return _maude.PySmtTermVector___bool__(self)

    def __len__(self):
        return _maude.PySmtTermVector___len__(self)

    def __getslice__(self, i, j):
        return _maude.PySmtTermVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _maude.PySmtTermVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _maude.PySmtTermVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _maude.PySmtTermVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _maude.PySmtTermVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _maude.PySmtTermVector___setitem__(self, *args)

    def pop(self):
        return _maude.PySmtTermVector_pop(self)

    def append(self, x):
        return _maude.PySmtTermVector_append(self, x)

    def empty(self):
        return _maude.PySmtTermVector_empty(self)

    def size(self):
        return _maude.PySmtTermVector_size(self)

    def swap(self, v):
        return _maude.PySmtTermVector_swap(self, v)

    def begin(self):
        return _maude.PySmtTermVector_begin(self)

    def end(self):
        return _maude.PySmtTermVector_end(self)

    def rbegin(self):
        return _maude.PySmtTermVector_rbegin(self)

    def rend(self):
        return _maude.PySmtTermVector_rend(self)

    def clear(self):
        return _maude.PySmtTermVector_clear(self)

    def get_allocator(self):
        return _maude.PySmtTermVector_get_allocator(self)

    def pop_back(self):
        return _maude.PySmtTermVector_pop_back(self)

    def erase(self, *args):
        return _maude.PySmtTermVector_erase(self, *args)

    def __init__(self, *args):
        _maude.PySmtTermVector_swiginit(self, _maude.new_PySmtTermVector(*args))

    def push_back(self, x):
        return _maude.PySmtTermVector_push_back(self, x)

    def front(self):
        return _maude.PySmtTermVector_front(self)

    def back(self):
        return _maude.PySmtTermVector_back(self)

    def assign(self, n, x):
        return _maude.PySmtTermVector_assign(self, n, x)

    def resize(self, *args):
        return _maude.PySmtTermVector_resize(self, *args)

    def insert(self, *args):
        return _maude.PySmtTermVector_insert(self, *args)

    def reserve(self, n):
        return _maude.PySmtTermVector_reserve(self, n)

    def capacity(self):
        return _maude.PySmtTermVector_capacity(self)
    __swig_destroy__ = _maude.delete_PySmtTermVector

# Register PySmtTermVector in _maude:
_maude.PySmtTermVector_swigregister(PySmtTermVector)
class SmtModelPair(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _maude.SmtModelPair_swiginit(self, _maude.new_SmtModelPair(*args))
    first = property(_maude.SmtModelPair_first_get, _maude.SmtModelPair_first_set)
    second = property(_maude.SmtModelPair_second_get, _maude.SmtModelPair_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _maude.delete_SmtModelPair

# Register SmtModelPair in _maude:
_maude.SmtModelPair_swigregister(SmtModelPair)
class SmtModelPairVector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _maude.SmtModelPairVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _maude.SmtModelPairVector___nonzero__(self)

    def __bool__(self):
        return _maude.SmtModelPairVector___bool__(self)

    def __len__(self):
        return _maude.SmtModelPairVector___len__(self)

    def __getslice__(self, i, j):
        return _maude.SmtModelPairVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _maude.SmtModelPairVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _maude.SmtModelPairVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _maude.SmtModelPairVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _maude.SmtModelPairVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _maude.SmtModelPairVector___setitem__(self, *args)

    def pop(self):
        return _maude.SmtModelPairVector_pop(self)

    def append(self, x):
        return _maude.SmtModelPairVector_append(self, x)

    def empty(self):
        return _maude.SmtModelPairVector_empty(self)

    def size(self):
        return _maude.SmtModelPairVector_size(self)

    def swap(self, v):
        return _maude.SmtModelPairVector_swap(self, v)

    def begin(self):
        return _maude.SmtModelPairVector_begin(self)

    def end(self):
        return _maude.SmtModelPairVector_end(self)

    def rbegin(self):
        return _maude.SmtModelPairVector_rbegin(self)

    def rend(self):
        return _maude.SmtModelPairVector_rend(self)

    def clear(self):
        return _maude.SmtModelPairVector_clear(self)

    def get_allocator(self):
        return _maude.SmtModelPairVector_get_allocator(self)

    def pop_back(self):
        return _maude.SmtModelPairVector_pop_back(self)

    def erase(self, *args):
        return _maude.SmtModelPairVector_erase(self, *args)

    def __init__(self, *args):
        _maude.SmtModelPairVector_swiginit(self, _maude.new_SmtModelPairVector(*args))

    def push_back(self, x):
        return _maude.SmtModelPairVector_push_back(self, x)

    def front(self):
        return _maude.SmtModelPairVector_front(self)

    def back(self):
        return _maude.SmtModelPairVector_back(self)

    def assign(self, n, x):
        return _maude.SmtModelPairVector_assign(self, n, x)

    def resize(self, *args):
        return _maude.SmtModelPairVector_resize(self, *args)

    def insert(self, *args):
        return _maude.SmtModelPairVector_insert(self, *args)

    def reserve(self, n):
        return _maude.SmtModelPairVector_reserve(self, n)

    def capacity(self):
        return _maude.SmtModelPairVector_capacity(self)
    __swig_destroy__ = _maude.delete_SmtModelPairVector

# Register SmtModelPairVector in _maude:
_maude.SmtModelPairVector_swigregister(SmtModelPairVector)
class PySmtTerm(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, data):
        _maude.PySmtTerm_swiginit(self, _maude.new_PySmtTerm(data))
    __swig_destroy__ = _maude.delete_PySmtTerm

    def data(self):
        return _maude.PySmtTerm_data(self)

# Register PySmtTerm in _maude:
_maude.PySmtTerm_swigregister(PySmtTerm)
class PySmtModel(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _maude.PySmtModel_swiginit(self, _maude.new_PySmtModel())
    __swig_destroy__ = _maude.delete_PySmtModel

    def set(self, k, v):
        return _maude.PySmtModel_set(self, k, v)

# Register PySmtModel in _maude:
_maude.PySmtModel_swigregister(PySmtModel)
class PyConverter(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _maude.delete_PyConverter

    def prepareFor(self, module):
        return _maude.PyConverter_prepareFor(self, module)

    def dag2term(self, dag):
        return _maude.PyConverter_dag2term(self, dag)

    def term2dag(self, term):
        return _maude.PyConverter_term2dag(self, term)

    def mkApp(self, symbol, args):
        return _maude.PyConverter_mkApp(self, symbol, args)

    def getSymbol(self, dag):
        return _maude.PyConverter_getSymbol(self, dag)

    def __init__(self):
        if self.__class__ == PyConverter:
            _self = None
        else:
            _self = self
        _maude.PyConverter_swiginit(self, _maude.new_PyConverter(_self, ))
    def __disown__(self):
        self.this.disown()
        _maude.disown_PyConverter(self)
        return weakref.proxy(self)

# Register PyConverter in _maude:
_maude.PyConverter_swigregister(PyConverter)
class PyTermSubst(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _maude.PyTermSubst_swiginit(self, _maude.new_PyTermSubst())
    __swig_destroy__ = _maude.delete_PyTermSubst

    def get(self, v):
        return _maude.PyTermSubst_get(self, v)

    def keys(self):
        return _maude.PyTermSubst_keys(self)

# Register PyTermSubst in _maude:
_maude.PyTermSubst_swigregister(PyTermSubst)
class SmtResult(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _maude.delete_SmtResult

    def is_sat(self):
        return _maude.SmtResult_is_sat(self)

    def is_unsat(self):
        return _maude.SmtResult_is_unsat(self)

    def is_unknown(self):
        return _maude.SmtResult_is_unknown(self)

    def __init__(self):
        if self.__class__ == SmtResult:
            _self = None
        else:
            _self = self
        _maude.SmtResult_swiginit(self, _maude.new_SmtResult(_self, ))
    def __disown__(self):
        self.this.disown()
        _maude.disown_SmtResult(self)
        return weakref.proxy(self)

# Register SmtResult in _maude:
_maude.SmtResult_swigregister(SmtResult)
...
class PyConnector(Connector):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _maude.delete_PyConnector

    def check_sat(self, consts):
        return _maude.PyConnector_check_sat(self, consts)

    def subsume(self, subst, prev, acc, cur):
        return _maude.PyConnector_subsume(self, subst, prev, acc, cur)

    def add_const(self, acc, cur):
        return _maude.PyConnector_add_const(self, acc, cur)

    def get_model(self):
        return _maude.PyConnector_get_model(self)

    def print_model(self):
        return _maude.PyConnector_print_model(self)

    def set_logic(self, logic):
        return _maude.PyConnector_set_logic(self, logic)

    def get_converter(self):
        return _maude.PyConnector_get_converter(self)

    def push(self):
        return _maude.PyConnector_push(self)

    def pop(self):
        return _maude.PyConnector_pop(self)

    def reset(self):
        return _maude.PyConnector_reset(self)

    def __init__(self):
        if self.__class__ == PyConnector:
            _self = None
        else:
            _self = self
        _maude.PyConnector_swiginit(self, _maude.new_PyConnector(_self, ))
    def __disown__(self):
        self.this.disown()
        _maude.disown_PyConnector(self)
        return weakref.proxy(self)

# Register PyConnector in _maude:
_maude.PyConnector_swigregister(PyConnector)
class PySmtManagerFactory(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _maude.delete_PySmtManagerFactory

    def createConnector(self, conv):
        return _maude.PySmtManagerFactory_createConnector(self, conv)

    def createConverter(self):
        return _maude.PySmtManagerFactory_createConverter(self)

    def __init__(self):
        if self.__class__ == PySmtManagerFactory:
            _self = None
        else:
            _self = self
        _maude.PySmtManagerFactory_swiginit(self, _maude.new_PySmtManagerFactory(_self, ))
    def __disown__(self):
        self.this.disown()
        _maude.disown_PySmtManagerFactory(self)
        return weakref.proxy(self)

# Register PySmtManagerFactory in _maude:
_maude.PySmtManagerFactory_swigregister(PySmtManagerFactory)
