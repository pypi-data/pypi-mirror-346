...
namespace cusolverdx {
    ...
    public:
        ...
        static constexpr unsigned int nrhs = detail::get_t<operator_type::size, Description>::nrhs;

        static constexpr value_type value = value_type {m, n, nrhs};
    ...
    template<class Description>
    inline constexpr unsigned int size_of_v_nrhs = size_of<Description>::nrhs;
    ...
    namespace detail {
        template<unsigned int M, unsigned int N, unsigned int NRHS, arrangement Arr, arrangement Brr>
        struct default_leading_dimension {
            using type = LeadingDimension<((Arr == arrangement::col_major) ? M : N), ((Brr == arrangement::col_major) ? N : NRHS)>;
        };

        template<unsigned int M, unsigned int N, unsigned int NRHS, arrangement Arr, arrangement Brr>
        using default_leading_dimension_t = typename default_leading_dimension<M, N, NRHS, Arr, Brr>::type;
    } // namespace detail
    ...
    private:
        static constexpr bool has_size = detail::has_operator<operator_type::size, Description>::value;
        static constexpr bool has_ld   = detail::has_operator<operator_type::leading_dimension, Description>::value;
        static_assert(has_size || has_ld, "Description does not have size nor leading dimensions defined");

        using default_ld =
            detail::default_leading_dimension_t<size_of<Description>::m, size_of<Description>::n, size_of<Description>::nrhs, arrangement_of_v_a<Description>, arrangement_of_v_b<Description>>;
    ...
    namespace detail {
        ...
        struct suggested_leading_dimension_of_impl {
            ...
            using default_ld = default_leading_dimension_t<Size::m, Size::n, Size::nrhs, Arr, Brr>;
