...
namespace cufftdx {
    ...
    namespace detail {
        ...
        struct remove_operators<Description, NewOperator> {
            static constexpr fft_operator operator_type   = commondx::detail::get_operator_type<NewOperator>::value;
        ...
        struct remove_operators<Description, HeadNewOperators, TailNewOperators...> {
            static constexpr fft_operator operator_type = commondx::detail::get_operator_type<HeadNewOperators>::value;
