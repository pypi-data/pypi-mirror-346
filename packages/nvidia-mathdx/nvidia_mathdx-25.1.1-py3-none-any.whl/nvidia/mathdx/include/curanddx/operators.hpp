...
namespace commondx::detail {
    ...
    template<>
    struct get_operator_type<curanddx::Thread> {
    ...
    template<>
    struct get_operator_type<curanddx::Block> {
    ...
    template<>
    struct get_operator_type<curanddx::Device> {
    ...
    template<unsigned int Architecture>
    struct get_operator_type<curanddx::SM<Architecture>> {
    ...
    template<unsigned int X, unsigned int Y, unsigned int Z>
    struct get_operator_type<curanddx::BlockDim<X, Y, Z>> {
    ...
    template<unsigned int X, unsigned int Y, unsigned int Z>
    struct get_operator_type<curanddx::GridDim<X, Y, Z>> {
