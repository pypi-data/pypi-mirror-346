    ...
    namespace detail {
        ...
        protected:
            ...
            static constexpr bool valid_size_for_block_gemm =
                ...
                !has_sm ||
                !(this_blas_function_v == function::MM) ||
                is_supported_logical_size_rmem_restrict<this_blas_precision, this_blas_type_v, this_blas_size, this_blas_sm_v>::value;
            ...
            static constexpr bool valid_ld_for_block_gemm =
                ...
                !has_sm ||
                !(this_blas_function_v == function::MM) ||
                (is_supported_real_size<this_blas_sm_v, this_blas_precision, this_blas_type_v, this_blas_a_size, this_blas_b_size>::value);
