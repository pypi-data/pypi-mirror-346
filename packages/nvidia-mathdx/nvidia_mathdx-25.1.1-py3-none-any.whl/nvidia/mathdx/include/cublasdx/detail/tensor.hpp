...
namespace cublasdx {
    ...
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(const Iterator& iter, Args const&... args) {
        return cute::make_tensor(iter, args...);
    }

    template<class T, class PointerTag, class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(const cute::gmem_ptr<T>& iter, const detail::pointer_layout<PointerTag, Layout>& pl) {
    ...
    template<class T, class PointerTag, class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(const cute::smem_ptr<T>& iter, const detail::pointer_layout<PointerTag, Layout>& pl) {
    ...
    template<class T, class PointerTag, class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(const cute::rmem_ptr<T>& iter, const detail::pointer_layout<PointerTag, Layout>& pl) {
    ...
    template<class T, class PointerTag, class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(T* ptr, const detail::pointer_layout<PointerTag, Layout>& pl) {
        using pl_t = typename detail::pointer_layout<PointerTag, Layout>;
        return cute::make_tensor(pl_t::make_ptr(ptr), pl.layout);
    }

    template<class T, class PointerTag, class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(void* ptr, const detail::pointer_layout<PointerTag, Layout>& pl) {
        using pl_t = typename detail::pointer_layout<PointerTag, Layout>;
        return cute::make_tensor(pl_t::template make_ptr<T>(ptr), pl.layout);
    }

    template<class T, class PointerTag, class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto make_tensor(const void*                                        ptr,
    ...
    CUBLASDX_HOST_DEVICE constexpr auto size(Layout const& layout) {
        if constexpr(is_layout_v<Layout> and not cute::is_layout<Layout>::value) {
    ...
    template<class Layout>
    CUBLASDX_HOST_DEVICE constexpr auto cosize(Layout const& layout) {
        if constexpr(is_layout_v<Layout> and not cute::is_layout<Layout>::value) {
