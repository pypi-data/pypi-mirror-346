...
namespace cublasdx {
    namespace detail {
        ...
        template<unsigned int   Arch,
                 class          Precision,
                 cublasdx::type Type>
        constexpr bool is_supported_helper(unsigned int a_size, unsigned int b_size, unsigned int c_size = 0) {
            unsigned type_multiplier = (Type == cublasdx::type::real) ? 1 : 2;
            size_t   required_shared_memory =
                sizeof(typename Precision::a_type) * type_multiplier * (a_size) +
                sizeof(typename Precision::b_type) * type_multiplier * (b_size) +
                sizeof(typename Precision::c_type) * type_multiplier * (c_size);
        ...
        struct is_supported_logical_size_rmem_restrict:
            public COMMONDX_STL_NAMESPACE::bool_constant<
                is_supported_helper<Arch, Precision, Type>(Size::m * Size::k,
                                                           Size::k * Size::n)>{};
        ...
        struct is_supported_real_size:
            public COMMONDX_STL_NAMESPACE::bool_constant<
                is_supported_helper<Arch, Precision, Type>(ASize, BSize, CSize)> {};
        ...
        struct is_supported_restrict_impl {
            ...
            static constexpr bool rmem_value() {
                return is_supported_helper<Arch, Precision, Type>(a_size, b_size);
            }

            static constexpr bool smem_value() {
                return is_supported_helper<Arch, Precision, Type>(a_size, b_size, c_size);
            }
            ...
            static constexpr bool rmem_value(unsigned dyn_lda, unsigned dyn_ldb) {
                ...
                return is_supported_helper<Arch, Precision, Type>(dyn_a_size, dyn_b_size);
            }
            ...
            static constexpr bool smem_value(unsigned dyn_lda, unsigned dyn_ldb, unsigned dyn_ldc) {
                ...
                return is_supported_helper<Arch, Precision, Type>(dyn_a_size, dyn_b_size, dyn_c_size);
            }
        };
    } // namespace detail
    ...
    struct is_supported_rmem_restrict {
        using type =
            detail::is_supported_restrict_impl<precision_of<Description>,
    ...
    template<class Description, unsigned int Architecture>
    inline constexpr bool is_supported_rmem_restrict_v = is_supported_rmem_restrict<Description, Architecture>::value;

    template<class Description, unsigned int Architecture>
    inline constexpr bool is_supported_smem_restrict_v = is_supported_smem_restrict<Description, Architecture>::value;
} // namespace cublasdx
