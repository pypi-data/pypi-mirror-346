...
namespace cublasdx {
    ...
    namespace detail {
        ...
        template<class Size, class Arrangement, class Precision, type Type, unsigned int Architecture>
        struct suggested_leading_dimension_of_impl {
            ...
            static constexpr bool padding_supported = is_supported_restrict_impl<Precision,
                                                                                 Type,
                                                                                 a_arrangement,
                                                                                 b_arrangement,
                                                                                 c_arrangement,
