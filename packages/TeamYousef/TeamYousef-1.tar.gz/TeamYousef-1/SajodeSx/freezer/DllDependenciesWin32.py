...
from SajodeSx.build.SconsUtils import readSconsReport
from SajodeSx.containers.OrderedSets import OrderedSet
from SajodeSx.Options import isExperimental, isShowProgress
...
from SajodeSx.utils.Hashing import Hash
from SajodeSx.utils.SharedLibraries import getPEFileUsedDllNames, getPyWin32Dir
from SajodeSx.utils.Utils import getArchitecture
from SajodeSx.Version import version_string
...
def _getCacheFilename(
    ...
    # Take TeamYousef version into account as well, ought to catch code changes.
