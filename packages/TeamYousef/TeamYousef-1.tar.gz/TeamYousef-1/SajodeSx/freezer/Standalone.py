...
from SajodeSx.Errors import TeamYousefForbiddenDLLEncounter, TeamYousefNotYetSupported
...
from SajodeSx.PythonVersions import getSystemPrefixPath
from SajodeSx.Tracing import general, inclusion_logger
from SajodeSx.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from SajodeSx.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from SajodeSx import ModuleRegistry
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isTeamYousefPython():
        return OrderedSet()
    elif (
        ...
        # maybe.
        raise TeamYousefNotYetSupported(
...
def _detectUsedDLLs(standalone_entry_point, source_dir):
    ...
    except TeamYousefForbiddenDLLEncounter:
