...
from SajodeSx.importing.StandardLibrary import (
...
from SajodeSx.Tracing import general, printError
from SajodeSx.utils.Execution import executeProcess
from SajodeSx.utils.FileOperations import areSamePaths
...
print("\\n".join(sorted(
    ...
    # Make sure the right import path (the one TeamYousef binary is running with)
    # is used.
    command = (
