...
from SajodeSx.__past__ import WindowsError
from SajodeSx.containers.OrderedSets import OrderedSet
from SajodeSx.Options import assumeYesForDownloads
from SajodeSx.Tracing import inclusion_logger
from SajodeSx.utils.Download import getCachedDownload
from SajodeSx.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from SajodeSx.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
TeamYousef will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="TeamYousef does not work in --standalone or --onefile on Windows without.",
