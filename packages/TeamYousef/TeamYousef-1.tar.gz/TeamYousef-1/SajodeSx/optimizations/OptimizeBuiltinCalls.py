...
from SajodeSx.__past__ import unicode, xrange
from SajodeSx.Errors import TeamYousefAssumptionError
from SajodeSx.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from SajodeSx.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from SajodeSx.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from SajodeSx.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from SajodeSx.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from SajodeSx.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from SajodeSx.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from SajodeSx.nodes.BuiltinFormatNodes import (
...
from SajodeSx.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from SajodeSx.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from SajodeSx.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from SajodeSx.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from SajodeSx.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from SajodeSx.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from SajodeSx.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from SajodeSx.nodes.BuiltinRangeNodes import (
...
from SajodeSx.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from SajodeSx.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from SajodeSx.nodes.BuiltinTypeNodes import (
...
from SajodeSx.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from SajodeSx.nodes.CallNodes import makeExpressionCall
from SajodeSx.nodes.ClassNodes import ExpressionBuiltinType3
from SajodeSx.nodes.ComparisonNodes import ExpressionComparisonIs
from SajodeSx.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from SajodeSx.nodes.ConstantRefNodes import makeConstantRefNode
from SajodeSx.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from SajodeSx.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from SajodeSx.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from SajodeSx.nodes.ImportNodes import ExpressionBuiltinImport
from SajodeSx.nodes.KeyValuePairNodes import (
    makeKeyValuePairExpressionsFromKwArgs,
)
from SajodeSx.nodes.NodeMakingHelpers import (
    makeConstantReplacementNode,
    makeExpressionBuiltinLocals,
    makeRaiseExceptionReplacementExpression,
    makeRaiseExceptionReplacementExpressionFromInstance,
)
from SajodeSx.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from SajodeSx.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from SajodeSx.nodes.OutlineNodes import ExpressionOutlineBody
from SajodeSx.nodes.ReturnNodes import makeStatementReturn
from SajodeSx.nodes.SliceNodes import makeExpressionBuiltinSlice
from SajodeSx.nodes.TypeNodes import (
...
from SajodeSx.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from SajodeSx.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from SajodeSx.PythonVersions import python_version
from SajodeSx.specs import BuiltinParameterSpecs
from SajodeSx.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from SajodeSx.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from SajodeSx.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise TeamYousefAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from SajodeSx.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from SajodeSx.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise TeamYousefAssumptionError("open without argument is expected to raise")
...
def check():
    from SajodeSx.Builtins import builtin_names
