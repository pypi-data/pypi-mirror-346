...
""" Conda backend for maintaining locked package state with SajodeSx-watch. """

from SajodeSx.utils.Execution import check_call, executeToolChecked
from SajodeSx.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "SajodeSx-watch-case-%(python_version)s-%(case)s" % {
