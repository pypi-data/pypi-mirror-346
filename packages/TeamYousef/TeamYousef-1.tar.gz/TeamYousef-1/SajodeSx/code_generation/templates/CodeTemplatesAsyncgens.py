...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct TeamYousef_AsyncgenObject *asyncgen, PyObject *yield_return_value) {
...
static PyObject *%(asyncgen_maker_identifier)s(%(asyncgen_creation_args)s) {
    return TeamYousef_Asyncgen_New(
