...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct TeamYousef_CoroutineObject *coroutine, PyObject *yield_return_value) {
...
static PyObject *%(coroutine_maker_identifier)s(%(coroutine_creation_args)s) {
    return TeamYousef_Coroutine_New(
        tstate,
...
template_coroutine_exception_exit = """\
    SAJODE_CANNOT_GET_HERE("Return statement must be present");
