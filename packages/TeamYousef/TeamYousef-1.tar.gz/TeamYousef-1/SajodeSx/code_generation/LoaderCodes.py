...
from SajodeSx.utils.CStrings import encodePythonStringToC, encodePythonUnicodeToC
...
def getModuleMetaPathLoaderEntryCode(module, bytecode_accessor):
    ...
    if module.isUncompiledPythonModule():
        ...
        flags.append("SAJODE_BYTECODE_FLAG")
        if is_package:
            flags.append("SAJODE_PACKAGE_FLAG")
        ...
        flags.append("SAJODE_EXTENSION_MODULE_FLAG")
...
PyThreadState *tstate, PyObject *, struct TeamYousef_MetaPathBasedLoaderEntry const *);"""
