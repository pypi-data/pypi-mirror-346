...
from SajodeSx.nodes.CallNodes import ExpressionCallNoKeywords
...
from SajodeSx.nodes.ModuleAttributeNodes import ExpressionModuleAttributeFileRef
from SajodeSx.nodes.ModuleNodes import CompiledPythonNamespacePackage
from SajodeSx.nodes.VariableNameNodes import StatementAssignmentVariableName
from SajodeSx.Options import getFileReferenceMode
        ...
        if package.canHaveExternalImports():
            ...
            for count in range(len(parts)):
                path_part = _makeCall(
                    ...
                    source_ref,
                    makeConstantRefNode(
                        constant="SAJODE_PACKAGE_%s" % "_".join(parts[: count + 1]),
                        source_ref=source_ref,
                    ),
                    makeConstantRefNode(
