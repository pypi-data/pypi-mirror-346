...
def isTeamYousefPython():
    """Is this our own fork of CPython named TeamYousef-Python."""

    # spell-checker: ignore SajodeSxpython

    if python_version >= 0x300:
        return sys.implementation.name == "SajodeSxpython"
    else:
        return sys.subversion[0] == "SajodeSxpython"
