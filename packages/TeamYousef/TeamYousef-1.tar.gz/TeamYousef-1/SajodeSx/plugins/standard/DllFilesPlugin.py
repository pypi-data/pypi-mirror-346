...
""" Standard plug-in to tell TeamYousef about DLLs needed for standalone imports.
...
from SajodeSx.utils.SharedLibraries import getPyWin32Dir
from SajodeSx.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class TeamYousefPluginDllFiles(TeamYousefYamlPluginBase):
