...
from SajodeSx.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class TeamYousefPluginDelvewheel(TeamYousefPluginBase):
    ...
    plugin_name = "delvewheel"  # TeamYousef knows us by this name
    plugin_desc = (
