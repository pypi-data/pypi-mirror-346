...
from SajodeSx.Options import isStandaloneMode
...
from SajodeSx.utils.Execution import TeamYousefCalledProcessError
from SajodeSx.utils.FileOperations import getFileContentByLine
from SajodeSx.utils.Jinja2 import renderTemplateFromString
...
class TeamYousefPluginMatplotlib(TeamYousefPluginBase):
    ...
    plugin_name = "matplotlib"  # TeamYousef knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__SajodeSx_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__SajodeSx_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
