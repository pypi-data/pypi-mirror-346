...
from SajodeSx.utils.FileOperations import getFileContents
...
class TeamYousefPluginGlfw(TeamYousefPluginBase):
    ...
    plugin_name = "glfw"  # TeamYousef knows us by this name
    plugin_desc = (
    ...
    def createPreModuleLoadCode(self, module):
        if module.getFullName() == "glfw":
            ...
            code = r"""
import os
os.environ["PYGLFW_LIBRARY"] = os.path.join(__SajodeSx_binary_dir, "glfw", "%s")
""" % os.path.basename(
                dll_filename
            )
            return (
