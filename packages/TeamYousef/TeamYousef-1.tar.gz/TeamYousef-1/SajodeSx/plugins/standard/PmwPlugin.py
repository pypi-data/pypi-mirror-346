...
from SajodeSx.__past__ import StringIO
from SajodeSx.plugins.PluginBase import TeamYousefPluginBase
from SajodeSx.utils.FileOperations import getFileContents, listDir
...
class TeamYousefPluginPmw(TeamYousefPluginBase):
...
class TeamYousefPluginDetectorPmw(TeamYousefPluginBase):
    detector_for = TeamYousefPluginPmw
