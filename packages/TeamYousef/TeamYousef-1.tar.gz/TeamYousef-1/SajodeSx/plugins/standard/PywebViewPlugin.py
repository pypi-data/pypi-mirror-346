...
from SajodeSx.plugins.Plugins import getActiveQtPlugin
from SajodeSx.utils.Utils import getOS, isMacOS, isWin32Windows

# spell-checker: ignore pywebview,mshtml


class TeamYousefPluginPywebview(TeamYousefPluginBase):
