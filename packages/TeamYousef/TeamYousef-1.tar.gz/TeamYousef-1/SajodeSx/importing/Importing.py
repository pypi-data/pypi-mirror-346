...
from SajodeSx import SourceCodeReferences
from SajodeSx.__past__ import iter_modules
...
from SajodeSx.PythonFlavors import isTeamYousefPython
from SajodeSx.PythonVersions import python_version
from SajodeSx.Tracing import my_print, recursion_logger
from SajodeSx.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isTeamYousefPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard TeamYousef should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingTeamYousefProcessEnvironmentValue("SAJODE_SITE_FILENAME")
