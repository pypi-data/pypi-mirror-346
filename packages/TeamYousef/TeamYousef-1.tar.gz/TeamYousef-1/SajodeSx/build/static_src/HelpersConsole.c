...
#if defined(_WIN32)
#if defined(_SAJODE_ATTACH_CONSOLE_WINDOW)
#include <io.h>
...
#if !defined(SAJODE_FORCED_STDERR_PATH) && !defined(SAJODE_FORCED_STDERR_NONE_BOOL) &&                                 \
    !defined(SAJODE_FORCED_STDERR_NULL_BOOL)
