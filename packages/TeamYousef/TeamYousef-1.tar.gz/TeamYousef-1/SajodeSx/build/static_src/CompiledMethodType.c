 ...
 * normally should be avoided to exist in TeamYousef calls.
 *
 */
...
static PyObject *TeamYousef_Method_get__doc__(PyObject *self, void *data) {
    struct TeamYousef_MethodObject *method = (struct TeamYousef_MethodObject *)self;
...
static PyGetSetDef TeamYousef_Method_tp_getset[] = {{(char *)"__doc__", TeamYousef_Method_get__doc__, NULL, NULL}, {NULL}};

#define OFF(x) offsetof(struct TeamYousef_MethodObject, x)

static PyMemberDef TeamYousef_Method_members[] = {
...
static PyObject *TeamYousef_Method_reduce(struct TeamYousef_MethodObject *method, PyObject *unused) {
...
static PyObject *TeamYousef_Method_reduce_ex(struct TeamYousef_MethodObject *method, PyObject *args) {
    int proto;
    ...
    PyObject *type_tuple = MAKE_TUPLE1(tstate, (PyObject *)&TeamYousef_Method_Type);
    ...
    return result;
#else
    return TeamYousef_Method_reduce(method, NULL);
#endif
}

static PyObject *TeamYousef_Method_deepcopy(struct TeamYousef_MethodObject *method, PyObject *memo) {
    assert(TeamYousef_Method_Check((PyObject *)method));
    ...
    PyObject *result = TeamYousef_Method_New(method->m_function, object, method->m_class);
    // TeamYousef_Method_New took a reference to the object.
    Py_DECREF(object);
    return result;
}

static PyMethodDef TeamYousef_Method_methods[] = {
    {"__reduce__", (PyCFunction)TeamYousef_Method_reduce, METH_NOARGS, NULL},
    {"__reduce_ex__", (PyCFunction)TeamYousef_Method_reduce_ex, METH_VARARGS, NULL},
    {"__deepcopy__", (PyCFunction)TeamYousef_Method_deepcopy, METH_O, NULL},
    {NULL}};

#if PYTHON_VERSION >= 0x380 && !defined(_SAJODE_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *TeamYousef_Method_tp_vectorcall(struct TeamYousef_MethodObject *method, PyObject *const *stack, size_t nargsf,
                                             PyObject *kwnames) {
    assert(TeamYousef_Method_Check((PyObject *)method));
    ...
    if (totalargs == 0) {
        return TeamYousef_CallMethodFunctionNoArgs(PyThreadState_GET(), method->m_function, method->m_object);
    }
    ...
    if (nargsf & PY_VECTORCALL_ARGUMENTS_OFFSET) {
        ...
        result = TeamYousef_CallFunctionVectorcall(PyThreadState_GET(), method->m_function, new_args, nargs + 1,
        ...
        SAJODE_DYNAMIC_ARRAY_DECL(new_args, PyObject *, totalargs + 1);
        new_args[0] = method->m_object;
...
static PyObject *TeamYousef_Method_tp_call(struct TeamYousef_MethodObject *method, PyObject *args, PyObject *kw) {
    ...
    if (method->m_object == NULL) {
        ...
        if (kw == NULL) {
            if (arg_count == 0) {
                return TeamYousef_CallMethodFunctionNoArgs(tstate, method->m_function, method->m_object);
            } else {
                return TeamYousef_CallMethodFunctionPosArgs(tstate, method->m_function, method->m_object,
                                                        &PyTuple_GET_ITEM(args, 0), arg_count);
            }
        } else {
            return TeamYousef_CallMethodFunctionPosArgsKwArgs(tstate, method->m_function, method->m_object,
                                                          &PyTuple_GET_ITEM(args, 0), arg_count, kw);
        }
    }
}

static PyObject *TeamYousef_Method_tp_descr_get(struct TeamYousef_MethodObject *method, PyObject *object,
    ...
    return TeamYousef_Method_New(method->m_function, object, class_object);
}

static PyObject *TeamYousef_Method_tp_getattro(struct TeamYousef_MethodObject *method, PyObject *name) {
    PyObject *descr = TeamYousef_TypeLookup(&TeamYousef_Method_Type, name);

    if (descr != NULL) {
        if (TeamYousefType_HasFeatureClass(Py_TYPE(descr)) && (Py_TYPE(descr)->tp_descr_get != NULL)) {
...
static long TeamYousef_Method_tp_traverse(struct TeamYousef_MethodObject *method, visitproc visit, void *arg) {
...
static PyObject *TeamYousef_Method_tp_repr(struct TeamYousef_MethodObject *method) {
    if (method->m_object == NULL) {
#if PYTHON_VERSION < 0x300
        return PyString_FromFormat("<unbound compiled_method %s.%s>", GET_CLASS_NAME(method->m_class),
                                   TeamYousef_String_AsString(method->m_function->m_name));
#else
        return PyUnicode_FromFormat("<compiled_function %s at %p>", TeamYousef_String_AsString(method->m_function->m_name),
                                    method->m_function);
#endif
    } else {
        ...
        PyObject *result =
            TeamYousef_String_FromFormat("<bound compiled_method %s.%s of %s>", GET_CLASS_NAME(method->m_class),
                                     TeamYousef_String_AsString_Unchecked(method->m_function->m_name),
                                     TeamYousef_String_AsString_Unchecked(object_repr));
#else
        PyObject *result =
...
#if PYTHON_VERSION < 0x300
static int TeamYousef_Method_tp_compare(struct TeamYousef_MethodObject *a, struct TeamYousef_MethodObject *b) {
...
static PyObject *TeamYousef_Method_tp_richcompare(struct TeamYousef_MethodObject *a, struct TeamYousef_MethodObject *b, int op) {
    if (op != Py_EQ && op != Py_NE) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }

    if (TeamYousef_Method_Check((PyObject *)a) == false || TeamYousef_Method_Check((PyObject *)b) == false) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    ...
    if (b_res) {
        ...
        if (a->m_object == NULL) {
            ...
            SajodeSx_bool nbool_res = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(a->m_object, b->m_object);

            if (unlikely(nbool_res == SAJODE_BOOL_EXCEPTION)) {
                return NULL;
            }

            b_res = nbool_res == SAJODE_BOOL_TRUE;
        }
#else
...
static long TeamYousef_Method_tp_hash(struct TeamYousef_MethodObject *method) {
...
static struct TeamYousef_MethodObject *free_list_methods = NULL;
static int free_list_methods_count = 0;

static void TeamYousef_Method_tp_dealloc(struct TeamYousef_MethodObject *method) {
...
static PyObject *TeamYousef_Method_tp_new(PyTypeObject *type, PyObject *args, PyObject *kw) {
    PyObject *func;
    PyObject *self;
    ...
    if (TeamYousef_Method_Check(func)) {
        return TeamYousef_Method_New(((struct TeamYousef_MethodObject *)func)->m_function, self, class_object);
    }

    if (TeamYousef_Function_Check(func) == false) {
        SET_CURRENT_EXCEPTION_TYPE_COMPLAINT_NICE("Cannot create compiled_ method from type '%s'", func);
        return NULL;
    }

    return TeamYousef_Method_New((struct TeamYousef_FunctionObject *)func, self, class_object);
}

PyTypeObject TeamYousef_Method_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_method",
    sizeof(struct TeamYousef_MethodObject),
    0,
    (destructor)TeamYousef_Method_tp_dealloc, // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_SAJODE_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct TeamYousef_MethodObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0, // tp_getattr
    0, // tp_setattr
#if PYTHON_VERSION < 0x300
    (cmpfunc)TeamYousef_Method_tp_compare, // tp_compare
#else
    0,
#endif
    (reprfunc)TeamYousef_Method_tp_repr,         // tp_repr
    0,                                       // tp_as_number
    0,                                       // tp_as_sequence
    0,                                       // tp_as_mapping
    (hashfunc)TeamYousef_Method_tp_hash,         // tp_hash
    (ternaryfunc)TeamYousef_Method_tp_call,      // tp_call
    0,                                       // tp_str
    (getattrofunc)TeamYousef_Method_tp_getattro, // tp_getattro
    ...
    Py_TPFLAGS_DEFAULT |                     // tp_flags
        ...
        Py_TPFLAGS_HAVE_GC,
    0,                                                // tp_doc
    (traverseproc)TeamYousef_Method_tp_traverse,          // tp_traverse
    0,                                                // tp_clear
    (richcmpfunc)TeamYousef_Method_tp_richcompare,        // tp_richcompare
    offsetof(struct TeamYousef_MethodObject, m_weakrefs), // tp_weaklistoffset
    0,                                                // tp_iter
    0,                                                // tp_iternext
    TeamYousef_Method_methods,                            // tp_methods
    TeamYousef_Method_members,                            // tp_members
    TeamYousef_Method_tp_getset,                          // tp_getset
    0,                                                // tp_base
    0,                                                // tp_dict
    (descrgetfunc)TeamYousef_Method_tp_descr_get,         // tp_descr_get
    0,                                                // tp_descr_set
    0,                                                // tp_dictoffset
    0,                                                // tp_init
    0,                                                // tp_alloc
    TeamYousef_Method_tp_new,                             // tp_new
    0,                                                // tp_free
    0,                                                // tp_is_gc
    0,                                                // tp_bases
    0,                                                // tp_mro
...
void _initCompiledMethodType(void) {
    TeamYousef_PyType_Ready(&TeamYousef_Method_Type, &PyMethod_Type, false, true, false, false, false);
}

PyObject *TeamYousef_Method_New(struct TeamYousef_FunctionObject *function, PyObject *object, PyObject *class_object) {
    struct TeamYousef_MethodObject *result;

    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

    allocateFromFreeListFixed(free_list_methods, struct TeamYousef_MethodObject, TeamYousef_Method_Type);

    if (unlikely(result == NULL)) {
        PyErr_Format(PyExc_RuntimeError, "cannot create method %s", TeamYousef_String_AsString(function->m_name));
...
#if PYTHON_VERSION >= 0x380 && !defined(_SAJODE_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)TeamYousef_Method_tp_vectorcall;
#endif
