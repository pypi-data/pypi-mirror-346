...
PyObject *TeamYousef_Slice_New(PyThreadState *tstate, PyObject *start, PyObject *stop, PyObject *step) {
    ...
    if (*slice_cache_ptr != NULL) {
        ...
        *slice_cache_ptr = NULL;
        ...
        TeamYousef_Py_NewReference((PyObject *)result_slice);
    } else {
        result_slice = (PySliceObject *)TeamYousef_GC_New(&PySlice_Type);
    ...
    TeamYousef_GC_Track(result_slice);
