...
#include "SajodeSx/compiled_method.h"
...
#if _DEBUG_REFCOUNTS
int count_active_TeamYousef_Function_Type;
int count_allocated_TeamYousef_Function_Type;
int count_released_TeamYousef_Function_Type;
#endif

// tp_descr_get slot, bind a function to an object.
static PyObject *TeamYousef_Function_descr_get(PyObject *function, PyObject *object, PyObject *class_object) {
    assert(TeamYousef_Function_Check(function));
    ...
    return TeamYousef_Method_New((struct TeamYousef_FunctionObject *)function, object == Py_None ? NULL : object, class_object);
}

// tp_repr slot, decide how compiled function shall be output to "repr" built-in
static PyObject *TeamYousef_Function_tp_repr(struct TeamYousef_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

#if PYTHON_VERSION < 0x300
    return TeamYousef_String_FromFormat("<compiled_function %s at %p>", TeamYousef_String_AsString(function->m_name), function);
#else
    return TeamYousef_String_FromFormat("<compiled_function %U at %p>", function->m_qualname, function);
#endif
}

static long TeamYousef_Function_tp_traverse(struct TeamYousef_FunctionObject *function, visitproc visit, void *arg) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static long TeamYousef_Function_tp_hash(struct TeamYousef_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *TeamYousef_Function_get_name(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    struct TeamYousef_FunctionObject *function = (struct TeamYousef_FunctionObject *)self;
...
static int TeamYousef_Function_set_name(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
#if PYTHON_VERSION >= 0x300
static PyObject *TeamYousef_Function_get_qualname(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_qualname(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *TeamYousef_Function_get_doc(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_doc(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *TeamYousef_Function_get_dict(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    ...
    if (function->m_dict == NULL) {
        SAJODE_MAY_BE_UNUSED PyThreadState *tstate = PyThreadState_GET();
...
static int TeamYousef_Function_set_dict(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *TeamYousef_Function_get_code(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_code(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyThreadState *tstate = PyThreadState_GET();
    SET_CURRENT_EXCEPTION_TYPE0_STR(tstate, PyExc_RuntimeError, "__code__ is not writable in TeamYousef");
    return -1;
}

static PyObject *TeamYousef_Function_get_compiled(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyObject *result = TeamYousef_dunder_compiled_value;
    CHECK_OBJECT(result);
...
static int TeamYousef_Function_set_compiled(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *TeamYousef_Function_get_compiled_constant(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_compiled_constant(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *TeamYousef_Function_get_closure(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_closure(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *TeamYousef_Function_get_defaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static void _onUpdatedCompiledFunctionDefaultsValue(struct TeamYousef_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
...
static int TeamYousef_Function_set_defaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
#if PYTHON_VERSION >= 0x300
static PyObject *TeamYousef_Function_get_kwdefaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_kwdefaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *TeamYousef_Function_get_annotations(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_annotations(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_globals(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *TeamYousef_Function_get_globals(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_builtins(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *TeamYousef_Function_get_builtins(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_type_params(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    CHECK_OBJECT_X(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *TeamYousef_Function_get_type_params(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int TeamYousef_Function_set_module(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *TeamYousef_Function_get_module(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(TeamYousef_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyGetSetDef TeamYousef_Function_getset[] = {
#if PYTHON_VERSION >= 0x300
    {(char *)"__qualname__", TeamYousef_Function_get_qualname, TeamYousef_Function_set_qualname, NULL},
#endif
#if PYTHON_VERSION < 0x300
    {(char *)"func_name", TeamYousef_Function_get_name, TeamYousef_Function_set_name, NULL},
#endif
    {(char *)"__name__", TeamYousef_Function_get_name, TeamYousef_Function_set_name, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_doc", TeamYousef_Function_get_doc, TeamYousef_Function_set_doc, NULL},
#endif
    {(char *)"__doc__", TeamYousef_Function_get_doc, TeamYousef_Function_set_doc, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_dict", TeamYousef_Function_get_dict, TeamYousef_Function_set_dict, NULL},
#endif
    {(char *)"__dict__", TeamYousef_Function_get_dict, TeamYousef_Function_set_dict, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_code", TeamYousef_Function_get_code, TeamYousef_Function_set_code, NULL},
#endif
    {(char *)"__code__", TeamYousef_Function_get_code, TeamYousef_Function_set_code, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_defaults", TeamYousef_Function_get_defaults, TeamYousef_Function_set_defaults, NULL},
#endif
    {(char *)"__defaults__", TeamYousef_Function_get_defaults, TeamYousef_Function_set_defaults, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_globals", TeamYousef_Function_get_globals, TeamYousef_Function_set_globals, NULL},
#endif
    {(char *)"__closure__", TeamYousef_Function_get_closure, TeamYousef_Function_set_closure, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_closure", TeamYousef_Function_get_closure, TeamYousef_Function_set_closure, NULL},
#endif
    {(char *)"__globals__", TeamYousef_Function_get_globals, TeamYousef_Function_set_globals, NULL},
    {(char *)"__module__", TeamYousef_Function_get_module, TeamYousef_Function_set_module, NULL},
#if PYTHON_VERSION >= 0x300
    {(char *)"__kwdefaults__", TeamYousef_Function_get_kwdefaults, TeamYousef_Function_set_kwdefaults, NULL},
    {(char *)"__annotations__", TeamYousef_Function_get_annotations, TeamYousef_Function_set_annotations, NULL},
#endif
#if PYTHON_VERSION >= 0x3a0
    {(char *)"__builtins__", TeamYousef_Function_get_builtins, TeamYousef_Function_set_builtins, NULL},
#endif
#if PYTHON_VERSION >= 0x3c0
    {(char *)"__type_params__", TeamYousef_Function_get_type_params, TeamYousef_Function_set_type_params, NULL},
#endif
    {(char *)"__compiled__", TeamYousef_Function_get_compiled, TeamYousef_Function_set_compiled, NULL},
    {(char *)"__compiled_constant__", TeamYousef_Function_get_compiled_constant, TeamYousef_Function_set_compiled_constant,
     NULL},
    {NULL}};

static PyObject *TeamYousef_Function_reduce(struct TeamYousef_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *TeamYousef_Function_clone(struct TeamYousef_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
#if PYTHON_VERSION >= 0x300
#if 0
    PRINT_STRING("TeamYousef_Function_clone:");
    ...
    struct TeamYousef_FunctionObject *result =
        TeamYousef_Function_New(function->m_c_code, function->m_name,
#if PYTHON_VERSION >= 0x300
                            function->m_qualname,
#endif
...
static struct TeamYousef_FunctionObject *free_list_functions = NULL;
static int free_list_functions_count = 0;

static void TeamYousef_Function_tp_dealloc(struct TeamYousef_FunctionObject *function) {
#if _DEBUG_REFCOUNTS
    count_active_TeamYousef_Function_Type -= 1;
    count_released_TeamYousef_Function_Type += 1;
#endif
...
#ifndef __SAJODE_NO_ASSERT__
    struct TeamYousef_ExceptionPreservationItem saved_exception_state2;
...
static PyMethodDef TeamYousef_Function_methods[] = {{"__reduce__", (PyCFunction)TeamYousef_Function_reduce, METH_NOARGS, NULL},
                                                {"clone", (PyCFunction)TeamYousef_Function_clone, METH_NOARGS, NULL},
                                                {NULL}};

static PyObject *TeamYousef_Function_tp_call(struct TeamYousef_FunctionObject *function, PyObject *tuple_args, PyObject *kw);

PyTypeObject TeamYousef_Function_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_function", // tp_name
    sizeof(struct TeamYousef_FunctionObject),               // tp_basicsize
    sizeof(struct TeamYousef_CellObject *),                 // tp_itemsize
    (destructor)TeamYousef_Function_tp_dealloc,             // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_SAJODE_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct TeamYousef_FunctionObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0,                                    // tp_getattr
    0,                                    // tp_setattr
    0,                                    // tp_compare
    (reprfunc)TeamYousef_Function_tp_repr,    // tp_repr
    0,                                    // tp_as_number
    0,                                    // tp_as_sequence
    0,                                    // tp_as_mapping
    (hashfunc)TeamYousef_Function_tp_hash,    // tp_hash
    (ternaryfunc)TeamYousef_Function_tp_call, // tp_call
    0,                                    // tp_str
    ...
    0,                                                  // tp_doc
    (traverseproc)TeamYousef_Function_tp_traverse,          // tp_traverse
    0,                                                  // tp_clear
    0,                                                  // tp_richcompare
    offsetof(struct TeamYousef_FunctionObject, m_weakrefs), // tp_weaklistoffset
    0,                                                  // tp_iter
    0,                                                  // tp_iternext
    TeamYousef_Function_methods,                            // tp_methods
    0,                                                  // tp_members
    TeamYousef_Function_getset,                             // tp_getset
    0,                                                  // tp_base
    0,                                                  // tp_dict
    TeamYousef_Function_descr_get,                          // tp_descr_get
    0,                                                  // tp_descr_set
    offsetof(struct TeamYousef_FunctionObject, m_dict),     // tp_dictoffset
    0,                                                  // tp_init
    0,                                                  // tp_alloc
    0,                                                  // tp_new
    0,                                                  // tp_free
...
void _initCompiledFunctionType(void) {
    TeamYousef_PyType_Ready(&TeamYousef_Function_Type, &PyFunction_Type, true, false, false, false, false);

    // Be a paranoid subtype of uncompiled function, we want nothing shared.
    assert(TeamYousef_Function_Type.tp_doc != PyFunction_Type.tp_doc);
    assert(TeamYousef_Function_Type.tp_traverse != PyFunction_Type.tp_traverse);
    assert(TeamYousef_Function_Type.tp_clear != PyFunction_Type.tp_clear || PyFunction_Type.tp_clear == NULL);
    assert(TeamYousef_Function_Type.tp_richcompare != PyFunction_Type.tp_richcompare ||
           PyFunction_Type.tp_richcompare == NULL);
    assert(TeamYousef_Function_Type.tp_weaklistoffset != PyFunction_Type.tp_weaklistoffset);
    assert(TeamYousef_Function_Type.tp_iter != PyFunction_Type.tp_iter || PyFunction_Type.tp_iter == NULL);
    assert(TeamYousef_Function_Type.tp_iternext != PyFunction_Type.tp_iternext || PyFunction_Type.tp_iternext == NULL);
    assert(TeamYousef_Function_Type.tp_methods != PyFunction_Type.tp_methods);
    assert(TeamYousef_Function_Type.tp_members != PyFunction_Type.tp_members);
    assert(TeamYousef_Function_Type.tp_getset != PyFunction_Type.tp_getset);
    assert(TeamYousef_Function_Type.tp_dict != PyFunction_Type.tp_dict);
    assert(TeamYousef_Function_Type.tp_descr_get != PyFunction_Type.tp_descr_get);

    assert(TeamYousef_Function_Type.tp_descr_set != PyFunction_Type.tp_descr_set || PyFunction_Type.tp_descr_set == NULL);
    assert(TeamYousef_Function_Type.tp_dictoffset != PyFunction_Type.tp_dictoffset);
    // TODO: These get changed and into the same thing, not sure what to compare against, project something
    // assert(TeamYousef_Function_Type.tp_init != PyFunction_Type.tp_init || PyFunction_Type.tp_init == NULL);
    // assert(TeamYousef_Function_Type.tp_alloc != PyFunction_Type.tp_alloc || PyFunction_Type.tp_alloc == NULL);
    // assert(TeamYousef_Function_Type.tp_new != PyFunction_Type.tp_new || PyFunction_Type.tp_new == NULL);
    // assert(TeamYousef_Function_Type.tp_free != PyFunction_Type.tp_free || PyFunction_Type.tp_free == NULL);
    assert(TeamYousef_Function_Type.tp_bases != PyFunction_Type.tp_bases);
    assert(TeamYousef_Function_Type.tp_mro != PyFunction_Type.tp_mro);
    assert(TeamYousef_Function_Type.tp_cache != PyFunction_Type.tp_cache || PyFunction_Type.tp_cache == NULL);
    assert(TeamYousef_Function_Type.tp_subclasses != PyFunction_Type.tp_subclasses || PyFunction_Type.tp_cache == NULL);
    assert(TeamYousef_Function_Type.tp_weaklist != PyFunction_Type.tp_weaklist);
    assert(TeamYousef_Function_Type.tp_del != PyFunction_Type.tp_del || PyFunction_Type.tp_del == NULL);
#if PYTHON_VERSION >= 0x300
    assert(TeamYousef_Function_Type.tp_finalize != PyFunction_Type.tp_finalize || PyFunction_Type.tp_finalize == NULL);
#endif

    // Make sure we don't miss out on attributes we are not having or should not have.
#ifndef __SAJODE_NO_ASSERT__
    for (struct PyGetSetDef *own = &TeamYousef_Function_getset[0]; own->name != NULL; own++) {
        bool found = false;
        ...
        if (found == false) {
            ...
            SAJODE_CANNOT_GET_HERE("Type problem");
        }
    }
...
// produce one.
static PyObject *_TeamYousef_FunctionEmptyCodeNoneImpl(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
static PyObject *_TeamYousef_FunctionEmptyCodeTrueImpl(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                                   PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_TeamYousef_FunctionEmptyCodeFalseImpl(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                                    PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_TeamYousef_FunctionEmptyCodeGenericImpl(PyThreadState *tstate,
                                                      struct TeamYousef_FunctionObject const *function,
                                                      PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(TeamYousef_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
void TeamYousef_Function_EnableConstReturnTrue(struct TeamYousef_FunctionObject *function) {
    function->m_constant_return_value = Py_True;
    function->m_c_code = _TeamYousef_FunctionEmptyCodeTrueImpl;
}

void TeamYousef_Function_EnableConstReturnFalse(struct TeamYousef_FunctionObject *function) {
    function->m_constant_return_value = Py_False;
    function->m_c_code = _TeamYousef_FunctionEmptyCodeFalseImpl;
}

void TeamYousef_Function_EnableConstReturnGeneric(struct TeamYousef_FunctionObject *function, PyObject *value) {
    function->m_constant_return_value = value;
    function->m_c_code = _TeamYousef_FunctionEmptyCodeGenericImpl;
}

#ifdef _SAJODE_PLUGIN_DILL_ENABLED
int TeamYousef_Function_GetFunctionCodeIndex(PyThreadState *tstate, struct TeamYousef_FunctionObject *function,
                                         function_impl_code const *function_table) {

    if (function->m_c_code == _TeamYousef_FunctionEmptyCodeTrueImpl) {
        return -2;
    }

    if (function->m_c_code == _TeamYousef_FunctionEmptyCodeFalseImpl) {
        return -3;
    }

    if (function->m_c_code == _TeamYousef_FunctionEmptyCodeNoneImpl) {
        return -4;
    }

    if (function->m_c_code == _TeamYousef_FunctionEmptyCodeGenericImpl) {
        return -5;
    }
...
PyObject *TeamYousef_Function_GetFunctionState(struct TeamYousef_FunctionObject *function,
                                           function_impl_code const *function_table) {
    PyThreadState *tstate = PyThreadState_GET();

    int offset = TeamYousef_Function_GetFunctionCodeIndex(tstate, function, function_table);
    ...
    PyObject *code_object_desc = TeamYousef_Function_ExtractCodeObjectDescription(tstate, function);

    PyObject *result = MAKE_TUPLE_EMPTY(tstate, 10);
    PyTuple_SET_ITEM(result, 0, TeamYousef_PyLong_FromLong(offset));
    ...
    if (closure != Py_None) {
        for (Py_ssize_t i = 0; i < PyTuple_GET_SIZE(closure); i++) {
            struct TeamYousef_CellObject *cell = (struct TeamYousef_CellObject *)PyTuple_GET_ITEM(closure, i);

            assert(TeamYousef_Cell_Check((PyObject *)cell));
...
struct TeamYousef_FunctionObject *TeamYousef_Function_CreateFunctionViaCodeIndex(
    ...
    SAJODE_DYNAMIC_ARRAY_DECL(closure_cells, struct TeamYousef_CellObject *, closure_size);

    for (Py_ssize_t i = 0; i < closure_size; i++) {
        closure_cells[i] = TeamYousef_Cell_New0(PyTuple_GET_ITEM(closure, i));
    }
    ...
    struct TeamYousef_FunctionObject *result =
        TeamYousef_Function_New(offset >= 0 ? function_table[offset] : NULL, code_object->co_name,
#if PYTHON_VERSION >= 0x300
                            function_qualname,
#endif
    ...
    if (offset == -2) {
        TeamYousef_Function_EnableConstReturnTrue(result);
    } else if (offset == -3) {
        TeamYousef_Function_EnableConstReturnFalse(result);
    } else if (offset == -4) {
        result->m_c_code = _TeamYousef_FunctionEmptyCodeNoneImpl;
    } else if (offset == -5) {
        CHECK_OBJECT(constant_return_value);

        TeamYousef_Function_EnableConstReturnGeneric(result, constant_return_value);

        Py_INCREF_IMMORTAL(constant_return_value);
    } else if (offset < 0) {
        // Try to catch if we are missing values for the specialized shared
        // bodies.
        SAJODE_CANNOT_GET_HERE("Compiled function unpickle problem");
    }
...
PyObject *TeamYousef_Function_ExtractCodeObjectDescription(PyThreadState *tstate, struct TeamYousef_FunctionObject *function) {
    PyObject *code_object_desc = MAKE_TUPLE_EMPTY(tstate, 8);

    PyTuple_SET_ITEM0(code_object_desc, 0, function->m_code_object->co_filename);
    PyTuple_SET_ITEM0(code_object_desc, 1, function->m_code_object->co_name);
    PyTuple_SET_ITEM(code_object_desc, 2, TeamYousef_PyLong_FromLong(function->m_code_object->co_firstlineno));
...
#endif
    PyTuple_SET_ITEM(code_object_desc, 4, TeamYousef_PyLong_FromLong(function->m_code_object->co_argcount));
    PyTuple_SET_ITEM(code_object_desc, 5, TeamYousef_PyLong_FromLong(function->m_code_object->co_flags));

#if PYTHON_VERSION < 0x380
    PyTuple_SET_ITEM(code_object_desc, 6, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 6, TeamYousef_PyLong_FromLong(function->m_code_object->co_posonlyargcount));
#endif

#if PYTHON_VERSION < 0x3b0
    PyTuple_SET_ITEM(code_object_desc, 7, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 7, TeamYousef_PyLong_FromLong(function->m_code_object->co_kwonlyargcount));
#endif
...
#if PYTHON_VERSION >= 0x380 && !defined(_SAJODE_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *TeamYousef_Function_tp_vectorcall(struct TeamYousef_FunctionObject *function, PyObject *const *stack,
                                               size_t nargsf, PyObject *kw_names);
#endif

// Make a function with closure.
#if PYTHON_VERSION < 0x300
struct TeamYousef_FunctionObject *TeamYousef_Function_New(function_impl_code c_code, PyObject *name, PyCodeObject *code_object,
                                                  PyObject *defaults, PyObject *module, PyObject *doc,
                                                  struct TeamYousef_CellObject **closure, Py_ssize_t closure_given)
#else
struct TeamYousef_FunctionObject *TeamYousef_Function_New(function_impl_code c_code, PyObject *name, PyObject *qualname,
...
#endif
{
#if _DEBUG_REFCOUNTS
    count_active_TeamYousef_Function_Type += 1;
    count_allocated_TeamYousef_Function_Type += 1;
#endif

    struct TeamYousef_FunctionObject *result;

    // Macro to assign result memory from GC or free list.
    allocateFromFreeList(free_list_functions, struct TeamYousef_FunctionObject, TeamYousef_Function_Type, closure_given);
    ...
    result->m_varnames = TeamYousef_GetCodeVarNames(code_object);
    ...
    static long TeamYousef_Function_counter = 0;
    result->m_counter = TeamYousef_Function_counter++;

#if PYTHON_VERSION >= 0x380 && !defined(_SAJODE_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)TeamYousef_Function_tp_vectorcall;
#endif
...
#if PYTHON_VERSION >= 0x300
static void formatErrorNoArgumentAllowedKwSplit(struct TeamYousef_FunctionObject const *function, PyObject *kw_name,
                                                Py_ssize_t given) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = TeamYousef_String_AsString(function->m_name);
#else
    char const *function_name = TeamYousef_String_AsString(function->m_qualname);
#endif

    PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                 TeamYousef_String_AsString(kw_name));
}
#endif

static void formatErrorNoArgumentAllowed(struct TeamYousef_FunctionObject const *function,
#if PYTHON_VERSION >= 0x300
                                         PyObject *kw,
#endif
                                         Py_ssize_t given) {
    ...
    if (kw == NULL) {
        ...
        PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                     TeamYousef_String_AsString(tmp_arg_name));
...
static void formatErrorMultipleValuesGiven(struct TeamYousef_FunctionObject const *function, Py_ssize_t index) {
...
#endif
                 function_name, TeamYousef_String_AsString(function->m_varnames[index]));
}

#if PYTHON_VERSION < 0x300
static void formatErrorTooFewArguments(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
static void formatErrorTooFewArguments(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
    ...
    PyErr_Format(PyExc_TypeError, "%s() missing %zd required positional argument%s: %s", function_name, max_missing,
                 max_missing > 1 ? "s" : "", TeamYousef_String_AsString(list_str));

    Py_DECREF(list_str);
}
#endif

static void formatErrorTooManyArguments(struct TeamYousef_FunctionObject const *function, Py_ssize_t given
#if PYTHON_VERSION < 0x270
                                        ,
                                        Py_ssize_t kw_size
...
#if PYTHON_VERSION >= 0x300
static void formatErrorTooFewKwOnlyArguments(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                             PyObject **kw_vars) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = TeamYousef_String_AsString(function->m_name);
#else
...
static void formatErrorKeywordsMustBeString(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function) {
#if PYTHON_VERSION < 0x390
    char const *function_name = TeamYousef_String_AsString(function->m_name);
...
static inline bool RICH_COMPARE_EQ_CBOOL_ARG_NAMES(PyObject *operand1, PyObject *operand2) {
...
#if PYTHON_VERSION < 0x300
    SajodeSx_bool result = RICH_COMPARE_EQ_NBOOL_STR_OBJECT(operand1, operand2);
#else
    SajodeSx_bool result = RICH_COMPARE_EQ_NBOOL_UNICODE_OBJECT(operand1, operand2);
#endif

    // Should be close to impossible, we will have to ignore it though.
    if (unlikely(result == SAJODE_BOOL_EXCEPTION)) {
        PyThreadState *tstate = PyThreadState_GET();
    ...
    return result == SAJODE_BOOL_TRUE;
}

#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgs(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
#endif
{
    ...
    while (TeamYousef_DictNext(kw, &pos, &key, &value)) {
        if (unlikely(!checkKeywordType(key))) {
            formatErrorKeywordsMustBeString(tstate, function);
            return -1;
        }

        SAJODE_MAY_BE_UNUSED bool found = false;
        ...
        if (unlikely(found == false)) {
            ...
            if (pos_only_error == true) {
                PyErr_Format(PyExc_TypeError,
                             ...
                             TeamYousef_String_Check(key) ? TeamYousef_String_AsString(key) : "<non-string>");
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsSplit(struct TeamYousef_FunctionObject const *function, PyObject **python_pars,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                           PyObject **python_pars, PyObject *kw) {
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                                PyObject **python_pars, PyObject *kw)
#else
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                                PyObject **python_pars, Py_ssize_t *kw_only_found, PyObject *kw)
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t
handleKeywordArgsSplitWithStarDict(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
static void makeStarListTupleCopy(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
static void makeStarListTupleCopyMethod(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                        PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    assert(function->m_args_star_list_index != -1);
    Py_ssize_t list_star_index = function->m_args_star_list_index;
...
static bool _handleArgumentsPlainOnly(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
...
static bool handleMethodArgumentsPlainOnly(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
#if PYTHON_VERSION < 0x270
static bool _handleArgumentsPlain(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                  PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
...
static void releaseParameters(struct TeamYousef_FunctionObject const *function, PyObject *const *python_pars) {
    Py_ssize_t arg_count = function->m_args_overall_count;
...
static bool parseArgumentsPos(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                              PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsEmpty(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                PyObject **python_pars) {
    return parseArgumentsPos(tstate, function, python_pars, NULL, 0);
}

static bool parseArgumentsMethodPos(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                    PyObject **python_pars, PyObject *object, PyObject *const *args,
                                    Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsFullKwSplit(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
                                      PyObject *const *kw_values, PyObject *kw_names) {
...
static bool parseArgumentsFull(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
PyObject *TeamYousef_CallFunctionNoArgs(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function) {
    SAJODE_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_overall_count);
...
PyObject *TeamYousef_CallMethodFunctionPosArgsKwArgs(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                                 PyObject *object, PyObject *const *args, Py_ssize_t args_size,
                                                 PyObject *kw) {
    SAJODE_DYNAMIC_ARRAY_DECL(new_args, PyObject *, args_size + 1);

    new_args[0] = object;
    memcpy(new_args + 1, args, args_size * sizeof(PyObject *));

    // TODO: Specialize implementation for massive gains.
    return TeamYousef_CallFunctionPosArgsKwArgs(tstate, function, new_args, args_size + 1, kw);
}

static Py_ssize_t _handleVectorcallKeywordArgs(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                               PyObject **python_pars, Py_ssize_t *kw_only_found,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY38(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
...
static bool parseArgumentsVectorcall(PyThreadState *tstate, struct TeamYousef_FunctionObject const *function,
                                     PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
    ...
    if (unlikely(arg_count == 0 && function->m_args_simple && args_size + kw_size > 0)) {
        ...
        if (kw_size == 0) {
            ...
            PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                         TeamYousef_String_AsString(kw_names[0]));
        }
...
static PyObject *TeamYousef_Function_tp_call(struct TeamYousef_FunctionObject *function, PyObject *tuple_args, PyObject *kw) {
    ...
    if (kw == NULL) {
        ...
        return TeamYousef_CallFunctionPosArgsKwArgs(tstate, function, &PyTuple_GET_ITEM(tuple_args, 0),
...
static PyObject *TeamYousef_Function_tp_vectorcall(struct TeamYousef_FunctionObject *function, PyObject *const *stack,
    ...
    PyThreadState *tstate = PyThreadState_GET();
    return TeamYousef_CallFunctionVectorcall(tstate, function, stack, nargs,
