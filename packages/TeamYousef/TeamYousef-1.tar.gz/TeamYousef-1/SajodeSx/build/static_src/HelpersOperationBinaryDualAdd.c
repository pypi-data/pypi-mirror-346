 ...
 */
bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(SajodeSx_ilong *result, SajodeSx_ilong *operand1, SajodeSx_ilong *operand2) {
 ...
 * Python objects. */
bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(SajodeSx_ilong *result, SajodeSx_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
#pragma warning(pop)
    ...
    exit_result_ok_clong:
        ...
        SAJODE_CANNOT_GET_HERE("cannot happen with types NILONG DIGIT");
        return false;
    }
}
