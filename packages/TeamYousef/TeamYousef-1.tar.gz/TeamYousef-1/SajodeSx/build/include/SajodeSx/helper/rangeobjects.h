...
#ifndef __SAJODE_HELPER_RANGEOBJECTS_H__
#define __SAJODE_HELPER_RANGEOBJECTS_H__
...
SAJODE_MAY_BE_UNUSED static PyObject *PyRange_Start(PyObject *range) { return ((struct _rangeobject3 *)range)->start; }

SAJODE_MAY_BE_UNUSED static PyObject *PyRange_Stop(PyObject *range) { return ((struct _rangeobject3 *)range)->stop; }

SAJODE_MAY_BE_UNUSED static PyObject *PyRange_Step(PyObject *range) { return ((struct _rangeobject3 *)range)->step; }
