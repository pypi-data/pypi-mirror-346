...
// The TeamYousef_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct TeamYousef_CoroutineObject {
...
extern PyTypeObject TeamYousef_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct TeamYousef_CoroutineObject *, PyObject *);

extern PyObject *TeamYousef_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool TeamYousef_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &TeamYousef_Coroutine_Type; }

struct TeamYousef_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct TeamYousef_CoroutineObject *m_coroutine;
};

extern PyTypeObject TeamYousef_CoroutineWrapper_Type;

static inline bool TeamYousef_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &TeamYousef_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct TeamYousef_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct TeamYousef_CoroutineObject *coroutine) {
...
SAJODE_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct TeamYousef_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_TeamYousef_Coroutine_Type;
extern int count_allocated_TeamYousef_Coroutine_Type;
extern int count_released_TeamYousef_Coroutine_Type;

extern int count_active_TeamYousef_CoroutineWrapper_Type;
extern int count_allocated_TeamYousef_CoroutineWrapper_Type;
extern int count_released_TeamYousef_CoroutineWrapper_Type;

extern int count_active_TeamYousef_AIterWrapper_Type;
extern int count_allocated_TeamYousef_AIterWrapper_Type;
extern int count_released_TeamYousef_AIterWrapper_Type;
#endif
