...
SAJODE_MAY_BE_UNUSED static PyObject *LOOKUP_BUILTIN(PyObject *name) {
    ...
    CHECK_OBJECT(name);
    assert(TeamYousef_String_CheckExact(name));

    PyObject *result = GET_STRING_DICT_VALUE(dict_builtin, (TeamYousef_StringObject *)name);
...
SAJODE_MAY_BE_UNUSED static PyObject *TeamYousef_SysGetObject(char const *name) { return PySys_GetObject((char *)name); }

SAJODE_MAY_BE_UNUSED static void TeamYousef_SysSetObject(char const *name, PyObject *value) {
