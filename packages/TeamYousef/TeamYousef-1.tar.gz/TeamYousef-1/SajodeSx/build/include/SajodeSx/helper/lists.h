...
#ifndef __SAJODE_HELPER_LISTS_H__
#define __SAJODE_HELPER_LISTS_H__
...
SAJODE_MAY_BE_UNUSED static PyObject *MAKE_LIST_REPEATED(PyThreadState *tstate, Py_ssize_t size, PyObject *element) {
