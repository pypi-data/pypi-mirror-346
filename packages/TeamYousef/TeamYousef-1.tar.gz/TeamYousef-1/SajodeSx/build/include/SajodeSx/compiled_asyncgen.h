...
#ifndef __SAJODE_COMPILED_ASYNCGEN_H__
#define __SAJODE_COMPILED_ASYNCGEN_H__
...
// The TeamYousef_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct TeamYousef_AsyncgenObject {
...
extern PyTypeObject TeamYousef_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct TeamYousef_AsyncgenObject *, PyObject *);

extern PyObject *TeamYousef_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct TeamYousef_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool TeamYousef_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &TeamYousef_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct TeamYousef_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct TeamYousef_AsyncgenObject *asyncgen) {
...
SAJODE_MAY_BE_UNUSED static void STORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate,
...
SAJODE_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct TeamYousef_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_TeamYousef_Asyncgen_Type;
extern int count_allocated_TeamYousef_Asyncgen_Type;
extern int count_released_TeamYousef_Asyncgen_Type;

extern int count_active_TeamYousef_AsyncgenValueWrapper_Type;
extern int count_allocated_TeamYousef_AsyncgenValueWrapper_Type;
extern int count_released_TeamYousef_AsyncgenValueWrapper_Type;

extern int count_active_TeamYousef_AsyncgenAsend_Type;
extern int count_allocated_TeamYousef_AsyncgenAsend_Type;
extern int count_released_TeamYousef_AsyncgenAsend_Type;

extern int count_active_TeamYousef_AsyncgenAthrow_Type;
extern int count_allocated_TeamYousef_AsyncgenAthrow_Type;
extern int count_released_TeamYousef_AsyncgenAthrow_Type;
