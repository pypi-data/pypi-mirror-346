...
#ifndef __SAJODE_HELPER_RAISING_H__
#define __SAJODE_HELPER_RAISING_H__

#if PYTHON_VERSION >= 0x300
SAJODE_MAY_BE_UNUSED static void CHAIN_EXCEPTION(PyThreadState *tstate, PyObject *exception_value) {
...
#if PYTHON_VERSION < 0x3b0
    {
        ...
        struct TeamYousef_ExceptionPreservationItem *exception_state =
            (struct TeamYousef_ExceptionPreservationItem *)&EXC_TYPE(tstate);
    ...
    if (old_exc_value != NULL && old_exc_value != Py_None && old_exc_value != exception_value) {
        ...
        while (true) {
            PyObject *context = TeamYousef_Exception_GetContext(current);
            if (context == NULL) {
                break;
            }
            ...
            if (context == exception_value) {
                TeamYousef_Exception_DeleteContext(current);
                break;
            }
        ...
        TeamYousef_Exception_SetContext(exception_value, old_exc_value);
...
extern void RAISE_EXCEPTION_WITH_TYPE(PyThreadState *tstate, struct TeamYousef_ExceptionPreservationItem *exception_state);
extern void RAISE_EXCEPTION_WITH_TYPE_AND_VALUE(PyThreadState *tstate,
                                                struct TeamYousef_ExceptionPreservationItem *exception_state);
#else
extern void RAISE_EXCEPTION_WITH_VALUE(PyThreadState *tstate, struct TeamYousef_ExceptionPreservationItem *exception_state);
#endif
...
extern void RAISE_EXCEPTION_WITH_TRACEBACK(PyThreadState *tstate,
                                           struct TeamYousef_ExceptionPreservationItem *exception_state);
#else
extern void RAISE_EXCEPTION_WITH_CAUSE(PyThreadState *tstate, struct TeamYousef_ExceptionPreservationItem *exception_state,
                                       PyObject *exception_cause);
#endif

extern bool RERAISE_EXCEPTION(PyThreadState *tstate, struct TeamYousef_ExceptionPreservationItem *exception_state);
