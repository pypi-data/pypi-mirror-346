...
#ifndef __SAJODE_HELPER_ATTRIBUTES_H__
#define __SAJODE_HELPER_ATTRIBUTES_H__
...
static inline bool TeamYousef_Descr_IsData(PyObject *object) { return Py_TYPE(object)->tp_descr_set != NULL; }
#else
#define TeamYousef_Descr_IsData(object) PyDescr_IsData(object)
#endif
