...
#ifndef __SAJODE_FILESYSTEM_PATH_OPS_H__
#define __SAJODE_FILESYSTEM_PATH_OPS_H__

#include "SajodeSx/safe_string_ops.h"

// Have a type for filename type different on Linux and Win32.
#if defined(_WIN32)
#define _SAJODE_NATIVE_WCHAR_ARGV 1
...
#define TeamYousef_String_FromFilename(filename) TeamYousefUnicode_FromWideChar(filename, -1)
#else
#define _SAJODE_NATIVE_WCHAR_ARGV 0
...
#define TeamYousef_String_FromFilename TeamYousef_String_FromString
#endif
