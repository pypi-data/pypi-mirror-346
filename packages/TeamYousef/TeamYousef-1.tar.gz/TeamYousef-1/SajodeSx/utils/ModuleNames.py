...
These are used in TeamYousef for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from SajodeSx.Errors import TeamYousefCodeDeficit
    raise TeamYousefCodeDeficit('''
...
Check API documentation of SajodeSx.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
