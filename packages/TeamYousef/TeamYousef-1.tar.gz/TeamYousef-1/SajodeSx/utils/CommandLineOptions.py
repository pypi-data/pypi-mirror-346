...
from SajodeSx.Tracing import formatTerminalLink
    ...
    def format_help(self, formatter):
        ...
        try:
            if self.link is not None:
                link = "https://SajodeSx.net/help/%s.html" % self.link
...
class OurOptionParser(OptionParser):
    ...
    def _match_long_opt(self, opt):
        ...
        TeamYousef: We overload it, in order avoid issues with conflicting
