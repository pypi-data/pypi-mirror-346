...
from SajodeSx import OutputDirectories
from SajodeSx.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from SajodeSx.utils.FileOperations import openPickleFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<SajodeSx.Serialization.BlobData %s>" % self.name
...
class GlobalConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in SajodeSx.Builtins
