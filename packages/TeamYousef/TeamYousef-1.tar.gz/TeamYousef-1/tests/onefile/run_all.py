...
""" Runner for onefile program tests of TeamYousef.
...
# Find SajodeSx package relative to us. The replacement is for POSIX python
...
from SajodeSx.tools.testing.RuntimeTracing import (
