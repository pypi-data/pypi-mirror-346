...
#ifndef __SAJODE_TRACING_H__
#define __SAJODE_TRACING_H__
...
#define SAJODE_PRINT_TRACE(value)                                                                                      \
    {                                                                                                                  \
        puts(value);                                                                                                   \
        fflush(stdout);                                                                                                \
    }
#define SAJODE_PRINTF_TRACE(...)                                                                                       \
    {                                                                                                                  \
        printf(__VA_ARGS__);                                                                                           \
        fflush(stdout);                                                                                                \
    }
...
#define SAJODE_PRINT_TIMING(value)                                                                                     \
    {                                                                                                                  \
        PRINT_TIME_STAMP();                                                                                            \
        puts(value);                                                                                                   \
        fflush(stdout);                                                                                                \
...
#define SAJODE_PRINT_TIMING(value) SAJODE_PRINT_TRACE(value)
