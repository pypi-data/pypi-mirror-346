...
#ifndef __SAJODE_CALLING_H__
#define __SAJODE_CALLING_H__
...
SAJODE_MAY_BE_UNUSED static inline PyObject *TeamYousef_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and TeamYousef inner workings can get
        // upset from it.
...
SAJODE_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return TeamYousef_CheckFunctionResult(tstate, function_object, result);
}
...
SAJODE_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_POS_ARGS(PyThreadState *tstate, PyObject *function_object,
...
SAJODE_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_KW_ARGS(PyThreadState *tstate, PyObject *function_object,
                                                                 PyObject *named_args) {
...
#include "SajodeSx/helper/calling_generated.h"
