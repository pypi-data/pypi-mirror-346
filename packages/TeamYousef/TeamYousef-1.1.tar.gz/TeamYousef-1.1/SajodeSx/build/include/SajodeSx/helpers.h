...
#ifndef __SAJODE_HELPERS_H__
#define __SAJODE_HELPERS_H__
...
// For profiling of TeamYousef compiled binaries
#if _SAJODE_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "SajodeSx/helper/boolean.h"
#include "SajodeSx/helper/dictionaries.h"
#include "SajodeSx/helper/indexes.h"
#include "SajodeSx/helper/mappings.h"
#include "SajodeSx/helper/operations_builtin_types.h"
#include "SajodeSx/helper/sets.h"
#include "SajodeSx/helper/strings.h"

#include "SajodeSx/helper/raising.h"

#include "SajodeSx/helper/ints.h"
#include "SajodeSx/helper/richcomparisons.h"
#include "SajodeSx/helper/sequences.h"

static inline bool TeamYousef_Function_Check(PyObject *object);
static inline PyObject *TeamYousef_Function_GetName(PyObject *object);

static inline bool TeamYousef_Generator_Check(PyObject *object);
static inline PyObject *TeamYousef_Generator_GetName(PyObject *object);

#include "SajodeSx/calling.h"
#include "SajodeSx/helper/bytes.h"
#include "SajodeSx/helper/complex.h"
#include "SajodeSx/helper/floats.h"

SAJODE_MAY_BE_UNUSED static PyObject *LOOKUP_VARS(PyThreadState *tstate, PyObject *source) {
    CHECK_OBJECT(source);
...
#include "SajodeSx/helper/attributes.h"
#include "SajodeSx/helper/bytearrays.h"
#include "SajodeSx/helper/iterators.h"
#include "SajodeSx/helper/lists.h"
#include "SajodeSx/helper/rangeobjects.h"
#include "SajodeSx/helper/slices.h"
#include "SajodeSx/helper/subscripts.h"
#include "SajodeSx/helper/tuples.h"

#include "SajodeSx/builtins.h"
...
SajodeSx_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "SajodeSx/importing.h"

// Hard imports have their own helpers.
#include "SajodeSx/helper/import_hard.h"
...
#include "SajodeSx/constants_blob.h"
...
SAJODE_MAY_BE_UNUSED static PyObject *MODULE_NAME1(PyThreadState *tstate, PyObject *module) {
...
SAJODE_MAY_BE_UNUSED static PyObject *MODULE_NAME0(PyThreadState *tstate, PyObject *module) {
    assert(PyModule_Check(module));
    PyObject *module_dict = ((PyModuleObject *)module)->md_dict;
...
extern PyTypeObject *TeamYousef_PyUnion_Type;

// Force a garbage collection, for debugging purposes.
SAJODE_MAY_BE_UNUSED static void forceGC(void) {
...
extern void TeamYousef_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "SajodeSx/exception_groups.h"
#endif

#if PYTHON_VERSION >= 0x3c0
#include "SajodeSx/type_aliases.h"
#endif
