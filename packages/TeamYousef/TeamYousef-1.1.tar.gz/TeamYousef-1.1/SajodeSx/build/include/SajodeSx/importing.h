...
#ifndef __SAJODE_IMPORTING_H__
#define __SAJODE_IMPORTING_H__
...
SAJODE_MAY_BE_UNUSED static PyObject *TeamYousef_GetSysModules(void) {
...
SAJODE_MAY_BE_UNUSED static bool TeamYousef_HasModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_HAS_ITEM(tstate, TeamYousef_GetSysModules(), module_name) == 1;
}

// Replacement for "PyImport_GetModule" working across all versions and less checks.
SAJODE_MAY_BE_UNUSED static PyObject *TeamYousef_GetModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_GET_ITEM1(tstate, TeamYousef_GetSysModules(), module_name);
}

// Replacement for PyImport_GetModule working across all versions and less checks.
SAJODE_MAY_BE_UNUSED static PyObject *TeamYousef_GetModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = TeamYousef_String_FromString(module_name);
    PyObject *result = TeamYousef_GetModule(tstate, module_name_object);
...
SAJODE_MAY_BE_UNUSED static bool TeamYousef_SetModule(PyObject *module_name, PyObject *module) {
    CHECK_OBJECT(module_name);
    CHECK_OBJECT(module);
    assert(PyModule_Check(module));

    return DICT_SET_ITEM(TeamYousef_GetSysModules(), module_name, module);
}

// Add a module to the modules dictionary from name C string
SAJODE_MAY_BE_UNUSED static bool TeamYousef_SetModuleString(char const *module_name, PyObject *module) {
    PyObject *module_name_object = TeamYousef_String_FromString(module_name);
    bool result = TeamYousef_SetModule(module_name_object, module);
    Py_DECREF(module_name_object);
...
SAJODE_MAY_BE_UNUSED static bool TeamYousef_DelModule(PyThreadState *tstate, PyObject *module_name) {
    CHECK_OBJECT(module_name);
...
SAJODE_MAY_BE_UNUSED static bool TeamYousef_DelModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = TeamYousef_String_FromString(module_name);
    bool result = TeamYousef_DelModule(tstate, module_name_object);
    Py_DECREF(module_name_object);
...
SAJODE_MAY_BE_UNUSED static PyObject *TeamYousef_GetFilenameObject(PyThreadState *tstate, PyObject *module) {
#if PYTHON_VERSION < 0x300
