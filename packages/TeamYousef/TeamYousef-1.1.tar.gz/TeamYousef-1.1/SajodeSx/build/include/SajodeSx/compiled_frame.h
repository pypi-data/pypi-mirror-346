...
#ifndef __SAJODE_COMPILED_FRAME_H__
#define __SAJODE_COMPILED_FRAME_H__
...
// TeamYousef frames.
#if PYTHON_VERSION < 0x3b0
typedef PyFrameObject TeamYousef_ThreadStateFrameType;
#else
typedef _PyInterpreterFrame TeamYousef_ThreadStateFrameType;
#endif
...
extern void PRINT_COMPILED_FRAME(char const *prefix, struct TeamYousef_FrameObject *frame);
extern void PRINT_INTERPRETER_FRAME(char const *prefix, TeamYousef_ThreadStateFrameType *frame);
#else
...
extern struct TeamYousef_FrameObject *MAKE_MODULE_FRAME(PyCodeObject *code, PyObject *module);
extern struct TeamYousef_FrameObject *MAKE_FUNCTION_FRAME(PyThreadState *tstate, PyCodeObject *code, PyObject *module,
                                                      Py_ssize_t locals_size);
extern struct TeamYousef_FrameObject *MAKE_CLASS_FRAME(PyThreadState *tstate, PyCodeObject *code, PyObject *module,
...
SAJODE_MAY_BE_UNUSED static inline bool isFakeCodeObject(PyCodeObject *code) {
#if PYTHON_VERSION < 0x300
...
extern PyTypeObject TeamYousef_Frame_Type;

static inline bool TeamYousef_Frame_CheckExact(PyObject *object) {
    CHECK_OBJECT(object);
    return Py_TYPE(object) == &TeamYousef_Frame_Type;
}

static inline bool TeamYousef_Frame_Check(PyObject *object) {
    assert(object);
    ...
    if (TeamYousef_Frame_CheckExact(object)) {
        return true;
    }
...
SAJODE_MAY_BE_UNUSED static inline bool isFrameUnusable(struct TeamYousef_FrameObject *frame_object) {
...
#if PYTHON_VERSION >= 0x3b0
inline static PyCodeObject *TeamYousef_InterpreterFrame_GetCodeObject(_PyInterpreterFrame *frame) {
...
inline static PyCodeObject *TeamYousef_Frame_GetCodeObject(PyFrameObject *frame) {
#if PYTHON_VERSION >= 0x3b0
    assert(frame->f_frame);
    return TeamYousef_InterpreterFrame_GetCodeObject(frame->f_frame);
#else
    return frame->f_code;
#endif
}
...
inline static void assertPythonFrameObject(PyFrameObject *frame_object) {
    ...
    CHECK_CODE_OBJECT(TeamYousef_Frame_GetCodeObject(frame_object));
}

inline static void assertFrameObject(struct TeamYousef_FrameObject *frame_object) {
    CHECK_OBJECT(frame_object);
...
inline static void assertThreadFrameObject(TeamYousef_ThreadStateFrameType *frame) {
#if PYTHON_VERSION < 0x3b0
...
static inline void TeamYousef_PythonFrame_MarkAsExecuting(PyFrameObject *frame) {
...
static inline void TeamYousef_Frame_MarkAsExecuting(struct TeamYousef_FrameObject *frame) {
    CHECK_OBJECT(frame);
#if PYTHON_VERSION >= 0x3b0
...
#else
#define TeamYousef_Frame_MarkAsExecuting(frame) ;
#endif

#if PYTHON_VERSION >= 0x300
static inline void TeamYousef_Frame_MarkAsNotExecuting(struct TeamYousef_FrameObject *frame) {
    CHECK_OBJECT(frame);
#if PYTHON_VERSION >= 0x3b0
...
#else
#define TeamYousef_Frame_MarkAsNotExecuting(frame) ;
#define TeamYousef_PythonFrame_MarkAsExecuting(frame) ;
#endif

#if PYTHON_VERSION >= 0x300
static inline bool TeamYousef_Frame_IsExecuting(struct TeamYousef_FrameObject *frame) {
    CHECK_OBJECT(frame);
#if PYTHON_VERSION >= 0x3b0
...
SAJODE_MAY_BE_UNUSED inline static void pushFrameStackInterpreterFrame(PyThreadState *tstate,
...
SAJODE_MAY_BE_UNUSED inline static void pushFrameStackPythonFrame(PyThreadState *tstate, PyFrameObject *frame_object) {
    ...
    if (old) {
        ...
        CHECK_CODE_OBJECT(TeamYousef_Frame_GetCodeObject(old));
    }
    ...
    TeamYousef_PythonFrame_MarkAsExecuting(frame_object);
...
SAJODE_MAY_BE_UNUSED inline static void pushFrameStackCompiledFrame(PyThreadState *tstate,
    ...
    TeamYousef_Frame_MarkAsExecuting(frame_object);
    Py_INCREF(frame_object);
#endif
}

SAJODE_MAY_BE_UNUSED inline static void popFrameStack(PyThreadState *tstate) {
#if _DEBUG_FRAME
    PRINT_TOP_FRAME("Normal pop entry top frame:");
#endif

#if PYTHON_VERSION < 0x3b0
    struct TeamYousef_FrameObject *frame_object = (struct TeamYousef_FrameObject *)(tstate->frame);
    CHECK_OBJECT(frame_object);

#if _DEBUG_FRAME
    printf("Taking off frame %s %s\n", TeamYousef_String_AsString(PyObject_Str((PyObject *)frame_object)),
    ...
    TeamYousef_Frame_MarkAsNotExecuting(frame_object);
    Py_DECREF(frame_object);
#else
    assert(CURRENT_TSTATE_INTERPRETER_FRAME(tstate));

    struct TeamYousef_FrameObject *frame_object =
        (struct TeamYousef_FrameObject *)CURRENT_TSTATE_INTERPRETER_FRAME(tstate)->frame_obj;
    CHECK_OBJECT(frame_object);
...
#if PYTHON_VERSION >= 0x300
SAJODE_MAY_BE_UNUSED static void TeamYousef_SetFrameGenerator(struct TeamYousef_FrameObject *SajodeSx_frame,
                                                          PyObject *generator) {
#if PYTHON_VERSION < 0x3b0
    SajodeSx_frame->m_frame.f_gen = generator;
#else
    SajodeSx_frame->m_generator = generator;
#endif

    // Mark the frame as executing
    if (generator) {
        TeamYousef_Frame_MarkAsExecuting(SajodeSx_frame);
    }
}
#endif

SAJODE_MAY_BE_UNUSED static PyCodeObject *TeamYousef_GetFrameCodeObject(struct TeamYousef_FrameObject *SajodeSx_frame) {
#if PYTHON_VERSION < 0x3b0
    return SajodeSx_frame->m_frame.f_code;
#else
    return TeamYousef_InterpreterFrame_GetCodeObject(&SajodeSx_frame->m_interpreter_frame);
#endif
}

SAJODE_MAY_BE_UNUSED static int TeamYousef_GetFrameLineNumber(struct TeamYousef_FrameObject *SajodeSx_frame) {
    return SajodeSx_frame->m_frame.f_lineno;
}

SAJODE_MAY_BE_UNUSED static PyObject **TeamYousef_GetCodeVarNames(PyCodeObject *code_object) {
#if PYTHON_VERSION < 0x3b0
...
extern void TeamYousef_Frame_AttachLocals(struct TeamYousef_FrameObject *frame, char const *type_description, ...);

SAJODE_MAY_BE_UNUSED static TeamYousef_ThreadStateFrameType *_TeamYousef_GetThreadStateFrame(PyThreadState *tstate) {
#if PYTHON_VERSION < 0x3b0
    return tstate->frame;
#else
...
SAJODE_MAY_BE_UNUSED inline static void pushFrameStackGenerator(PyThreadState *tstate,
                                                                TeamYousef_ThreadStateFrameType *frame_object) {
#if PYTHON_VERSION < 0x3b0
...
SAJODE_MAY_BE_UNUSED inline static void pushFrameStackGeneratorCompiledFrame(PyThreadState *tstate,
                                                                             struct TeamYousef_FrameObject *frame_object) {
#if PYTHON_VERSION < 0x3b0
...
#define SAJODE_TYPE_DESCRIPTION_NULL 'N'
#define SAJODE_TYPE_DESCRIPTION_CELL 'c'
#define SAJODE_TYPE_DESCRIPTION_OBJECT 'o'
#define SAJODE_TYPE_DESCRIPTION_OBJECT_PTR 'O'
#define SAJODE_TYPE_DESCRIPTION_BOOL 'b'
#define SAJODE_TYPE_DESCRIPTION_NILONG 'L'

#if _DEBUG_REFCOUNTS
extern int count_active_TeamYousef_Frame_Type;
extern int count_allocated_TeamYousef_Frame_Type;
extern int count_released_TeamYousef_Frame_Type;
#endif
