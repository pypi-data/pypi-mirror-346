...
#ifndef __SAJODE_PRELUDE_H__
#define __SAJODE_PRELUDE_H__
...
#include "SajodeSx/debug_settings.h"
 ...
 */
#ifdef __GNUC__
#define SAJODE_MAY_BE_UNUSED __attribute__((__unused__))
#else
#define SAJODE_MAY_BE_UNUSED
#endif
...
#define SAJODE_USE_PYCORE_THREAD_STATE
#endif

#ifdef SAJODE_USE_PYCORE_THREAD_STATE
#undef Py_BUILD_CORE
...
static inline size_t TeamYousef_static_builtin_index_get(PyTypeObject *self) { return (size_t)self->tp_subclasses - 1; }

// Changed internal type access for Python3.13
#if PYTHON_VERSION < 0x3d0
#define managed_static_type_state static_builtin_state

static inline managed_static_type_state *TeamYousef_static_builtin_state_get(PyInterpreterState *interp,
                                                                         PyTypeObject *self) {
    return &(interp->types.builtins[TeamYousef_static_builtin_index_get(self)]);
}
#else
static inline managed_static_type_state *TeamYousef_static_builtin_state_get(PyInterpreterState *interp,
                                                                         PyTypeObject *self) {
    return &(interp->types.builtins.initialized[TeamYousef_static_builtin_index_get(self)]);
}
#endif

SAJODE_MAY_BE_UNUSED static inline managed_static_type_state *TeamYousef_PyStaticType_GetState(PyInterpreterState *interp,
                                                                                           PyTypeObject *self) {
    assert(self->tp_flags & _Py_TPFLAGS_STATIC_BUILTIN);
    return TeamYousef_static_builtin_state_get(interp, self);
}

#define _PyStaticType_GetState(interp, self) TeamYousef_PyStaticType_GetState(interp, self)
#endif
...
#define SAJODE_NO_RETURN HEDLEY_NO_RETURN

/* This is used to indicate code control flows we know cannot happen. */
#ifndef __SAJODE_NO_ASSERT__
#define SAJODE_CANNOT_GET_HERE(NAME)                                                                                   \
    PRINT_FORMAT("%s : %s\n", __FUNCTION__, #NAME);                                                                    \
    abort();
#else
#define SAJODE_CANNOT_GET_HERE(NAME) abort();
#endif

#define SAJODE_ERROR_EXIT(NAME)                                                                                        \
    PRINT_FORMAT("%s : %s\n", __FUNCTION__, #NAME);                                                                    \
    abort();
 ...
 */
#include <malloc.h>
#define SAJODE_DYNAMIC_ARRAY_DECL(VARIABLE_NAME, ELEMENT_TYPE, COUNT)                                                  \
    ELEMENT_TYPE *VARIABLE_NAME = (ELEMENT_TYPE *)_alloca(sizeof(ELEMENT_TYPE) * (COUNT));
#else
#define SAJODE_DYNAMIC_ARRAY_DECL(VARIABLE_NAME, ELEMENT_TYPE, COUNT) ELEMENT_TYPE VARIABLE_NAME[COUNT];
#endif
...
#define TeamYousef_String_AsString PyString_AsString
#define TeamYousef_String_AsString_Unchecked PyString_AS_STRING
#define TeamYousef_String_Check PyString_Check
#define TeamYousef_String_CheckExact PyString_CheckExact
SAJODE_MAY_BE_UNUSED static inline bool TeamYousef_StringOrUnicode_CheckExact(PyObject *value) {
    return PyString_CheckExact(value) || PyUnicode_CheckExact(value);
}
#define TeamYousef_StringObject PyStringObject
#define TeamYousef_String_FromString PyString_FromString
#define TeamYousef_String_FromStringAndSize PyString_FromStringAndSize
#define TeamYousef_String_FromFormat PyString_FromFormat
#define PyUnicode_CHECK_INTERNED (0)
SAJODE_MAY_BE_UNUSED static Py_UNICODE *TeamYousef_UnicodeAsWideString(PyObject *str, Py_ssize_t *size) {
    PyObject *unicode;
...
#else
#define TeamYousef_String_AsString _PyUnicode_AsString
...
#ifdef __SAJODE_NO_ASSERT__
#define TeamYousef_String_AsString_Unchecked PyUnicode_UTF8
#else
SAJODE_MAY_BE_UNUSED static char const *TeamYousef_String_AsString_Unchecked(PyObject *object) {
    char const *result = PyUnicode_UTF8(object);
    assert(result != NULL);
    return result;
}
#endif
#define TeamYousef_String_Check PyUnicode_Check
#define TeamYousef_String_CheckExact PyUnicode_CheckExact
#define TeamYousef_StringOrUnicode_CheckExact PyUnicode_CheckExact
#define TeamYousef_StringObject PyUnicodeObject
#define TeamYousef_String_FromString PyUnicode_FromString
#define TeamYousef_String_FromStringAndSize PyUnicode_FromStringAndSize
#define TeamYousef_String_FromFormat PyUnicode_FromFormat
#define TeamYousef_UnicodeAsWideString PyUnicode_AsWideCharString
#endif
...
#ifdef __SAJODE_NO_ASSERT__
#define TeamYousef_TypeLookup(x, y) _PyType_Lookup(x, y)
#else
SAJODE_MAY_BE_UNUSED static PyObject *TeamYousef_TypeLookup(PyTypeObject *type, PyObject *name) {
...
#if PYTHON_VERSION < 0x300
#define SAJODE_MODULE_ENTRY_FUNCTION void
#else
#define SAJODE_MODULE_ENTRY_FUNCTION PyObject *
#endif
 ...
 */
#define SAJODE_CROSS_MODULE
#define SAJODE_LOCAL_MODULE static
...
#define TeamYousef_GC_Track PyObject_GC_Track
#define TeamYousef_GC_UnTrack PyObject_GC_UnTrack
...
#undef _PyObject_GC_TRACK
#undef _PyObject_GC_UNTRACK
#elif _SAJODE_MODULE_MODE && PYTHON_VERSION >= 0x370 && PYTHON_VERSION < 0x380
#define TeamYousef_GC_Track PyObject_GC_Track
#define TeamYousef_GC_UnTrack PyObject_GC_UnTrack
#undef _PyObject_GC_TRACK
#undef _PyObject_GC_UNTRACK
...
#else
#define TeamYousef_GC_Track _PyObject_GC_TRACK
#define TeamYousef_GC_UnTrack _PyObject_GC_UNTRACK
#endif

#if _SAJODE_EXPERIMENTAL_FAST_THREAD_GET && PYTHON_VERSION >= 0x300 && PYTHON_VERSION < 0x370
...
#if PYTHON_VERSION < 0x300
#define TeamYousefType_HasFeatureClass(descr) (PyType_HasFeature(Py_TYPE(descr), Py_TPFLAGS_HAVE_CLASS))
#else
#define TeamYousefType_HasFeatureClass(descr) (1)
#endif
...
extern bool TeamYousef_Type_IsSubtype(PyTypeObject *a, PyTypeObject *b);

#include "SajodeSx/allocator.h"
#include "SajodeSx/exceptions.h"
...
typedef long SajodeSx_digit;

#include "SajodeSx/helpers.h"

#include "SajodeSx/compiled_frame.h"

#include "SajodeSx/compiled_cell.h"

#include "SajodeSx/compiled_function.h"

/* Sentinel PyObject to be used for all our call iterator endings. */
extern PyObject *TeamYousef_sentinel_value;

/* Value to use for __compiled__ value of all modules. */
extern PyObject *TeamYousef_dunder_compiled_value;

#include "SajodeSx/compiled_generator.h"

#include "SajodeSx/compiled_method.h"

#if PYTHON_VERSION >= 0x350
#include "SajodeSx/compiled_coroutine.h"
#endif

#if PYTHON_VERSION >= 0x360
#include "SajodeSx/compiled_asyncgen.h"
#endif

#include "SajodeSx/filesystem_paths.h"
#include "SajodeSx/safe_string_ops.h"

#include "SajodeSx/jit_sources.h"

#if _SAJODE_EXPERIMENTAL_WRITEABLE_CONSTANTS
#include "SajodeSx_data_decoder.h"
#else
#define DECODE(x) assert(x)
#define UN_TRANSLATE(x) (x)
#endif

#if _SAJODE_EXPERIMENTAL_FILE_TRACING
#include "SajodeSx_file_tracer.h"
#else
#if PYTHON_VERSION < 0x300
...
#if _SAJODE_EXPERIMENTAL_INIT_PROGRAM
#include "SajodeSx_init_program.h"
#else
#define SAJODE_INIT_PROGRAM_EARLY(argc, argv)
#define SAJODE_INIT_PROGRAM_LATE(module_name)
#endif

#if _SAJODE_EXPERIMENTAL_EXIT_PROGRAM
#include "SajodeSx_exit_program.h"
#else
#define SAJODE_FINALIZE_PROGRAM(tstate)
#endif
