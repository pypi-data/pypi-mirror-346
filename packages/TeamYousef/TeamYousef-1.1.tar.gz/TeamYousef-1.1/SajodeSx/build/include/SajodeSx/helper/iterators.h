...
#ifndef __SAJODE_HELPER_ITERATORS_H__
#define __SAJODE_HELPER_ITERATORS_H__
...
SAJODE_MAY_BE_UNUSED static inline bool HAS_ITERNEXT(PyObject *value) {
...
SAJODE_MAY_BE_UNUSED static PyObject *MAKE_ITERATOR_INFALLIBLE(PyObject *iterated) {
    ...
    if (tp_iter) {
        ...
        seqiterobject *result = (seqiterobject *)TeamYousef_GC_New(&PySeqIter_Type);
        assert(result);
...
SAJODE_MAY_BE_UNUSED static PyObject *MAKE_ITERATOR(PyThreadState *tstate, PyObject *iterated) {
    CHECK_OBJECT(iterated);

#if _SAJODE_EXPERIMENTAL_DISABLE_ITERATOR_OPT
...
SAJODE_MAY_BE_UNUSED static PyObject *MAKE_UNPACK_ITERATOR(PyObject *iterated) {
    CHECK_OBJECT(iterated);
...
SAJODE_MAY_BE_UNUSED static PyObject *ITERATOR_NEXT_ITERATOR(PyObject *iterator) {
...
SAJODE_MAY_BE_UNUSED static PyObject *ITERATOR_NEXT(PyObject *iterator) {
    CHECK_OBJECT(iterator);
...
SAJODE_MAY_BE_UNUSED static PyObject *BUILTIN_NEXT2(PyThreadState *tstate, PyObject *iterator,
...
SAJODE_MAY_BE_UNUSED static PyObject *UNPACK_NEXT_INFALLIBLE(PyObject *iterator) {
    CHECK_OBJECT(iterator);
...
SAJODE_MAY_BE_UNUSED static PyObject *UNPACK_NEXT(PyThreadState *tstate,
...
SAJODE_MAY_BE_UNUSED static PyObject *UNPACK_NEXT_STARRED(PyThreadState *tstate,
                                                          struct TeamYousef_ExceptionPreservationItem *exception_state,
                                                          PyObject *iterator, int seq_size_so_far, int expected) {
    CHECK_OBJECT(iterator);
    assert(HAS_ITERNEXT(iterator));
...
SAJODE_MAY_BE_UNUSED static bool UNPACK_ITERATOR_CHECK(PyThreadState *tstate,
                                                       struct TeamYousef_ExceptionPreservationItem *exception_state,
