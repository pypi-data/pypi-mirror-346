...
#ifndef __SAJODE_COMPILED_GENERATOR_H__
#define __SAJODE_COMPILED_GENERATOR_H__
...
// The TeamYousef_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct TeamYousef_GeneratorObject {
...
#if PYTHON_VERSION >= 0x300
    struct TeamYousef_ExceptionStackItem m_resume_exception;
#endif
...
extern PyTypeObject TeamYousef_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct TeamYousef_GeneratorObject *, PyObject *);

extern PyObject *TeamYousef_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *TeamYousef_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct TeamYousef_CellObject **closure,
...
extern PyObject *TeamYousef_Generator_qiter(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                        bool *finished);

static inline bool TeamYousef_Generator_Check(PyObject *object) { return Py_TYPE(object) == &TeamYousef_Generator_Type; }

static inline PyObject *TeamYousef_Generator_GetName(PyObject *object) {
    return ((struct TeamYousef_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator) {
...
extern void TeamYousef_PreserveHeap(void *dest, ...);
extern void TeamYousef_RestoreHeap(void *source, ...);

SAJODE_MAY_BE_UNUSED static void STORE_GENERATOR_EXCEPTION(PyThreadState *tstate,
...
SAJODE_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct TeamYousef_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_TeamYousef_Generator_Type;
extern int count_allocated_TeamYousef_Generator_Type;
extern int count_released_TeamYousef_Generator_Type;
#endif
