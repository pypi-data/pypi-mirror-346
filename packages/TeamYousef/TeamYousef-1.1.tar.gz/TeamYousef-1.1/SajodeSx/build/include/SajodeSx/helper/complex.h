...
#ifndef __SAJODE_HELPER_COMPLEX_H__
#define __SAJODE_HELPER_COMPLEX_H__

SAJODE_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX1(PyThreadState *tstate, PyObject *real) {
    CHECK_OBJECT(real);
...
SAJODE_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX2(PyThreadState *tstate, PyObject *real, PyObject *imag) {
    if (real == NULL) {
        assert(imag != NULL);
