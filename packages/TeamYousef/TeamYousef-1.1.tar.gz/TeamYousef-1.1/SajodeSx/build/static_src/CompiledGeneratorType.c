...
#if _DEBUG_REFCOUNTS
int count_active_TeamYousef_Generator_Type;
int count_allocated_TeamYousef_Generator_Type;
int count_released_TeamYousef_Generator_Type;
#endif
...
#if _DEBUG_GENERATOR
SAJODE_MAY_BE_UNUSED static void _PRINT_GENERATOR_STATUS(char const *descriptor, char const *context,
                                                         struct TeamYousef_GeneratorObject *generator) {
    char const *status;
...
SAJODE_MAY_BE_UNUSED static void PRINT_COROUTINE_VALUE(char const *name, PyObject *value) {
    PRINT_STRING(name);
    PRINT_STRING("=");
    PRINT_ITEM(value);
    if (value) {
...
SAJODE_MAY_BE_UNUSED static void PRINT_COROUTINE_STRING(char const *name, char const *value) {
    PRINT_STRING(name);
    PRINT_STRING("=");
    PRINT_STRING(value);
    PRINT_NEW_LINE();
...
static void TeamYousef_MarkGeneratorAsFinished(struct TeamYousef_GeneratorObject *generator) {
...
static void TeamYousef_MarkGeneratorAsRunning(struct TeamYousef_GeneratorObject *generator) {
    generator->m_running = 1;

    if (generator->m_frame) {
        TeamYousef_Frame_MarkAsExecuting(generator->m_frame);
    }
}

static void TeamYousef_MarkGeneratorAsNotRunning(struct TeamYousef_GeneratorObject *generator) {
    generator->m_running = 0;

    if (generator->m_frame) {
        TeamYousef_Frame_MarkAsNotExecuting(generator->m_frame);
    }
}

static PyObject *TeamYousef_Generator_tp_repr(struct TeamYousef_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x300
    return TeamYousef_String_FromFormat("<compiled_generator object %s at %p>", TeamYousef_String_AsString(generator->m_name),
                                    generator);
#elif PYTHON_VERSION < 0x350
    return TeamYousef_String_FromFormat("<compiled_generator object %U at %p>", generator->m_name, generator);

#else
    return TeamYousef_String_FromFormat("<compiled_generator object %U at %p>", generator->m_qualname, generator);
#endif
}

static long TeamYousef_Generator_tp_traverse(struct TeamYousef_GeneratorObject *generator, visitproc visit, void *arg) {
...
static void TeamYousef_Generator_release_closure(struct TeamYousef_GeneratorObject *generator) {
    for (Py_ssize_t i = 0; i < generator->m_closure_given; i++) {
...
static PyObject *_TeamYousef_CallGeneratorCodeC(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                            PyObject *send_value) {

#if PYTHON_VERSION < 0x300
    return ((generator_code)generator->m_code)(tstate, generator, send_value);
#else
    struct TeamYousef_ExceptionStackItem enter_exception = GET_CURRENT_EXCEPTION(tstate);
...
static PyObject *TeamYousef_CallGeneratorThrowMethod(PyObject *throw_method,
...
static PyObject *_TeamYousef_Generator_throw2(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                          struct TeamYousef_ExceptionPreservationItem *exception_state);
...
static PyObject *_TeamYousef_YieldFromPassExceptionTo(PyThreadState *tstate, PyObject *value,
                                                  struct TeamYousef_ExceptionPreservationItem *exception_state) {
    ...
    if (PyGen_CheckExact(value)
        ...
        PyObject *result = TeamYousef_UncompiledGenerator_throw(tstate, gen, 1, exception_state);

        return result;
    }
#endif

    if (TeamYousef_Generator_Check(value)) {
        struct TeamYousef_GeneratorObject *gen = ((struct TeamYousef_GeneratorObject *)value);

        return _TeamYousef_Generator_throw2(tstate, gen, exception_state);
    }

#if PYTHON_VERSION >= 0x350
    if (TeamYousef_Coroutine_Check(value)) {
        struct TeamYousef_CoroutineObject *coro = ((struct TeamYousef_CoroutineObject *)value);
        // Handing exception ownership over.
        return _TeamYousef_Coroutine_throw2(tstate, coro, true, exception_state);
    }

    if (TeamYousef_CoroutineWrapper_Check(value)) {
        struct TeamYousef_CoroutineObject *coro = ((struct TeamYousef_CoroutineWrapperObject *)value)->m_coroutine;
        // Handing exception ownership over.
        return _TeamYousef_Coroutine_throw2(tstate, coro, true, exception_state);
    }
#endif
    ...
    if (throw_method != NULL) {
        PyObject *result = TeamYousef_CallGeneratorThrowMethod(throw_method, exception_state);
...
static PyObject *_TeamYousef_YieldFromGeneratorCore(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
...
static PyObject *TeamYousef_YieldFromGeneratorCore(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                               PyObject *send_value) {
    CHECK_OBJECT(generator);
    ...
    PyObject *yielded = _TeamYousef_YieldFromGeneratorCore(tstate, generator, yield_from, send_value);
    ...
    if (yielded == NULL) {
        ...
        if (generator->m_returned != NULL) {
            ...
            yielded = _TeamYousef_CallGeneratorCodeC(tstate, generator, yield_from_result);
        } else {
            assert(HAS_ERROR_OCCURRED(tstate));
            yielded = _TeamYousef_CallGeneratorCodeC(tstate, generator, NULL);
        }
...
static PyObject *TeamYousef_YieldFromGeneratorNext(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator) {
    CHECK_OBJECT(generator);

    // Coroutines are already perfect for yielding from.
#if PYTHON_VERSION >= 0x350
    if (PyCoro_CheckExact(generator->m_yield_from) || TeamYousef_Coroutine_Check(generator->m_yield_from)) {
    ...
    return TeamYousef_YieldFromGeneratorCore(tstate, generator, Py_None);
}

static PyObject *TeamYousef_YieldFromGeneratorInitial(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                                  PyObject *send_value) {
    PyObject *result = TeamYousef_YieldFromGeneratorCore(tstate, generator, send_value);
...
static void _TeamYousef_GeneratorPopFrame(PyThreadState *tstate, TeamYousef_ThreadStateFrameType *return_frame) {
#if PYTHON_VERSION < 0x3b0
...
static void RAISE_RUNTIME_ERROR_RAISED_STOP_ITERATION(PyThreadState *tstate, char const *message) {
    ...
    struct TeamYousef_ExceptionPreservationItem new_exception_state;
    ...
    TeamYousef_Exception_SetContext(new_exception_state.exception_value, saved_exception_state.exception_value);
...
static PyObject *_TeamYousef_Generator_send(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                        PyObject *value, struct TeamYousef_ExceptionPreservationItem *exception_state) {
    CHECK_OBJECT(generator);
    assert(TeamYousef_Generator_Check((PyObject *)generator));
    ...
    if (generator->m_status != status_Finished) {
        ...
        TeamYousef_MarkGeneratorAsRunning(generator);
        ...
        if (generator->m_yield_from == NULL) {
            yielded = _TeamYousef_CallGeneratorCodeC(tstate, generator, value);
        } else {
            // This does not release the value if any, so we need to do it afterwards.
            yielded = TeamYousef_YieldFromGeneratorInitial(tstate, generator, value);
            Py_XDECREF(value);
        }
#else
        yielded = _TeamYousef_CallGeneratorCodeC(tstate, generator, value);
        ...
        while (yielded == NULL && generator->m_yield_from != NULL) {
            yielded = TeamYousef_YieldFromGeneratorNext(tstate, generator);
        }
#endif
        TeamYousef_MarkGeneratorAsNotRunning(generator);
        ...
        if (yielded == NULL) {
            ...
            PRINT_NEW_LINE();
#endif
            TeamYousef_MarkGeneratorAsFinished(generator);

            if (generator->m_frame != NULL) {
#if PYTHON_VERSION >= 0x300
                TeamYousef_SetFrameGenerator(generator->m_frame, NULL);
#endif
                Py_DECREF(generator->m_frame);
                generator->m_frame = NULL;
            }

            TeamYousef_Generator_release_closure(generator);
            ...
            if (generator->m_returned) {
                if (generator->m_returned != Py_None) {
                    TeamYousef_SetStopIterationValue(tstate, generator->m_returned);
                }
...
#if _SAJODE_MAINTAIN_SYS_EXC_VARS
...
static PyObject *TeamYousef_Generator_send(struct TeamYousef_GeneratorObject *generator, PyObject *value) {
    CHECK_OBJECT(value);
    ...
    PyObject *result = _TeamYousef_Generator_send(tstate, generator, value, &exception_state);
...
static PyObject *TeamYousef_Generator_tp_iternext(struct TeamYousef_GeneratorObject *generator) {
#if _DEBUG_GENERATOR
    PRINT_GENERATOR_STATUS("Enter", generator);
    PRINT_CURRENT_EXCEPTION();
    PRINT_NEW_LINE();
    ...
    return _TeamYousef_Generator_send(tstate, generator, Py_None, &exception_state);
}

/* Our own qiter interface, which is for quicker simple loop style iteration,
   that does not send anything in. */
PyObject *TeamYousef_Generator_qiter(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator, bool *finished) {
    Py_INCREF_IMMORTAL(Py_None);

    struct TeamYousef_ExceptionPreservationItem exception_state;
    INIT_ERROR_OCCURRED_STATE(&exception_state);

    PyObject *result = _TeamYousef_Generator_send(tstate, generator, Py_None, &exception_state);
...
static bool _TeamYousef_Generator_close(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator) {
#if _DEBUG_GENERATOR
    PRINT_GENERATOR_STATUS("Enter", generator);
#endif
    CHECK_OBJECT(generator);
    ...
    if (generator->m_status == status_Running) {
        ...
        PyObject *result = _TeamYousef_Generator_send(tstate, generator, NULL, &exception_state);
...
static PyObject *TeamYousef_Generator_close(struct TeamYousef_GeneratorObject *generator, PyObject *unused) {
    PyThreadState *tstate = PyThreadState_GET();

    bool r = _TeamYousef_Generator_close(tstate, generator);
...
#if PYTHON_VERSION >= 0x3c0
static bool _TeamYousef_Generator_check_throw_args(PyThreadState *tstate, PyObject **exception_type,
...
static bool _TeamYousef_Generator_make_throw_exception_state(PyThreadState *tstate,
                                                         struct TeamYousef_ExceptionPreservationItem *exception_state,
    ...
    if (_TeamYousef_Generator_check_throw_args(tstate, &exception_type, &exception_value, &exception_tb) == false) {
...
static bool TeamYousef_gen_close_iter(PyThreadState *tstate, PyObject *yield_from) {
#if _DEBUG_GENERATOR
    PRINT_STRING("TeamYousef_gen_close_iter: Enter\n");
#endif
    ...
    // generators.
    if (TeamYousef_Generator_Check(yield_from)) {
#if _DEBUG_GENERATOR
        PRINT_STRING("TeamYousef_gen_close_iter: Defer to _TeamYousef_Generator_close\n");
#endif
        return _TeamYousef_Generator_close(tstate, (struct TeamYousef_GeneratorObject *)yield_from);
    }

#if PYTHON_VERSION >= 0x350
    if (TeamYousef_Coroutine_Check(yield_from)) {
#if _DEBUG_GENERATOR
        PRINT_STRING("TeamYousef_gen_close_iter: Defer to _TeamYousef_Coroutine_close\n");
#endif
        return _TeamYousef_Coroutine_close(tstate, (struct TeamYousef_CoroutineObject *)yield_from);
    }
#endif

#if PYTHON_VERSION >= 0x360
    if (TeamYousef_Asyncgen_Check(yield_from)) {
#if _DEBUG_GENERATOR
        PRINT_STRING("TeamYousef_gen_close_iter: Defer to _TeamYousef_Asyncgen_close\n");
#endif
        return _TeamYousef_Asyncgen_close(tstate, (struct TeamYousef_AsyncgenObject *)yield_from);
    }
#endif
...
#if _DEBUG_GENERATOR
            PRINT_STRING("TeamYousef_gen_close_iter: Strange error while looking up close method.\n");
#endif
...
#if _DEBUG_GENERATOR
        PRINT_STRING("TeamYousef_gen_close_iter: Leave, has no close method.\n");
#endif
        return true;
    }
...
#if _DEBUG_GENERATOR
        PRINT_STRING("TeamYousef_gen_close_iter: Leave, exception from close.\n");
#endif
        return false;
    }
...
#if _DEBUG_GENERATOR
    PRINT_STRING("TeamYousef_gen_close_iter: Leave, closed.\n");
#endif
...
static PyObject *_TeamYousef_Generator_throw2(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
    ...
    if (generator->m_yield_from != NULL) {
        if (EXCEPTION_STATE_MATCH_BOOL_SINGLE(tstate, exception_state, PyExc_GeneratorExit)) {
            ...
            TeamYousef_MarkGeneratorAsRunning(generator);
            bool res = TeamYousef_gen_close_iter(tstate, generator->m_yield_from);
            TeamYousef_MarkGeneratorAsNotRunning(generator);
            ...
            // Transferred exception ownership to "_TeamYousef_Generator_send".
            return _TeamYousef_Generator_send(tstate, generator, NULL, exception_state);
        }
        ...
        if (TeamYousef_Generator_Check(generator->m_yield_from)) {
            struct TeamYousef_GeneratorObject *gen = ((struct TeamYousef_GeneratorObject *)generator->m_yield_from);
...
#endif
#if PYTHON_VERSION >= 0x350
        } else if (TeamYousef_Coroutine_Check(generator->m_yield_from)) {
            struct TeamYousef_CoroutineObject *coro = ((struct TeamYousef_CoroutineObject *)generator->m_yield_from);
            ...
            TeamYousef_MarkGeneratorAsNotRunning(generator);
        } else if (TeamYousef_CoroutineWrapper_Check(generator->m_yield_from)) {
            struct TeamYousef_CoroutineObject *coro =
                ((struct TeamYousef_CoroutineWrapperObject *)generator->m_yield_from)->m_coroutine;
...
#endif
#if PYTHON_VERSION >= 0x360
        } else if (TeamYousef_AsyncgenAsend_Check(generator->m_yield_from)) {
            struct TeamYousef_AsyncgenAsendObject *asyncgen_asend =
                ((struct TeamYousef_AsyncgenAsendObject *)generator->m_yield_from);
        ...
        if (unlikely(ret == NULL)) {
            ...
            if (TeamYousef_PyGen_FetchStopIterationValue(tstate, &val)) {
                ...
                ret = _TeamYousef_Generator_send(tstate, generator, val, &no_exception_state);
            } else {
#if _DEBUG_GENERATOR
                ...
                ret = _TeamYousef_Generator_send(tstate, generator, NULL, &no_exception_state);
            }
...
throw_here:
    ...
    if (generator->m_status == status_Running) {
        // Passing exception ownership to _TeamYousef_Generator_send
        PyObject *result = _TeamYousef_Generator_send(tstate, generator, NULL, exception_state);
...
static PyObject *TeamYousef_Generator_throw(struct TeamYousef_GeneratorObject *generator, PyObject *args) {
    ...
    PyObject *result = _TeamYousef_Generator_throw2(tstate, generator, &exception_state);
...
static void TeamYousef_CallFinalizer(PyObject *self) {
...
static bool TeamYousef_CallFinalizerFromDealloc(PyObject *self) {
    assert(Py_REFCNT(self) == 0);

    // Temporarily resurrect the object, so it can be worked with.
    Py_SET_REFCNT(self, 1);

    TeamYousef_CallFinalizer(self);
...
static void TeamYousef_Generator_tp_finalizer(struct TeamYousef_GeneratorObject *generator) {
    if (generator->m_status != status_Running) {
        return;
    }
    ...
    bool close_result = _TeamYousef_Generator_close(tstate, generator);
...
static struct TeamYousef_GeneratorObject *free_list_generators = NULL;
static int free_list_generators_count = 0;

static void TeamYousef_Generator_tp_dealloc(struct TeamYousef_GeneratorObject *generator) {
#if _DEBUG_REFCOUNTS
    count_active_TeamYousef_Generator_Type -= 1;
    count_released_TeamYousef_Generator_Type += 1;
#endif

    if (generator->m_weakrefs != NULL) {
        TeamYousef_GC_UnTrack(generator);
        ...
        TeamYousef_GC_Track(generator);
    }

#if PYTHON_VERSION >= 0x300
    if (TeamYousef_CallFinalizerFromDealloc((PyObject *)generator) == false) {
        return;
    }
#else
    // Revive temporarily.
...
static long TeamYousef_Generator_tp_hash(struct TeamYousef_GeneratorObject *generator) { return generator->m_counter; }

static PyObject *TeamYousef_Generator_get_name(PyObject *self, void *data) {
    struct TeamYousef_GeneratorObject *generator = (struct TeamYousef_GeneratorObject *)self;
...
#if PYTHON_VERSION >= 0x350
static int TeamYousef_Generator_set_name(PyObject *self, PyObject *value, void *data) {
...
static PyObject *TeamYousef_Generator_get_qualname(PyObject *self, void *data) {
    struct TeamYousef_GeneratorObject *generator = (struct TeamYousef_GeneratorObject *)self;
...
static int TeamYousef_Generator_set_qualname(PyObject *self, PyObject *value, void *data) {
    // Cannot be deleted, not be non-unicode value.
    if (unlikely((value == NULL) || !PyUnicode_Check(value))) {
        PyThreadState *tstate = PyThreadState_GET();
...
static PyObject *TeamYousef_Generator_get_yield_from(PyObject *self, void *data) {
    struct TeamYousef_GeneratorObject *generator = (struct TeamYousef_GeneratorObject *)self;
...
static PyObject *TeamYousef_Generator_get_code(PyObject *self, void *data) {
    struct TeamYousef_GeneratorObject *generator = (struct TeamYousef_GeneratorObject *)self;
...
static int TeamYousef_Generator_set_code(PyObject *self, PyObject *value, void *data) {
    PyThreadState *tstate = PyThreadState_GET();

    SET_CURRENT_EXCEPTION_TYPE0_STR(tstate, PyExc_RuntimeError, "gi_code is not writable in TeamYousef");
    return -1;
}

static PyObject *TeamYousef_Generator_get_frame(PyObject *self, void *data) {
    PyObject *result;
...
static int TeamYousef_Generator_set_frame(PyObject *self, PyObject *value, void *data) {
    PyThreadState *tstate = PyThreadState_GET();
...
static PyObject *TeamYousef_Generator_get_running(PyObject *self, void *data) {
    PyObject *result;

    struct TeamYousef_GeneratorObject *generator = (struct TeamYousef_GeneratorObject *)self;
/* The type of "gi_running" changed in Python3. */
#if PYTHON_VERSION < 0x300
    result = TeamYousef_PyInt_FromLong(generator->m_running);
#else
...
static int TeamYousef_Generator_set_running(PyObject *self, PyObject *value, void *data) {
#if PYTHON_VERSION < 0x300
...
#if !defined(_SAJODE_FULL_COMPAT) || PYTHON_VERSION >= 0x3a0
...
static PyGetSetDef TeamYousef_Generator_tp_getset[] = {
#if PYTHON_VERSION < 0x350
    {(char *)"__name__", TeamYousef_Generator_get_name, NULL, NULL},
#else
    {(char *)"__name__", TeamYousef_Generator_get_name, TeamYousef_Generator_set_name, NULL},
    {(char *)"__qualname__", TeamYousef_Generator_get_qualname, TeamYousef_Generator_set_qualname, NULL},
    {(char *)"gi_yieldfrom", TeamYousef_Generator_get_yield_from, NULL, NULL},
#endif
    {(char *)"gi_code", TeamYousef_Generator_get_code, TeamYousef_Generator_set_code, NULL},
    {(char *)"gi_frame", TeamYousef_Generator_get_frame, TeamYousef_Generator_set_frame, NULL},
    {(char *)"gi_running", TeamYousef_Generator_get_running, TeamYousef_Generator_set_running, NULL},

    {NULL}};

static PyMethodDef TeamYousef_Generator_methods[] = {{"send", (PyCFunction)TeamYousef_Generator_send, METH_O, NULL},
                                                 {"throw", (PyCFunction)TeamYousef_Generator_throw, METH_VARARGS, NULL},
                                                 {"close", (PyCFunction)TeamYousef_Generator_close, METH_NOARGS, NULL},
                                                 {NULL}};

// This is only used.
#if PYTHON_VERSION >= 0x3a0
static PyAsyncMethods TeamYousef_Generator_as_async = {
    NULL, /* am_await */
    NULL, /* am_aiter */
    NULL, /* am_anext */
    // TODO: have this too, (sendfunc)_TeamYousef_Generator_am_send
    NULL /* am_send */
};
#endif

PyTypeObject TeamYousef_Generator_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_generator", // tp_name
    sizeof(struct TeamYousef_GeneratorObject),               // tp_basicsize
    sizeof(struct TeamYousef_CellObject *),                  // tp_itemsize
    (destructor)TeamYousef_Generator_tp_dealloc,             // tp_dealloc
    0,                                                   // tp_print
    0,                                                   // tp_getattr
    0,                                                   // tp_setattr
#if PYTHON_VERSION < 0x3a0
    0, // tp_as_async
#else
    &TeamYousef_Generator_as_async, // tp_as_async
#endif
    (reprfunc)TeamYousef_Generator_tp_repr, // tp_repr
    0,                                  // tp_as_number
    0,                                  // tp_as_sequence
    0,                                  // tp_as_mapping
    (hashfunc)TeamYousef_Generator_tp_hash, // tp_hash
    0,                                  // tp_call
    0,                                  // tp_str
    ...
    // tp_flags
    0,                                                   // tp_doc
    (traverseproc)TeamYousef_Generator_tp_traverse,          // tp_traverse
    0,                                                   // tp_clear
    0,                                                   // tp_richcompare
    offsetof(struct TeamYousef_GeneratorObject, m_weakrefs), // tp_weaklistoffset
    0,                                                   // tp_iter (PyObject_SelfIter)
    (iternextfunc)TeamYousef_Generator_tp_iternext,          // tp_iternext
    TeamYousef_Generator_methods,                            // tp_methods
    NULL,                                                // tp_members
    TeamYousef_Generator_tp_getset,                          // tp_getset
    0,                                                   // tp_base
    0,                                                   // tp_dict
    0,                                                   // tp_descr_get
    0,                                                   // tp_descr_set
...
#if PYTHON_VERSION >= 0x300
    ,
    (destructor)TeamYousef_Generator_tp_finalizer // tp_finalize
#endif
};
...
void _initCompiledGeneratorType(void) {
    TeamYousef_PyType_Ready(&TeamYousef_Generator_Type, &PyGen_Type, true, false, true, false, false);

    // Be a paranoid subtype of uncompiled function, we want nothing shared.
    assert(TeamYousef_Generator_Type.tp_doc != PyGen_Type.tp_doc || PyGen_Type.tp_doc == NULL);
    assert(TeamYousef_Generator_Type.tp_traverse != PyGen_Type.tp_traverse);
    assert(TeamYousef_Generator_Type.tp_clear != PyGen_Type.tp_clear || PyGen_Type.tp_clear == NULL);
    assert(TeamYousef_Generator_Type.tp_richcompare != PyGen_Type.tp_richcompare || PyGen_Type.tp_richcompare == NULL);
    assert(TeamYousef_Generator_Type.tp_iter != PyGen_Type.tp_iter || PyGen_Type.tp_iter == PyObject_SelfIter);
    assert(TeamYousef_Generator_Type.tp_iternext != PyGen_Type.tp_iternext || PyGen_Type.tp_iternext == NULL);
#if PYTHON_VERSION >= 0x350
    assert(TeamYousef_Generator_Type.tp_as_async != PyGen_Type.tp_as_async || PyGen_Type.tp_as_async == NULL);
#endif
    assert(TeamYousef_Generator_Type.tp_methods != PyGen_Type.tp_methods);
    assert(TeamYousef_Generator_Type.tp_members != PyGen_Type.tp_members);
    assert(TeamYousef_Generator_Type.tp_getset != PyGen_Type.tp_getset);
    assert(TeamYousef_Generator_Type.tp_base != PyGen_Type.tp_base);
    assert(TeamYousef_Generator_Type.tp_dict != PyGen_Type.tp_dict);
    assert(TeamYousef_Generator_Type.tp_descr_get != PyGen_Type.tp_descr_get || PyGen_Type.tp_descr_get == NULL);

    assert(TeamYousef_Generator_Type.tp_descr_set != PyGen_Type.tp_descr_set || PyGen_Type.tp_descr_set == NULL);
    assert(TeamYousef_Generator_Type.tp_dictoffset != PyGen_Type.tp_dictoffset || PyGen_Type.tp_dictoffset == 0);
    // TODO: These get changed and into the same thing, not sure what to compare against, project something
    // assert(TeamYousef_Generator_Type.tp_init != PyGen_Type.tp_init || PyGen_Type.tp_init == NULL);
    // assert(TeamYousef_Generator_Type.tp_alloc != PyGen_Type.tp_alloc || PyGen_Type.tp_alloc == NULL);
    // assert(TeamYousef_Generator_Type.tp_new != PyGen_Type.tp_new || PyGen_Type.tp_new == NULL);
    // assert(TeamYousef_Generator_Type.tp_free != PyGen_Type.tp_free || PyGen_Type.tp_free == NULL);
    assert(TeamYousef_Generator_Type.tp_bases != PyGen_Type.tp_bases);
    assert(TeamYousef_Generator_Type.tp_mro != PyGen_Type.tp_mro);
    assert(TeamYousef_Generator_Type.tp_cache != PyGen_Type.tp_cache || PyGen_Type.tp_cache == NULL);
    assert(TeamYousef_Generator_Type.tp_subclasses != PyGen_Type.tp_subclasses || PyGen_Type.tp_cache == NULL);
    assert(TeamYousef_Generator_Type.tp_weaklist != PyGen_Type.tp_weaklist);
    assert(TeamYousef_Generator_Type.tp_del != PyGen_Type.tp_del || PyGen_Type.tp_del == NULL);
#if PYTHON_VERSION >= 0x300
    assert(TeamYousef_Generator_Type.tp_finalize != PyGen_Type.tp_finalize || PyGen_Type.tp_finalize == NULL);
#endif
...
PyObject *TeamYousef_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                               PyObject *qualname,
#endif
...
#if _DEBUG_REFCOUNTS
    count_active_TeamYousef_Generator_Type += 1;
    count_allocated_TeamYousef_Generator_Type += 1;
#endif

    struct TeamYousef_GeneratorObject *result;
    ...
    allocateFromFreeList(free_list_generators, struct TeamYousef_GeneratorObject, TeamYousef_Generator_Type, full_size);
...
#if PYTHON_VERSION >= 0x300
    result->m_resume_exception = TeamYousef_ExceptionStackItem_Empty;
#endif

    static long TeamYousef_Generator_counter = 0;
    result->m_counter = TeamYousef_Generator_counter++;

    TeamYousef_GC_Track(result);
    return (PyObject *)result;
}

static PyObject *_EMPTY_GENERATOR_CONTEXT(PyThreadState *tstate, struct TeamYousef_GeneratorObject *generator,
                                          PyObject *yield_return_value) {
    return NULL;
}

PyObject *TeamYousef_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                    PyObject *qualname,
#endif
                                    PyCodeObject *code_object, struct TeamYousef_CellObject **closure,
                                    Py_ssize_t closure_given) {
    return TeamYousef_Generator_New(_EMPTY_GENERATOR_CONTEXT, module, name,
#if PYTHON_VERSION >= 0x350
                                qualname,
#endif
