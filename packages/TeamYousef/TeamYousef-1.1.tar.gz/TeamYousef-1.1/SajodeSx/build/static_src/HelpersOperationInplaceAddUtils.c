...
SAJODE_MAY_BE_UNUSED static bool STRING_RESIZE(PyObject **value, Py_ssize_t newsize) {
    PyStringObject *sv;
    ...
    *value = (PyObject *)PyObject_REALLOC((char *)*value, PyStringObject_SIZE + newsize);
    ...
    TeamYousef_Py_NewReference(*value);
...
SAJODE_MAY_BE_UNUSED static bool STRING_ADD_INPLACE(PyObject **operand1, PyObject *operand2) {
...
#if PYTHON_VERSION >= 0x300
SAJODE_MAY_BE_UNUSED static bool BYTES_ADD_INCREMENTAL(PyObject **operand1, PyObject *operand2) {
    ...
    {
        SAJODE_MAY_BE_UNUSED int res = PyObject_GetBuffer(operand2, &wb, PyBUF_SIMPLE);
        // Has to work.
        assert(res == 0);
    }
    assert(wb.len >= 0);
...
SAJODE_MAY_BE_UNUSED static bool UNICODE_ADD_INCREMENTAL(PyThreadState *tstate, PyObject **operand1,
                                                         PyObject *operand2) {
