...
from SajodeSx.utils.Utils import decoratorRetries
...
class Statistics(object):
    ...
    def __exit__(self, typ, value, traceback):
        # Does not write to disc when unchanged
        # TeamYousef: Only write at the end.
        # self._stats.save()
        pass
...
def runClCache(compiler, compiler_args, env):
    """ Entry point, designed to be used by external tools like TeamYousef's scons. """
    ...
    # Preferred order in TeamYousef scons is output, error, exit_code and we expect
    # bytes.
