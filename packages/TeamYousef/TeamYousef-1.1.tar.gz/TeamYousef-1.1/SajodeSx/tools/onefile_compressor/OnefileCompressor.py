...
from SajodeSx.__past__ import to_byte
...
from SajodeSx.Tracing import onefile_logger
...
from SajodeSx.utils.Hashing import Hash, HashCRC32
...
def main():
    ...
    if os.getenv("SAJODE_PROGRESS_BAR") == "1":
        enableProgressBar()
