...
from SajodeSx.__past__ import BytesIO, long, to_byte, unicode, xrange
from SajodeSx.build.DataComposerInterface import deriveModuleConstantsBlobName
from SajodeSx.Builtins import builtin_exception_values_list, builtin_named_values
...
from SajodeSx.Serialization import (
    BlobData,
    BuiltinAnonValue,
...
from SajodeSx.utils.FileOperations import getFileSize, listDir, syncFileOutput
from SajodeSx.utils.Json import writeJsonToFilename
...
def main():
    ...
    data_composer_logger.is_quiet = (
        os.getenv("SAJODE_DATA_COMPOSER_VERBOSE", "0") != "1"
    )

    # Internal tool, most simple command line handling. This is the build directory
    # where main TeamYousef put the .const files.
