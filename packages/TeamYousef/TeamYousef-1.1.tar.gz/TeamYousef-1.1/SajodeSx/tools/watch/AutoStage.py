...
""" Stage changes in TeamYousef-Watch automatically
...
from SajodeSx.tools.quality.Git import (
    getCheckoutFileChangeDesc,
    getFileHashContent,
    putFileHashContent,
    updateGitFile,
)
from SajodeSx.TreeXML import fromString, toString
from SajodeSx.utils.FileOperations import getFileContents, withTemporaryFile
...
def onCompilationReportChange(filename, git_stage):
    ...
    new_SajodeSx_version = new_report.attrib["SajodeSx_version"]
    changed = False
    if old_report.attrib["SajodeSx_version"] != new_SajodeSx_version:
        old_report.attrib["SajodeSx_version"] = new_SajodeSx_version
