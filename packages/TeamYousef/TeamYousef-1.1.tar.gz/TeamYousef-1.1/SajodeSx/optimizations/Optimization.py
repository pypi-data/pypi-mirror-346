...
from SajodeSx import ModuleRegistry, Options, Variables
from SajodeSx.importing.Importing import addExtraSysPaths
from SajodeSx.importing.Recursion import considerUsedModules
...
from SajodeSx.Tracing import general, optimization_logger, progress_logger
from SajodeSx.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from SajodeSx.nodes.NodeBases import fromXML
    from SajodeSx.TreeXML import fromString
