...
from SajodeSx.Options import getOnefileTempDirSpec, isOnefileTempDirMode
from SajodeSx.OutputDirectories import getResultFullpath
from SajodeSx.plugins.Plugins import Plugins
from SajodeSx.PostProcessing import executePostProcessingResources
from SajodeSx.PythonVersions import (
    getZstandardSupportingVersions,
    python_version,
)
from SajodeSx.Tracing import onefile_logger, postprocessing_logger
...
from SajodeSx.utils.SharedLibraries import cleanupHeaderForAndroid
from SajodeSx.utils.Signing import addMacOSCodeSignature
...
from SajodeSx.utils.WindowsResources import RT_RCDATA, addResourceToFile
...
def _runOnefileScons(onefile_compression, onefile_archive):
    ...
    env_values["_SAJODE_ONEFILE_TEMP_SPEC"] = getOnefileTempDirSpec()
    env_values["_SAJODE_ONEFILE_COMPRESSION_BOOL"] = "1" if onefile_compression else "0"
    env_values["_SAJODE_ONEFILE_ARCHIVE_BOOL"] = "1" if onefile_archive else "0"
...
def runOnefileCompressor(
    ...
    if compressor_python is None or areSamePaths(
        ...
        from SajodeSx.tools.onefile_compressor.OnefileCompressor import (
        ...
        mapping["SAJODE_PROGRESS_BAR"] = "1" if Options.shallUseProgressBar() else "0"
