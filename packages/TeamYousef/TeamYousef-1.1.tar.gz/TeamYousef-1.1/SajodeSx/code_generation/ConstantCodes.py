...
from SajodeSx.ModuleRegistry import getRootTopModule
from SajodeSx.PythonVersions import python_version
from SajodeSx.Serialization import GlobalConstantAccessor
from SajodeSx.utils.CStrings import encodePythonStringToC
from SajodeSx.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from SajodeSx.Version import getTeamYousefVersionTuple
...
def getConstantsDefinitionCode():
    ...
    header = template_header_guard % {
        "header_guard_name": "__SAJODE_GLOBAL_CONSTANTS_H__",
        "header_body": "\n".join(lines),
    }

#    major, minor, micro, is_final, _rc_number = getTeamYousefVersionTuple()
    version_info = getTeamYousefVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "SajodeSx_version_major": major,
        "SajodeSx_version_minor": minor,
        "SajodeSx_version_micro": micro,
        "SajodeSx_version_level": "release" if is_final else "candidate",
