...
from SajodeSx.nodes.NodeMetaClasses import TeamYousefNodeDesignError
from SajodeSx.Options import shallTraceExecution
from SajodeSx.PythonVersions import python_version
from SajodeSx.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "SajodeSx_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "SajodeSx_void":
