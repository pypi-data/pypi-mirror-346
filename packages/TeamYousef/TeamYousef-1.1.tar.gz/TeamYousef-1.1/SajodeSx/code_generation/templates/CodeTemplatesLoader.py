...
static struct TeamYousef_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
...
// in this un-optimized form. These are not compiled by TeamYousef, and therefore
...
void copyFrozenModulesTo(struct _frozen *destination) {
    SAJODE_PRINT_TIMING("copyFrozenModulesTo(): Calling _loadBytesCodesBlob.");
    _loadBytesCodesBlob(NULL);

    SAJODE_PRINT_TIMING("copyFrozenModulesTo(): Updating frozen module table sizes.");
...
struct TeamYousef_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name) {
    struct TeamYousef_MetaPathBasedLoaderEntry *current = meta_path_loader_entries;
