 ...
 * created by TeamYousef version %(version)s
 *
 * This code is in part copyright %(year)s SaJaD.
 *
...
SAJODE_MAY_BE_UNUSED static uint32_t _TeamYousef_PyDictKeys_GetVersionForCurrentState(PyInterpreterState *interp, PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
...
static uint32_t _TeamYousef_next_dict_keys_version = 2;

SAJODE_MAY_BE_UNUSED static uint32_t _TeamYousef_PyDictKeys_GetVersionForCurrentState(PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
        return dk->dk_version;
    }
    uint32_t result = _TeamYousef_next_dict_keys_version++;
    dk->dk_version = result;
    return result;
}
#endif
...
#if !defined(_SAJODE_EXPERIMENTAL_NEW_CODE_OBJECTS)
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    struct TeamYousef_FunctionObject *function = (struct TeamYousef_FunctionObject *)func;

    return TeamYousef_Function_GetFunctionState(function, function_table_%(module_identifier)s);
}
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)TeamYousef_Function_CreateFunctionViaCodeIndex(
...
#if _SAJODE_MODULE_MODE && %(is_top)d
static char const *module_full_name = %(module_name_cstr)s;
#endif

// Internal entry point for module code.
PyObject *modulecode_%(module_identifier)s(PyThreadState *tstate, PyObject *module, struct TeamYousef_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
        ...
        module_full_name = strdup(TeamYousef_String_AsString(real_module_name));
#endif
        ...
        SAJODE_PRINT_TRACE("%(module_identifier)s: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
...
#ifdef _SAJODE_PLUGIN_DILL_ENABLED
    {
        ...
        if (loader_entry != NULL) {
            ...
            PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (TeamYousef_StringObject *)const_str_plain___name__);
            module_name_c = TeamYousef_String_AsString(module_name);
        }
    ...
    UPDATE_STRING_DICT0(
        ...
        (TeamYousef_StringObject *)const_str_plain___compiled__,
        TeamYousef_dunder_compiled_value
    );
    ...
    // Update "__package__" value to what it ought to be.
    {
        ...
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (TeamYousef_StringObject *)const_str_plain___package__,
    ...
    if (GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (TeamYousef_StringObject *)const_str_plain___builtins__) == NULL) {
        PyObject *value = (PyObject *)builtin_module;

        // Check if main module, not a dict then but the module itself.
#if _SAJODE_MODULE_MODE || !%(is_dunder_main)s
        value = PyModule_GetDict(value);
#endif

        UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (TeamYousef_StringObject *)const_str_plain___builtins__, value);
    }

    PyObject *module_loader = TeamYousef_Loader_New(loader_entry);
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (TeamYousef_StringObject *)const_str_plain___loader__, module_loader);
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (TeamYousef_StringObject *)const_str_plain___spec__, Py_None);
#else
...
#if _SAJODE_MODULE_MODE && %(is_top)d && %(module_def_size)s >= 0
        // Set our loader object in the "__spec__" value.
        SET_ATTRIBUTE(tstate, spec_value, const_str_plain_loader, module_loader);
#endif

        UPDATE_STRING_DICT1(moduledict_%(module_identifier)s, (TeamYousef_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
...
#if defined(_WIN32)
#define SAJODE_MODULE_INIT_FUNCTION __declspec(dllexport) PyMODINIT_FUNC
#else
#define SAJODE_MODULE_INIT_FUNCTION PyMODINIT_FUNC __attribute__((visibility("default")))
#endif

#else

#if defined(_WIN32)
#define SAJODE_MODULE_INIT_FUNCTION __declspec(dllexport) PyObject *
#else

#ifdef __cplusplus
#define SAJODE_MODULE_INIT_FUNCTION extern "C" __attribute__((visibility("default"))) PyObject *
#else
#define SAJODE_MODULE_INIT_FUNCTION __attribute__((visibility("default"))) PyObject *
#endif
...
#else
#define SAJODE_MODULE_INIT_FUNCTION PyMODINIT_FUNC
#endif
...
static int TeamYousef_TopLevelModule_tp_setattro(PyObject *module, PyObject *name, PyObject *value) {
    PyModule_Type.tp_setattro = orig_PyModule_Type_tp_setattro;

    if (orig_dunder_file_value != NULL) {
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (TeamYousef_StringObject *)const_str_plain___file__,
...
extern struct TeamYousef_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name);
...
static PyObject *%(module_dll_entry_point)s_phase2(PyObject *module) {
    ...
    if (result != NULL) {
        ...
        PyModule_Type.tp_setattro = TeamYousef_TopLevelModule_tp_setattro;
...
SAJODE_MODULE_INIT_FUNCTION (%(module_dll_entry_point)s)(void) {
#if PYTHON_VERSION < 0x3c0
    ...
    {
        SAJODE_MAY_BE_UNUSED bool res = TeamYousef_SetModuleString(module_full_name, module);
        assert(res != false);
    }
