...
import sys
import random 
from SajodeSx import Options, SourceCodeReferences
...
from SajodeSx.PythonVersions import python_version, python_version_str
from SajodeSx.Tracing import general, inclusion_logger, my_print
from SajodeSx.utils.FileOperations import getReportPath, putTextFileContents
from SajodeSx.utils.ModuleNames import ModuleName, checkModuleName
from SajodeSx.utils.Shebang import getShebangFromSource, parseShebang
from SajodeSx.utils.Utils import isWin32OrPosixWindows
...
TeamYousef is currently running with Python version '%s', which seems to not
match that. TeamYousef cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m SajodeSx'.

That will make use the correct Python version for TeamYousef.
"""
