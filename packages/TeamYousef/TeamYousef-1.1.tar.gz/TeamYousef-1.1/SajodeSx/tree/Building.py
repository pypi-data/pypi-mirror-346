...
In the "SajodeSx.tree.TreeHelpers" module, the dispatching is happening. One function
...
from SajodeSx import ModuleRegistry, OutputDirectories, SourceCodeReferences
from SajodeSx.__past__ import long, unicode
from SajodeSx.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from SajodeSx.Bytecodes import loadCodeObjectData
from SajodeSx.containers.OrderedSets import OrderedSet
from SajodeSx.Errors import CodeTooComplexCode
from SajodeSx.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from SajodeSx.importing import Importing
from SajodeSx.importing.ImportCache import addImportedModule
from SajodeSx.importing.PreloadedPackages import getPthImportedPackages
from SajodeSx.importing.StandardLibrary import isStandardLibraryPath
...
from SajodeSx.nodes.BuiltinRefNodes import quick_names
from SajodeSx.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from SajodeSx.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from SajodeSx.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from SajodeSx.nodes.ExceptionNodes import StatementRaiseException
from SajodeSx.nodes.FutureSpecs import FutureSpec
from SajodeSx.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from SajodeSx.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from SajodeSx.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from SajodeSx.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from SajodeSx.nodes.ModuleNodes import (
...
from SajodeSx.nodes.OperatorNodes import makeBinaryOperationNode
from SajodeSx.nodes.OperatorNodesUnary import makeExpressionOperationUnary
...
from SajodeSx.nodes.StatementNodes import StatementExpressionOnly
from SajodeSx.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from SajodeSx.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from SajodeSx.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from SajodeSx.utils import MemoryUsage
from SajodeSx.utils.ModuleNames import ModuleName
from SajodeSx.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_SajodeSx"):
                    raise
