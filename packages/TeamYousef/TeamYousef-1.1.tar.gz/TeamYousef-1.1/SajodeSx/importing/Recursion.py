...
from SajodeSx import ModuleRegistry, Options
from SajodeSx.Errors import TeamYousefForbiddenImportEncounter
from SajodeSx.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from SajodeSx.importing import ImportCache, StandardLibrary
from SajodeSx.ModuleRegistry import addUsedModule, getRootTopModule
from SajodeSx.pgo.PGO import decideInclusionFromPGO
from SajodeSx.plugins.Plugins import Plugins
from SajodeSx.PythonVersions import python_version
from SajodeSx.Tracing import recursion_logger
from SajodeSx.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from SajodeSx.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from SajodeSx.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except TeamYousefForbiddenImportEncounter as e:
