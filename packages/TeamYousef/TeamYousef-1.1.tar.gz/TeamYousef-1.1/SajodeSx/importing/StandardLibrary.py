...
from SajodeSx.utils.FileOperations import getFileContents, isFilenameBelowPath
...
def getStandardLibraryPaths():
    ...
    if not hasattr(getStandardLibraryPaths, "result"):
        ...
        if isWin32OrPosixWindows():
            from SajodeSx.Options import shallUseStaticLibPython
...
_stdlib_no_auto_inclusion_list = (
    ...
    # the TeamYousef plugin "multiprocessing" that is always enabled.
