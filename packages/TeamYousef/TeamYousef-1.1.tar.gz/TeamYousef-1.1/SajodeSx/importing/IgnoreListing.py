...
from SajodeSx.Errors import TeamYousefOptimizationError
...
def isIgnoreListedNotExistingModule(module_name):
    if module_name in sys.builtin_module_names and not isTeamYousefPython():
        raise TeamYousefOptimizationError(
            """
