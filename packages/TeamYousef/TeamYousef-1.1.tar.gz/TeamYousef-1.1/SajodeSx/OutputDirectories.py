...
""" Directories and paths to for output of TeamYousef.
...
from SajodeSx.utils.SharedLibraries import getDllSuffix
from SajodeSx.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".SajodeSx-pgo"
