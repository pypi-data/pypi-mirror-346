...
configuration files of TeamYousef.
"""

from SajodeSx.utils.Yaml import getYamlPackageConfiguration

from .PluginBase import TeamYousefPluginBase


class TeamYousefYamlPluginBase(TeamYousefPluginBase):
    """TeamYousef base class for all plugins that use yaml config"""
