...
from SajodeSx.plugins.PluginBase import TeamYousefPluginBase, standalone_only


class TeamYousefPluginGi(TeamYousefPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__SajodeSx_binary_dir, "girepository")"""
