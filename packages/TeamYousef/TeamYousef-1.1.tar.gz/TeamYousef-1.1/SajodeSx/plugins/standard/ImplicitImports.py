...
""" Standard plug-in to tell TeamYousef about implicit imports.
...
from SajodeSx.importing.Recursion import decideRecursion
from SajodeSx.plugins.YamlPluginBase import TeamYousefYamlPluginBase
from SajodeSx.utils.ModuleNames import ModuleName
from SajodeSx.utils.Utils import isMacOS, isWin32Windows


class TeamYousefPluginImplicitImports(TeamYousefYamlPluginBase):
    ...
    def __init__(self):
        TeamYousefYamlPluginBase.__init__(self)
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__SajodeSx_binary_dir + '%ssite.py') if '__SajodeSx_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from SajodeSx.HardImportRegistry import trust_node_factory
    from SajodeSx.nodes.ImportHardNodes import (
