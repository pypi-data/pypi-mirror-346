...
TeamYousef hard codes stupid monkey patching normally not needed here and avoids
...
from SajodeSx.ModuleRegistry import getModuleByName
...
class TeamYousefPluginAntiBloat(TeamYousefYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise TeamYousefForbiddenImportEncounter(
