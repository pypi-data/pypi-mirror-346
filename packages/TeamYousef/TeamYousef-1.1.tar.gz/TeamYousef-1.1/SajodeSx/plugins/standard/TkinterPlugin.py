...
from SajodeSx.Options import isStandaloneMode, shallCreateAppBundle
from SajodeSx.plugins.PluginBase import TeamYousefPluginBase
from SajodeSx.PythonFlavors import isHomebrewPython
from SajodeSx.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
class TeamYousefPluginTkinter(TeamYousefPluginBase):
    ...
    plugin_name = "tk-inter"  # TeamYousef knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__SajodeSx_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__SajodeSx_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. TeamYousef is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to TeamYousef."""
            )
...
class TeamYousefPluginDetectorTkinter(TeamYousefPluginBase):
    ...
    detector_for = TeamYousefPluginTkinter
