...
from SajodeSx import Options, Tracing, TreeXML
from SajodeSx.__past__ import iterItems
from SajodeSx.Errors import TeamYousefNodeError
from SajodeSx.PythonVersions import python_version
from SajodeSx.SourceCodeReferences import SourceCodeReference
...
from SajodeSx.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise TeamYousefNodeError("Problem cloning node", self, e)
