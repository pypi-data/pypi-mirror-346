...
from SajodeSx.build.DataComposerInterface import getConstantBlobFilename
from SajodeSx.ModuleRegistry import getImportedModuleNames
from SajodeSx.PythonFlavors import isSelfCompiledPythonUninstalled
from SajodeSx.PythonVersions import getTargetPythonDLLPath, python_version
from SajodeSx.Tracing import postprocessing_logger
from SajodeSx.utils.Execution import wrapCommandForDebuggerForExec
...
from SajodeSx.utils.Images import convertImageToIconFormat
from SajodeSx.utils.Importing import importFromInlineCopy
from SajodeSx.utils.MacOSApp import createPlistInfoFile
...
from SajodeSx.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from SajodeSx.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def createScriptFileForExecution(result_filename):
    ...
    if isWin32Windows():
        script_contents = """
@echo off
rem This script was created by TeamYousef to execute '%(exe_filename)s' with Python DLL being found.
set PATH=%(dll_directory)s;%%PATH%%
set PYTHONHOME=%(python_home)s
set SAJODE_PYTHONPATH=%(python_path)s
...
export PYTHONHOME
SAJODE_PYTHONPATH="%(python_path)s"
export SAJODE_PYTHONPATH
...
def _createModulePyiFile():
    ...
    contents = """\
# This file was generated by TeamYousef
"""
