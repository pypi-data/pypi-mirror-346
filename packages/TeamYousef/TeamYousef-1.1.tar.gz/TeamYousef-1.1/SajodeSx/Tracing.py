...
from SajodeSx.__past__ import (  # pylint: disable=redefined-builtin
    BrokenPipeError,
    raw_input,
)
from SajodeSx.utils.Utils import isWin32Windows
...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://SajodeSx.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from SajodeSx.Progress import closeProgressBar
...
general = OurLogger("TeamYousef")
plugins_logger = OurLogger("TeamYousef-Plugins")
recursion_logger = OurLogger("TeamYousef-Inclusion")
progress_logger = OurLogger("TeamYousef-Progress", quiet=True)
memory_logger = OurLogger("TeamYousef-Memory")
metadata_logger = OurLogger("TeamYousef-Metadata")
optimization_logger = FileLogger("TeamYousef-Optimization")
pgo_logger = FileLogger("TeamYousef-PGO")
code_generation_logger = OurLogger("TeamYousef-CodeGen")
inclusion_logger = FileLogger("TeamYousef-Inclusion")
scons_logger = OurLogger("TeamYousef-Scons")
scons_details_logger = OurLogger("TeamYousef-Scons")
postprocessing_logger = OurLogger("TeamYousef-Postprocessing")
options_logger = OurLogger("TeamYousef-Options")
unusual_logger = OurLogger("TeamYousef-Unusual")
data_composer_logger = OurLogger("TeamYousef-DataComposer")
onefile_logger = OurLogger("TeamYousef-Onefile")
tools_logger = OurLogger("TeamYousef-Tools")
wheel_logger = OurLogger("TeamYousef-Wheel", base_style="blue")
cache_logger = OurLogger("TeamYousef-Cache")
reports_logger = OurLogger("TeamYousef-Reports")
offsets_logger = OurLogger("TeamYousef-Offsets")
