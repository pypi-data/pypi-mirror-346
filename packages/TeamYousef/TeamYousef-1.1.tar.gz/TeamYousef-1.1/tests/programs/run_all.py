...
""" Runner for program tests of TeamYousef.
...
def main():
    ...
    extra_options = os.environ.get("SAJODE_EXTRA_OPTIONS", "")
    ...
    for filename, filename_main in scanDirectoryForTestCaseFolders("."):
        ...
        if filename == "plugin_import":
            os.environ["SAJODE_EXTRA_OPTIONS"] = (
            ...
            os.environ["SAJODE_EXTRA_OPTIONS"] = extra_options
