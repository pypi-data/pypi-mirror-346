 ...
 */
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_kp_u_The_cuda_nvrtc_module_is_depreca, __pyx_builtin_FutureWarning); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 18, __pyx_L1_error)
