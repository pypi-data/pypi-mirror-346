...
cdef class CUDA_BATCH_MEM_OP_NODE_PARAMS_st:
    ...
    """
    cdef cydriver.CUDA_BATCH_MEM_OP_NODE_PARAMS_st __val
    cdef cydriver.CUDA_BATCH_MEM_OP_NODE_PARAMS_st* _ptr
    cdef CUcontext _ctx
...
cdef class CUDA_MEM_ALLOC_NODE_PARAMS_st:
    ...
    """
    cdef cydriver.CUDA_MEM_ALLOC_NODE_PARAMS_st __val
    cdef cydriver.CUDA_MEM_ALLOC_NODE_PARAMS_st* _ptr
...
cdef class CUDA_KERNEL_NODE_PARAMS(CUDA_KERNEL_NODE_PARAMS_v1):
    """
    GPU kernel node parameters
