...
@mcp.resource(
    "file://{file_id}/status/{token}",
    name="DREX‑file status",
    description="Current processing information for an uploaded file",
...
@mcp.resource(
    "file://{file_id}/results/{token}",
    mime_type="application/json",
    name="DREX‑file results",
    description="Final processed data and revision grid for an uploaded file",
)
