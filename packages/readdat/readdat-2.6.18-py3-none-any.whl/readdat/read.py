...
def autodetect_file_format(filename: str) -> str:
    ...
    elif extension in ["MSEED", "SEGY", "SU", "SEG2", "SEGD", "SIG", "TUS", "MUS", "DZT", "BIN", "NPZ", "MAT", "CSV"]:
        format = extension
...
def read(filename: str, 
         format: Literal["AUTO", "MSEED", "SEGY", "SU", "SEG2", "SEGD", "SIG", "TUS", "DZT", "NPZ", "MAT", "SEISCOD", "CSV"],
    ...
    :param format: file format
           can be one of  "AUTO", "MSEED", "SEGY", "SU", "SEG2", "SEGD", "SIG", "TUS", "DZT", "NPZ", "MAT", "SEISCOD", "CSV"
