...
assert type(qoi_rs.encode([(1, 2, 3)] * 12, width=4, height=3)) is bytes
assert type(qoi_rs.encode([(1, 2, 3, 4)] * 12, width=4, height=3)) is bytes
try:
...
assert type(qoi_rs.encode([(1, 2, 3, 4)], width=1, height=1, colour_space="linear")) is bytes
assert type(qoi_rs.encode([(1, 2, 3, 4)], width=1, height=1, colour_space="SRGB")) is bytes
try:
