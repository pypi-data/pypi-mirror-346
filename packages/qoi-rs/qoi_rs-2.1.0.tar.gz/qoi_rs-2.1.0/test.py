...
assert isinstance(qoi_rs.encode([(1, 2, 3)] * 12, width=4, height=3), Buffer)
assert isinstance(qoi_rs.encode([(1, 2, 3, 4)] * 12, width=4, height=3), Buffer)
try:
...
assert isinstance(qoi_rs.encode([(1, 2, 3, 4)], width=1, height=1, colour_space="linear"), Buffer)
assert isinstance(qoi_rs.encode([(1, 2, 3, 4)], width=1, height=1, colour_space="SRGB"), Buffer)
try:
