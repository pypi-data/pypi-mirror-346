...
release = soma.__release__
# The short X.Y version.
version = soma.__version__
...
latex_documents = [
    ("index", "somabase.tex", "Soma-base Documentation", "someone", "manual"),
]
...
extlinks = {
    ...
    "anatomist": (
        "../build-stable-release/share/doc/anatomist-" + version + "/%s",
        "anatomist ",
    ),
    "pyanatomist": (
        "../build-stable-release/share/doc/pyanatomist-" + version + "/sphinx/%s",
        "pyanatomist ",
    ),
    "aimsdox": (
        "../build-stable-release/share/doc/aimsdata-" + version + "/doxygen/%s",
        "aimsdox ",
    ),
    "cartobdox": (
        "../build-stable-release/share/doc/cartobase-" + version + "/doxygen/%s",
        "cartobdox ",
    ),
    "cartoddox": (
        "../build-stable-release/share/doc/cartodata-" + version + "/doxygen/%s",
        "cartoddox ",
    ),
    "graphdox": (
        "../build-stable-release/share/doc/graph-" + version + "/doxygen/%s",
        "graphdox ",
    ),
