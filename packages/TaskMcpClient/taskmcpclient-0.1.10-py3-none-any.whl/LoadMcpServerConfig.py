...
from weberFuncs import load_name_value_dict
import os
import json
...
class LoadMcpServerConfig:
    def __init__(self, sWorkDir=''):
        ...
        self.dictCmdPath = load_name_value_dict(os.path.join(self.sConfigDir, 'cmdPath.env'))
        self.dictMcpServers = self._load_mcp_server_json()

    # 转移到 weberFuncs.load_name_value_dict 以便可以跨项目共享
