...
class TestGreedyAlgorithm:
    def test_init(self, simple_graph):
        ...
        assert all(algorithm.firing_script.get_firings(v.name) == 0 for v in simple_graph.vertices)
    ...
    def test_play_winnable(self, simple_graph):
        ...
        assert all(algorithm.divisor.get_degree(v.name) >= 0 for v in simple_graph.vertices)
    ...
    def test_play_path_graph(self, path_graph):
        ...
        assert all(algorithm.divisor.get_degree(v.name) >= 0 for v in path_graph.vertices)
    ...
    def test_play_weighted_graph(self, weighted_graph):
        ...
        assert all(algorithm.divisor.get_degree(v.name) >= 0 for v in weighted_graph.vertices)
    ...
    def test_play_unwinnable(self, simple_graph):
        ...
        divisor = CFDivisor(simple_graph, [("A", -100), ("B", -100), ("C", -100), ("D", -100)])
        algorithm = GreedyAlgorithm(simple_graph, divisor)
    ...
    def test_play_with_sequence_test_graph(self, sequence_test_graph, sequence_test_initial_divisor):
        ...
        assert algorithm.divisor.get_total_degree() == sequence_test_initial_divisor.get_total_degree() 