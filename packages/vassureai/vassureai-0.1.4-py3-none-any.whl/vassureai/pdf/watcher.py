...
class PDFWatcher:
    ...
    async def start(self, daemon: bool = False) -> None:
        ...
        # Always resolve paths relative to workspace root
        workspace_root = os.getcwd()
        self._watch_dir = os.path.join(workspace_root, self._watch_dir)
        self._test_dir = os.path.join(workspace_root, self._test_dir)
        self._registry_path = os.path.join(workspace_root, self._registry_path)
