...
"""
import abc
import buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2
import grpc
...
class FetchStub:
    ...
    FetchBlob: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchBlobRequest,
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchBlobResponse,
    ]
    ...
    * `DEADLINE_EXCEEDED`: The fetch could not be completed within the given
    ...
    FetchDirectory: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchDirectoryRequest,
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchDirectoryResponse,
    ]
...
class FetchServicer(metaclass=abc.ABCMeta):
    ...
    def FetchBlob(
        self,
        request: buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchBlobRequest,
    ...
    def FetchDirectory(
        self,
        request: buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchDirectoryRequest,
        context: grpc.ServicerContext,
    ) -> buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.FetchDirectoryResponse: ...
...
class PushStub:
    ...
    PushBlob: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushBlobRequest,
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushBlobResponse,
    ]
    ...
    * `INTERNAL`: An internal error occurred while performing the operation.
    ...
    PushDirectory: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushDirectoryRequest,
        buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushDirectoryResponse,
    ]
...
class PushServicer(metaclass=abc.ABCMeta):
    ...
    def PushBlob(
        self,
        request: buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushBlobRequest,
        context: grpc.ServicerContext,
    ) -> buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushBlobResponse:
        """These APIs associate the identifying information of a resource, as
        indicated by URI and optionally Qualifiers, with content available in the
    ...
    def PushDirectory(
        self,
        request: buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushDirectoryRequest,
        context: grpc.ServicerContext,
    ) -> buildgrid.common.protos.build.bazel.remote.asset.v1.remote_asset_pb2.PushDirectoryResponse: ...
