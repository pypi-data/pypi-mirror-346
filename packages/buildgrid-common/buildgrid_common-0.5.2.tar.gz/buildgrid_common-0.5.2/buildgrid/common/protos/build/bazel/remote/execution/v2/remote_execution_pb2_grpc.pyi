...
class ExecutionServicer(metaclass=abc.ABCMeta):
    ...
    ) -> collections.abc.Iterator[buildgrid.common.protos.google.longrunning.operations_pb2.Operation]:
        """Execute an action remotely.
...
class ContentAddressableStorageServicer(metaclass=abc.ABCMeta):
    ...
    def GetTree(
        ...
        context: grpc.ServicerContext,
    ) -> collections.abc.Iterator[buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.GetTreeResponse]:
        """Fetch the entire directory tree rooted at a node.
