...
class FetchBlobResponse(google.protobuf.message.Message):
    ...
    def expires_at(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        """
    @property
    def blob_digest(self) -> buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest:
    ...
    def __init__(
        ...
        *,
        ...
        blob_digest: buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest | None = ...,
    ) -> None: ...
...
class FetchDirectoryResponse(google.protobuf.message.Message):
    ...
    def expires_at(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        """
    @property
    def root_directory_digest(self) -> buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest:
        """The result of the fetch, if the status had code `OK`.
    ...
    def __init__(
        ...
        *,
        ...
        qualifiers: collections.abc.Iterable[global___Qualifier] | None = ...,
        expires_at: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        root_directory_digest: buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest | None = ...,
    ) -> None: ...
...
class PushBlobRequest(google.protobuf.message.Message):
    ...
    @property
    def references_blobs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest]:
        ...
        """
    @property
    def references_directories(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest]: ...
    def __init__(
        self,
        *,
        instance_name: builtins.str = ...,
        ...
        blob_digest: buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest | None = ...,
        references_blobs: collections.abc.Iterable[buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest] | None = ...,
        references_directories: collections.abc.Iterable[buildgrid.common.protos.build.bazel.remote.execution.v2.remote_execution_pb2.Digest] | None = ...,
    ) -> None: ...
