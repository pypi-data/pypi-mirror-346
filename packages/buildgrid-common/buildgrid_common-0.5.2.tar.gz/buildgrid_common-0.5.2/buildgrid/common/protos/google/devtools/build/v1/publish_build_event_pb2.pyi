...
class OrderedBuildEvent(google.protobuf.message.Message):
    ...
    """
    @property
    def event(self) -> buildgrid.common.protos.google.devtools.build.v1.build_events_pb2.BuildEvent:
        """The actual event."""
    def __init__(
        self,
        *,
        stream_id: buildgrid.common.protos.google.devtools.build.v1.build_events_pb2.StreamId | None = ...,
        sequence_number: builtins.int = ...,
        event: buildgrid.common.protos.google.devtools.build.v1.build_events_pb2.BuildEvent | None = ...,
    ) -> None: ...
