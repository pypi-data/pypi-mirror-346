...
import buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2
...
class PublishBuildEventStub:
    ...
    PublishLifecycleEvent: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2.PublishLifecycleEventRequest,
    ...
    PublishBuildToolEventStream: grpc.StreamStreamMultiCallable[
        buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2.PublishBuildToolEventStreamRequest,
        buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2.PublishBuildToolEventStreamResponse,
    ]
...
class PublishBuildEventServicer(metaclass=abc.ABCMeta):
    ...
    async def PublishLifecycleEvent(
        self,
        request: buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2.PublishLifecycleEventRequest,
    ...
    async def PublishBuildToolEventStream(
        self,
        request_iterator: collections.abc.AsyncIterator[buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2.PublishBuildToolEventStreamRequest],
        context: grpc.ServicerContext[typing.Any, typing.Any],
    ) -> collections.abc.AsyncIterator[buildgrid.common.protos.google.devtools.build.v1.publish_build_event_pb2.PublishBuildToolEventStreamResponse]:
        """Publish build tool events belonging to the same stream to a backend job
        using bidirectional streaming.
        """
