...
"""
import abc
import buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2
...
class BotsStub:
    ...
    CreateBotSession: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.CreateBotSessionRequest,
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.BotSession,
    ]
    ...
    UpdateBotSession: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.UpdateBotSessionRequest,
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.BotSession,
    ]
    ...
    PostBotEventTemp: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.PostBotEventTempRequest,
...
class BotsServicer(metaclass=abc.ABCMeta):
    ...
    def CreateBotSession(
        self,
        request: buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.CreateBotSessionRequest,
    ...
    def UpdateBotSession(
        self,
        request: buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.UpdateBotSessionRequest,
        context: grpc.ServicerContext,
    ) -> buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.BotSession:
        """UpdateBotSession must be called periodically by the bot (on a schedule
        determined by the server) to let the server know about its status, and to
    ...
    def PostBotEventTemp(
        self,
        request: buildgrid.common.protos.google.devtools.remoteworkers.v1test2.bots_pb2.PostBotEventTempRequest,
        context: grpc.ServicerContext,
    ) -> google.protobuf.empty_pb2.Empty:
        """PostBotEventTemp may be called by the bot to indicate that some exceptional
        event has occurred. This method is subject to change or removal in future
