...
"""
import abc
import buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2
...
class TasksStub:
    ...
    GetTask: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.GetTaskRequest,
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.Task,
    ]
    ...
    UpdateTaskResult: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.UpdateTaskResultRequest,
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.TaskResult,
    ]
    """DEPRECATED - use Lease.result instead.
    UpdateTaskResult updates the result.
    """
    AddTaskLog: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.AddTaskLogRequest,
        buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.AddTaskLogResponse,
    ]
...
class TasksServicer(metaclass=abc.ABCMeta):
    ...
    async def GetTask(
        self,
        request: buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.GetTaskRequest,
    ...
    async def UpdateTaskResult(
        self,
        request: buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.UpdateTaskResultRequest,
        context: grpc.ServicerContext[typing.Any, typing.Any],
    ) -> buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.TaskResult:
        """DEPRECATED - use Lease.result instead.
        UpdateTaskResult updates the result.
    ...
    async def AddTaskLog(
        self,
        request: buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.AddTaskLogRequest,
        context: grpc.ServicerContext[typing.Any, typing.Any],
    ) -> buildgrid.common.protos.google.devtools.remoteworkers.v1test2.tasks_pb2.AddTaskLogResponse:
        """DEPRECATED - precreate logs prior to sending to bot.
        AddTaskLog creates a new streaming log. The log is streamed and marked as
