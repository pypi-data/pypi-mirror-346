...
"""
import buildgrid.common.protos.build.bazel.semver.semver_pb2
import builtins
...
import buildgrid.common.protos.google.rpc.status_pb2
import sys
import typing
...
class Command(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["arguments", b"arguments", "environment_variables", b"environment_variables", "output_directories", b"output_directories", "output_files", b"output_files", "output_node_properties", b"output_node_properties", "output_paths", b"output_paths", "platform", b"platform", "working_directory", b"working_directory"]) -> None: ...
...
class ExecutedActionMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["execution_completed_timestamp", b"execution_completed_timestamp", "execution_start_timestamp", b"execution_start_timestamp", "input_fetch_completed_timestamp", b"input_fetch_completed_timestamp", "input_fetch_start_timestamp", b"input_fetch_start_timestamp", "output_upload_completed_timestamp", b"output_upload_completed_timestamp", "output_upload_start_timestamp", b"output_upload_start_timestamp", "queued_timestamp", b"queued_timestamp", "worker_completed_timestamp", b"worker_completed_timestamp", "worker_start_timestamp", b"worker_start_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auxiliary_metadata", b"auxiliary_metadata", "execution_completed_timestamp", b"execution_completed_timestamp", "execution_start_timestamp", b"execution_start_timestamp", "input_fetch_completed_timestamp", b"input_fetch_completed_timestamp", "input_fetch_start_timestamp", b"input_fetch_start_timestamp", "output_upload_completed_timestamp", b"output_upload_completed_timestamp", "output_upload_start_timestamp", b"output_upload_start_timestamp", "queued_timestamp", b"queued_timestamp", "worker", b"worker", "worker_completed_timestamp", b"worker_completed_timestamp", "worker_start_timestamp", b"worker_start_timestamp"]) -> None: ...
...
class OutputDirectory(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["tree_digest", b"tree_digest"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["path", b"path", "tree_digest", b"tree_digest"]) -> None: ...
...
class ExecuteRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action_digest", b"action_digest", "execution_policy", b"execution_policy", "instance_name", b"instance_name", "results_cache_policy", b"results_cache_policy", "skip_cache_lookup", b"skip_cache_lookup"]) -> None: ...
...
class ExecuteResponse(google.protobuf.message.Message):
    ...
    @property
    def status(self) -> buildgrid.common.protos.google.rpc.status_pb2.Status:
    ...
    def __init__(
        ...
        *,
        ...
        cached_result: builtins.bool = ...,
        status: buildgrid.common.protos.google.rpc.status_pb2.Status | None = ...,
...
class ExecuteOperationMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action_digest", b"action_digest", "stage", b"stage", "stderr_stream_name", b"stderr_stream_name", "stdout_stream_name", b"stdout_stream_name"]) -> None: ...
...
class GetActionResultRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["action_digest", b"action_digest"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action_digest", b"action_digest", "inline_output_files", b"inline_output_files", "inline_stderr", b"inline_stderr", "inline_stdout", b"inline_stdout", "instance_name", b"instance_name"]) -> None: ...
...
class UpdateActionResultRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action_digest", b"action_digest", "action_result", b"action_result", "instance_name", b"instance_name", "results_cache_policy", b"results_cache_policy"]) -> None: ...
...
class FindMissingBlobsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["blob_digests", b"blob_digests", "instance_name", b"instance_name"]) -> None: ...
...
class BatchUpdateBlobsRequest(google.protobuf.message.Message):
    ...
    class Request(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["digest", b"digest"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "digest", b"digest"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["instance_name", b"instance_name", "requests", b"requests"]) -> None: ...
...
class BatchReadBlobsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["digests", b"digests", "instance_name", b"instance_name"]) -> None: ...
...
class BatchReadBlobsResponse(google.protobuf.message.Message):
    ...
    class Response(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["digest", b"digest", "status", b"status"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "digest", b"digest", "status", b"status"]) -> None: ...
...
class GetTreeRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["instance_name", b"instance_name", "page_size", b"page_size", "page_token", b"page_token", "root_digest", b"root_digest"]) -> None: ...
...
class ServerCapabilities(google.protobuf.message.Message):
    ...
    @property
    def deprecated_api_version(self) -> buildgrid.common.protos.build.bazel.semver.semver_pb2.SemVer:
        """Earliest RE API version supported, including deprecated versions."""
    @property
    def low_api_version(self) -> buildgrid.common.protos.build.bazel.semver.semver_pb2.SemVer:
        """Earliest non-deprecated RE API version supported."""
    @property
    def high_api_version(self) -> buildgrid.common.protos.build.bazel.semver.semver_pb2.SemVer:
    ...
    def __init__(
        ...
        *,
        ...
        deprecated_api_version: buildgrid.common.protos.build.bazel.semver.semver_pb2.SemVer | None = ...,
        low_api_version: buildgrid.common.protos.build.bazel.semver.semver_pb2.SemVer | None = ...,
        high_api_version: buildgrid.common.protos.build.bazel.semver.semver_pb2.SemVer | None = ...,
    ) -> None: ...
...
class CacheCapabilities(google.protobuf.message.Message):
    ...
    @property
    def digest_function(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___DigestFunction.Value.ValueType]:
    ...
    def __init__(
        self,
        *,
        digest_function: collections.abc.Iterable[global___DigestFunction.Value.ValueType] | None = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action_cache_update_capabilities", b"action_cache_update_capabilities", "cache_priority_capabilities", b"cache_priority_capabilities", "digest_function", b"digest_function", "max_batch_total_size_bytes", b"max_batch_total_size_bytes", "symlink_absolute_path_strategy", b"symlink_absolute_path_strategy"]) -> None: ...
...
class ExecutionCapabilities(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["digest_function", b"digest_function", "exec_enabled", b"exec_enabled", "execution_priority_capabilities", b"execution_priority_capabilities", "supported_node_properties", b"supported_node_properties"]) -> None: ...
...
class RequestMetadata(google.protobuf.message.Message):
    ...
    * contents: the base64 encoded binary `RequestMetadata` message.
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action_id", b"action_id", "correlated_invocations_id", b"correlated_invocations_id", "tool_details", b"tool_details", "tool_invocation_id", b"tool_invocation_id"]) -> None: ...
