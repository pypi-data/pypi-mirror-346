...
Log Stream API"""
import abc
import buildgrid.common.protos.build.bazel.remote.logstream.v1.remote_logstream_pb2
...
class LogStreamServiceStub:
    ...
    CreateLogStream: grpc.UnaryUnaryMultiCallable[
        buildgrid.common.protos.build.bazel.remote.logstream.v1.remote_logstream_pb2.CreateLogStreamRequest,
        buildgrid.common.protos.build.bazel.remote.logstream.v1.remote_logstream_pb2.LogStream,
    ]
...
class LogStreamServiceServicer(metaclass=abc.ABCMeta):
    ...
    async def CreateLogStream(
        self,
        request: buildgrid.common.protos.build.bazel.remote.logstream.v1.remote_logstream_pb2.CreateLogStreamRequest,
