...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41160);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(52664),
    __webpack_require__(87237),
    __webpack_require__(54400),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(49251),
  __webpack_require__(40497),
  __webpack_require__(45118),
  __webpack_require__(45208),
  __webpack_require__(5474),
  __webpack_require__(74499),
  __webpack_require__(12052),
  
      (__webpack_require__(2550)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(18640)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(62764),
  
      (__webpack_require__(37820)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(6019)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(58174),
  
      (__webpack_require__(27826)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(83238)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(99697)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(44325)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(53122)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(6947),
  __webpack_require__(4187),
  __webpack_require__(78321),
  
      (__webpack_require__(55815)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(73639),
  __webpack_require__(98609),
  __webpack_require__(45579),
  
      (__webpack_require__(89540)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(67933),
  __webpack_require__(25074),
  __webpack_require__(61700),
  __webpack_require__(78190),
  __webpack_require__(98723),
  __webpack_require__(48615),
  __webpack_require__(92147),
  __webpack_require__(66376),
  __webpack_require__(29501),
  __webpack_require__(4429),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(42667),
  
      (__webpack_require__(61569)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(66251),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(42944),
  __webpack_require__(11306),
  
      (__webpack_require__(72611)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(90912)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(11813)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(49442).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(54746).IServiceManager);
...
//# sourceMappingURL=8781.30d203631c8d44cac089.js.map?v=30d203631c8d44cac089