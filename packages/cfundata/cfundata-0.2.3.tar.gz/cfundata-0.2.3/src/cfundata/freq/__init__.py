...
Example:
    ```python
    from cfundata.freq import FREQUENCY_PATH, FREQUENCY2_PATH
...
FREQUENCY_PATH = pkg_resources.files("cfundata.freq").joinpath("frequency.parquet")
FREQUENCY2_PATH = pkg_resources.files("cfundata.freq").joinpath("frequency2.parquet")
