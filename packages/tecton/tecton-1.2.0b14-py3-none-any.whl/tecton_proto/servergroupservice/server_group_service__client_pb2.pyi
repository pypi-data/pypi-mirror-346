...
class IngestServerGroup(_message.Message):
    ...
    class PendingConfig(_message.Message):
        __slots__ = ["autoscaling", "node_type", "provisioned_scaling"]
        ...
        def __init__(self, autoscaling: _Optional[_Union[AutoscalingConfig, _Mapping]] = ..., provisioned_scaling: _Optional[_Union[ProvisionedScalingConfig, _Mapping]] = ..., node_type: _Optional[str] = ...) -> None: ...
    AUTOSCALING_CONFIG_FIELD_NUMBER: _ClassVar[int]
...
class UpdateIngestServerGroupRequest(_message.Message):
    __slots__ = ["autoscaling_config", "id", "provisioned_config"]
    AUTOSCALING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    PROVISIONED_CONFIG_FIELD_NUMBER: _ClassVar[int]
    autoscaling_config: AutoscalingConfig
    id: str
    provisioned_config: ProvisionedScalingConfig
    def __init__(self, id: _Optional[str] = ..., autoscaling_config: _Optional[_Union[AutoscalingConfig, _Mapping]] = ..., provisioned_config: _Optional[_Union[ProvisionedScalingConfig, _Mapping]] = ...) -> None: ...
