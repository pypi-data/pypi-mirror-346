...
class EngineClient:
    ...
    _api_url: str = "https://engine.gcp.kerfed.dev/api/v2"
    ...
    def authorized(self) -> OAuth2Client:
        ...
        if not hasattr(self, "_authorized"):
            ...
            # after the first fetch it will be refreshed automatically
            self._authorized.fetch_token()
