...
def _raise_exception_for_response(resp: requests.Response):
    ...
    if not isinstance(error, str):
        ...
        if "'save: true'" in error:
            score, n_samples, eval_id, seed = json_body.get("score"), json_body.get("n_samples"), json_body.get("id"), json_body.get("seed")
            ...
            score = float(score)
            raise NotAllowedToSaveEvalResultError(error, EvalResult(score, eval_id, seed, n_samples))
