...
extern __declspec(dllexport) char* getScanEntryDataColumn(GoString scanId, GoString columnName);
...
extern __declspec(dllexport) char* getQuantColumn(GoString quantId, GoString columnName, GoString detector);
