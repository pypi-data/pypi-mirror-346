...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_CLIENTBEAMLOCATION']._serialized_end = 277
    _globals['_CLIENTBEAMLOCATIONS']._serialized_start = 279
    _globals['_CLIENTBEAMLOCATIONS']._serialized_end = 340