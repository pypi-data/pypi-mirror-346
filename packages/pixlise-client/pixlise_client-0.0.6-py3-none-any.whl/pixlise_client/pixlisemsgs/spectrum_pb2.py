...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_SPECTRUMTYPE']._serialized_start = 262
    _globals['_SPECTRUMTYPE']._serialized_end = 376
