...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_USERGROUPRELATIONSHIP']._serialized_start = 1004
    _globals['_USERGROUPRELATIONSHIP']._serialized_end = 1091
    _globals['_USERGROUPDB']._serialized_start = 57
    _globals['_USERGROUPDB']._serialized_end = 278
    _globals['_USERGROUPINFO']._serialized_start = 281
    _globals['_USERGROUPINFO']._serialized_end = 468
    _globals['_USERGROUPINFOLIST']._serialized_start = 470
    _globals['_USERGROUPINFOLIST']._serialized_end = 547
    _globals['_USERGROUP']._serialized_start = 550
    _globals['_USERGROUP']._serialized_end = 696
    _globals['_USERGROUPJOINSUMMARYINFO']._serialized_start = 699
    _globals['_USERGROUPJOINSUMMARYINFO']._serialized_end = 856
    _globals['_USERGROUPJOINREQUESTDB']._serialized_start = 859
    _globals['_USERGROUPJOINREQUESTDB']._serialized_end = 1002