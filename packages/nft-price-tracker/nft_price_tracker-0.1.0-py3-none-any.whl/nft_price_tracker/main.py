...
from opensea_nft_prices import OpenSeaNFTFetcher, format_price as format_opensea_price
from magic_eden_nft_prices import MagicEdenNFTFetcher, Chain, format_price as format_magiceden_price
