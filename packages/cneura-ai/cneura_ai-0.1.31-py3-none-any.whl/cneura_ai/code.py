...
class CodeGenerator:
    ...
    def synthesize(self, rules: dict) -> str:
        ...
        - If external secrets (e.g., API keys, passwords) are needed, access them like this:
            - Import: from config import Config
            - Usage: Config.SECRET_NAME
            - Variable names of secrets must be in uppercase.
    ...
    def debug(self, code: str, instructions: str) -> str:
        ...
        - If external secrets (e.g., API keys or passwords) are needed, access them using:
            - Import: `from config import Config`
            - Usage: `Config.SECRET_NAME`
            - Variable names of secrets must be in uppercase.
        """
