...
class CodeGenerator:
    ...
    def synthesize(self, rules: dict) -> str:
        ...
        variable : Config.VARIABLE_NAME
            ...
            - with all required imports and variables defined. Structure your answer of the code solution. \n
            - Then list the imports. And finally list the functioning code block

        Instruction:
        * Extract the import statements and the rest of the Python code separately.
