...
cdef class Model(masterinterface.MasterInterface):
    ...
    def get_dischargemodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.dischargemodel
    def set_dischargemodel(self, dischargemodel: Optional[masterinterface.MasterInterface]) -> None:
    ...
    def get_waterlevelmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.waterlevelmodel
    def set_waterlevelmodel(self, waterlevelmodel: Optional[masterinterface.MasterInterface]) -> None:
