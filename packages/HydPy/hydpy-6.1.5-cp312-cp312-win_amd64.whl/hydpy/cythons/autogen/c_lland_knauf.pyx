...
cdef class Model(masterinterface.MasterInterface):
    ...
    def get_aetmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.aetmodel
    def set_aetmodel(self, aetmodel: Optional[masterinterface.MasterInterface]) -> None:
    ...
    def get_soilmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.soilmodel
    def set_soilmodel(self, soilmodel: Optional[masterinterface.MasterInterface]) -> None:
