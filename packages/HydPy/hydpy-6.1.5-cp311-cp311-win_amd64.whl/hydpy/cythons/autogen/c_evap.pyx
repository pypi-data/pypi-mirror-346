...
cdef class Model:
    ...
    def get_intercmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.intercmodel
    def set_intercmodel(self, intercmodel: Optional[masterinterface.MasterInterface]) -> None:
        self.intercmodel = intercmodel
    def get_petmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.petmodel
    def set_petmodel(self, petmodel: Optional[masterinterface.MasterInterface]) -> None:
        self.petmodel = petmodel
    def get_precipmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.precipmodel
    def set_precipmodel(self, precipmodel: Optional[masterinterface.MasterInterface]) -> None:
        self.precipmodel = precipmodel
    def get_radiationmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.radiationmodel
    def set_radiationmodel(self, radiationmodel: Optional[masterinterface.MasterInterface]) -> None:
        self.radiationmodel = radiationmodel
    def get_retmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.retmodel
    def set_retmodel(self, retmodel: Optional[masterinterface.MasterInterface]) -> None:
        self.retmodel = retmodel
    def get_snowalbedomodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.snowalbedomodel
    def set_snowalbedomodel(self, snowalbedomodel: Optional[masterinterface.MasterInterface]) -> None:
        self.snowalbedomodel = snowalbedomodel
    def get_snowcovermodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.snowcovermodel
    def set_snowcovermodel(self, snowcovermodel: Optional[masterinterface.MasterInterface]) -> None:
        self.snowcovermodel = snowcovermodel
    def get_snowycanopymodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.snowycanopymodel
    def set_snowycanopymodel(self, snowycanopymodel: Optional[masterinterface.MasterInterface]) -> None:
        self.snowycanopymodel = snowycanopymodel
    def get_soilwatermodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.soilwatermodel
    def set_soilwatermodel(self, soilwatermodel: Optional[masterinterface.MasterInterface]) -> None:
        self.soilwatermodel = soilwatermodel
    def get_tempmodel(self) -> Optional[masterinterface.MasterInterface]:
        return self.tempmodel
    def set_tempmodel(self, tempmodel: Optional[masterinterface.MasterInterface]) -> None:
