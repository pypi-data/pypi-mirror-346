...
class ToApiGDC:
    ...
    def migrate(self: str, schema: str, table_name: str, token: str, conn_string: str, *date_field: str):
        ...
        try:
            ...
            while True:
                ...
                try:
                    api_call_response = requests.get(self, headers=api_call_headers, params=params)
                except Exception as e:
                    logging.error(e)
                    sys.exit(1)
