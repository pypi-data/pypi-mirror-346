...
_deps = [
    ...
    "keras>2.9,<2.16",
    # keras-nlp 0.14 doesn't support keras 2, see pin on keras.
    ...
    # Installing torch 2.7 results in slower compiled LLMs. Pinned while we investigate.
    "torch>=2.1,<2.7",
    "torchaudio",
    "torchvision",
    "pyctcdecode>=0.4.0",
...
extras["ja"] = deps_list("fugashi", "ipadic", "unidic_lite",
                         "unidic", "sudachipy", "sudachidict_core", "rhoknp")
extras["sklearn"] = deps_list("scikit-learn")

extras["tf"] = deps_list("tensorflow", "onnxconverter-common",
                         "tf2onnx", "tensorflow-text", "keras-nlp")
...
extras["integrations"] = extras["hub-kernels"] + \
    extras["optuna"] + extras["ray"] + extras["sigopt"]
...
extras["deepspeed-testing"] = extras["deepspeed"] + \
    extras["testing"] + extras["optuna"] + extras["sentencepiece"]
...
extras["dev"] = (
    ...
    extras["ja"] + extras["sklearn"] + extras["modelcreation"]
)
