...
class BusinessObject:
    ...
    def cloneBindId(self, bindOrigin, idOrigin, bindDestination, idDestination):
        ...
        if bindOrigin in self.jsonComplete['data'] and idOrigin in self.jsonComplete['data'][bindOrigin]:
            # Clonazione profonda del contenuto
            cloned_element = copy.deepcopy(self.jsonComplete['data'][bindOrigin][idOrigin])
