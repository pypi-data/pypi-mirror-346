...
class Header(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_missing_entries", b"allow_missing_entries", "axis_label", b"axis_label", "record_label", b"record_label"]) -> None: ...
