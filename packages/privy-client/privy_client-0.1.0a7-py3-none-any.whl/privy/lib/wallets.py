...
from ..resources.wallets import WalletsResource as BaseWalletsResource, AsyncWalletsResource as BaseAsyncWalletsResource
...
class WalletsResource(BaseWalletsResource):
    def safe_authenticate_with_jwt(
        self,
        *,
        user_jwt: str,
...
class AsyncWalletsResource(BaseAsyncWalletsResource):
    async def safe_authenticate_with_jwt(
        self,
        *,
        user_jwt: str,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
