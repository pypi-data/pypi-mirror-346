...
from .lib.privy_client import PrivyAPIExtension
...
class PrivyAPI(SyncAPIClient, PrivyAPIExtension):
    ...
    def __init__(
        ...
        *,
        ...
        if authorization_key is not None:
            self.update_authorization_key(authorization_key)
    ...
    def copy(
        ...
        *,
        ...
        return self.__class__(
            ...
            authorization_key=authorization_key or self._authorization_key,
