...
from ...types import fiat_configure_params
from .offramp import (
    OfframpResource,
...
from ...types.fiat_configure_response import FiatConfigureResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                fiat_configure_params.FiatConfigureParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=FiatConfigureResponse,
        )
