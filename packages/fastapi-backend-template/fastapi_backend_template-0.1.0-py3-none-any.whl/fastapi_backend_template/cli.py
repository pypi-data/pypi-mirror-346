...
- `backend/src/api`: API路由与控制器
- `backend/src/models`: 数据模型和验证模式
- `backend/src/repository`: 数据库交互
- `backend/src/securities`: 安全与认证
- `backend/src/utilities`: 通用工具
- `backend/src/config`: 配置和环境设置
"""
