...
analytical_base = script_base.parent.relative_to(pathlib.Path().absolute()) / "analytical"
...
ffibuilder = FFI()
ffibuilder.set_source("_cfsa", src, sources=[str(x) for x in sources], libraries=libraries)
