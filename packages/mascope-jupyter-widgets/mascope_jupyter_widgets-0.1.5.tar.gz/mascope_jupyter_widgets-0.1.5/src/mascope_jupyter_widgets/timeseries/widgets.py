...
class TimeSeriesWidget:
    ...
    def __init__(
        ...
        """
        Set up interactive widget-selector for timeseries figures
...
class ClosestPeakSelector:
    ...
    def __init__(self, peaks: list, on_selection_change: callable | None = None):
        """
        Create a widget for selecting the closest peak from search by searching
        from given list of peaks.
