...
class FilteringWidget:
    ...
    def collect_and_calculate_intensity_threshold(self) -> None:
        """
        Collect and calculate the intensity threshold
        from the dataset and set it to the widget.
    ...
    def display_dataframe(self, df: pd.DataFrame) -> None:
        """Display the given
        DataFrame in the output widget
    ...
    def populate_widgets_with_data(self) -> None:
        ...
        try:
            ...
            # Get unique sample names from protected _match_samples df which contains always un-filtered data
