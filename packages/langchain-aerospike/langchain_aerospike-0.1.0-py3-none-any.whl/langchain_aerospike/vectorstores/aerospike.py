...
class Aerospike(VectorStore):
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        """
        if self._distance_strategy == VectorDistanceMetric.COSINE:
            return self._cosine_relevance_score_fn
        elif self._distance_strategy == VectorDistanceMetric.DOT_PRODUCT:
            return self._max_inner_product_relevance_score_fn
        elif self._distance_strategy == VectorDistanceMetric.SQUARED_EUCLIDEAN:
