...
class CommunicationResource(SyncAPIResource):
    ...
    def send_email(
        ...
        *,
        ...
        """
        Args:
          body: Email body content in plain text or HTML format

          subject: Email subject line

          to: Comma-separated list of recipient email addresses (e.g., 'john@example.com,
              jane@example.com')

          attachments: Array of file metadata IDs to attach (as a link) to the email

          enable_encryption: If true, the email body will be encrypted and a secure link will be sent instead

          zip_attachments: If true, all attachments will be combined into a single zip file
