...
class LegacyResource(SyncAPIResource):
    ...
    def reason(
        ...
        *,
        ...
        """
        Legacy endpoint for initiating asynchronous document reasoning tasks

        Args:
          documents: An array of documents to be used in the reasoning task.

          task: The specific reasoning task configuration.
