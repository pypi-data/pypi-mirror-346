...
class ConcatOp(_ods_ir.OpView):
  ...
  def __init__(self, inputs, axis, *, out_dim=None, outputParamDecls=None, loc=None, ip=None):
    ...
    if out_dim is not None: attributes["out_dim"] = (out_dim if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_1031')) else
          _ods_ir.AttrBuilder.get('anonymous_1031')(out_dim, context=_ods_context))
    if outputParamDecls is not None: attributes["outputParamDecls"] = (outputParamDecls if (
        isinstance(outputParamDecls, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('MO_ParamDecls')) else
          _ods_ir.AttrBuilder.get('MO_ParamDecls')(outputParamDecls, context=_ods_context))
...
class ConvOp(_ods_ir.OpView):
  ...
  def __init__(self, input, filter, strides, dilations, paddings, num_groups, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def conv(input, filter, strides, dilations, paddings, num_groups, *, loc=None, ip=None) -> _ods_ir.Value:
  return ConvOp(input=input, filter=filter, strides=strides, dilations=dilations, paddings=paddings, num_groups=num_groups, loc=loc, ip=ip).result
...
class ConvTransposeOp(_ods_ir.OpView):
  ...
  def __init__(self, input, filter, strides, dilations, paddings, output_paddings, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def conv_transpose(input, filter, strides, dilations, paddings, output_paddings, *, loc=None, ip=None) -> _ods_ir.Value:
  return ConvTransposeOp(input=input, filter=filter, strides=strides, dilations=dilations, paddings=paddings, output_paddings=output_paddings, loc=loc, ip=ip).result
...
def mo_conv(result, input, filter, strides, dilations, paddings, num_groups, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return MOConvOp(result=result, input=input, filter=filter, strides=strides, dilations=dilations, paddings=paddings, num_groups=num_groups, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
def mo_conv_transpose(result, input, filter, strides, dilations, paddings, output_paddings, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return MOConvTransposeOp(result=result, input=input, filter=filter, strides=strides, dilations=dilations, paddings=paddings, output_paddings=output_paddings, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
class MOMutableLoadOp(_ods_ir.OpView):
  ...
  def __init__(self, outChain, outTensor, inChain, inBuffer, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def mo_mutable_load(out_chain, out_tensor, in_chain, in_buffer, *, output_param_decls=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return MOMutableLoadOp(outChain=out_chain, outTensor=out_tensor, inChain=in_chain, inBuffer=in_buffer, outputParamDecls=output_param_decls, loc=loc, ip=ip).results
...
class MOMutableStoreOp(_ods_ir.OpView):
  ...
  def __init__(self, inChain, inBuffer, inTensor, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def mo_mutable_store(in_chain, in_buffer, in_tensor, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return MOMutableStoreOp(inChain=in_chain, inBuffer=in_buffer, inTensor=in_tensor, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
def mo_mutable_store_slice(in_chain, in_buffer, slice, start, stop, step, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return MOMutableStoreSliceOp(inChain=in_chain, inBuffer=in_buffer, slice=slice, start=start, stop=stop, step=step, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
