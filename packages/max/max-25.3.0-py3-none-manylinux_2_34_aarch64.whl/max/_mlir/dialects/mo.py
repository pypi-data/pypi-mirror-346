...
def shape_from_tensor(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return FromTensorOp(input=input, loc=loc, ip=ip).result
...
class RandomNormalOp(_ods_ir.OpView):
  OPERATION_NAME = "mo.static.random.normal"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, mean, variance, seed, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def static_random_normal(result, mean, variance, seed, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return RandomNormalOp(result=result, mean=mean, variance=variance, seed=seed, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
def abs(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return AbsOp(input=input, loc=loc, ip=ip).result
...
def add(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return AddOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def distributed_allgather(outputs, inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(AllGatherOp(outputs=outputs, inputs=inputs, loc=loc, ip=ip))
...
class AllReduceSumOp(_ods_ir.OpView):
  ...
  def __init__(self, outChain, outputs, inChain, inputs, signalBuffers, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def distributed_allreduce_sum(out_chain, outputs, in_chain, inputs, signal_buffers, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(AllReduceSumOp(outChain=out_chain, outputs=outputs, inChain=in_chain, inputs=inputs, signalBuffers=signal_buffers, loc=loc, ip=ip))
...
def and_(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return AndOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
class AssertOp(_ods_ir.OpView):
  ...
  def __init__(self, cond, message, *, inChain=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def assert_(cond, message, *, in_chain=None, loc=None, ip=None) -> _ods_ir.Value:
  return AssertOp(cond=cond, message=message, inChain=in_chain, loc=loc, ip=ip).result
...
def atanh(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return AtanhOp(input=input, loc=loc, ip=ip).result
...
class BufferTransferOp(_ods_ir.OpView):
  ...
  def __init__(self, inChain, src, dst, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def buffer_transfer(in_chain, src, dst, *, loc=None, ip=None) -> _ods_ir.Value:
  return BufferTransferOp(inChain=in_chain, src=src, dst=dst, loc=loc, ip=ip).result
...
class CallOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, operands_, symbol, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def call(results_, operands_, symbol, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CallOp(results_=results_, operands_=operands_, symbol=symbol, outputParamDecls=output_param_decls, loc=loc, ip=ip))
...
def ceil(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return CeilOp(input=input, loc=loc, ip=ip).result
...
def chain_create(inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return ChainCreateOp(inputs=inputs, loc=loc, ip=ip).result
...
class ConstantExternalOp(_ods_ir.OpView):
  ...
  def __init__(self, result, name, align, *, hasAlias=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def constant_external(result, name, align, *, has_alias=None, loc=None, ip=None) -> _ods_ir.Value:
  return ConstantExternalOp(result=result, name=name, align=align, hasAlias=has_alias, loc=loc, ip=ip).result
...
class ConstantScalarOp(_ods_ir.OpView):
  ...
  def __init__(self, result, value, *, loc=None, ip=None):
    ...
    attributes["value"] = (value if (
    isinstance(value, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1125')) else
      _ods_ir.AttrBuilder.get('anonymous_1125')(value, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class ConvOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, filter, strides, dilations, paddings, num_groups, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def conv(result, input, filter, strides, dilations, paddings, num_groups, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return ConvOp(result=result, input=input, filter=filter, strides=strides, dilations=dilations, paddings=paddings, num_groups=num_groups, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
class ConvTransposeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, filter, strides, dilations, paddings, output_paddings, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def conv_transpose(result, input, filter, strides, dilations, paddings, output_paddings, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return ConvTransposeOp(result=result, input=input, filter=filter, strides=strides, dilations=dilations, paddings=paddings, output_paddings=output_paddings, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
def cos(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return CosOp(input=input, loc=loc, ip=ip).result
...
class CumSumOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, axis, exclusive, reverse, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('Builtin_IntegerAttr')) else
      _ods_ir.AttrBuilder.get('Builtin_IntegerAttr')(exclusive, context=_ods_context))
    attributes["reverse"] = (reverse if (
    isinstance(reverse, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('Builtin_IntegerAttr')) else
      _ods_ir.AttrBuilder.get('Builtin_IntegerAttr')(reverse, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class CustomOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, operands_, symbol, *, function=None, operandDevices=None, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if operandDevices is not None: attributes["operandDevices"] = (operandDevices if (
        isinstance(operandDevices, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('MO_DeviceIndexArrayAttr')) else
          _ods_ir.AttrBuilder.get('MO_DeviceIndexArrayAttr')(operandDevices, context=_ods_context))
    if outputParamDecls is not None: attributes["outputParamDecls"] = (outputParamDecls if (
        isinstance(outputParamDecls, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('MO_ParamDecls')) else
          _ods_ir.AttrBuilder.get('MO_ParamDecls')(outputParamDecls, context=_ods_context))
  ...
  @builtins.property
  def operandDevices(self):
    return self.operation.attributes["operandDevices"]

  @operandDevices.setter
  def operandDevices(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["operandDevices"] = value
...
def custom(results_, operands_, symbol, *, function=None, operand_devices=None, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CustomOp(results_=results_, operands_=operands_, symbol=symbol, function=function, operandDevices=operand_devices, outputParamDecls=output_param_decls, loc=loc, ip=ip))
...
class DebugPrintOp(_ods_ir.OpView):
  ...
  def __init__(self, inChain, value, *, label=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def debug_print(in_chain, value, *, label=None, loc=None, ip=None) -> _ods_ir.Value:
  return DebugPrintOp(inChain=in_chain, value=value, label=label, loc=loc, ip=ip).result
...
class DebugTensorPrintOp(_ods_ir.OpView):
  ...
  def __init__(self, inChain, input, *, label=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def debug_tensor_print(in_chain, input, *, label=None, loc=None, ip=None) -> _ods_ir.Value:
  return DebugTensorPrintOp(inChain=in_chain, input=input, label=label, loc=loc, ip=ip).result
...
def div(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return DivOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def erf(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return ErfOp(input=input, loc=loc, ip=ip).result
...
def exp(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return ExpOp(input=input, loc=loc, ip=ip).result
...
def floor(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return FloorOp(input=input, loc=loc, ip=ip).result
...
class GatherNdOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, indices, batchDims, *, outputParamDecls=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('Builtin_IntegerAttr')) else
      _ods_ir.AttrBuilder.get('Builtin_IntegerAttr')(batchDims, context=_ods_context))
    if outputParamDecls is not None: attributes["outputParamDecls"] = (outputParamDecls if (
        isinstance(outputParamDecls, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('MO_ParamDecls')) else
          _ods_ir.AttrBuilder.get('MO_ParamDecls')(outputParamDecls, context=_ods_context))
...
def gelu(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return GeluOp(input=input, loc=loc, ip=ip).result
...
class GraphOp(_ods_ir.OpView):
  ...
  def __init__(self, name, signature, functionType, inputParameters, resultParameters, counter, *, isSubgraph=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1074')) else
      _ods_ir.AttrBuilder.get('anonymous_1074')(signature, context=_ods_context))
    attributes["functionType"] = (functionType if (
    isinstance(functionType, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1078')) else
      _ods_ir.AttrBuilder.get('anonymous_1078')(functionType, context=_ods_context))
...
class GuardOp(_ods_ir.OpView):
  ...
  def __init__(self, chain, inputs, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def guard(chain, inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GuardOp(chain=chain, inputs=inputs, loc=loc, ip=ip))
...
def isqrt(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return IsqrtOp(input=input, loc=loc, ip=ip).result
...
def log1p(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return Log1pOp(input=input, loc=loc, ip=ip).result
...
def log(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return LogOp(input=input, loc=loc, ip=ip).result
...
def logsoftmax(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return LogSoftmaxOp(input=input, loc=loc, ip=ip).result
...
def max(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return MaxOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def min(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return MinOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def mod(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return ModOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def mul(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return MulOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
class MutableLoadOp(_ods_ir.OpView):
  ...
  def __init__(self, outChain, outTensor, inChain, inBuffer, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def mutable_load(out_chain, out_tensor, in_chain, in_buffer, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return MutableLoadOp(outChain=out_chain, outTensor=out_tensor, inChain=in_chain, inBuffer=in_buffer, loc=loc, ip=ip).results
...
class MutableStoreOp(_ods_ir.OpView):
  ...
  def __init__(self, inChain, inBuffer, inTensor, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def mutable_store(in_chain, in_buffer, in_tensor, *, loc=None, ip=None) -> _ods_ir.Value:
  return MutableStoreOp(inChain=in_chain, inBuffer=in_buffer, inTensor=in_tensor, loc=loc, ip=ip).result
...
class MutableStoreSliceOp(_ods_ir.OpView):
  ...
  def __init__(self, inChain, inBuffer, slice, start, stop, step, *, outputParamDecls=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def mutable_store_slice(in_chain, in_buffer, slice, start, stop, step, *, output_param_decls=None, loc=None, ip=None) -> _ods_ir.Value:
  return MutableStoreSliceOp(inChain=in_chain, inBuffer=in_buffer, slice=slice, start=start, stop=stop, step=step, outputParamDecls=output_param_decls, loc=loc, ip=ip).result
...
def negative(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return NegativeOp(input=input, loc=loc, ip=ip).result
...
def or_(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return OrOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def relu(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return ReluOp(input=input, loc=loc, ip=ip).result
...
def round(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return RoundOp(input=input, loc=loc, ip=ip).result
...
def sin(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return SinOp(input=input, loc=loc, ip=ip).result
...
def softmax(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return SoftmaxOp(input=input, loc=loc, ip=ip).result
...
def sqrt(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return SqrtOp(input=input, loc=loc, ip=ip).result
...
def sub(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return SubOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
...
def tanh(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return TanhOp(input=input, loc=loc, ip=ip).result
...
class TransferOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, *, alwaysElideSameDeviceCopy=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def transfer(result, input, *, always_elide_same_device_copy=None, loc=None, ip=None) -> _ods_ir.Value:
  return TransferOp(result=result, input=input, alwaysElideSameDeviceCopy=always_elide_same_device_copy, loc=loc, ip=ip).result
...
def trunc(input, *, loc=None, ip=None) -> _ods_ir.Value:
  return TruncOp(input=input, loc=loc, ip=ip).result
...
def xor(input_x, input_y, *, loc=None, ip=None) -> _ods_ir.Value:
  return XorOp(input_x=input_x, input_y=input_y, loc=loc, ip=ip).result
