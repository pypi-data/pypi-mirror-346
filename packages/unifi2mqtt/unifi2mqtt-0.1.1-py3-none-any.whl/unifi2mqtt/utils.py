...
#    parser.add_argument("--unifi-ignore-ssl", 
#                        action="store_true" if os.getenv("UNIFI_IGNORE_SSL", "false").lower() in ("1", "true", "yes") else "store_false",
#                        help="Ignore SSL verification", default=os.getenv("UNIFI_IGNORE_SSL", "false").lower() in ("1", "true", "yes"))
