...
* Linux and Windows
  ...
  install as Python package from PyPi[^2]:
...
[^2]: I couldn't publish md2fileo v.1.3.40 to PyPi after PyPi limited upload authentication to token only, it doesn't work for me
