...
See full MR log [here](https://git.ligo.org/lscsoft/bilby_pipe/-/merge_requests?scope=all&state=all&milestone_title=1.4.2)

### Changes

- Change `bilby_pipe_gracedb` to use temporary calibration envelopes (!615)

## v1.4.1 2024-09-18

See full MR log [here](https://git.ligo.org/lscsoft/bilby_pipe/-/merge_requests?scope=all&state=all&milestone_title=1.4.1)

### Changes

- Change `bilby_pipe_gracedb` to use the closest available calibration envelope prior to the trigger time (!611) 
