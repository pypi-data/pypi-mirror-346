...
def check_geometry(testfile_path,testfile_h5path,
                    flip_detector_x=False, flip_detector_y=False,
    ...
    pyf.check_detector_geometry(
        ...
        os.path.join(sample_dir,'analysis','gemeometry.py'),
        flip_detector_x, flip_detector_y,vmax,logscale,
        )
...
def save_results( ):
    ...
    with h5py.File( 
        ...
        hf.create_dataset('opt_file', data=['optimization'][()])
