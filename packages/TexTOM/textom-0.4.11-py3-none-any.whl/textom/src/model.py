...
class model:
    ...
    def _init_diffractlets(self):
        ...
        uc_pos_rot = rot.stack_mrot( uc_pos.astype(data_type), self.Gc)
        lattice_vectors_rot = rot.stack_mrot( self.lattice_vectors.astype(data_type), self.Gc)
        ...
        t0 = time()
        self.Isc = single_crystal_images( Q_ew, uc_pos_rot, bool_pos_el, FF_el, crystalsize, lattice_vectors_rot) 
