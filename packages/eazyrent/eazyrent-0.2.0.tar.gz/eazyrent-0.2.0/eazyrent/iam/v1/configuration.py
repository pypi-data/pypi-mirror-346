...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "/iam/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("iam.v1")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            ...
            {
                "url": "https://api.eazyrent.fr/iam/v1",
                "description": "No description provided",
            },
            {
                "url": "https://api.v2.eazyrent.fr/iam/v1",
                "description": "No description provided",
            },
            {
                "url": "https://api.v2.solution-eazyrent.fr/iam/v1",
                "description": "No description provided",
            },
            {
                "url": "http://localhost:5053/iam/v1",
                "description": "No description provided",
            },
        ]
