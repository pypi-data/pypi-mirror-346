...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("core.v1")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            ...
            {
                "url": "https://api.eazyrent.fr/v1",
                "description": "No description provided",
            },
            {
                "url": "https://api.v2.eazyrent.fr/v1",
                "description": "No description provided",
            },
            {
                "url": "https://api.v2.solution-eazyrent.fr/v1",
                "description": "No description provided",
            },
            {
                "url": "http://localhost:5053/v1",
                "description": "No description provided",
            },
        ]
