...
class PropertyRentList(BaseModel):
    """
    PropertyRentList
    """  # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if photo_uri (nullable) is None
        # and model_fields_set contains the field
        if self.photo_uri is None and "photo_uri" in self.model_fields_set:
            _dict["photo_uri"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "photo_uri": obj.get("photo_uri"),
                "title": obj.get("title"),
                "rent_amount": obj.get("rent_amount"),
                "added_at": obj.get("added_at"),
                "applicant_file_count": obj.get("applicant_file_count")
                if obj.get("applicant_file_count") is not None
                else 0,
            }
        )
        return _obj
