...
class ApisCoreSchemasV1PhysicalGuarantorsPhysicalGuarantor(BaseModel):
    """
    ...
    applicant_file: StrictStr
    for_applicant: StrictStr
        ...
        _obj = cls.model_validate(
            {
                ...
                "for_applicant": obj.get("for_applicant"),
