...
class PaginatedResponseAcceptedSupportingDocument(BaseModel):
    """
    ...
    results: Optional[List[AcceptedSupportingDocument]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    AcceptedSupportingDocument.from_dict(_item)
