...
class PaginatedResponseListAcceptedDocument(BaseModel):
    """
    ...
    results: Optional[List[ListAcceptedDocument]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    ListAcceptedDocument.from_dict(_item) for _item in obj["results"]
                ]
