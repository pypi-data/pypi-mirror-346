...
class JsonDescriptor(BaseModel):
    """
    JsonDescriptor
    """  # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_params
        if self.json_params:
            _dict["json_params"] = self.json_params.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "json_params": JsonParams.from_dict(obj["json_params"])
                if obj.get("json_params") is not None
                else None,
            }
        )
        return _obj
