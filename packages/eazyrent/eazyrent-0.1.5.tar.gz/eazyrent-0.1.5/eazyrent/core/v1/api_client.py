...
from eazyrent.core.v1.api_response import ApiResponse, T as ApiResponseT
import eazyrent.core.v1.models
from eazyrent.core.v1 import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(eazyrent.core.v1.models, klass)
