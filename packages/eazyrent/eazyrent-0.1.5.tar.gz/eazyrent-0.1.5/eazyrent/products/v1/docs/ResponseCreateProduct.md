...
json = "{}"
# create an instance of ResponseCreateProduct from a JSON string
response_create_product_instance = ResponseCreateProduct.from_json(json)
# print the JSON string representation of the object
print(ResponseCreateProduct.to_json())

# convert the object into a dict
response_create_product_dict = response_create_product_instance.to_dict()
# create an instance of ResponseCreateProduct from a dict
response_create_product_from_dict = ResponseCreateProduct.from_dict(response_create_product_dict)
```
