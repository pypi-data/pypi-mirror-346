...
json = "{}"
# create an instance of ResponseGetProduct from a JSON string
response_get_product_instance = ResponseGetProduct.from_json(json)
# print the JSON string representation of the object
print(ResponseGetProduct.to_json())

# convert the object into a dict
response_get_product_dict = response_get_product_instance.to_dict()
# create an instance of ResponseGetProduct from a dict
response_get_product_from_dict = ResponseGetProduct.from_dict(response_get_product_dict)
```
