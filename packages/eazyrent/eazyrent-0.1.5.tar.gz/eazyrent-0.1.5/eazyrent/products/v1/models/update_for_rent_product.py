...
class UpdateForRentProduct(BaseModel):
    """
    ...
    disable_spontaneous_applications: Optional[StrictBool] = Field(
        default=False,
        description="If disabled, the public link to send an application will stop accepting applications.",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("disable_spontaneous_applications") is not None
                else False,
