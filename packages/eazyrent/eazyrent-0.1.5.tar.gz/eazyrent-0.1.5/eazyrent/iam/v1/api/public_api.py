...
class PublicApi:
    ...
    def register(
        ...
        :param register_serializer: (required)
        :type register_serializer: RegisterSerializer
    ...
    def register_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RegisterSerializer]:
        """Register
    ...
    def _register_serialize(
        ...
        if register_serializer is not None:
            _body_params = register_serializer
