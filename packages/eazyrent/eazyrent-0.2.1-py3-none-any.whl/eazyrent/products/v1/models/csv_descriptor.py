...
class CsvDescriptor(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of csv_params
        if self.csv_params:
            _dict["csv_params"] = self.csv_params.to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "csv_params": CsvParams.from_dict(obj["csv_params"])
                if obj.get("csv_params") is not None
                else None,
            }
        )
        return _obj
