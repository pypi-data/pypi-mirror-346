...
class PaginatedResponseUnionListForRentProductListForSalesProduct(BaseModel):
    """
    ...
    results: Optional[
        List[PaginatedResponseUnionListForRentProductListForSalesProductResultsInner]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    PaginatedResponseUnionListForRentProductListForSalesProductResultsInner.from_dict(
                        _item
                    )
