...
class RentalFileList(BaseModel):
    """
    RentalFileList
    """  # noqa: E501
    ...
    property_rent: StrictStr
    applicants: List[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "status", "property_rent", "applicants"]
