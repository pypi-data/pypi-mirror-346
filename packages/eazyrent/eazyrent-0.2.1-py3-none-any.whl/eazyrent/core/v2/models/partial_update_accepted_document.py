...
class PartialUpdateAcceptedDocument(BaseModel):
    """
    ...
    analyzed_as: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if analyzed_as (nullable) is None
        # and model_fields_set contains the field
        if self.analyzed_as is None and "analyzed_as" in self.model_fields_set:
            _dict["analyzed_as"] = None
