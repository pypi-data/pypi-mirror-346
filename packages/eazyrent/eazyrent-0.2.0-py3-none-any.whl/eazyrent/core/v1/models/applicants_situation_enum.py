...
class ApplicantsSituationEnum(str, Enum):
    """
    ApplicantsSituationEnum
    """
    ...
    COUPLE = "COUPLE"
    ROOMATES = "ROOMATES"
    SOLID_ROOMATES = "SOLID_ROOMATES"

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApplicantsSituationEnum from a JSON string"""
