...
class ZipDescriptor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["format", "zip_params"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of zip_params
        if self.zip_params:
            _dict["zip_params"] = self.zip_params.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "zip_params": ZipParams.from_dict(obj["zip_params"])
                if obj.get("zip_params") is not None
                else None,
            }
        )
        return _obj
...
ZipDescriptor.model_rebuild(raise_errors=False)
