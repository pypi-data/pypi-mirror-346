...
class PoolSpecification(BaseModel):
    ...
    materials: Optional[StrictStr] = None
    heating_system: Optional[StrictStr] = None
    construction_date: Optional[date] = None
    indoor: Optional[StrictBool] = False
    safety_compliance: Optional[StrictBool] = False
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["in-ground", "above-ground"]):
            raise ValueError("must be one of enum values ('in-ground', 'above-ground')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if materials (nullable) is None
        # and model_fields_set contains the field
        if self.materials is None and "materials" in self.model_fields_set:
            _dict["materials"] = None

        # set to None if heating_system (nullable) is None
        # and model_fields_set contains the field
        if self.heating_system is None and "heating_system" in self.model_fields_set:
            _dict["heating_system"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "indoor": obj.get("indoor") if obj.get("indoor") is not None else False,
                "safety_compliance": obj.get("safety_compliance")
                if obj.get("safety_compliance") is not None
                else False,
            }
        )
        return _obj
