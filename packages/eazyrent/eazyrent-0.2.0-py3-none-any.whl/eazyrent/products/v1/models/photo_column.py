...
class PhotoColumn(BaseModel):
    """
    PhotoColumn
    """  # noqa: E501

    var_field: Optional[StrictStr] = Field(default="photos", alias="field")
    sub_field: Optional[StrictStr] = None
    suffix: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["field", "sub_field", "suffix"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sub_field (nullable) is None
        # and model_fields_set contains the field
        if self.sub_field is None and "sub_field" in self.model_fields_set:
            _dict["sub_field"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "field": obj.get("field") if obj.get("field") is not None else "photos",
