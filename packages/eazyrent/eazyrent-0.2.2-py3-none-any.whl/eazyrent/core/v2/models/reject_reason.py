...
class RejectReason(BaseModel):
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('TOO_MANY_PAGES', 'INCOMPLETE_DOCUMENT', 'UNREADABLE_DOCUMENT', 'WRONG_DOCUMENT', 'NOT_SUPPORTED', 'UNPROCESSABLE')"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"reason": obj.get("reason"), "comment": obj.get("comment")}
        )
        return _obj
