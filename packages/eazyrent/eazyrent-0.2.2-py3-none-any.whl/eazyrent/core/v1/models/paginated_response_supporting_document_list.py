...
class PaginatedResponseSupportingDocumentList(BaseModel):
    """
    ...
    results: Optional[List[SupportingDocumentList]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    SupportingDocumentList.from_dict(_item) for _item in obj["results"]
                ]
