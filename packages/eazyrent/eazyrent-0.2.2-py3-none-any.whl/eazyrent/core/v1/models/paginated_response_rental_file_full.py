...
class PaginatedResponseRentalFileFull(BaseModel):
    """
    ...
    results: Optional[List[RentalFileFull]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [RentalFileFull.from_dict(_item) for _item in obj["results"]]
