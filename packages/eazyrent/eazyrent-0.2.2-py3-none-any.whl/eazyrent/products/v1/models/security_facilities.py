...
class SecurityFacilities(BaseModel):
    """
    ...
    concierge: Optional[StrictBool] = None
    security_guard: Optional[StrictBool] = None
    camera: Optional[StrictBool] = None
    alarm_system: Optional[StrictBool] = None
    armored_door: Optional[StrictBool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if concierge (nullable) is None
        # and model_fields_set contains the field
        if self.concierge is None and "concierge" in self.model_fields_set:
            _dict["concierge"] = None

        # set to None if security_guard (nullable) is None
        # and model_fields_set contains the field
        if self.security_guard is None and "security_guard" in self.model_fields_set:
            _dict["security_guard"] = None
        ...
        # set to None if alarm_system (nullable) is None
        # and model_fields_set contains the field
        if self.alarm_system is None and "alarm_system" in self.model_fields_set:
            _dict["alarm_system"] = None

        # set to None if armored_door (nullable) is None
        # and model_fields_set contains the field
        if self.armored_door is None and "armored_door" in self.model_fields_set:
            _dict["armored_door"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "security_guard": obj.get("security_guard"),
                "camera": obj.get("camera"),
                "alarm_system": obj.get("alarm_system"),
                "armored_door": obj.get("armored_door"),
            }
        )
        return _obj
