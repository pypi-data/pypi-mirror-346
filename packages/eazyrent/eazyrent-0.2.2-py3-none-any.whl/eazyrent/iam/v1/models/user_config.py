...
class UserConfig(BaseModel):
    ...
    email_signature: Optional[StrictStr] = ""
    dark_mode: Optional[StrictBool] = False
    property_rent_subscriptions: Optional[
        List[UserConfigPropertyRentSubscriptionsInner]
    ] = None
    send_notification_by_mail: Optional[StrictBool] = False
    raw_html_email: Optional[StrictBool] = False
    interface_config: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_rent_subscriptions (list)
        _items = []
        if self.property_rent_subscriptions:
            for _item_property_rent_subscriptions in self.property_rent_subscriptions:
                if _item_property_rent_subscriptions:
                    _items.append(_item_property_rent_subscriptions.to_dict())
            _dict["property_rent_subscriptions"] = _items
        # set to None if interface_config (nullable) is None
        # and model_fields_set contains the field
        if (
            self.interface_config is None
            and "interface_config" in self.model_fields_set
        ):
            _dict["interface_config"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("email_signature") is not None
                else "",
                "dark_mode": obj.get("dark_mode")
                if obj.get("dark_mode") is not None
                else False,
                "property_rent_subscriptions": [
                    UserConfigPropertyRentSubscriptionsInner.from_dict(_item)
                    for _item in obj["property_rent_subscriptions"]
                ]
                if obj.get("property_rent_subscriptions") is not None
                else None,
                "send_notification_by_mail": obj.get("send_notification_by_mail")
                if obj.get("send_notification_by_mail") is not None
                else False,
                "raw_html_email": obj.get("raw_html_email")
                if obj.get("raw_html_email") is not None
                else False,
                "interface_config": obj.get("interface_config"),
            }
        )
        return _obj
