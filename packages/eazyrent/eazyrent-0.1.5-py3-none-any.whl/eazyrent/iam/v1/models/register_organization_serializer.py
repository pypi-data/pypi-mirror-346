...
class RegisterOrganizationSerializer(BaseModel):
    """
    ...
    pairing_code: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "registration_number", "pairing_code"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pairing_code (nullable) is None
        # and model_fields_set contains the field
        if self.pairing_code is None and "pairing_code" in self.model_fields_set:
            _dict["pairing_code"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "pairing_code": obj.get("pairing_code"),
            }
        )
        return _obj
