...
class RegisterSerializer(BaseModel):
    ...
    organization: RegisterOrganizationSerializer
    org_admin: RegisterAdminOrgSerializer
    __properties: ClassVar[List[str]] = ["organization", "org_admin"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of org_admin
        if self.org_admin:
            _dict["org_admin"] = self.org_admin.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "organization": RegisterOrganizationSerializer.from_dict(
                    obj["organization"]
                )
                if obj.get("organization") is not None
                else None,
                "org_admin": RegisterAdminOrgSerializer.from_dict(obj["org_admin"])
                if obj.get("org_admin") is not None
                else None,
            }
        )
        return _obj
