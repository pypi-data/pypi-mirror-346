...
class ApplicantFormsApi:
    ...
    def get_applicant_form(
        ...
        _param = self._get_applicant_form_serialize(
            id=id,
    ...
    @validate_call
    def get_applicant_form_with_http_info(
        self,
        id: StrictStr,
        x_eaz_account_id: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def get_applicant_form_without_preload_content(
        self,
        id: StrictStr,
        x_eaz_account_id: Annotated[
            Optional[StrictStr],
    ...
    def _get_applicant_form_serialize(
        self,
        id,
        x_eaz_account_id,
        _request_auth,
    ...
    @validate_call
    def get_applicant_form_comment(
        self,
        id: StrictStr,
        x_eaz_account_id: Annotated[
            Optional[StrictStr],
        ...
        _param = self._get_applicant_form_comment_serialize(
            id=id,
            x_eaz_account_id=x_eaz_account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_applicant_form_comment_with_http_info(
        self,
        id: StrictStr,
        x_eaz_account_id: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def get_applicant_form_comment_without_preload_content(
        self,
        id: StrictStr,
        x_eaz_account_id: Annotated[
            Optional[StrictStr],
    ...
    def _get_applicant_form_comment_serialize(
        self,
        id,
        x_eaz_account_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/forms/{id}/comment/",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
