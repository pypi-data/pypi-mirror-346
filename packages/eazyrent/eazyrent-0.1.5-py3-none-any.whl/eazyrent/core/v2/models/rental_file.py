...
class RentalFile(BaseModel):
    ...
    comments: Optional[List[RentalFileComment]] = None
    analysis_required_at: Optional[datetime] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if analysis_required_at (nullable) is None
        # and model_fields_set contains the field
        if (
            self.analysis_required_at is None
            and "analysis_required_at" in self.model_fields_set
        ):
            _dict["analysis_required_at"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "applicants": [
                    Applicant.from_dict(_item) for _item in obj["applicants"]
                ]
                ...
                "comments": [
                    RentalFileComment.from_dict(_item) for _item in obj["comments"]
                ]
                if obj.get("comments") is not None
                else None,
                "analysis_required_at": obj.get("analysis_required_at"),
            }
        )
        return _obj
