...
from eazyrent.core.v2.api_response import ApiResponse, T as ApiResponseT
import eazyrent.core.v2.models
from eazyrent.core.v2 import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(eazyrent.core.v2.models, klass)
