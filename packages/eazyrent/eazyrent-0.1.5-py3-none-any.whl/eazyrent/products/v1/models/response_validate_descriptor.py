...
RESPONSEVALIDATEDESCRIPTOR_ANY_OF_SCHEMAS = [
    "CsvDescriptor",
    "JsonDescriptor",
    "XmlDescriptor",
    "ZipDescriptor",
...
class ResponseValidateDescriptor(BaseModel):
    """
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[
            Union[CsvDescriptor, JsonDescriptor, XmlDescriptor, ZipDescriptor]
        ] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ResponseValidateDescriptor.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in ResponseValidateDescriptor with anyOf schemas: CsvDescriptor, JsonDescriptor, XmlDescriptor, ZipDescriptor. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into ResponseValidateDescriptor with anyOf schemas: CsvDescriptor, JsonDescriptor, XmlDescriptor, ZipDescriptor. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
    ...
    def to_dict(
        ...
        Union[
            Dict[str, Any], CsvDescriptor, JsonDescriptor, XmlDescriptor, ZipDescriptor
        ]
    ]:
