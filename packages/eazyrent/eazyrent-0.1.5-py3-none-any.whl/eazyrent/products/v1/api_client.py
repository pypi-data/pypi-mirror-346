...
from eazyrent.products.v1.api_response import ApiResponse, T as ApiResponseT
import eazyrent.products.v1.models
from eazyrent.products.v1 import rest
from eazyrent.products.v1.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(eazyrent.products.v1.models, klass)
