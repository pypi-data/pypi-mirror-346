...
class AppNotificationConfig(BaseModel):
    """
    Manage notifications subscriptions.
    """  # noqa: E501

    rental_file_submitted: Optional[StrictBool] = True
    rental_file_created: Optional[StrictBool] = True
    rental_file_deletion: Optional[StrictBool] = True
    rental_file_analyzed: Optional[StrictBool] = True
    rental_file_collected: Optional[StrictBool] = True
