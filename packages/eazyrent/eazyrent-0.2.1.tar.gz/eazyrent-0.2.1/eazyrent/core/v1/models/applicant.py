...
class Applicant(BaseModel):
    ...
    id: StrictStr
    physical_guarantors: Optional[
        List[ApisCoreSchemasV1ApplicantsPhysicalGuarantor]
    ] = None
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "physical_guarantors": [
                    ApisCoreSchemasV1ApplicantsPhysicalGuarantor.from_dict(_item)
