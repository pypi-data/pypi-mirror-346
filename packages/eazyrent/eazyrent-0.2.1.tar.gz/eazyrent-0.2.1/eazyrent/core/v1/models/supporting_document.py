...
class SupportingDocument(BaseModel):
    ...
    id: StrictStr
    uploaded_files: Optional[List[LightUploadFile]] = None
    alerts: Optional[List[AlertPretty]] = None
    applicant: StrictStr
    document_type: Optional[StrictStr] = None
    status: Status6d0Enum
    document_type_name: Optional[StrictStr] = None
    created_at: datetime
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if document_type_name (nullable) is None
        # and model_fields_set contains the field
        if (
            self.document_type_name is None
            and "document_type_name" in self.model_fields_set
        ):
            _dict["document_type_name"] = None
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "uploaded_files": [
                    LightUploadFile.from_dict(_item) for _item in obj["uploaded_files"]
                ]
                if obj.get("uploaded_files") is not None
                else None,
                "alerts": [AlertPretty.from_dict(_item) for _item in obj["alerts"]]
