...
class UpdateApplicant(BaseModel):
    """
    UpdateApplicant
    """  # noqa: E501
    ...
    physical_guarantors: Optional[List[UpdateApplicant]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "meta": obj.get("meta"),
                "physical_guarantors": [
                    UpdateApplicant.from_dict(_item)
...
UpdateApplicant.model_rebuild(raise_errors=False)
