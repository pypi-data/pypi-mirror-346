...
class CsvParams(BaseModel):
    ...
    skip_rows: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["delimiter", "encoding", "skip_rows"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if skip_rows (nullable) is None
        # and model_fields_set contains the field
        if self.skip_rows is None and "skip_rows" in self.model_fields_set:
            _dict["skip_rows"] = None
