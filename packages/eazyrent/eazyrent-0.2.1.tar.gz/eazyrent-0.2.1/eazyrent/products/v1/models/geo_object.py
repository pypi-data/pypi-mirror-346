...
class GeoObject(BaseModel):
    ...
    type: Optional[StrictStr] = "Point"
    coordinates: Annotated[List[Any], Field(min_length=2, max_length=2)]
    format: Optional[StrictStr] = "EPSG:2154"
    __properties: ClassVar[List[str]] = ["type", "coordinates", "format"]
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(["EPSG:2154", "EPSG:4326"]):
            raise ValueError("must be one of enum values ('EPSG:2154', 'EPSG:4326')")
        return value
