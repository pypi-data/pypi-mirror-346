...
class PaginatedResponseRentalFileList(BaseModel):
    """
    ...
    results: Optional[List[RentalFileList]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [RentalFileList.from_dict(_item) for _item in obj["results"]]
