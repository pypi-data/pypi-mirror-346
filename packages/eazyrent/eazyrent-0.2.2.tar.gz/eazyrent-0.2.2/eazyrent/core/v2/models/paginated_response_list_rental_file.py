...
class PaginatedResponseListRentalFile(BaseModel):
    """
    ...
    results: Optional[List[ListRentalFile]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [ListRentalFile.from_dict(_item) for _item in obj["results"]]
