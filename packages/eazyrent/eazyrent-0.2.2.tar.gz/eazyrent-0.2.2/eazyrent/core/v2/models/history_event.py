...
class HistoryEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_type", "timestamp", "actor", "payload"]
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('rental_file.created', 'rental_file.updated', 'rental_file.archived', 'rental_file.deleted', 'applicant.created', 'applicant.updated', 'applicant.deleted')"
            )
        return value
