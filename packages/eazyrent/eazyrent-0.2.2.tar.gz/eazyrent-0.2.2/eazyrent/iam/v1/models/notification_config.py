...
class NotificationConfig(BaseModel):
    ...
    app: Optional[AppNotificationConfig] = None
    email: Optional[EmailNotificationConfig] = None
    __properties: ClassVar[List[str]] = ["app", "email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "app": AppNotificationConfig.from_dict(obj["app"])
                if obj.get("app") is not None
                else None,
                "email": EmailNotificationConfig.from_dict(obj["email"])
