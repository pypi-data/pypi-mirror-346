...
class User(BaseModel):
    ...
    state: Optional[StrictStr] = "USER_STATE_UNSPECIFIED"
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('USER_STATE_UNSPECIFIED', 'USER_STATE_ACTIVE', 'USER_STATE_INACTIVE', 'USER_STATE_DELETED', 'USER_STATE_LOCKED', 'USER_STATE_SUSPEND', 'USER_STATE_INITIAL')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                else "USER_STATE_UNSPECIFIED",
                "config": UserConfig.from_dict(obj["config"])
