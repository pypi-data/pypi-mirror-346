...
class DailyRotatingFileHandler(TimedRotatingFileHandler):
    def __init__(self, filename,file_type='log', when='midnight', interval=1, backupCount=0, encoding=None, delay=False, utc=False,maxBytes=10485760,mutiple_process=False):
        # 获取基础文件名（不带日期）
