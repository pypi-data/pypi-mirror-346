...
class MillSettings(google.protobuf.message.Message):
    ...
    DEFAULT_RADIAL_FINISH_ABSOLUTE_FIELD_NUMBER: builtins.int
    DEFAULT_RADIAL_FINISH_RELATIVE_FIELD_NUMBER: builtins.int
    DEFAULT_BIARC_RELATIVE_FIELD_NUMBER: builtins.int
    ...
    """
    default_radial_finish_absolute: builtins.float
    ...
    i.e. 0.010" -> `0.000254`
    """
    default_radial_finish_relative: builtins.float
    """can also be specified as a percentage of tool diameter.
    note that the total allowance includes BOTH VALUES, i.e.
    `allowance = absolute + (relative * tool_diameter)`
    """
    default_biarc_relative: builtins.float
    """the radius of the biarc connection relative to the tool radius"""
    ...
    *before* any toolpathing and will return results that are a subset
    ...
    def ClearField(self, field_name: typing_extensions.Literal["angle_helix", b"angle_helix", "default_biarc_relative", b"default_biarc_relative", "default_radial_depth_of_cut", b"default_radial_depth_of_cut", "default_radial_finish_absolute", b"default_radial_finish_absolute", "default_radial_finish_relative", b"default_radial_finish_relative", "default_skip_ball", b"default_skip_ball", "detail", b"detail", "machine", b"machine", "material_id", b"material_id", "max_directions", b"max_directions", "plane_normals", b"plane_normals", "preprocess", b"preprocess", "return_gcode", b"return_gcode", "return_plan", b"return_plan", "return_volume", b"return_volume", "skip_fixture_collisions", b"skip_fixture_collisions", "skip_prune", b"skip_prune", "tools", b"tools"]) -> None: ...
