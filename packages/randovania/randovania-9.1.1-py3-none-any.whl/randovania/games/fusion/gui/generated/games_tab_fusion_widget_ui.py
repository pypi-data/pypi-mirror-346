...
class Ui_FusionGameTabWidget(object):
    def setupUi(self, FusionGameTabWidget):
        ...
        self.differences_scroll_contents.setGeometry(QRect(0, 0, 664, 631))
...
"\n"
"- In order to fight the SA-X, you will need to collect a configurable amount of infant Metroids, a way to approach the door to the Operations Room, Charge Beam and Missiles. Plasma Beam is not required to defeat the SA-X, and the Level 4 Keycard is not require"
                        "d to go to the Operations Room.\n"
"\n"
...
"\n"
"- The destruction of Sector 5 has been changed to always be consistent. Everything in West Sector 5 will always be undamaged, while everything East will be destroyed.\n"
"\n"
"- Sector 5 - The red Level 4 hatch between Arctic Containment and Crows Nest has been changed to a yellow Level 3 hatch.\n"
"\n"
"### Quality of Life\n"
"\n"
"- You can now warp to start by pressing L on the map screen. All progress since your last save will be lost. This is NEVER consid"
                        "ered logical.\n"
"\n"
...
"- On the map screen, you can now cycle the Sectors on the map by pressing SELECT and show the current room name by pressing A. In-game Time (IGT) and Level 0 security status is also displayed.", None))
        ...
        self.hints_label.setText(QCoreApplication.translate("FusionGameTabWidget", u"<html><head/><body><p>In Metroid Fusion, players can find hints at the various Navigation Terminals spread throught the B.S.L. There are three main types of hints: </p><p>1) <span style=\" font-weight:700;\">Infant Metroids</span>: The Restricted Navigation Room gives a hint where all Infant Metroids can be found. This Navigation Terminal is always unlocked. </p><p>2) <span style=\" font-weight:700;\">Charge Beam</span>: The Auxiliary Navigation Terminal gives a hint where the Charge Beam can be found. This Navigation Terminal is always unlocked </p><p>3) <span style=\" font-weight:700;\">Regular: </span>The remaining Navigation Terminals give hints to random pickups with varying precision. Activating these Navigation Terminals require a specific Keycard to be acquired, and will prevent interaction before then.</p><p>The table below summarizes the above:</p></body></html>", None))
        ...
        ___qtablewidgetitem29.setText(QCoreApplication.translate("FusionGameTabWidget", u"Level 0 Keycard (GREY)", None));
        ___qtablewidgetitem30 = self.tableWidget.item(3, 3)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("FusionGameTabWidget", u"Regular Hint, Featural", None));
        ...
        ___qtablewidgetitem33.setText(QCoreApplication.translate("FusionGameTabWidget", u"Unlocked", None));
