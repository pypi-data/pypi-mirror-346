...
class UpdateScheduleContract(object):
    ...
    def __init__(self, workflow_id=None, owner_id=None, iteration=None, name=None, comment=None, priority=None, worker_tag=None, enabled=None, credential_id=None, time_zone=None, questions=None, _configuration=None):  # noqa: E501
