...
class WorkflowView(object):
    ...
    def __init__(self, id=None, source_app_id=None, date_created=None, run_count=None, versions=None, name=None, owner_id=None, worker_tag=None, district_tags=None, comments=None, is_public=None, is_ready_for_migration=None, published_version_id=None, others_may_download=None, others_can_view_history=None, others_can_execute=None, execution_mode=None, has_private_data_exemption=None, _configuration=None):  # noqa: E501
