...
class ReducedScheduleView(object):
    ...
    def __init__(self, id=None, name=None, workflow_id=None, owner_id=None, run_date_time=None, time_zone=None, _configuration=None):  # noqa: E501
    ...
    def workflow_id(self):
        ...
        The application id for the workflow in the gallery DB.    Will be null if the workflow has been deleted.  # noqa: E501
    ...
    def run_date_time(self):
        ...
        RunDateTime will either be the next time the schedule will be run, OR  the next run time in the specified window of a search range  # noqa: E501
