...
class WorkflowVersionView(object):
    ...
    def __init__(self, version_id=None, version_number=None, date_created=None, upload_source=None, upload_date=None, package_workflow_type=None, published=None, comments=None, run_disabled=None, execution_mode=None, workflow_credential_type=None, credential_id=None, has_private_data_exemption=None, others_may_download=None, others_can_view_history=None, details=None, _configuration=None):  # noqa: E501
    ...
    def upload_source(self, upload_source):
        ...
        if (self._configuration.client_side_validation and
                upload_source not in allowed_values):
            raise ValueError(
                "Invalid value for `upload_source` ({0}), must be one of {1}"  # noqa: E501
                .format(upload_source, allowed_values)
            )
    ...
    def package_workflow_type(self, package_workflow_type):
        ...
        if (self._configuration.client_side_validation and
                package_workflow_type not in allowed_values):
            raise ValueError(
                "Invalid value for `package_workflow_type` ({0}), must be one of {1}"  # noqa: E501
                .format(package_workflow_type, allowed_values)
            )
    ...
    def workflow_credential_type(self, workflow_credential_type):
        ...
        if (self._configuration.client_side_validation and
                workflow_credential_type not in allowed_values):
            raise ValueError(
                "Invalid value for `workflow_credential_type` ({0}), must be one of {1}"  # noqa: E501
                .format(workflow_credential_type, allowed_values)
            )
