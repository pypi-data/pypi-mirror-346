...
class JobView(object):
    ...
    def __init__(self, id=None, app_id=None, create_date_time=None, status=None, disposition=None, outputs=None, messages=None, priority=None, worker_tag=None, run_with_e2=None, _configuration=None):  # noqa: E501
