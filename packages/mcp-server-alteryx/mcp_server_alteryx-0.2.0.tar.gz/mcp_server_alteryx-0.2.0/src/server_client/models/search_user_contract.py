...
class SearchUserContract(object):
    ...
    def __init__(self, active=None, email=None, role=None, first_name=None, last_name=None, created_after=None, created_before=None, _configuration=None):  # noqa: E501
