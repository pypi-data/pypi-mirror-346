...
class DCMEUpsertConnectionContract(object):
    ...
    def __init__(self, id=None, name=None, schema_name=None, allow_in_sdks=None, parameters=None, data_source=None, credentials=None, _configuration=None):  # noqa: E501
