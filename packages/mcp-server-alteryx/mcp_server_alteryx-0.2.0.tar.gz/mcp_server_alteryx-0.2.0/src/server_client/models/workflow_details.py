...
class WorkflowDetails(object):
    ...
    def __init__(self, is_amp=None, file_name=None, author=None, copyright=None, description=None, name=None, no_output_files_message=None, output_message=None, url=None, url_text=None, _configuration=None):  # noqa: E501
