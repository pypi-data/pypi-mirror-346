...
class DCMEConnectApi(object):
    ...
    def d_cme_connect_get_dcme_connection_for_connect_with_http_info(self, connection_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('connection_id' not in params or
            ...
            raise ValueError("Missing the required parameter `connection_id` when calling `d_cme_connect_get_dcme_connection_for_connect`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/DCMEConnections/{connectionId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
