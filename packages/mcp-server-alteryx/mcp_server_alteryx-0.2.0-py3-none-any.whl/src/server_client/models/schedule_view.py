...
class ScheduleView(object):
    ...
    def run_date_time(self):
        ...
        RunDateTime will either be the next time the schedule will be run, OR  the next run time in the specified window of a search range.  UTC-0.  # noqa: E501
