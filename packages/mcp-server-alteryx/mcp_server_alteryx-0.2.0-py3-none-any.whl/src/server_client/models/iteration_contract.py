...
class IterationContract(object):
    ...
    def __init__(self, iteration_type=None, start_time=None, end_time=None, hourly_contract=None, daily_contract=None, weekly_contract=None, monthly_contract=None, custom_contract=None, _configuration=None):  # noqa: E501
    ...
    def iteration_type(self, iteration_type):
        ...
        if (self._configuration.client_side_validation and
                iteration_type not in allowed_values):
            raise ValueError(
                "Invalid value for `iteration_type` ({0}), must be one of {1}"  # noqa: E501
                .format(iteration_type, allowed_values)
            )
    ...
    def end_time(self):
        ...
        End Date Time as UTC-0  Optional, if excluded the iteration will be indefinite.   Ignored for \"Single\" IterationType  # noqa: E501
