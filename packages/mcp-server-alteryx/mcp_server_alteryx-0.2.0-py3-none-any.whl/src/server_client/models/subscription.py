...
class Subscription(object):
    ...
    def __init__(self, name=None, api_key=None, api_secret=None, active=None, expiration_date=None, exp_date=None, date_updated=None, api_enabled=None, can_share_schedules=None, credential_id=None, credentials=None, data_connections=None, id=None, _configuration=None):  # noqa: E501
