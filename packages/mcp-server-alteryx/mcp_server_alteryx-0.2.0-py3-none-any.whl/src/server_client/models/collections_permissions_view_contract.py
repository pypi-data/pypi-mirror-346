...
class CollectionsPermissionsViewContract(object):
    ...
    def __init__(self, is_admin=None, can_add_assets=None, can_remove_assets=None, can_update_assets=None, can_add_users=None, can_remove_users=None, _configuration=None):  # noqa: E501
