...
class ReducedWorkflowView(object):
    ...
    def __init__(self, id=None, source_app_id=None, name=None, owner_id=None, date_created=None, published_version_number=None, is_amp=None, execution_mode=None, _configuration=None):  # noqa: E501
