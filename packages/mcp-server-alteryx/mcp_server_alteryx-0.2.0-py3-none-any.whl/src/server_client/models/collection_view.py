...
class CollectionView(object):
    ...
    def __init__(self, id=None, name=None, owner_id=None, date_added=None, workflow_ids=None, users=None, subscription_ids=None, user_group_ids=None, schedule_ids=None, _configuration=None):  # noqa: E501
