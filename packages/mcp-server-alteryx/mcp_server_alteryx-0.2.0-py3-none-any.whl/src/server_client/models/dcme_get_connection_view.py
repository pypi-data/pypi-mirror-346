...
class DCMEGetConnectionView(object):
    ...
    def __init__(self, shared_by=None, shared_from_connection=None, connection_id=None, assigned_connection_ids=None, created_on=None, last_changed_on=None, owner=None, sharing=None, id=None, name=None, schema_name=None, allow_in_sdks=None, parameters=None, data_source=None, credentials=None, _configuration=None):  # noqa: E501
