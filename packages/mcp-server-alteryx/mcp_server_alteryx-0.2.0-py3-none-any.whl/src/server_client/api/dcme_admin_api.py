...
class DCMEAdminApi(object):
    ...
    def d_cme_admin_delete_connection_admin_with_http_info(self, object_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_cme_admin_delete_connection_admin" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('object_id' not in params or
            ...
            raise ValueError("Missing the required parameter `object_id` when calling `d_cme_admin_delete_connection_admin`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connections/{objectId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_delete_dcme_connection_handling_rule_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `d_cme_admin_delete_dcme_connection_handling_rule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connectionhandlingrules/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_get_all_connections_admin_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method d_cme_admin_get_all_connections_admin" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def d_cme_admin_get_all_dcme_connection_handling_rules_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connectionhandlingrules', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_get_connection_admin_with_http_info(self, object_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method d_cme_admin_get_connection_admin" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'object_id' is set
        if self.api_client.client_side_validation and ('object_id' not in params or
                                                       params['object_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `object_id` when calling `d_cme_admin_get_connection_admin`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connections/{objectId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_get_dcme_connection_handling_rule_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `d_cme_admin_get_dcme_connection_handling_rule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connectionhandlingrules/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_unshare_connection_for_collaboration_admin_with_http_info(self, object_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('object_id' not in params or
                                                       params['object_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `object_id` when calling `d_cme_admin_unshare_connection_for_collaboration_admin`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connections/{objectId}/sharing/collaboration', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_unshare_connection_for_execution_admin_with_http_info(self, object_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('object_id' not in params or
                                                       params['object_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `object_id` when calling `d_cme_admin_unshare_connection_for_execution_admin`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connections/{objectId}/sharing/execution', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def d_cme_admin_upsert_dcm_connection_with_http_info(self, upsert_connection_contract, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method d_cme_admin_upsert_dcm_connection" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'upsert_connection_contract' is set
        if self.api_client.client_side_validation and ('upsert_connection_contract' not in params or
                                                       params['upsert_connection_contract'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `upsert_connection_contract` when calling `d_cme_admin_upsert_dcm_connection`")  # noqa: E501
    ...
    def d_cme_admin_upsert_dcme_connection_handling_rule_with_http_info(self, rule, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rule' not in params or
            ...
            raise ValueError("Missing the required parameter `rule` when calling `d_cme_admin_upsert_dcme_connection_handling_rule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/dcm/admin/connectionhandlingrules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
