...
class WorkflowsApi(object):
    ...
    def workflows_add_version_to_workflow(self, workflow_id, file, name, owner_id, others_may_download, others_can_execute, execution_mode, make_published, workflow_credential_type, **kwargs):  # noqa: E501
        """Upload a new version of an existing workflow.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workflows_add_version_to_workflow(workflow_id, file, name, owner_id, others_may_download, others_can_execute, execution_mode, make_published, workflow_credential_type, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.workflows_add_version_to_workflow_with_http_info(workflow_id, file, name, owner_id, others_may_download, others_can_execute, execution_mode, make_published, workflow_credential_type, **kwargs)  # noqa: E501
        else:
            (data) = self.workflows_add_version_to_workflow_with_http_info(workflow_id, file, name, owner_id, others_may_download, others_can_execute, execution_mode, make_published, workflow_credential_type, **kwargs)  # noqa: E501
            return data

    def workflows_add_version_to_workflow_with_http_info(self, workflow_id, file, name, owner_id, others_may_download, others_can_execute, execution_mode, make_published, workflow_credential_type, **kwargs):  # noqa: E501
        """Upload a new version of an existing workflow.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workflows_add_version_to_workflow_with_http_info(workflow_id, file, name, owner_id, others_may_download, others_can_execute, execution_mode, make_published, workflow_credential_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['workflow_id', 'file', 'name', 'owner_id', 'others_may_download', 'others_can_execute', 'execution_mode', 'make_published', 'workflow_credential_type', 'has_private_data_exemption', 'comments', 'credential_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method workflows_add_version_to_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('workflow_id' not in params or
            ...
            raise ValueError("Missing the required parameter `workflow_id` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('owner_id' not in params or
                                                       params['owner_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner_id` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        # verify the required parameter 'others_may_download' is set
        if self.api_client.client_side_validation and ('others_may_download' not in params or
                                                       params['others_may_download'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `others_may_download` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        # verify the required parameter 'others_can_execute' is set
        if self.api_client.client_side_validation and ('others_can_execute' not in params or
                                                       params['others_can_execute'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `others_can_execute` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        # verify the required parameter 'execution_mode' is set
        if self.api_client.client_side_validation and ('execution_mode' not in params or
                                                       params['execution_mode'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `execution_mode` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        # verify the required parameter 'make_published' is set
        if self.api_client.client_side_validation and ('make_published' not in params or
                                                       params['make_published'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `make_published` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        # verify the required parameter 'workflow_credential_type' is set
        if self.api_client.client_side_validation and ('workflow_credential_type' not in params or
                                                       params['workflow_credential_type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workflow_credential_type` when calling `workflows_add_version_to_workflow`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}/versions', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_create_workflow(self, file, name, owner_id, is_public, is_ready_for_migration, others_may_download, others_can_execute, execution_mode, workflow_credential_type, **kwargs):  # noqa: E501
        """Upload a new workflow package.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workflows_create_workflow(file, name, owner_id, is_public, is_ready_for_migration, others_may_download, others_can_execute, execution_mode, workflow_credential_type, async_req=True)
        >>> result = thread.get()
        ...
        :param str comments:
        :param str source_app_id:  Sets the source app id of a workflow. Can be used as the 'sourceId' reference for the POST admin/v1/workflows API endpoint. Providing an pre existing sourceAppId will result in an invalid request.
        :param bool has_private_data_exemption:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.workflows_create_workflow_with_http_info(file, name, owner_id, is_public, is_ready_for_migration, others_may_download, others_can_execute, execution_mode, workflow_credential_type, **kwargs)  # noqa: E501
        else:
            (data) = self.workflows_create_workflow_with_http_info(file, name, owner_id, is_public, is_ready_for_migration, others_may_download, others_can_execute, execution_mode, workflow_credential_type, **kwargs)  # noqa: E501
            return data

    def workflows_create_workflow_with_http_info(self, file, name, owner_id, is_public, is_ready_for_migration, others_may_download, others_can_execute, execution_mode, workflow_credential_type, **kwargs):  # noqa: E501
        """Upload a new workflow package.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workflows_create_workflow_with_http_info(file, name, owner_id, is_public, is_ready_for_migration, others_may_download, others_can_execute, execution_mode, workflow_credential_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['file', 'name', 'owner_id', 'is_public', 'is_ready_for_migration', 'others_may_download', 'others_can_execute', 'execution_mode', 'workflow_credential_type', 'worker_tag', 'district_tags', 'comments', 'source_app_id', 'has_private_data_exemption', 'credential_id', 'collection_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_create_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'file' is set
        ...
        if self.api_client.client_side_validation and ('is_public' not in params or
                                                       params['is_public'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('is_ready_for_migration' not in params or
                                                       params['is_ready_for_migration'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `is_ready_for_migration` when calling `workflows_create_workflow`")  # noqa: E501
        # verify the required parameter 'others_may_download' is set
        if self.api_client.client_side_validation and ('others_may_download' not in params or
                                                       params['others_may_download'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `others_may_download` when calling `workflows_create_workflow`")  # noqa: E501
        # verify the required parameter 'others_can_execute' is set
        if self.api_client.client_side_validation and ('others_can_execute' not in params or
                                                       params['others_can_execute'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `others_can_execute` when calling `workflows_create_workflow`")  # noqa: E501
        # verify the required parameter 'execution_mode' is set
        if self.api_client.client_side_validation and ('execution_mode' not in params or
                                                       params['execution_mode'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workflow_credential_type' not in params or
                                                       params['workflow_credential_type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workflow_credential_type` when calling `workflows_create_workflow`")  # noqa: E501
    ...
    def workflows_delete_workflow(self, workflow_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str workflow_id: Identifier for an existing workflow or app (required)
        :param bool force: If the workflow is scheduled, setting force to True will delete all impacted schedules before deleting the workflow.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def workflows_delete_workflow_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_delete_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_download_workflow(self, workflow_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str workflow_id: Identifier for an existing workflow or app (required)
        :param str version_id: A specific version number of the workflow. If no version is provided, the published version will be downloaded.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def workflows_download_workflow_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_download_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}/package', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_enqueue_with_http_info(self, workflow_id, contract, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_enqueue" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        ...
        if self.api_client.client_side_validation and ('contract' not in params or
                                                       params['contract'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}/jobs', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_get_jobs_for_workflow(self, workflow_id, **kwargs):  # noqa: E501
        ...
        A Job may be returned as Completed even if the query status is Error. This would indicate an error occurred during  execution, but the workflow was run.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str result_code: The result code of the execution of a workflow. This can indicate a failed workflow, but a successful job.
    ...
    def workflows_get_jobs_for_workflow_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_get_jobs_for_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        if self.api_client.client_side_validation and ('workflow_id' not in params or
                                                       params['workflow_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workflow_id` when calling `workflows_get_jobs_for_workflow`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}/jobs', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_get_workflow_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_get_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
    ...
    def workflows_get_workflow_questions_with_http_info(self, workflow_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_get_workflow_questions" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        if self.api_client.client_side_validation and ('workflow_id' not in params or
                                                       params['workflow_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workflow_id` when calling `workflows_get_workflow_questions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}/questions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_get_workflows_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_get_workflows" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def workflows_transfer_workflow(self, workflow_id, contract, **kwargs):  # noqa: E501
        ...
        If any of the workflows require DCM connections, server connections, or specific run as credentials to run, these items will need to be updated before the workflow can run.   Additionally, if users are not in the same studio, when a workflow is transferred to the new studio, all other users in the new owner's studio will also receive access to the workflow,   and all users from the old studio will lose access  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def workflows_transfer_workflow_with_http_info(self, workflow_id, contract, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_transfer_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        ...
        return self.api_client.call_api(
            '/v3/workflows/{workflowId}/transfer', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def workflows_update_workflow(self, workflow_id, update_workflow_contract, **kwargs):  # noqa: E501
        ...
        Only Curators can use this API endpoint.   To change the ownerId, the new owner must be in the same subscription as the current owner.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def workflows_update_workflow_with_http_info(self, workflow_id, update_workflow_contract, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflows_update_workflow" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'workflow_id' is set
        ...
        if self.api_client.client_side_validation and ('update_workflow_contract' not in params or
                                                       params['update_workflow_contract'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `update_workflow_contract` when calling `workflows_update_workflow`")  # noqa: E501
