...
def train_segformer_semantic_segmentation_model(
    ...
    train_dataset = create_segformer_segmentation_dataset(
        train_data.copy(), transforms=train_transforms
    )
    ...
    val_dataset = create_segformer_segmentation_dataset(
        (
            ...
            else val_data.sample(
                n=max_val_size, random_state=random_state
            ).copy()
        ),
    ...
    dataset = create_segformer_segmentation_dataset(
        train_data.copy(), transforms=val_transforms
    )
    ...
    dataset = create_segformer_segmentation_dataset(
        val_data.copy(), transforms=val_transforms
    )
    ...
    if test_data is not None:
        ...
        dataset = create_segformer_segmentation_dataset(
            test_data.copy(), transforms=val_transforms
        )
