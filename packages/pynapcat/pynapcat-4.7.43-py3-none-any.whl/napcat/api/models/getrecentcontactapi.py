...
type MessageComponentUnion = TextMessage | AtMessage | FaceMessage | ImageMessage | FileMessage | ReplyMessage | JsonMessage | VoiceMessage | VideoMessage | MarkdownMessage | ForwardMessage # Now defined
...
class GetRecentContactRes(BaseModel):
    ...
    status: Literal["ok"] = Field("ok", description="状态码，固定为 'ok'") # Modified based on rule 2
