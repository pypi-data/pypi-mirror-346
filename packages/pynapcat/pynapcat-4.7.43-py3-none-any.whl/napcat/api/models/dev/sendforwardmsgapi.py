...
class SendForwardMsgReq(BaseModel):
    ...
    MessageComponent = TextMessage | FaceMessage | ImageMessage | ReplyMessage | JsonMessage | VideoMessage | FileMessage | MarkdownMessage | ForwardWrapper | SecondLevelForwardMessage
