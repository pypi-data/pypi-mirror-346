...
from typing import Literal # Keep Literal as it's not deprecated for this use case
...
# region res
class GetVersionInfoResData(BaseModel):
    """
    响应模型嵌套数据：版本信息详情
    """
...
class GetVersionInfoRes(BaseModel):
    ...
    data: GetVersionInfoResData = Field(..., description="版本信息详情")
