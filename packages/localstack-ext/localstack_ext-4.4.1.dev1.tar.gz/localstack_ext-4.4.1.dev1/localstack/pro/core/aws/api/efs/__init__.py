...
class ReplicationOverwriteProtection(StrEnum):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"
...
class TransitionToArchiveRules(StrEnum):
...
class TransitionToIARules(StrEnum):
    AFTER_7_DAYS = "AFTER_7_DAYS"
    AFTER_14_DAYS = "AFTER_14_DAYS"
    AFTER_30_DAYS = "AFTER_30_DAYS"
    AFTER_60_DAYS = "AFTER_60_DAYS"
...
class TransitionToPrimaryStorageClassRules(StrEnum):
...
class DestinationToCreate(TypedDict, total=False):
    ...
    -  If you want to replicate to a new file system, do not specify the
       ...
       EFS file
       system <https://docs.aws.amazon.com/efs/latest/ug/create-replication.html>`__
       in the *Amazon EFS User Guide*.

       After the file system is created, you cannot change the KMS key or
    ...
    -  If you want to replicate to an existing file system that's in the
       ...
       replicate. The file system's replication overwrite protection must be
       disabled. For more information, see `Replicating to an existing file
    ...
    -  If you are replicating the file system to a file system that's in a
       ...
       accounts <https://docs.aws.amazon.com/efs/latest/ug/cross-account-replication.html>`__
       in the *Amazon EFS User Guide*.
    """
...
class EfsApi:
    ...
    def create_file_system(
        ...
        **kwargs,
        ...
        ``PerformanceMode`` for all file systems. The ``maxIO`` mode is a
        ...
        ``generalPurpose`` mode. ``MaxIO`` mode is not supported for One Zone
    ...
    def create_replication_configuration(
        ...
        **kwargs,
        ...
        -  **Destination file system** – The destination file system to which
           ...
           on whether you are replicating to a new file system or to an existing
           file system, and if you are replicating across Amazon Web Services
           accounts. See DestinationToCreate for more information.
        ...
        permissions for
        replication <https://docs.aws.amazon.com/efs/latest/ug/efs-replication.html#efs-replication-permissions>`__
        in the *Amazon EFS User Guide*.
