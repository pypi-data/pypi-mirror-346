...
class FileSymlinksUtility:
    def __init__(self,
        ...
        """
        - gd_root: Google Drive 側 root パス
        - sd_root: SD WebUI 側 root パス
        - extra_file_pairs: 追加/上書きするファイルペア {sd_rel: gd_rel, …}
        """
...
class FolderSymlinksUtility:
    def __init__(self,
        ...
        - gd_root: Google Drive 側 root パス
        - sd_root: SD WebUI 側 root パス
        - extra_folder_pairs: 追加/上書きするフォルダペア {sd_rel: gd_rel, …}
        """
        self.gd_root     = Path(gd_root)
        self.sd_root     = Path(sd_root)
