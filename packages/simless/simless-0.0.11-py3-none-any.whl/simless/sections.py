...
class Section:
    ...
    Additionally, the `Meta` class within the `Section` defines the group to which the section belongs.
    This allows for organizing sections into logical groups for simulation purposes.
    """
...
class ParamSweepSection(ConfigSection):
    ...
    class Meta:
        group = SectionGroup.PARAM_SWEEP
