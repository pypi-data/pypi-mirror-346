...
class Configurations:
    ...
    def _get_section_groups(self, sections):
        ...
        for section in sections:
            if section.Meta.group == self.SECTION_GROUP_OBJ.GROUP_FREE:
                group_free.append(section)
            else:
                if section.Meta.group not in groups:
                    groups[section.Meta.group] = []
                groups[section.Meta.group].append(section)
