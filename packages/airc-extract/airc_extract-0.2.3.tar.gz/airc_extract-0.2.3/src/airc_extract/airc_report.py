...
class AIRCReport:
    ...
    def validate_identifiers(self) -> None:
        ...
        self.report_data["age"] = int(ref.PatientAge[:-1]) if ref.PatientAge != '' else None
        self.report_data["study_description"] = ref.StudyDescription
    ...
    def _create_main_dict(self) -> None:
        ...
        self.report_data["main"] = {
            ...
            "study_descriptions": self.report_data.get("study_description"),
            "sex": self.report_data.get("sex"),
            "age": self.report_data.get("age"),
