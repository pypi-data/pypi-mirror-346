...
class TestPaymentGatewayApi:
    ...
    def test_cancel_order_success(self, api_instance: PaymentGatewayApi, create_order_by_api_request: CreateOrderByApiRequest, cancel_order_request: CancelOrderRequest):
        ...
        api_response_cancel = api_instance.cancel_order(cancel_order_request)
        
        # Assert successful cancellation
        assert api_response_cancel.response_code == '2005700'
        assert api_response_cancel.response_message == 'Successful'
