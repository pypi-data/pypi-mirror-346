...
class PaymentGatewayApi:
    ...
    def create_order(
        self,
        create_order_request: Union[CreateOrderByApiRequest, CreateOrderByRedirectRequest], # Was CreateOrderRequest
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type create_order_request: Union[CreateOrderByApiRequest, CreateOrderByRedirectRequest] # Was CreateOrderRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
