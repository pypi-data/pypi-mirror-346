...
from rara_subject_indexer.config import (
    ...
    SUPPORTED_LANGUAGES, POSTAGS_TO_IGNORE,
...
class RaraSubjectIndexer:
    ...
    def _set_threshold_config(self, 
            threshold_config: dict = {}, default_min_score: float = None, 
