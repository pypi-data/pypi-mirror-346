...
class DailyFileWatcher:
    ...
    def __init__(self, *fps, report_server='cchendailycheckin', check_time=':50', report_hour=23):
        """
        Initialize the DailyFileWatcher.

        Args:
            *fps: Variable number of file paths to be monitored.
            report_server (str): Notification topic for sending alerts/reports.
    ...
    def check_growth(self, fp):
        ...
        if this_count <= last_count:
            notify(self.report_server, 'Interrupted!',
