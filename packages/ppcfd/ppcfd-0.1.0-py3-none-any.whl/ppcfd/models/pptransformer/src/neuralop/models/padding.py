...
class DomainPadding(nn.Layer):
    ...
    def pad(self, x):
        ...
        try:
            ...
            return F.pad(x, padding, mode="constant", data_format="NCDHW")
            ...
            output_pad = [
                int(round(i * j))
                for (i, j) in zip(self.output_scaling_factor, output_pad)
            ]
            ...
            padded = F.pad(x, padding, mode="constant", data_format="NCDHW")
