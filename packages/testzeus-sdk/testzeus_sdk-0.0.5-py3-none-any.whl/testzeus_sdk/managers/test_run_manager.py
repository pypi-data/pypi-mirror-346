...
class TestRunManager(BaseManager[TestRun]):
    ...
    async def create_and_start(self, name: str, test: str, modified_by: Optional[str] = None) -> TestRun:
        """
    ...
    async def cancel(self, id_or_name: str, modified_by: Optional[str] = None) -> TestRun:
        """
        Cancel a test run.
    ...
    async def cancel_with_email(self, id_or_name: str, user_email: str) -> TestRun:
        """
    ...
    async def create_and_start_with_email(self, name: str, test: str, user_email: str) -> TestRun:
        """
        ...
        return await self.create_and_start(name, test, modified_by=str(user.id))
