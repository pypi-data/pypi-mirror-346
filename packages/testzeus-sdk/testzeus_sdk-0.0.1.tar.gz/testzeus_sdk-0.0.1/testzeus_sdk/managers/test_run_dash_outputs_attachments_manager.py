...
import httpx
import logging
from testzeus_sdk.models.test_run_dash_outputs_attachments import TestRunDashOutputsAttachments
...
class TestRunDashOutputsAttachmentsManager(BaseManager):
    ...
    async def download_attachment(self, id_or_name: str, output_dir: str = ".") -> Optional[Path]:
        """
