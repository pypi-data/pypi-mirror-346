...
def _change(variables, targets: List[str], file):
    ...
    \b
    Example: fct change 'NODE_WEATHER_DEBUG=0=*' 4D163 4D164
    Example with fleets: fct change 'NODE_WEATHER_DEBUG=0=*' Staging4_x Test4_x 4D164
...
def _schedule_change(file, date, date_format, tz, variables, targets):
    """
    ...
    \b
    Example: fct schedule change --date '2025-02-25 12:06:00' 'WEATHER_NODE_DEBUG=0=main' 4B058 4D163
...
@click.argument("targets", nargs=-1, required=False)
def _schedule_update(file, date, date_format, tz, targets, fleet, release):
    """
    ...
    \b
    Example: fct schedule update Autonomy_Staging4_x 1.3.19+rev43 4B058 4D163
    Example: fct schedule update --date '2025-02-25 12:06:00' Autonomy_Staging4_x 1.3.19+rev43 4B058
