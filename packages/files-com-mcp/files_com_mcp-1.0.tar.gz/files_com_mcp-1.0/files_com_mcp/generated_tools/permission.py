...
async def list_permission(context: Context, path: str | None = None, group_id: str | None = None, user_id: str | None = None) -> str:
    """List Permissions
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["path", "group_id", "user_id", "permission", "id"])
...
async def create_permission(context: Context, path: str | None = None, group_id: int | None = None, permission: str | None = None, user_id: int | None = None) -> str:
    """Create Permission
...
def register_tools(mcp):
    @mcp.tool()
    async def list_permission_tool(context: Context, path: str | None = None, group_id: str | None = None, user_id: str | None = None) -> str:
        return await list_permission(context, path, group_id, user_id)

    @mcp.tool()
    async def create_permission_tool(context: Context, path: str | None = None, group_id: int | None = None, permission: str | None = None, user_id: int | None = None) -> str:
        return await create_permission(context, path, group_id, permission, user_id)

    @mcp.tool()
    async def delete_permission_tool(context: Context, id: int | None = None) -> str:
