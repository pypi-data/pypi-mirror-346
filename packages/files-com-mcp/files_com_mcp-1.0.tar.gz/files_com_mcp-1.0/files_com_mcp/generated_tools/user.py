...
async def list_user(context: Context) -> str:
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["id", "username", "email", "group_ids", "password", "authentication_method", "name", "company", "notes", "require_password_change", "user_root", "user_home"])
...
async def create_user(context: Context, username: str | None = None, email: str | None = None, group_ids: str | None = None, password: str | None = None, authentication_method: str | None = None, name: str | None = None, company: str | None = None, notes: str | None = None, require_password_change: bool | None = None, user_root: str | None = None, user_home: str | None = None) -> str:
    """Create User
...
async def update_user(context: Context, id: int | None = None, email: str | None = None, group_ids: str | None = None, password: str | None = None, authentication_method: str | None = None, name: str | None = None, company: str | None = None, notes: str | None = None, require_password_change: bool | None = None, user_root: str | None = None, user_home: str | None = None, username: str | None = None) -> str:
    """Update User
...
def register_tools(mcp):
    ...
    @mcp.tool()
    async def create_user_tool(context: Context, username: str | None = None, email: str | None = None, group_ids: str | None = None, password: str | None = None, authentication_method: str | None = None, name: str | None = None, company: str | None = None, notes: str | None = None, require_password_change: bool | None = None, user_root: str | None = None, user_home: str | None = None) -> str:
        return await create_user(context, username, email, group_ids, password, authentication_method, name, company, notes, require_password_change, user_root, user_home)

    @mcp.tool()
    async def update_user_tool(context: Context, id: int | None = None, email: str | None = None, group_ids: str | None = None, password: str | None = None, authentication_method: str | None = None, name: str | None = None, company: str | None = None, notes: str | None = None, require_password_change: bool | None = None, user_root: str | None = None, user_home: str | None = None, username: str | None = None) -> str:
        return await update_user(context, id, email, group_ids, password, authentication_method, name, company, notes, require_password_change, user_root, user_home, username)
