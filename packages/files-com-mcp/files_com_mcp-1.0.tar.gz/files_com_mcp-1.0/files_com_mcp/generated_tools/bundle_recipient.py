...
async def list_bundle_recipient(context: Context, bundle_id: int | None = None) -> str:
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["bundle_id", "recipient", "name", "company", "note"])
...
async def create_bundle_recipient(context: Context, bundle_id: int | None = None, recipient: str | None = None, name: str | None = None, company: str | None = None, note: str | None = None) -> str:
...
def register_tools(mcp):
    @mcp.tool()
    async def list_bundle_recipient_tool(context: Context, bundle_id: int | None = None) -> str:
        return await list_bundle_recipient(context, bundle_id)

    @mcp.tool()
    async def create_bundle_recipient_tool(context: Context, bundle_id: int | None = None, recipient: str | None = None, name: str | None = None, company: str | None = None, note: str | None = None) -> str:
        return await create_bundle_recipient(context, bundle_id, recipient, name, company, note)
