...
async def delete_file(context: Context, path: str | None = None) -> str:
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["path", "destination"])
...
async def copy_file(context: Context, path: str | None = None, destination: str | None = None) -> str:
    """Copy File/Folder
...
async def move_file(context: Context, path: str | None = None, destination: str | None = None) -> str:
    """Move File/Folder
...
def register_tools(mcp):
    @mcp.tool()
    async def delete_file_tool(context: Context, path: str | None = None) -> str:
    ...
    @mcp.tool()
    async def copy_file_tool(context: Context, path: str | None = None, destination: str | None = None) -> str:
        return await copy_file(context, path, destination)

    @mcp.tool()
    async def move_file_tool(context: Context, path: str | None = None, destination: str | None = None) -> str:
