...
async def list_bundle_notification(context: Context) -> str:
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["id", "bundle_id", "user_id", "notify_on_registration", "notify_on_upload"])
...
async def find_bundle_notification(context: Context, id: int | None = None) -> str:
...
async def create_bundle_notification(context: Context, bundle_id: int | None = None, user_id: int | None = None) -> str:
...
async def update_bundle_notification(context: Context, id: int | None = None, notify_on_registration: bool | None = None, notify_on_upload: bool | None = None) -> str:
...
async def delete_bundle_notification(context: Context, id: int | None = None) -> str:
...
def register_tools(mcp):
    ...
    @mcp.tool()
    async def find_bundle_notification_tool(context: Context, id: int | None = None) -> str:
        return await find_bundle_notification(context, id)

    @mcp.tool()
    async def create_bundle_notification_tool(context: Context, bundle_id: int | None = None, user_id: int | None = None) -> str:
        return await create_bundle_notification(context, bundle_id, user_id)

    @mcp.tool()
    async def update_bundle_notification_tool(context: Context, id: int | None = None, notify_on_registration: bool | None = None, notify_on_upload: bool | None = None) -> str:
        return await update_bundle_notification(context, id, notify_on_registration, notify_on_upload)

    @mcp.tool()
    async def delete_bundle_notification_tool(context: Context, id: int | None = None) -> str:
