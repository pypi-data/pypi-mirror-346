...
async def list_group(context: Context) -> str:
    ...
    try:
        ...
        markdown_list = object_list_to_markdown_table(retval, ["id", "name", "notes", "user_ids", "admin_ids"])
...
async def create_group(context: Context, name: str | None = None, notes: str | None = None, user_ids: str | None = None, admin_ids: str | None = None) -> str:
    """Create Group
...
async def update_group(context: Context, id: int | None = None, notes: str | None = None, user_ids: str | None = None, admin_ids: str | None = None, name: str | None = None) -> str:
    """Update Group
...
def register_tools(mcp):
    ...
    @mcp.tool()
    async def create_group_tool(context: Context, name: str | None = None, notes: str | None = None, user_ids: str | None = None, admin_ids: str | None = None) -> str:
        return await create_group(context, name, notes, user_ids, admin_ids)

    @mcp.tool()
    async def update_group_tool(context: Context, id: int | None = None, notes: str | None = None, user_ids: str | None = None, admin_ids: str | None = None, name: str | None = None) -> str:
        return await update_group(context, id, notes, user_ids, admin_ids, name)

    @mcp.tool()
    async def delete_group_tool(context: Context, id: int | None = None) -> str:
