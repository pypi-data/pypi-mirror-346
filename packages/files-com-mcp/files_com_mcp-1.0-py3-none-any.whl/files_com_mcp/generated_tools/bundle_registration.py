...
async def list_bundle_registration(context: Context, bundle_id: int | None = None) -> str:
...
def register_tools(mcp):
    @mcp.tool()
    async def list_bundle_registration_tool(context: Context, bundle_id: int | None = None) -> str:
