...
ax = axes.flat
writhe.plot_writhe_matrix(index=None, label_stride=8, ax=ax[0])  #xticks=residues, yticks=residues, to match example
...
```jupyterpython
writhe.plot_writhe_matrix(index=None, absolute=False, xlabel=None, ylabel=None, xticks=None, yticks=None,
                          label_stride=5, dscr=None, font_scale=1, ax=None)
