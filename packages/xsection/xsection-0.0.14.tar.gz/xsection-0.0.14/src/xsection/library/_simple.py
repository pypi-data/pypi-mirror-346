...
class Circle(_SimpleShape):
    ...
    def __init__(self, radius, 
        ...
        pradius = s/(2*np.sin(np.pi/divisions))

        mesh_size = pradius*self.mesh_scale

        exterior = np.array([
            [pradius*np.cos(theta), pradius*np.sin(theta)]
...
class HollowRectangle(_SimpleShape):
    ...
    def __init__(self, b, d, t=None, centroid=None, **kwds):
        self.b = b
        self.d = d
...
class Channel(_SimpleShape):
    ...
    def __init__(self, d, b, tf, tw=None, centroid=None, mesh_scale=1/4, **kwds):
        ...
        super().__init__(exterior=exterior, interior=None, 
