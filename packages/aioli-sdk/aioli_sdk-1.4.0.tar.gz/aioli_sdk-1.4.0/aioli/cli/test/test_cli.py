...
class TestCli:
    ...
    def test_registry_create(self, setup_login: None) -> None:
        ...
        expected = (
            "default   | bento-registry | s3     | minioadmin   | demo-bento-registry | "
            "**********   | http://10.30.89.14:30008/"
        )
        actual = subprocess.check_output(["aioli", "registry", "list"]).decode("utf-8")
        assert (actual.find(expected)) > 0
    ...
    def test_model_list(self, setup_login: None) -> None:
        ...
        expected = "default   | my-model | the model description |         2 |       | fictional.re"
        ...
        # all models
        expected = "default   | my-model | the model description |         2 |       | fictional.re"
        "gistry.example/imagename |                    |\n default   | my-model | the model descrip"
    ...
    def test_model_create(self, setup_login: None) -> None:
        ...
        expected = (
            " default   | iris-tf-keras | the model description |         1 | "
            "s3://demo-bento-registry/iris-tf-keras | "
            "fictional.registry.example/imagename | default            | bento-registry1"
        )
        actual = subprocess.check_output(["aioli", "model", "list"]).decode("utf-8")
        assert (actual.find(expected)) > 0
    ...
    def test_model_create_no_image(self, setup_login: None) -> None:
        ...
        expected = (
            " default   | openllm       | the model description |         1 | "
            "s3://demo-bento-registry/iris-tf-keras |"
            "                                      | default            | bento-registry1"
        )
        actual = subprocess.check_output(["aioli", "model", "list"]).decode("utf-8")
    ...
    def test_model_update(self, setup_login: None) -> None:
        ...
        expected = (
            " default   | iris-tf-keras1 | the updated model description |         1 "
            "| s3://demo-bento-registry/iris-tf-keras_updated | "
            "fictional.registry.example/updated_imagename | default            | bento-registry1"
        )
        assert (actual.find(expected)) > 0
        ...
        actual = subprocess.check_output(["aioli", "model", "list", "--all"]).decode("utf-8")
        expected = (
            " default   | iris-tf-keras  | the updated model description |         2 "
        ...
        expected = "default   | iris-tf-keras  | the updated model description |         3 | s3://d"
        "emo-bento-registry/iris-tf-keras_updated_v3 | fictional.registry.example/updated_imagename"
        " | default            | bento-registry1\n default   | iris-tf-keras  | the updated model d"
        "escription |         2 | s3://demo-bento-registry/iris-tf-keras_updated_v2 | fictional.reg"
        "istry.example/updated_imagename | default            | bento-registry1"
        assert (actual.find(expected)) > 0
        ...
        expected = (
            " default   | iris-tf-keras-v4 | the updated model description |         1 "
    ...
    def test_deployment_create(self, setup_login: None) -> None:
        ...
        expected = " default   | iris-tf-keras-deployment | default         | iris-tf-keras |      "
