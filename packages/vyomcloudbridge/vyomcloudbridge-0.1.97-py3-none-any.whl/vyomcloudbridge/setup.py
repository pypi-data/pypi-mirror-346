...
def setup_ros2_workspaces():
    ...
    if (not ament_prefix_path or not python_path) and not os.path.exists(ros2_env_file):
        print(
        ...
        return False
    # else here either we have both varibale or the file saved already
    ...
    try:
        if ament_prefix_path and python_path:  # we have both varibale
