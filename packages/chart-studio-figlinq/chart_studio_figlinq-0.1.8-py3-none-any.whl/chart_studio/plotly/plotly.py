...
from chart_studio.utils import validate_fid
...
def plot(figure_or_data, validate=True, **plot_options):
    ...
    # Return URL
    if plot_options.get("return_type", "url") == "file":
        return file_info
    elif plot_options.get("return_type", "url") == "fid":
...
def get_grid(url_or_fid, raw=False):
    ...
    if validate_fid(url_or_fid):
        ...
        fid = parse_grid_id_args(None, url_or_fid)
