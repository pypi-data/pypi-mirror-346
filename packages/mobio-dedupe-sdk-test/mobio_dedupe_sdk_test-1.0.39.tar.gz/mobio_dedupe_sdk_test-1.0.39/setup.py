...
class Requirements(object):
    ...
    def get():
        ...
        requirements = ['m-singleton', 'asv', 'black', 'coverage[toml]', 'coveralls', 'flake8', 'mock', 'mypy',
                        ...
                        'dedupe-Levenshtein-search==1.4.5', 'flake8==5.0.4', 'future==0.18.3', 'haversine==2.8.0',
    ...
    def get_link():
        ...
        """
        requirements = [
            'git+https://github.com/fzimmermann89/pylbfgs.git@fzimmermann89-cython',
            'git+https://github.com/yudelevi/doublemetaphone.git@af0ffc9195c0e3d6bac7afc1a898e85ee938afb4'
        ]
        return requirements


version_dev='1.0.39'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.39',  # Required, Phần này cũng không được format file.
