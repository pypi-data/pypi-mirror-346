...
from ..models.result_get_catalog import GetDataCatalogResponse # 追加
from ..models.result import GetStatsDataResponse # 追加
...
class EstatsAPIClient:
    ...
    def get_stats_list(
        ...
        return GetDataCatalogResponse(**response_json) # Pydanticモデルを返す
    ...
    def get_stats_data(
        ...
        lang: Language = Language.JAPANESE,
        data_format: DataFormat = DataFormat.JSON,
    ) -> GetStatsDataResponse: # 戻り値を変更
        endpoint = "getStatsData"
        params_dict = params.model_dump(exclude_none=True)
        params_dict["lang"] = lang.value
        params_dict["dataFormat"] = data_format.value
        response_json = self._make_request(endpoint, params_dict)
        return GetStatsDataResponse(**response_json) # Pydanticモデルを返す
