...
class RequestInfo(UniversalBaseModel):
    ...
    event_type: typing.Optional[typing.List[EventType]] = pydantic.Field(alias="eventType", default=None)
    ...
    response_body_encoded: typing.Optional[str] = pydantic.Field(alias="responseBodyEncoded", default=None)
