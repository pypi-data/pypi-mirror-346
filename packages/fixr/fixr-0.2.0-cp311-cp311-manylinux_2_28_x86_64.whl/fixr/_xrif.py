...
# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-I/usr/bin/../lib/clang/18/include', '-I/usr/local/include', '-I/usr/include']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
...
_libraries = {}
_libraries['libxrif.so'] = ctypes.CDLL('../../xrif/build/src/libxrif.so')
...
xrif_reorder_bitpack = _libraries['libxrif.so'].xrif_reorder_bitpack
...
xrif_difference_method_string = _libraries['libxrif.so'].xrif_difference_method_string
xrif_difference_method_string.restype = ctypes.POINTER(ctypes.c_char)
xrif_difference_method_string.argtypes = [ctypes.c_int32]
xrif_reorder_method_string = _libraries['libxrif.so'].xrif_reorder_method_string
xrif_reorder_method_string.restype = ctypes.POINTER(ctypes.c_char)
xrif_reorder_method_string.argtypes = [ctypes.c_int32]
xrif_compress_method_string = _libraries['libxrif.so'].xrif_compress_method_string
