"""
Integration tests for urllib3 enhanced features.
...
import urllib3
from urllib3.http2 import ConnectionProfile, FlowControlStrategy, HTTP2Settings
from urllib3.util.cert_verification import CertificateTransparencyPolicy, SPKIPinningVerifier
from urllib3.util.hsts import HSTSCache, HSTSHandler, HSTSPolicy
from urllib3.websocket import WebSocketConnection, WebSocketMessage


class TestEnhancedFeaturesIntegration(unittest.TestCase):
    """Test integration of enhanced urllib3 features."""
    ...
    def setUp(self):
        ...
        self.ct_verifier = urllib3.util.cert_verification.CertificateTransparencyVerifier(
    ...
    def test_websocket_with_security_features(self):
        ...
        with mock.patch('urllib3.websocket.WebSocketConnection') as mock_ws_class:
            ...
            urllib3.websocket_connect(secured_url)
    ...
    def test_http2_websocket_upgrade(self):
        ...
        try:
            ...
            with mock.patch.object(http, 'request') as mock_request:
                ...
                with mock.patch('urllib3.websocket.connection.WebSocketConnection._send_frame'):
                    with mock.patch('urllib3.websocket.connection.WebSocketConnection._start_receiver'):
