...
class UpdateManagerState(betterproto.Message):
    ...
    is_update_service_active: "bool | None" = betterproto.bool_field(6, optional=True)
...
class Action(betterproto.Message):
    ...
    users_action: "UsersAction" = betterproto.message_field(137, group="action")
    ...
    vs_code_action: "VsCodeAction" = betterproto.message_field(142, group="action")
    ...
    wi_fi_action: "WiFiAction" = betterproto.message_field(147, group="action")
