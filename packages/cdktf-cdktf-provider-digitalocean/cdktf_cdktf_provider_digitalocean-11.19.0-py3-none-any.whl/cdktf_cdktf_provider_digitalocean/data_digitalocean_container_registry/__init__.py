...
class DataDigitaloceanContainerRegistry(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: name of the container registry. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.53.0/docs/data-sources/container_registry#name DataDigitaloceanContainerRegistry#name}
