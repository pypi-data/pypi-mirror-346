...
class Config(metaclass=SingletonMeta):
    ...
    def __init__(self, project_path):
        ...
        self.open_ai_key = os.getenv("openai_key", default="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")
        self.db_name = os.getenv("db_name", default="db_name")
        self.db_uri = os.getenv("db_uri", default="mongodb://admin:7c8ef10155504bffb8df21044034a79a@5.189.146.119:27017")
