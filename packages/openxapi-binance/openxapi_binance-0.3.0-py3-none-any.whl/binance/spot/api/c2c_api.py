...
class C2cApi:
    ...
    @validate_call
    def get_c2c_order_match_list_user_order_history_v1(
        self,
        timestamp: StrictInt,
        ...
        _param = self._get_c2c_order_match_list_user_order_history_v1_serialize(
            timestamp=timestamp,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetC2cOrderMatchListUserOrderHistoryV1Resp",
            '4XX': "APIError",
            '5XX': "APIError",
        }
    ...
    @validate_call
    def get_c2c_order_match_list_user_order_history_v1_with_http_info(
        self,
        timestamp: StrictInt,
        start_time: Optional[StrictInt] = None,
        end_time: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetC2cOrderMatchListUserOrderHistoryV1Resp]:
        """Get C2C Trade History (USER_DATA)
    ...
    @validate_call
    def get_c2c_order_match_list_user_order_history_v1_without_preload_content(
        self,
        timestamp: StrictInt,
        start_time: Optional[StrictInt] = None,
        end_time: Optional[StrictInt] = None,
    ...
    def _get_c2c_order_match_list_user_order_history_v1_serialize(
        self,
        timestamp,
        start_time,
        end_time,
