...
class GetMiningWorkerDetailV1RespDataInnerHashrateDatasInner(BaseModel):
    """
    GetMiningWorkerDetailV1RespDataInnerHashrateDatasInner
    """ # noqa: E501
    hashrate: Optional[StrictStr] = None
    reject: Optional[StrictInt] = None
    time: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["hashrate", "reject", "time"]
