...
class GetSolStakingSolHistoryRedemptionHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "arrivalTime", "asset", "distributeAmount", "distributeAsset", "exchangeRate", "status", "time"]
