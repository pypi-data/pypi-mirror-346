...
class GetSolStakingSolQuotaV1Resp(BaseModel):
    """
    ...
    left_redemption_personal_quota: Optional[StrictStr] = Field(default=None, alias="leftRedemptionPersonalQuota")
    left_staking_personal_quota: Optional[StrictStr] = Field(default=None, alias="leftStakingPersonalQuota")
    min_redeem_amount: Optional[StrictStr] = Field(default=None, alias="minRedeemAmount")
    ...
    __properties: ClassVar[List[str]] = ["calculating", "commissionFee", "leftRedemptionPersonalQuota", "leftStakingPersonalQuota", "minRedeemAmount", "minStakeAmount", "nextEpochTime", "redeemPeriod", "redeemable", "soldOut", "stakeable"]
