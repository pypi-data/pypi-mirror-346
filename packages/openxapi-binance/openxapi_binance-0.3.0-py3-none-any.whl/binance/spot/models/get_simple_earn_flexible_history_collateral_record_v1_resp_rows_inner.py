...
class GetSimpleEarnFlexibleHistoryCollateralRecordV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "createTime", "orderId", "productId", "productName", "type"]
