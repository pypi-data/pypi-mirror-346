...
class GetSimpleEarnLockedHistoryRewardsRecordV1Resp(BaseModel):
    """
    GetSimpleEarnLockedHistoryRewardsRecordV1Resp
    """ # noqa: E501
    rows: Optional[List[GetSimpleEarnLockedHistoryRewardsRecordV1RespRowsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [GetSimpleEarnLockedHistoryRewardsRecordV1RespRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
            "total": obj.get("total")
        })
        return _obj
