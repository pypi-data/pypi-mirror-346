...
class GetMiningWorkerListV1RespDataWorkerDatasInner(BaseModel):
    """
    ...
    last_share_time: Optional[StrictInt] = Field(default=None, alias="lastShareTime")
    reject_rate: Optional[StrictInt] = Field(default=None, alias="rejectRate")
    ...
    __properties: ClassVar[List[str]] = ["dayHashRate", "hashRate", "lastShareTime", "rejectRate", "status", "workerId", "workerName"]
