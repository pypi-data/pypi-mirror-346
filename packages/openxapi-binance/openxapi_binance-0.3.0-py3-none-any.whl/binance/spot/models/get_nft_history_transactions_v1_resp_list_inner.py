...
class GetNftHistoryTransactionsV1RespListInner(BaseModel):
    """
    GetNftHistoryTransactionsV1RespListInner
    """ # noqa: E501
    order_no: Optional[StrictStr] = Field(default=None, alias="orderNo")
    tokens: Optional[List[GetNftHistoryTransactionsV1RespListInnerTokensInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["orderNo", "tokens", "tradeAmount", "tradeCurrency", "tradeTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokens": [GetNftHistoryTransactionsV1RespListInnerTokensInner.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
