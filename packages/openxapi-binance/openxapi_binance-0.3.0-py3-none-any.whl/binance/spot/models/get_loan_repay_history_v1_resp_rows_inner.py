...
class GetLoanRepayHistoryV1RespRowsInner(BaseModel):
    """
    GetLoanRepayHistoryV1RespRowsInner
    """ # noqa: E501
    collateral_coin: Optional[StrictStr] = Field(default=None, alias="collateralCoin")
    collateral_return: Optional[StrictStr] = Field(default=None, alias="collateralReturn")
    ...
    __properties: ClassVar[List[str]] = ["collateralCoin", "collateralReturn", "collateralUsed", "loanCoin", "orderId", "repayAmount", "repayStatus", "repayTime", "repayType"]
