...
class GetSolStakingAccountV1Resp(BaseModel):
    """
    ...
    thirty_days_profit_in_sol: Optional[StrictStr] = Field(default=None, alias="thirtyDaysProfitInSOL")
    __properties: ClassVar[List[str]] = ["bnsolAmount", "holdingInSOL", "thirtyDaysProfitInSOL"]
