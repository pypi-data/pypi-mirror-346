...
class GetSimpleEarnLockedHistorySubscriptionRecordV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "amtFromFunding", "amtFromSpot", "asset", "lockPeriod", "positionId", "projectId", "purchaseId", "sourceAccount", "status", "time", "type"]
