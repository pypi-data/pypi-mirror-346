...
class GetMiningHashTransferConfigDetailsListV1RespDataConfigDetailsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["algoName", "configId", "endDay", "hashRate", "poolUsername", "startDay", "status", "toPoolUsername"]
