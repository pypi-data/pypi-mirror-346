...
class GetEthStakingEthHistoryRewardsHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "annualPercentageRate", "asset", "holding", "status", "time"]
