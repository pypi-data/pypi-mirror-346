...
class GetEthStakingWbethHistoryUnwrapHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["exchangeRate", "fromAmount", "fromAsset", "status", "time", "toAmount", "toAsset"]
