...
class GetEthStakingEthHistoryWbethRewardsHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amountInETH", "annualPercentageRate", "holding", "holdingInETH", "time"]
