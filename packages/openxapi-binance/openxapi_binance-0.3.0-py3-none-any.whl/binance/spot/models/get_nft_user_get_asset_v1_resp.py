...
class GetNftUserGetAssetV1Resp(BaseModel):
    """
    GetNftUserGetAssetV1Resp
    """ # noqa: E501
    list: Optional[List[GetNftHistoryTransactionsV1RespListInnerTokensInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [GetNftHistoryTransactionsV1RespListInnerTokensInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
            "total": obj.get("total")
        })
        return _obj
