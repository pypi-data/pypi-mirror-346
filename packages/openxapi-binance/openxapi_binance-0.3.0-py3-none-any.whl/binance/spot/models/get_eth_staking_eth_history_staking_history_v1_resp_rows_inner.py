...
class GetEthStakingEthHistoryStakingHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "conversionRatio", "distributeAmount", "distributeAsset", "status", "time"]
