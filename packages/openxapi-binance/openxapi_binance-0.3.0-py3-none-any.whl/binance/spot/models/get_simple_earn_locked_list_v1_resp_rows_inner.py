...
class GetSimpleEarnLockedListV1RespRowsInner(BaseModel):
    """
    GetSimpleEarnLockedListV1RespRowsInner
    """ # noqa: E501
    detail: Optional[GetSimpleEarnLockedListV1RespRowsInnerDetail] = None
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    quota: Optional[GetSimpleEarnLockedListV1RespRowsInnerQuota] = None
    __properties: ClassVar[List[str]] = ["detail", "projectId", "quota"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": GetSimpleEarnLockedListV1RespRowsInnerDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
            "projectId": obj.get("projectId"),
            "quota": GetSimpleEarnLockedListV1RespRowsInnerQuota.from_dict(obj["quota"]) if obj.get("quota") is not None else None
        })
        return _obj
