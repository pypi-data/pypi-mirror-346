...
class GetMiningPaymentListV1Resp(BaseModel):
    """
    GetMiningPaymentListV1Resp
    """ # noqa: E501
    code: Optional[StrictInt] = None
    data: Optional[GetMiningPaymentListV1RespData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": GetMiningPaymentListV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "msg": obj.get("msg")
        })
        return _obj
