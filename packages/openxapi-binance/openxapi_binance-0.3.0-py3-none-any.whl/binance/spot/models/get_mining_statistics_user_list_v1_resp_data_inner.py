...
class GetMiningStatisticsUserListV1RespDataInner(BaseModel):
    """
    GetMiningStatisticsUserListV1RespDataInner
    """ # noqa: E501
    list: Optional[List[GetMiningStatisticsUserListV1RespDataInnerListInner]] = None
    type: Optional[StrictStr] = None
    user_name: Optional[StrictStr] = Field(default=None, alias="userName")
    __properties: ClassVar[List[str]] = ["list", "type", "userName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [GetMiningStatisticsUserListV1RespDataInnerListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
            "type": obj.get("type"),
