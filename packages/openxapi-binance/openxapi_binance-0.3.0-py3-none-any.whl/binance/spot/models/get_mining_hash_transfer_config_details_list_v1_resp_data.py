...
class GetMiningHashTransferConfigDetailsListV1RespData(BaseModel):
    """
    GetMiningHashTransferConfigDetailsListV1RespData
    """ # noqa: E501
    config_details: Optional[List[GetMiningHashTransferConfigDetailsListV1RespDataConfigDetailsInner]] = Field(default=None, alias="configDetails")
    page_size: Optional[StrictInt] = Field(default=None, alias="pageSize")
    total_num: Optional[StrictInt] = Field(default=None, alias="totalNum")
    __properties: ClassVar[List[str]] = ["configDetails", "pageSize", "totalNum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configDetails": [GetMiningHashTransferConfigDetailsListV1RespDataConfigDetailsInner.from_dict(_item) for _item in obj["configDetails"]] if obj.get("configDetails") is not None else None,
