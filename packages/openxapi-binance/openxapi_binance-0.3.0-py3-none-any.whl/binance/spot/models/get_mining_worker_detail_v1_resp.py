...
class GetMiningWorkerDetailV1Resp(BaseModel):
    """
    GetMiningWorkerDetailV1Resp
    """ # noqa: E501
    code: Optional[StrictInt] = None
    data: Optional[List[GetMiningWorkerDetailV1RespDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [GetMiningWorkerDetailV1RespDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "msg": obj.get("msg")
        })
        return _obj
