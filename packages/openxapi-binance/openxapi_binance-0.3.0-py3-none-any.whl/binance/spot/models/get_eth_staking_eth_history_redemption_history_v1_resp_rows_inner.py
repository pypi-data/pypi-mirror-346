...
class GetEthStakingEthHistoryRedemptionHistoryV1RespRowsInner(BaseModel):
    """
    ...
    distribute_amount: Optional[StrictStr] = Field(default=None, alias="distributeAmount")
    distribute_asset: Optional[StrictStr] = Field(default=None, alias="distributeAsset")
    status: Optional[StrictStr] = None
    time: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["amount", "arrivalTime", "asset", "conversionRatio", "distributeAmount", "distributeAsset", "status", "time"]
