...
class GetRebateTaxQueryV1RespData(BaseModel):
    """
    GetRebateTaxQueryV1RespData
    """ # noqa: E501
    data: Optional[List[GetRebateTaxQueryV1RespDataDataInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["data", "page", "totalPageNum", "totalRecords"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetRebateTaxQueryV1RespDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "page": obj.get("page"),
