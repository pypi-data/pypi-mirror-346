...
class GetLoanLtvAdjustmentHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adjustTime", "afterLTV", "amount", "collateralCoin", "direction", "loanCoin", "orderId", "preLTV"]
