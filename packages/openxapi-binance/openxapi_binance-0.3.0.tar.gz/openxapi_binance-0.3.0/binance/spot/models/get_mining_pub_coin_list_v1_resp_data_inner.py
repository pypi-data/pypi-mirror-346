...
class GetMiningPubCoinListV1RespDataInner(BaseModel):
    """
    ...
    pool_index: Optional[StrictInt] = Field(default=None, alias="poolIndex")
    __properties: ClassVar[List[str]] = ["algoId", "algoName", "coinId", "coinName", "poolIndex"]
