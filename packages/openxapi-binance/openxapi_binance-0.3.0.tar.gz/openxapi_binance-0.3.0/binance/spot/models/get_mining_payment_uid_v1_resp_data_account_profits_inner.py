...
class GetMiningPaymentUidV1RespDataAccountProfitsInner(BaseModel):
    """
    GetMiningPaymentUidV1RespDataAccountProfitsInner
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    coin_name: Optional[StrictStr] = Field(default=None, alias="coinName")
    puid: Optional[StrictInt] = None
    sub_name: Optional[StrictStr] = Field(default=None, alias="subName")
    time: Optional[StrictInt] = None
    type: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["amount", "coinName", "puid", "subName", "time", "type"]
