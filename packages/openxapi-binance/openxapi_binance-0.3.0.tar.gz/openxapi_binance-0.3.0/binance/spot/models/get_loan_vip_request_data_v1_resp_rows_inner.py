...
class GetLoanVipRequestDataV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collateralAccountId", "collateralCoin", "loanAccountId", "loanAmount", "loanCoin", "loanDate", "loanTerm", "orderId", "requestId", "status"]
