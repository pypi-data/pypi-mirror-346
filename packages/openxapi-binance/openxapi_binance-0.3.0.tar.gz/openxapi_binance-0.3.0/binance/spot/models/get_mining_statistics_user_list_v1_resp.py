...
class GetMiningStatisticsUserListV1Resp(BaseModel):
    """
    GetMiningStatisticsUserListV1Resp
    """ # noqa: E501
    code: Optional[StrictInt] = None
    data: Optional[List[GetMiningStatisticsUserListV1RespDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [GetMiningStatisticsUserListV1RespDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "msg": obj.get("msg")
        })
        return _obj
