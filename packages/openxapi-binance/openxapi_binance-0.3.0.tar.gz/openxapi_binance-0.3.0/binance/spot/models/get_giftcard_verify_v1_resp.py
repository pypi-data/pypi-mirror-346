...
class GetGiftcardVerifyV1Resp(BaseModel):
    """
    GetGiftcardVerifyV1Resp
    """ # noqa: E501
    code: Optional[StrictStr] = None
    data: Optional[GetGiftcardVerifyV1RespData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": GetGiftcardVerifyV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None,
