...
class GetLoanFlexibleOngoingOrdersV2RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collateralAmount", "collateralCoin", "currentLTV", "loanCoin", "totalDebt"]
