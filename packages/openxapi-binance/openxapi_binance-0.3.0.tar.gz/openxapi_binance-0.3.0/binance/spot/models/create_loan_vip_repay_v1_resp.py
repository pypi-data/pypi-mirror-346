...
class CreateLoanVipRepayV1Resp(BaseModel):
    """
    ...
    remaining_interest: Optional[StrictStr] = Field(default=None, alias="remainingInterest")
    remaining_principal: Optional[StrictStr] = Field(default=None, alias="remainingPrincipal")
    ...
    __properties: ClassVar[List[str]] = ["collateralCoin", "currentLTV", "loanCoin", "remainingInterest", "remainingPrincipal", "repayAmount", "repayStatus"]
