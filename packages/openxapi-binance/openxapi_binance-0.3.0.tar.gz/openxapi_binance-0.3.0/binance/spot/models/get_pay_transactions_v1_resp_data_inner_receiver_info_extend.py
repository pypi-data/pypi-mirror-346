...
class GetPayTransactionsV1RespDataInnerReceiverInfoExtend(BaseModel):
    """
    GetPayTransactionsV1RespDataInnerReceiverInfoExtend
    """ # noqa: E501
    card_number: Optional[StrictStr] = Field(default=None, alias="cardNumber")
    digital_wallet_id: Optional[StrictStr] = Field(default=None, alias="digitalWalletId")
    institution_name: Optional[StrictStr] = Field(default=None, alias="institutionName")
    __properties: ClassVar[List[str]] = ["cardNumber", "digitalWalletId", "institutionName"]
