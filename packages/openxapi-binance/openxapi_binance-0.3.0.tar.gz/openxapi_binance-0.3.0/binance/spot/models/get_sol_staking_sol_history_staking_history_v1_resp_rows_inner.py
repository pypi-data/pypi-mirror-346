...
class GetSolStakingSolHistoryStakingHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "distributeAmount", "distributeAsset", "exchangeRate", "status", "time"]
