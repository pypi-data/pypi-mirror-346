...
class GetSolStakingSolHistoryBnsolRewardsHistoryV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amountInSOL", "annualPercentageRate", "holding", "holdingInSOL", "time"]
