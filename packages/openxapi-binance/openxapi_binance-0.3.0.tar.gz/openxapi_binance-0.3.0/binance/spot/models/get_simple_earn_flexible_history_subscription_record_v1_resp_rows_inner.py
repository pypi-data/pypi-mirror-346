...
class GetSimpleEarnFlexibleHistorySubscriptionRecordV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "amtFromFunding", "amtFromSpot", "asset", "productId", "purchaseId", "sourceAccount", "status", "time", "type"]
