...
class CreateLoanFlexibleAdjustLtvV2Resp(BaseModel):
    """
    CreateLoanFlexibleAdjustLtvV2Resp
    """ # noqa: E501
    adjustment_amount: Optional[StrictStr] = Field(default=None, alias="adjustmentAmount")
    ...
    __properties: ClassVar[List[str]] = ["adjustmentAmount", "collateralCoin", "currentLTV", "direction", "loanCoin", "status"]
