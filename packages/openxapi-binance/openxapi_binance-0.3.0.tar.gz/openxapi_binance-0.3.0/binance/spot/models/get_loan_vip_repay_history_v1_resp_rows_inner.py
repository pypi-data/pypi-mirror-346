...
class GetLoanVipRepayHistoryV1RespRowsInner(BaseModel):
    """
    ...
    repay_time: Optional[StrictStr] = Field(default=None, alias="repayTime")
    __properties: ClassVar[List[str]] = ["collateralCoin", "loanCoin", "loanDate", "orderId", "repayAmount", "repayStatus", "repayTime"]
