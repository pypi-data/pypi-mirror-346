...
class GetLoanFlexibleRepayHistoryV2RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collateralCoin", "collateralReturn", "loanCoin", "repayAmount", "repayStatus", "repayTime"]
