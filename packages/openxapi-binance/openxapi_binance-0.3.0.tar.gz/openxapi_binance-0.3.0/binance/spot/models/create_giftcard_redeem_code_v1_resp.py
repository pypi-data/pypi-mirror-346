...
class CreateGiftcardRedeemCodeV1Resp(BaseModel):
    """
    CreateGiftcardRedeemCodeV1Resp
    """ # noqa: E501
    code: Optional[StrictStr] = None
    data: Optional[CreateGiftcardRedeemCodeV1RespData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": CreateGiftcardRedeemCodeV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None,
