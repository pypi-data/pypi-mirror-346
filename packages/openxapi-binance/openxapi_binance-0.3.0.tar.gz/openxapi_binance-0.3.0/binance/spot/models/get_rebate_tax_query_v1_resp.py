...
class GetRebateTaxQueryV1Resp(BaseModel):
    """
    GetRebateTaxQueryV1Resp
    """ # noqa: E501
    code: Optional[StrictStr] = None
    data: Optional[GetRebateTaxQueryV1RespData] = None
    status: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["code", "data", "status", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": GetRebateTaxQueryV1RespData.from_dict(obj["data"]) if obj.get("data") is not None else None,
