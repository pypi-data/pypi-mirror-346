...
class GetNftHistoryWithdrawV1Resp(BaseModel):
    """
    GetNftHistoryWithdrawV1Resp
    """ # noqa: E501
    list: Optional[List[GetNftHistoryWithdrawV1RespListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [GetNftHistoryWithdrawV1RespListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
            "total": obj.get("total")
        })
        return _obj
