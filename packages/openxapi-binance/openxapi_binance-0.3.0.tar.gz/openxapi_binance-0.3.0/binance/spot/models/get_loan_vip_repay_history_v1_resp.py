...
class GetLoanVipRepayHistoryV1Resp(BaseModel):
    """
    GetLoanVipRepayHistoryV1Resp
    """ # noqa: E501
    rows: Optional[List[GetLoanVipRepayHistoryV1RespRowsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [GetLoanVipRepayHistoryV1RespRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
            "total": obj.get("total")
        })
        return _obj
