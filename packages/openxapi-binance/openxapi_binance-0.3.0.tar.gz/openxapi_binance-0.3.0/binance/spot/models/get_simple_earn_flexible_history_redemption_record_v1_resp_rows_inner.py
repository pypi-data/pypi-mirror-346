...
class GetSimpleEarnFlexibleHistoryRedemptionRecordV1RespRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "asset", "destAccount", "projectId", "redeemId", "status", "time"]
