...
class BinancePayHistoryApi:
    ...
    @validate_call
    def get_pay_transactions_v1(
        self,
        timestamp: StrictInt,
        start_time: Optional[StrictInt] = None,
        end_time: Optional[StrictInt] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="default 100, max 100")] = None,
        ...
        _param = self._get_pay_transactions_v1_serialize(
            timestamp=timestamp,
    ...
    @validate_call
    def get_pay_transactions_v1_with_http_info(
        self,
        timestamp: StrictInt,
        start_time: Optional[StrictInt] = None,
        end_time: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPayTransactionsV1Resp]:
        """Get Pay Trade History
    ...
    @validate_call
    def get_pay_transactions_v1_without_preload_content(
        self,
        timestamp: StrictInt,
        start_time: Optional[StrictInt] = None,
        end_time: Optional[StrictInt] = None,
    ...
    def _get_pay_transactions_v1_serialize(
        self,
        timestamp,
        start_time,
        end_time,
