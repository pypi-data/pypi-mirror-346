...
class DriverInterface:
    def __init__(self, platform: Literal['android', 'ios', "web"], appium_server_url: Optional[str] = None,
                 selenium_server_url: Optional[str] = None, browser: Optional[Literal['chrome', 'firefox', 'safari', 'edge', 'brave']] = None,
    ...
    def _initialize_driver(self):
        if self.platform == 'android':
            ...
            if not self._selenium_server_url:
                ...
                self.driver = selenium_webdriver.Remote(self._selenium_server_url, options=self._desired_capabilities)
                if self._debug:
