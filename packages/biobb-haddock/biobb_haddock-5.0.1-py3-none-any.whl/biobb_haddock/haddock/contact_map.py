...
class ContactMap(BiobbObject):
    ...
    | The ContactMap module. `Haddock ContactMap module <https://www.bonvinlab.org/haddock3/modules/analysis/haddock.modules.analysis.contactmap.html>`_ computes contacts between chains in complexes and generates heatmaps and chordcharts.
...
def main():
    parser = argparse.ArgumentParser(
        description="Wrapper of the haddock ContactMap module.",
    ...
    required_args.add_argument("--output_contactmap_zip_path", required=True)
    ...
    contact_map(
        ...
        output_contactmap_zip_path=args.output_contactmap_zip_path,
