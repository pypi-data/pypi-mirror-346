...
class LinkProductResponse(BaseModel):
    ...
    error_code: Optional[LinkProductError] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LinkProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LinkProductResponse from a dict"""
        if obj is None:
            return None
