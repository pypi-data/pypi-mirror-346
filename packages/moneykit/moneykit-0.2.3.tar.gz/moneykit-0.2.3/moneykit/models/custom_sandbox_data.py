...
class CustomSandboxData(BaseModel):
    """
    CustomSandboxData
    """  # noqa: E501

    accounts: List[CustomSandboxAccount]
    owners: Optional[List[Owner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accounts", "owners"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomSandboxData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CustomSandboxData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "accounts": [
                    CustomSandboxAccount.from_dict(_item)
