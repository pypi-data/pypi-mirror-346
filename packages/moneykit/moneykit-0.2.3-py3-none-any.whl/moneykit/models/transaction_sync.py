...
class TransactionSync(BaseModel):
    ...
    updated: List[TransactionResponse]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TransactionSync from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TransactionSync from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "created": [
                    TransactionResponse.from_dict(_item) for _item in obj.get("created")
                ]
                if obj.get("created") is not None
                else None,
                "updated": [
                    TransactionResponse.from_dict(_item) for _item in obj.get("updated")
                ]
