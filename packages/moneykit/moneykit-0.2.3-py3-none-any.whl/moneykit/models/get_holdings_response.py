...
class GetHoldingsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["holdings", "securities", "accounts", "link"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetHoldingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetHoldingsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "holdings": [
                    HoldingResponse.from_dict(_item) for _item in obj.get("holdings")
                ]
