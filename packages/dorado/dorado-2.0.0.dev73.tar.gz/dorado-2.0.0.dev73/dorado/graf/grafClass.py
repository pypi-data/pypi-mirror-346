...
class star_chart:
    def __init__(self, im, title = '', wcs = None, cm = 'viridis', grid_c = 'w'):
        ...
        self.ax_im = self.ax.imshow(self.im.data, cmap = cm, vmin = down, vmax = 2 * up)
        self.ax_im.set_clim(vmin=0, vmax=1)
        self.legend_labels = []
        self.legend_patchs = []

    def plt_hist(self):
        plt.title(title + ' Histogram', fontdict = font)
