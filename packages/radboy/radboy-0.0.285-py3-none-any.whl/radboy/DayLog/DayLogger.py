...
{Back.turquoise_4} {Fore.black}'rm rcpt','rmrcpt','remove receipt'{Fore.dark_red_1}- delete a receipt and possibly related DayLogs{Style.reset}
{Back.turquoise_4} {Fore.black}'clear_all_receipts','clear all reciepts' {Back.grey_15}{Fore.dark_orange_3b}Completely delete {Style.underline}ALL{Style.res_underline} reciepts.{Style.reset}
