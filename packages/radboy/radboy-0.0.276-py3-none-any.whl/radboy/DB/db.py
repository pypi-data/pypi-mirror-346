...
class UniqueRecieptIdInfo(BASE,Template):
    ...
    EstablishmentName=Column(String,default='Establishment X of A Retail Goods inc.')
    EstablishmentNumber=Column(String,default="#0000")
    EstablishmentAddress=Column(String,default='2 NoWay Crt, NopeLand Bay, NowhereLand 00000-0000')
    DTOE=Column(DateTime,default=datetime.now())
    EstablishmentDirector=Column(String,default='Brady Nunsen Inexsistancia')
    EstablishmentOwner=Column(String,default="Owner ExStablishment Gatorada")
    EstablishmentDescription=Column(String,default="a store, a restaraunt, a pub, a strip club, or whatever you please.")
    ...
    POSNumber=Column(String,default="0000")
    Cashier=Column(String,default="Jane Doe")
    CashierNumber=Column(String,default="0000")
    TransactionNumber=Column(String,default="0000")
