...
def analyze( datadir: str,
    ...
    match sys.platform:
        ...
        case _:
            sys.exit( 'Error: your OS is not yet supported, by me a machine and I will provide support' )
...
def toxlsx( path: str ) -> str:
    ...
    if path == retval:
        sys.exit( f"Dangerous internal error with risk for data loss - aborting!\n" +
