...
impl_div!(MassPerDistanceTimeSquare, Distance, ForcePerVolume);
impl_div!(MassPerDistanceTimeSquare, ForcePerVolume, Distance);
impl_mul!(MassPerDistanceTimeSquare, Distance, MassPerTimeSquare);
