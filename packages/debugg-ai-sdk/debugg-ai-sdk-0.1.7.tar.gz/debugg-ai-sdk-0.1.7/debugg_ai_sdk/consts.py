    ...
    def __init__(
        ...
        *,
        ...
        :param max_breadcrumbs: This variable controls the total amount of breadcrumbs that should be captured.
            ...
            However, you should be aware that Sentry has a `maximum payload size <https://develop.debugg-ai.dev/sdk/data-model/envelopes/#size-limits>`_
        ...
        :param max_request_body_size: This parameter controls whether integrations should capture HTTP request bodies.
            ...
            Please note that the Sentry server [limits HTTP request body size](https://develop.debugg-ai.dev/sdk/
