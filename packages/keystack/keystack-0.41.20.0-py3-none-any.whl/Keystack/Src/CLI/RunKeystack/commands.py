...
# multiple=True: --reconfigs demo1 --reconfigs demo2
@click.option('-reconfigs', multiple=True,
              help='Which config file(s) to use to modify test params. Use --reconfigs for each file.')
