                ...
                for key_dict in list(value.keys()):
                    ...
                    match key:
                        ...
                        case 'termsListTranslate':
                            _value_dict = value_dict.strip().replace(' ', '%')
                            print(f'_value_dict={_value_dict}')
                            _termo = "translate(lower('" + eval(
                                _value_dict) + "%'),'áàâãäåaaaÁÂÃÄÅAAAÀéèêëeeeeeEEEÉEEÈìíîïìiiiÌÍÎÏÌIIIóôõöoooòÒÓÔÕÖOOOùúûüuuuuÙÚÛÜUUUUçÇñÑýÝ','aaaaaaaaaAAAAAAAAAeeeeeeeeeEEEEEEEiiiiiiiiIIIIIIIIooooooooOOOOOOOOuuuuuuuuUUUUUUUUcCnNyY')"
                            where.append(f'lower({key_dict}) LIKE {_termo}')
