...
class TestCorrespondenceInput(unittest.TestCase):
    """CorrespondenceInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorrespondenceInput:
        """Test CorrespondenceInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorrespondenceInput`
        """
        model = CorrespondenceInput()
        if include_optional:
            return CorrespondenceInput(
    ...
    def testCorrespondenceInput(self):
        """Test CorrespondenceInput"""
