...
class TestCorrespondenceOutput(unittest.TestCase):
    """CorrespondenceOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorrespondenceOutput:
        """Test CorrespondenceOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorrespondenceOutput`
        """
        model = CorrespondenceOutput()
        if include_optional:
            return CorrespondenceOutput(
                ...
                http___rdf_vocabulary_ddialliance_org_xkoscompares = [{@id=http://data.europa.eu/xsp/cn2023/cn2023}, {@id=http://data.europa.eu/xsp/cn2024/cn2024}],
                http___rdf_vocabulary_ddialliance_org_xkosmade_of = [{@language=en, @value=Includes all sorts of live animals, including things you probably never heard of before, like psittaciformes. Those are birds like parrots, by the way. Also includes silly names like hinnies and asses, but not those kinds of asses, get your mind out of the gutter. We are very serious people doing very serious work with our asses.}]
            )
        else:
            return CorrespondenceOutput(
                id = 'http://data.europa.eu/xsp/cn2024/010021000090',
    ...
    def testCorrespondenceOutput(self):
        """Test CorrespondenceOutput"""
