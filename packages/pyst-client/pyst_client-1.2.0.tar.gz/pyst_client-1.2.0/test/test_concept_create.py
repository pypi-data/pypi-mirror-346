...
class TestConceptCreate(unittest.TestCase):
    """ConceptCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConceptCreate:
        """Test ConceptCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConceptCreate`
        """
        model = ConceptCreate()
        if include_optional:
            return ConceptCreate(
                ...
                http___www_w3_org_2004_02_skos_corein_scheme = [{@id=http://data.europa.eu/xsp/cn2024/cn2024}],
                http___www_w3_org_2004_02_skos_corealt_label = [{@language=en, @value=Horsies, moo-moos, etc.}],
                http___www_w3_org_2004_02_skos_corehidden_label = [{@language=ine-pro, @value=ékwos}],
                ...
                http___www_w3_org_2004_02_skos_coretop_concept_of = [{@id=http://data.europa.eu/xsp/cn2024/cn2024}],
