...
class NuscenesDet:
    ...
    def __init__(self, nuscenes_root: str, output_dir: str, oss_root: str, predata: bool = False, json_file_name: str = None):
        """
        初始化NuScenes数据集转换工具
    ...
    def _get_key_frame_data(self, sample_tokens: List[str], data_type: str) -> List[Dict]:
        ...
        for token in sample_tokens:
            ...
            if data_type == 'pointcloud':
                matched_data = [d for d in matched_data if 'LIDAR_0' in d['filename']]
