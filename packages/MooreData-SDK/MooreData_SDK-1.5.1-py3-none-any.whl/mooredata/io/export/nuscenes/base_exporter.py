...
class BaseExporter(ABC):
    ...
    def _create_nuscenes_attributes(self):
        ...
        if not hasattr(self, 'nuscenes_data') or not self.nuscenes_data['attribute']:
...
class NuscenesExporterStrategy(ABC):
    """NuScenes导出策略接口"""
    
    @abstractmethod
    def process_sequence(self, sequence: Dict, seq_idx: int):
        """处理单个序列"""
        pass
