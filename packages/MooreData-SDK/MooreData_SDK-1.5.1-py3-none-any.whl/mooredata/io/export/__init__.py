...
class Export(object):
    ...
    @classmethod
    def moore_json2waymo(cls, source_data, out_path=None, sensor_mapping=None):
        cls.export_f.export_waymo_product(source_data, out_path, sensor_mapping).moore_json2waymo()