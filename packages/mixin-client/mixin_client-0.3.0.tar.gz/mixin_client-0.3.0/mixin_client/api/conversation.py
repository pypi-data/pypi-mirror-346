...
class ConversationApi:
    ...
    def create_conversation(
        ...
        return self.http.post("/conversations", body=data)
    ...
    def get_conversation(self, conversation_id: str) -> dict[str, Any]:
        ...
        Example:
            ...
            >>> print(conversation)
        """
        return self.http.get(f"/conversations/{conversation_id}")
    ...
    def update_conversation(
        ...
        return self.http.post(f"/conversations/{conversation_id}", body=data)
    ...
    def add_participants(
        ...
        return self.http.post(f"/conversations/{conversation_id}/participants", body=data)
    ...
    def exit_conversation(self, conversation_id: str) -> dict[str, Any]:
        ...
        Example:
            ...
            >>> print(response)
        """
        return self.http.post(f"/conversations/{conversation_id}/exit", body={}) 