...
from ..models import MessageResponse, MessageListResponse
...
class MessageApi:
    ...
    def send_message(
        ...
        Args:
            ...
            category (str): The category of the message, e.g., "PLAIN_TEXT", "PLAIN_IMAGE", etc.
            content (str): The content of the message. For plain text, this is the text itself.
                          For media, this is typically a JSON string with details.
        ...
        Example:
            ...
            >>> message = client.api.message.send_message(
        ...
        if category == "PLAIN_TEXT":
            # PLAIN_TEXT 必须用 data 字段，内容 base64 编码
        ...
        response = self.http.post("/messages", body=data)
    ...
    def get_message(self, message_id: str) -> MessageResponse:
        ...
        """
        response = self.http.get(f"/messages/{message_id}")
        return MessageResponse(**response)
    ...
    def acknowledge_message(self, message_id: str) -> dict[str, Any]:
        ...
        return self.http.post("/acknowledgements", body=data)
