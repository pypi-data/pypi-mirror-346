...
from metadata.nonelectric_criteria import getQCcriteria
...
#---------- Loading the json file from package metadata directory (using importlib.resources)
json_file = files("metadata").joinpath("reportTypeMap.json")
