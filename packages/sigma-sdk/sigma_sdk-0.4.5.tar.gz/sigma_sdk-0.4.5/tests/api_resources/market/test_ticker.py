...
class TestTicker:
    ...
    def test_method_retrieve(self, client: Petstore) -> None:
        ticker = client.market.ticker.retrieve()
        assert_matches_type(Ticker, ticker, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Petstore) -> None:
        response = client.market.ticker.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: Petstore) -> None:
        with client.market.ticker.with_streaming_response.retrieve() as response:
    ...
    def test_streaming_response_get(self, client: Petstore) -> None:
        with client.market.ticker.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncTicker:
    ...
    async def test_method_retrieve(self, async_client: AsyncPetstore) -> None:
        ticker = await async_client.market.ticker.retrieve()
        assert_matches_type(Ticker, ticker, path=["response"])

    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncPetstore) -> None:
        response = await async_client.market.ticker.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPetstore) -> None:
        async with async_client.market.ticker.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_get(self, async_client: AsyncPetstore) -> None:
        async with async_client.market.ticker.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
