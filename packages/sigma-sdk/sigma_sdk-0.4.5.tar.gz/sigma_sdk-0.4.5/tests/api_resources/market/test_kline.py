...
class TestKline:
    ...
    def test_streaming_response_retrieve(self, client: Petstore) -> None:
        with client.market.kline.with_streaming_response.retrieve() as response:
    ...
    def test_streaming_response_get(self, client: Petstore) -> None:
        with client.market.kline.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncKline:
    ...
    async def test_method_retrieve(self, async_client: AsyncPetstore) -> None:
        kline = await async_client.market.kline.retrieve()
        assert_matches_type(Kline, kline, path=["response"])

    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncPetstore) -> None:
        response = await async_client.market.kline.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPetstore) -> None:
        async with async_client.market.kline.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_get(self, async_client: AsyncPetstore) -> None:
        async with async_client.market.kline.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
