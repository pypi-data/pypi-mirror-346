...
from sigma.types.portfolio import Portfolio
...
class TestPortfolio:
    ...
    def test_streaming_response_retrieve(self, client: Petstore) -> None:
        with client.portfolio.with_streaming_response.retrieve() as response:
    ...
    def test_raw_response_get(self, client: Petstore) -> None:
        response = client.portfolio.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Petstore) -> None:
        with client.portfolio.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPortfolio:
    ...
    async def test_method_retrieve(self, async_client: AsyncPetstore) -> None:
        portfolio = await async_client.portfolio.retrieve()
        assert_matches_type(Portfolio, portfolio, path=["response"])

    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncPetstore) -> None:
        response = await async_client.portfolio.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncPetstore) -> None:
        async with async_client.portfolio.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get(self, async_client: AsyncPetstore) -> None:
        portfolio = await async_client.portfolio.get()
        assert_matches_type(Portfolio, portfolio, path=["response"])

    @parametrize
    async def test_raw_response_get(self, async_client: AsyncPetstore) -> None:
        response = await async_client.portfolio.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPetstore) -> None:
        async with async_client.portfolio.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
