...
from sigma._constants import RAW_RESPONSE_HEADER
from sigma._exceptions import PetstoreError, APIStatusError, APITimeoutError, APIResponseValidationError
from sigma._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
class TestPetstore:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.get(
                "/trading/orders", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
