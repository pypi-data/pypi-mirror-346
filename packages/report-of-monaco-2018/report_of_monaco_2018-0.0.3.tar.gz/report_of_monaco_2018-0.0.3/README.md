...
```
## Instalation 
Report-of-monaco-2018 can be installed by running `pip install report-of-monaco-2018==0.0.3`. 
...
```bash
 - report --file ./data --desc
 - report --file ./data --driver "Sebastian Vettel"
```
# Options:
