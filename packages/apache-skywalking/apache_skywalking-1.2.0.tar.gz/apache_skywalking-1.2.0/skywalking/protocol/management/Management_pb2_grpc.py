...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in management/Management_pb2_grpc.py depends on'
...
def add_ManagementServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('skywalking.v3.ManagementService', rpc_method_handlers)
