...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in language_agent/CLRMetric_pb2_grpc.py depends on'
...
def add_CLRMetricReportServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('skywalking.v3.CLRMetricReportService', rpc_method_handlers)
