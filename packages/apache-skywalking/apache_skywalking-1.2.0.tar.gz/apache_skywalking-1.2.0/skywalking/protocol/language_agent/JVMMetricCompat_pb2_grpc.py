...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in language_agent/JVMMetricCompat_pb2_grpc.py depends on'
...
def add_JVMMetricReportServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('JVMMetricReportService', rpc_method_handlers)
