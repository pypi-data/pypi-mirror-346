...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in language_agent/Meter_pb2_grpc.py depends on'
...
def add_MeterReportServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('skywalking.v3.MeterReportService', rpc_method_handlers)
