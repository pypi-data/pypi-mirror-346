...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in language_agent/Tracing_pb2_grpc.py depends on'
...
def add_TraceSegmentReportServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('skywalking.v3.TraceSegmentReportService', rpc_method_handlers)
...
def add_SpanAttachedEventReportServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('skywalking.v3.SpanAttachedEventReportService', rpc_method_handlers)
