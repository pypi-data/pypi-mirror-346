...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in logging/Logging_pb2_grpc.py depends on'
...
def add_LogReportServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('skywalking.v3.LogReportService', rpc_method_handlers)
