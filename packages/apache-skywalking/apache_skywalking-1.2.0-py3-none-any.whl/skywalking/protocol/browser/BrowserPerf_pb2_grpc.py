...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in browser/BrowserPerf_pb2_grpc.py depends on'
...
def add_BrowserPerfServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('skywalking.v3.BrowserPerfService', rpc_method_handlers)
