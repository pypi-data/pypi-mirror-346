...
"""
    ...
    The version of the OpenAPI document: 78.0.0
...
class SingleCellRnaSeqQualityMetric(BaseModel):
    ...
    num_barcodes_on_onlist: Optional[Union[StrictFloat, StrictInt]] = None
    percentage_barcodes_on_onlist: Optional[Union[StrictFloat, StrictInt]] = None
    num_reads_on_onlist: Optional[Union[StrictFloat, StrictInt]] = None
    percentage_reads_on_onlist: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    kmer_length: Optional[Union[StrictFloat, StrictInt]] = None
