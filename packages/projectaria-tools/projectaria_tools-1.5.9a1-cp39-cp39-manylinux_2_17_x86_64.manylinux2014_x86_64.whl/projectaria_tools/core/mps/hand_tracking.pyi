...
import datetime
import typing
__all__ = ['HandLandmark', 'HandTrackingResult', 'Handness', 'WristAndPalmPose', 'kHandJointConnections', 'kNumHandJointConnections', 'kNumHandLandmarks', 'read_hand_tracking_results', 'read_wrist_and_palm_poses']
class HandLandmark:
    """
    Members:
...
class Handness:
    ...
    Members:
      ...
      RIGHT
    """
    LEFT: typing.ClassVar[Handness]  # value = <Handness.LEFT: 0>
    RIGHT: typing.ClassVar[Handness]  # value = <Handness.RIGHT: 1>
    __members__: typing.ClassVar[typing.Dict[str, Handness]]  # value = {'LEFT': <Handness.LEFT: 0>, 'RIGHT': <Handness.RIGHT: 1>}
    @staticmethod
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __eq__(self, other: object) -> bool:
