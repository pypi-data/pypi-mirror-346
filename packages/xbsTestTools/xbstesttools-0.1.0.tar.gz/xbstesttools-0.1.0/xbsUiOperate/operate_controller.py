...
class XbsUiOperate:
    ...
    def get_image_in_screenshot(self, small_image_path, threshold=0.98):
        ...
        points[0][0] += height // 2  # 获取x轴中心
        points[0][1] += width // 2  # 获取y轴中心
        return points[0]  # 仅返回第一个坐标

    def click(self, text=None, index=None, resourceId=None, class_=None, image_path=None):
        if image_path:
            # 点击图片方式
            coordinate = self.get_image_in_screenshot(image_path)
            if not coordinate:
    ...
    def click_long(self, text=None, index=None, resourceId=None, class_=None, image_path=None):
        if image_path:
            # 点击图片方式
            coordinate = self.get_image_in_screenshot(image_path)
            if not coordinate:
    ...
    def click_roll(self, text=None, index=None, resourceId=None, class_=None, image_path=None):
        """
        滑动找到元素再点击
        """
        if image_path:
    ...
    def exists(self, text=None, index=None, resourceId=None, class_=None, image_path=None, timeout=3):
        if image_path:
    ...
    def input(self, text=None, index=None, resourceId=None, class_=None, image_path=None, content=None):
        if image_path:
            coordinate = self.get_image_in_screenshot(image_path)
            if not coordinate:
                return False
