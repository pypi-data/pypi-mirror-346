...
class TokenUserExternals(GenericCRUD, metaclass=MetaLogger, object=object_init):
    ...
    def insert_or_update_user_external_access_token(
        ...
        *,
        ...
        if current_token is not None:
            ...
            logger.info(f"Number of updated tokens: {updated_access_token_row}", object=data_dict)
        ...
        try:
            ...
            logger.info(
                "Record inserted into profile_user_external", object=data_dict
            )
        except Exception as e:
            logger.error(
    ...
    def delete_access_token_by_user_external_id(self, *, user_external_id: int, username: str) -> int:
        """
    ...
    def delete_access_token_by_token__user_external_id(self, *, token__user_external_id: int) -> int:
        """
        Marks a token as deleted by setting end_timestamp to the current time
        """
        object_start = {
    ...
    def get_auth_details(self, *, user_external_id: int) -> tuple:
        """
        ...
        Return: tuple - a tuple containing access_token, refresh_token, and expiry
        """
