...
class UserExternalsLocal(GenericCRUD, metaclass=MetaLogger, object=object_init):
    ...
    def insert_or_update_user_external_access_token(
        ...
        *,
        ...
        access_token_row_id = self.token__user_externals.insert_or_update_user_external_access_token(
    ...
    def get_access_token(
        self, *, user_external_id: int | None = None, system_id: int, username: str, profile_id: int = None
    ) -> str:
        object_start = {  # noqa
            "username": username,
            "profile_id": profile_id,
    ...
    def get_access_token_by_username_and_system_id(
        ...
        return self.get_access_token(username=username, system_id=system_id, profile_id=None)
    ...
    def delete_access_token(self, *, system_id: int, username: str, profile_id: int) -> int:
        object_start = {
            "username": username,
            "system_id": system_id,
            "profile_id": profile_id,
    ...
    #     connection.commit()
        ...
        deleted_rows = self.token__user_externals.delete_access_token_by_user_external_id(
            user_external_id=user_external_id,
            username=username,
        )
        return deleted_rows
    ...
    def get_auth_details_by_system_id_and_profile_id(
        ...
        try:
            ...
            auth_details = self.token__user_externals.get_auth_details_by_system_id_and_profile_id(
                system_id=system_id,
                profile_id=profile_id,
            )
