...
from . import utils
from .MyTypes import Measurement
from ..layouts import ui_interactiveScope, interactiveController, ui_interactive_data_logger, ui_popupEditor, \
...
class DIOINPUT(QtWidgets.QDialog, interactiveController.Ui_Dialog):
    SLIDER_SCALING = 1000.
