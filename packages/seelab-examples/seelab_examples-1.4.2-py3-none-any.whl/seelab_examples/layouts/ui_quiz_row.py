...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.resultLabel, 1, 0, 1, 3)
        self.scoreLabel = QtWidgets.QLabel(self.frame)
        self.scoreLabel.setObjectName("scoreLabel")
        self.gridLayout_2.addWidget(self.scoreLabel, 0, 2, 1, 1)
        self.nameLabel = QtWidgets.QLabel(self.frame)
        self.nameLabel.setObjectName("nameLabel")
        self.gridLayout_2.addWidget(self.nameLabel, 0, 0, 1, 2)
