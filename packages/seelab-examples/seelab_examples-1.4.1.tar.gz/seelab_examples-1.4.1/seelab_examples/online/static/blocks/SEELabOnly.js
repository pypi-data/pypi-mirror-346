...
Blockly.JavaScript['capture1'] = function(block) {
  ...
  var code = "var jsondata = capture1('"+dropdown_channel+"',"+number_samples+","+number_timegap+");\n"+timevar+"=jsondata.CH1.timestamps;\n"+datavar+"=jsondata.CH1.voltages;\n";
  return code;
};
...
Blockly.JavaScript['capture4'] = function(block) {
  ...
  var code = "var jsondata = capture4('"+dropdown_channel+"',"+number_samples+","+number_timegap+");\n"
              ...
              + datavar1+"=jsondata.CH1.voltages;\n"
              + datavar2+"=jsondata.CH2.voltages;\n"
              + datavar3+"=jsondata.CH3.voltages;\n"
              + datavar4+"=jsondata.CH4.voltages;\n";
...
Blockly.JavaScript['capture_plot'] = function(block) {
  ...
  var code = "var jsondata = capture2('"+dropdown_channel+"',"+number_samples+","+number_timegap+");\n";
  code += timevar+"=jsondata.CH1.timestamps;\n"+datavar1+"=jsondata.CH1.voltages;\n"+datavar2+"=jsondata.CH2.voltages;\n";
...
function initSEELab(interpreter, scope) {
		  ...
		  interpreter.setProperty(scope, 'get_frequency', interpreter.createAsyncFunction(
				function(channel, callback) {
				  fetch(`/get_freq/${channel}`)
				  .then(response => response.json())
				  .then(data => {
					  callback(data.result);
				  })
				  .catch(error => {
					  console.error('Error in get_frequency:', error);
					  callback(0);
				  });
				})
			);
      ...
      // Add an API for the singlePinEdges call
		  ...
		  // Add an API for the capture1 call
		  interpreter.setProperty(scope, 'capture1', interpreter.createAsyncFunction(
				function(channel, ns, tg, callback) {
				  fetch(`/capture1/${channel}/${parseInt(ns)}/${parseInt(tg)}`)
				  .then(response => response.json())
				  .then(data => {
            //console.log(data);
				  ...
				  .catch(error => {
					  console.error('Error in capture1:', error);
					  callback(0);
				  });
				})
			);
		  ...
		  // Add an API for the capture2 call
		  interpreter.setProperty(scope, 'capture2', interpreter.createAsyncFunction(
				function(channel, ns, tg, callback) {
				  fetch(`/capture2/${channel}/${parseInt(ns)}/${parseInt(tg)}`)
				  .then(response => response.json())
				  .then(data => {
            //console.log(data)
					  callback(interpreter.nativeToPseudo(data));
				  ...
				  .catch(error => {
					  console.error('Error in capture2:', error);
					  resetInterpreter();
            //callback(0);
				  });
				})
		  ...
		  // Add an API for the capture1 call
		  interpreter.setProperty(scope, 'capture4', interpreter.createAsyncFunction(
				function(channel, ns, tg, callback) {
				  fetch(`/capture4/${channel}/${parseInt(ns)}/${parseInt(tg)}`)
				  .then(response => response.json())
				  .then(data => {
					  callback(interpreter.nativeToPseudo(data));
				  })
				  .catch(error => {
					  console.error('Error in capture4:', error);
					  callback(0);
				  });
				})
			);
		  ...
		  // Add an API for the capture1 call
		  interpreter.setProperty(scope, 'capture_data', interpreter.createAsyncFunction(
				function(channel, callback) {
				  fetch(`/capture1/${channel}`)
				  .then(response => response.json())
				  .then(data => {
					  callback(interpreter.nativeToPseudo(data));
				  })
				  .catch(error => {
					  console.error('Error in capture_data:', error);
					  callback(0);
				  });
				})
			);
		  ...
		  // Add an API for the capture1 call
		  interpreter.setProperty(scope, 'capture_action', interpreter.createAsyncFunction(
				function(channel, ns, tg, callback) {
				  fetch(`/capture_action/${channel}/${parseInt(ns)}/${parseInt(tg)/action}`)
				  .then(response => response.json())
				  .then(data => {
            console.log(data);
					  callback(interpreter.nativeToPseudo(data));
    ...
    interpreter.setProperty(scope, 'set_sine', interpreter.createAsyncFunction(
        function(value, callback) {
            fetch(`/set_sine/${value}`)
            .then(response => response.json())
            .then(data => {
                callback(data.success);
            })
            .catch(error => {
                console.error('Error setting sine:', error);
                callback(false);
            });
        }
    ));
    
    interpreter.setProperty(scope, 'set_sq1', interpreter.createAsyncFunction(
      function(value,dc, callback) {
          fetch(`/set_sq1/${value}/${dc}`)
          .then(response => response.json())
          .then(data => {
              callback(data.success);
          })
          .catch(error => {
              console.error('Error setting sq1:', error);
              callback(false);
          });
      }
  ));
  ...
  interpreter.setProperty(scope, 'set_sq2', interpreter.createAsyncFunction(
    function(value,dc, callback) {
        fetch(`/set_sq2/${value}/${dc}`)
        .then(response => response.json())
        .then(data => {
            callback(data.success);
        })
