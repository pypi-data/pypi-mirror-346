...
class UnderlineBar:
    ...
    def __rich_console__(self, console: Console, options: ConsoleOptions) -> RenderResult:
        ...
        if half_start:
            output_bar.append(Text(half_bar_left + bar * (bar_width - 1), style=highlight_style, end=""))
        else:
        ...
        output_bar.append(Text(bar * (int(width) - int(end) - 1), style=background_style, end=""))
