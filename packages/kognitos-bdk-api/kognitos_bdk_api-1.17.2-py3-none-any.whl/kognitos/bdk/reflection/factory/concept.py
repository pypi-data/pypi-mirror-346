...
class ConceptFactory:
    ...
    def from_noun_phrases_and_annotation(
        cls, noun_phrase: List[NounPhrase], annotation: "type", description: Optional[str] = None, default_value: Optional[Any] = None
    ) -> "ConceptDescriptor":
        t = ConceptTypeFactory.from_type(annotation)

        return ConceptDescriptor(noun_phrases=noun_phrase, type=t, description=description, default_value=default_value)
