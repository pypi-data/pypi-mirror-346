...
&lt;/html&gt;
    ...
    return f'Hello {greeting}!'
        ...
        html = markdown.markdown(text, extensions=["docdown.scoped_code_tabs"], output_format="html5")

        self.assertEqual(html, expected_output)

    def test_custom_config_values(self):
        config = {"docdown.scoped_code_tabs": {"single_block_as_tab": True, "template": "bootstrap4"}}
...
<p> <div class=md-fenced-code-tabs id=tab-tab-group-0><ul class="nav nav-tabs"><li class=nav-item><a class="nav-link active" href=#tab-group-0-0_python-panel role=tab id=tab-group-0-0_python-tab data-toggle=tab data-lang=python aria-controls=tab-group-0-0_python-panel aria-selected=true>Python</a></li></ul><div class=tab-content><div id=tab-group-0-0_python-panel class="tab-pane show active" role=tabpanel aria-labelledby=tab-group-0-0_python-tab><pre><code class=python>def hello_world(greeting: str = 'World'):
    return f'Hello {greeting}!'
        ...
        html = markdown.markdown(
            text, extensions=["docdown.scoped_code_tabs"], extension_configs=config, output_format="html5"
        )
...
<span class=p>}</span>
</code></pre></div></div><input name=tab-group-0 type=radio id=tab-group-0-1_swift class=code-tab data-lang=swift aria-controls=tab-group-0-1_swift-panel role=tab><label for=tab-group-0-1_swift class=code-tab-label data-lang=swift id=tab-group-0-1_swift-label>Swift</label><div class=code-tabpanel role=tabpanel data-lang=swift id=tab-group-0-1_swift-panel aria-labelledby=tab-group-0-1_swift-label><div class=codehilite><pre><span></span><code><span class=c1>// Hello, World! Program</span>
<span class=kd>import</span><span class=w> </span><span class=nc>Swift</span>
<span class=bp>print</span><span class=p>(</span><span class=s>&quot;Hello, World!&quot;</span><span class=p>)</span>
</code></pre></div></div></div>
<div class="codehilite"><pre><span></span><code><span class="nt">&lt;interface</span><span class="w"> </span><span class="na">name=</span><span class="s">&quot;string&quot;</span><span class="w"> </span><span class="na">version=</span><span class="s">&quot;string&quot;</span><span class="w"> </span><span class="na">minVersion=</span><span class="s">&quot;string&quot;</span><span class="w"> </span><span class="na">date=</span><span class="s">&quot;string&quot;</span><span class="nt">&gt;</span>
<span class="w">  </span><span class="cm">&lt;!--Zero or more repetitions:--&gt;</span>
...
func hmiLevel(_ oldLevel: SDLHMILevel, didChangeToLevel newLevel: SDLHMILevel) {
        ...
        html = markdown.markdown(text, extensions=self.MARKDOWN_EXTENSIONS, output_format="html5")
