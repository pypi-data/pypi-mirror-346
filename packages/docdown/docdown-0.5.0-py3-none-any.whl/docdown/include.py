...
class IncludePreprocessor(Preprocessor):
    ...
    def handle_csv(self, file_path):
        ...
        """
        return self.md.htmlStash.store("".join(self.build_csv_table(file_path)))
...
class IncludeExtension(Extension):
    def __init__(self, **kwargs):
        self.config = {
            "asset_directory": [
                "",
                (
                    "Name of the dirirectory for the assets to include via this extension within"
            ...
            "extension_map": [
                {},
                (
                    "Optional dictionary mapping one file extension to another"
    ...
    def extendMarkdown(self, md):
        ...
        md.preprocessors.register(
            ...
            "include",
            29,  # before normalize_whitespace
        )
