...
class Worker:
    ...
    _celery_conf: dict = {
        ...
        'uts_lock_prefix': 'celery-unique-tasks',
        'uts_default_ttl': 900,
    }
    ...
    def set_uts_lock_prefix(self, uts_lock_prefix: str):
        self._celery_conf['uts_lock_prefix'] = uts_lock_prefix
        return self

    def set_uts_default_ttl(self, uts_default_ttl: int):
        self._celery_conf['uts_default_ttl'] = uts_default_ttl
        return self
