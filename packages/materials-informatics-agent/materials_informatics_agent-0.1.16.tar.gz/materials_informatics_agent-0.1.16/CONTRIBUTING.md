...
Welcome to `mi_agent` contributor's guide.
...
If you experience bugs or general issues with `mi_agent`, please have a look
...
You can help improve `mi_agent` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mi_agent` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mi_agent`'s files. While this mechanism can
...
```
conda create -n mi_agent python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mi_agent.git
   cd mi_agent
   ```
...
5. Install [pre-commit]:
   ...
   `mi_agent` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mi_agent
[issue tracker]: https://github.com/<USERNAME>/mi_agent/issues
