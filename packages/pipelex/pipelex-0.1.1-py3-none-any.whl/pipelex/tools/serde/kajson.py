"""
This file includes portions derived from an original work by Bastien Pietropaoli,
licensed under the Apache License, Version 2.0. Those portions are governed by the
Apache License. Copyright © 2018 Bastien Pietropaoli See the license text at:
    http://www.apache.org/licenses/LICENSE-2.0

All other portions of this code, including modifications, enhancements, and new features,
are © 2024-2025 Pipelex, All rights reserved.
"""
...
from pipelex.tools.serde.json_decoder import UniversalJSONDecoder
from pipelex.tools.serde.json_encoder import UniversalJSONEncoder
