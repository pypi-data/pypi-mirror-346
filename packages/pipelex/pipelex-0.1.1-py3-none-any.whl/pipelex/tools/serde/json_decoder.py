...
are © 2024 Pipelex, All rights reserved.
"""
...
from pipelex.tools.class_registry import class_registry
...
class KajsonDecoderError(ToolException):
    pass
    ...
    def universal_decoder(self, the_dict: Dict[str, Any]) -> Any:
        ...
        if module_name in all_mods:
            ...
            try:
                ...
                self.log(error_msg)
                raise ToolException(error_msg) from exc
