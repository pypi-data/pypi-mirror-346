...
from pipelex.tools.utils.module_utils import find_classes_in_module, import_module_from_file
...
class ClassRegistryInheritanceError(ToolException):
    pass


class ClassRegistryNotFoundError(ToolException):
    pass
