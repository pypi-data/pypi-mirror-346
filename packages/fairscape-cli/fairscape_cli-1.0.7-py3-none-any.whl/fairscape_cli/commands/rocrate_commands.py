...
def addSoftware(
    ...
    try:
        copied_filepath = CopyToROCrate(source_filepath, destination_filepath, rocrate_path)
    except Exception as exc:
...
def addDataset(
    ...
    try:
        copied_filepath = CopyToROCrate(source_filepath, destination_filepath, rocrate_path)
        click.echo(f"Copied '{source_filepath}' to '{copied_filepath}' inside the crate.")
