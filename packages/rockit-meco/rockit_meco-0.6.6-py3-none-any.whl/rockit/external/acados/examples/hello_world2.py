...
#xp1 = ocp.state()
#ocp.set_der(xp1,x1-xp1)
#ocp.subject_to(ocp.at_t0(xp1)==0)
#ocp.subject_to(xp1 >= -0.25)
...
#method = external_method('acados', intg='rk',N=10,qp_solver='PARTIAL_CONDENSING_HPIPM',nlp_solver_max_iter=200,hessian_approx='EXACT',regularize_method = 'CONVEXIFY',integrator_type='ERK',nlp_solver_type='SQP',qp_solver_cond_N=10)
ocp.method(MultipleShooting(N=10,intg='rk'))
...
#_, xp1a = sol.sample(xp1, grid='control')
