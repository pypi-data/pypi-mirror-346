classdef Stage < handle
  ...
  methods
    ...
    function varargout = subject_to(obj,varargin)
      ...
      % Arguments: constr, grid=None, include_first=True, include_last=True, scale=1, refine=1, group_refine=<rockit.grouping_techniques.GroupingTechnique object at 0x7fc5c3d65400>, group_dim=<rockit.grouping_techniques.GroupingTechnique object at 0x7fc5c3d65430>, group_control=<rockit.grouping_techniques.GroupingTechnique object at 0x7fc5c3d65460>, meta=None
      % 
      %         Parameters
      %         ----------
