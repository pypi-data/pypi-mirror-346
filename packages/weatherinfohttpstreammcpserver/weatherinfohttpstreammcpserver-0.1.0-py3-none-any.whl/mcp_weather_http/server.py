...
USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.248 Safari/537.36"
...
async def fetch_weather(city: str, api_key: str) -> dict[str, str]:
    ...
    async with httpx.AsyncClient(timeout=60) as client:
        r = await client.get(OPENWEATHER_URL, params=params,headers=headers,timeout=60)
        r.raise_for_status()
        data = r.json()
