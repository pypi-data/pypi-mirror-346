...
from whoisfreaks import WhoisfreaksApi
client = WhoisfreaksApi(..., )
response = client.with_raw_response.get_live_whois_information_for_multiple_domains(...)
...
```python
client.get_live_whois_information_for_multiple_domains(..., request_options={
    "max_retries": 1
})
```
