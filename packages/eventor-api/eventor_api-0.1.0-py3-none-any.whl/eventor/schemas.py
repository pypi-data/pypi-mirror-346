...
class EventRace(BaseXmlModel, search_mode="ordered"):
    ...
    event_position: Position | None = element("EventCenterPosition", default=None)
...
class Event(BaseXmlModel, tag="Event", search_mode="ordered"):
    ...
    # organisers: list[Organisation] = wrapped(
    # "Organiser",
    # element(tag="Organisation"), default_factory=list
    # )
...
class Person(BaseXmlModel, search_mode="ordered"):
    ...
    nationality: Country = wrapped("Nationality", element("Country", default=None))
...
class ClassResult(BaseXmlModel, search_mode="ordered"):
    ...
    class_result: list[PersonResult] = element("PersonResult", default_factory=list)
