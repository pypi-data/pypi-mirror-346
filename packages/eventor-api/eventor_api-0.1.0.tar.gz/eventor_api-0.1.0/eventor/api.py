...
class EventorAPI:
    ...
    def get_events(
        ...
        if organisationIds:
            params["organisationIds"] = organisationIds
        ...
        print(resp, file=open("debug.xml", "w+"))
    ...
    def get_all_results_for_person(
        ...
        print(resp.content, file=open("debug.xml", "w+"))
    ...
    def get_all_persons_in_own_organization(self) -> Iterator[Person]:
        ...
        resp = self._make_call(
            Endpoint.PERSONS, params, headers, extra_path=str(org.organisation_id)
        )
        print(resp.content, file=open("debug.xml", "w+"))
    ...
    def parse_distance(text: str) -> int:
        """Parse distance in the format as it is displayed on Result pages in Eventor."""
        number = (
            (
    ...
    def get_course_distances(self, event: EventRace) -> dict[str, int]:
        ...
        divs = soup.findAll(class_="eventClassHeader")
        for div in divs:
