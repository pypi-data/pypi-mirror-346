...
const chunkTypeEnum = z.enum(['start', 'content', 'end'] as const) satisfies z.ZodType<ChunkType>;
const queryTypeEnum = z.enum(['simple_query', 'agent'] as const) satisfies z.ZodType<QueryType>;
const cellOpTypeEnum = z.enum(['create_cell', 'update_cell', 'delete_cell'] as const);
