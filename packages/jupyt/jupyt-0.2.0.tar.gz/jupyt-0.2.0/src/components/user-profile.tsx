...
import { getUserFromStorage, clearUserData, getApiKey, saveUserToStorage } from '../config';
import { IUser, IUserResponse, ILoginRequest, IRegisterRequest } from '../types/auth';
...
const UserProfile: React.FC = () => {
  ...
  const [loginData, setLoginData] = useState<ILoginRequest>({ username: '', password: '' });
  const [registerData, setRegisterData] = useState<IRegisterRequest>({ name: '', email: '', password: '' });
