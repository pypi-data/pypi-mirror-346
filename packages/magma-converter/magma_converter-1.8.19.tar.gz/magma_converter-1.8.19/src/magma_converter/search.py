...
class Search:
    def __init__(self,
        ...
        self.directory_structure = validate_directory_structure(directory_structure) if directory_structure != 'sds' \
    ...
    def search(self, date_str: str) -> Stream:
        ...
        if directory_structure == 'ijen' or directory_structure in directory_structures_group['ijen']:
            stream = self.ijen(date_str)

        if directory_structure == 'dieng' or directory_structure in directory_structures_group['dieng']:
            stream = self.dieng(date_str)

        if directory_structure == 'idds' or directory_structure in ['idds']:
            stream = self.idds(date_str)

        if directory_structure == 'seisan' or directory_structure in directory_structures_group['seisan']:
            stream = self.seisan(date_str)

        if directory_structure == 'sac' or directory_structure in directory_structures_group['sac']:
