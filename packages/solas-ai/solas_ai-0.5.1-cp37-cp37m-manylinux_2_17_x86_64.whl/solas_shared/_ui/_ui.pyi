...
class Ui:
    ...
    def print(self, text: Union[str, Any]) -> None: ...
    def print_debug(self, text: Union[str, Any]) -> None: ...
    def print_markdown(self, markdown: str) -> None: ...
    def clean_string(self, val: str) -> str: ...
    def show(self, obj: Union[pd.DataFrame, Any]) -> None: ...
    @staticmethod
    def suppress_stdout() -> Generator[None, None, None]: ...
    def init_notebook(self) -> None: ...
    def df_to_table(self, df: pd.DataFrame, rich_table: Table, show_index: bool = ..., index_name: Optional[str] = ...) -> Table: ...
