...
def true_negative_rate(group_data: pd.DataFrame, protected_groups: List[str], reference_groups: List[str], group_categories: List[str], outcome: pd.Series, label: pd.Series, ratio_threshold: float, difference_threshold: float, sample_weight: Optional[pd.Series] = ...) -> Disparity: ...
