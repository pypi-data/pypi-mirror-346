...
class MultiIndex(Index):
    ...
    def get_loc(self, key): # -> Any | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | ndarray[Any, Any] | ndarray[_Shape, dtype[bool_]] | ndarray[_Shape, dtype[Any]] | slice[Any, Any, Any] | _Array1D[Any] | int | integer[Any] | ndarray[tuple[int], dtype[signedinteger[_NBitIntP]]] | slice[int, int, Any] | None:
        """
    ...
    def get_loc_level(self, key, level: IndexLabel = ..., drop_level: bool = ...): # -> tuple[int | integer[Any] | _Array1D[Any] | Any | ndarray[_Shape, dtype[bool_]] | ndarray[_Shape, dtype[Any]] | ndarray[Any, Any] | ndarray[tuple[int], dtype[signedinteger[_NBitIntP]]] | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | slice[Any, Any, Any] | slice[int, int, Any] | None, tuple[Any, ...] | MultiIndex | Index | Any | None]:
        """
