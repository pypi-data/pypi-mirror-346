...
class MaleoMetadataBloodTypeHTTPController(MaleoClientHTTPController):
    ...
    async def get_blood_type(self, parameters:MaleoMetadataBloodTypeGeneralParametersTransfers.GetSingle) -> BaseClientHTTPControllerResults:
        ...
        async with self._manager.get_client() as client:
            ...
            #* Parse parameters to query params
            params = MaleoMetadataBloodTypeGeneralParametersTransfers.GetSingleQuery.model_validate(parameters.model_dump()).model_dump(exclude={"sort_columns", "date_filters"}, exclude_none=True)
