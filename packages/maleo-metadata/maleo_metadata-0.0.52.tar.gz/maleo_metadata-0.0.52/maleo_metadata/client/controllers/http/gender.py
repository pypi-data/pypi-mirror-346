...
class MaleoMetadataGenderHTTPController(MaleoClientHTTPController):
    ...
    async def get_gender(self, parameters:MaleoMetadataGenderGeneralParametersTransfers.GetSingle) -> BaseClientHTTPControllerResults:
        ...
        async with self._manager.get_client() as client:
            ...
            #* Parse parameters to query params
            params = MaleoMetadataGenderGeneralParametersTransfers.GetSingleQuery.model_validate(parameters.model_dump()).model_dump(exclude={"sort_columns", "date_filters"}, exclude_none=True)
