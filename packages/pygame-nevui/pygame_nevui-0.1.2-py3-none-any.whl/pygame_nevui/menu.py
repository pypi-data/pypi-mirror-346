import pygame
import copy
from .style import StyleType, Style, StyleManager, default_style, default_style_manager, Gradient, Align
from .utils import time, mouse, Event, RoundedSurface
from .color import Color_Type, ColorType, Color
from .window import Window
from .animations import Animation, AnimationManager, AnimationEaseInOut, AnimationType, AnimationLinear
from .widgets import Widget, Button

class NevuInfo:
    VERSION = 0.12
    RELEASE = "Alpha"
    AUTHOR = "Golem bebrov(Nikita)"
