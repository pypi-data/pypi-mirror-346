...
class AnimationEaseOutBack(Animation):
    def _animation_update(self, value):
        ...
        self._apply_easing(eased_value)
class AnimationEaseInElastic(Animation):
    def _animation_update(self, value):
        """Applies ease-in elastic easing to the animation."""
        c4 = (2 * math.pi) / 3
        if value == 0:
            eased_value = 0
        elif value == 1:
            ...
            eased_value = -math.pow(2, 10 * value - 10) * math.sin((value * 10 - 10.75) * c4)
        self._apply_easing(eased_value)

class AnimationEaseOutElastic(Animation):
    def _animation_update(self, value):
        """Applies ease-out elastic easing to the animation."""
        c4 = (2 * math.pi) / 3
        if value == 0:
            eased_value = 0
        elif value == 1:
            ...
            eased_value = math.pow(2, -10 * value) * math.sin((value * 10 - 0.75) * c4) + 1
        self._apply_easing(eased_value)

class AnimationEaseInOutElastic(Animation):
    def _animation_update(self, value):
        """Applies ease-in-out elastic easing to the animation."""
        c5 = (2 * math.pi) / 4.5
        if value == 0:
            eased_value = 0
        elif value == 1:
            ...
            eased_value = -(math.pow(2, 20 * value - 10) * math.sin((20 * value - 11.125) * c5)) / 2
        else:
            eased_value = (math.pow(2, -20 * value + 10) * math.sin((20 * value - 11.125) * c5)) / 2 + 1
        self._apply_easing(eased_value)
