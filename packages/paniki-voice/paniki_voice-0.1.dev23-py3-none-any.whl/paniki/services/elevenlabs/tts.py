...
from paniki.services.tts_service import InterruptibleWordTTSService, WordTTSService
...
try:
    ...
    logger.error("In order to use ElevenLabs, you need to `pip install paniki-voice[elevenlabs]`.")
