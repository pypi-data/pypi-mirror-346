...
from paniki.adapters.services.open_ai_realtime_adapter import OpenAIRealtimeLLMAdapter
...
from paniki.services.openai.llm import OpenAIContextAggregatorPair
...
try:
    ...
    logger.error("In order to use OpenAI, you need to `pip install paniki-voice[openai]`.")
