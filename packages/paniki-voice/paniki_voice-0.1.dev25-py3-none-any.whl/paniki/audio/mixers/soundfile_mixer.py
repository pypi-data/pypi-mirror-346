...
from paniki.audio.mixers.base_audio_mixer import BaseAudioMixer
from paniki.frames.frames import MixerControlFrame, MixerEnableFrame, MixerUpdateSettingsFrame
...
try:
    ...
    logger.error(
        "In order to use the soundfile mixer, you need to `pip install paniki-voice[soundfile]`."
    )
