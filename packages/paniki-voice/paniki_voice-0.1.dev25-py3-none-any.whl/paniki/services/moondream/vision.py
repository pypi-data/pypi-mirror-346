...
from paniki.frames.frames import ErrorFrame, Frame, TextFrame, VisionImageRawFrame
from paniki.services.vision_service import VisionService
...
try:
    ...
    logger.error("In order to use Moondream, you need to `pip install paniki-voice[moondream]`.")
