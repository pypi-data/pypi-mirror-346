...
from paniki.adapters.services.anthropic_adapter import AnthropicLLMAdapter
...
try:
    ...
    logger.error("In order to use Anthropic, you need to `pip install paniki-voice[anthropic]`.")
