...
from paniki.serializers.base_serializer import FrameSerializer, FrameSerializerType
...
try:
    ...
    logger.error(
        "In order to use FastAPI websockets, you need to `pip install paniki-voice[websocket]`."
    )
