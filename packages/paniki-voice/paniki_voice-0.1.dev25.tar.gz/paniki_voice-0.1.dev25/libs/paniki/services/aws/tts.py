...
try:
    ...
    logger.error(
        "In order to use Deepgram, you need to `pip install paniki-voice[aws]`. Also, set `AWS_SECRET_ACCESS_KEY`, `AWS_ACCESS_KEY_ID`, and `AWS_REGION` environment variable."
    )
