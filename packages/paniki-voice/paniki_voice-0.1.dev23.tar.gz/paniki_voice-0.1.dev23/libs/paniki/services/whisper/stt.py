...
from paniki.frames.frames import ErrorFrame, Frame, TranscriptionFrame
from paniki.services.stt_service import SegmentedSTTService
...
if TYPE_CHECKING:
    try:
        ...
        logger.error("In order to use Whisper, you need to `pip install paniki-voice[whisper]`.")
    ...
    try:
        ...
        logger.error(f"Exception: {e}")
        logger.error("In order to use Whisper, you need to `pip install paniki-voice[mlx-whisper]`.")
        raise Exception(f"Missing module: {e}")
