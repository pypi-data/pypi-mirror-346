...
from paniki.processors.frame_processor import FrameDirection, FrameProcessor, StartFrame
...
try:
    ...
    logger.error("In order to use Simli, you need to `pip install paniki-voice[simli]`.")
