...
from paniki.audio.turn.smart_turn.base_smart_turn import BaseSmartTurn
...
try:
    ...
    logger.error(
        "In order to use the LocalSmartTurnAnalyzer, you need to `pip install paniki-voice[local-smart-turn]`."
    )
