"""
Template for Supabase database server NGINX configuration with SSL/HTTP2 support.
"""

TEMPLATE = """# Template for Supabase database server configuration nginx incl. SSL/http2
# 07.04.2025
...
server {
    ...
    location /realtime/v1 {
        ...
        proxy_pass http://127.0.0.1:{{PORT}}/realtime/v1;
    }
    ...
    location /rest/v1/ {
        ...
        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
        proxy_set_header X-Forwarded-Proto https;
        proxy_pass http://127.0.0.1:{{PORT}}/rest/v1/;
    }
    ...
    location /graphql/v1 {
        ...
        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
        proxy_set_header X-Forwarded-Proto https;
        proxy_pass http://127.0.0.1:{{PORT}}/graphql/v1;
    }
    ...
    location /auth/v1 {
        ...
        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
        proxy_set_header X-Forwarded-Proto https;
        proxy_pass http://127.0.0.1:{{PORT}}/auth/v1;
    }
    ...
    location /storage/v1 {
        ...
        proxy_pass http://127.0.0.1:{{PORT}}/storage/v1;
    }
