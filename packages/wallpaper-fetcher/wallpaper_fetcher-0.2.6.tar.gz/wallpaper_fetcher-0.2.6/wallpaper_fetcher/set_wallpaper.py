...
# ---------------------------------------------------------------------------- #
#         source code from here: https://github.com/1j01/textual-paint         #
#         adapted to use Paths instead of string in set_wallpaper()            #
# ---------------------------------------------------------------------------- #
...
def set_wallpaper(file_loc: Path, first_run: bool = True):
    ...
    file_loc = str(file_loc.absolute())
    ...
    #     subprocess.Popen(args)
        ...
        if first_run:  # don't spam the user with the same message over and over again
            ...
            sys.stderr.write(
                f"You can try manually to set your wallpaper to {file_loc}"
            )
        return False
    return True
