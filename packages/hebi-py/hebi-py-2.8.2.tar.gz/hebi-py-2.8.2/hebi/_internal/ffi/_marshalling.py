...
class CommandLEDField(WeakReferenceContainer["HebiCommandRef"]):
  ...
  @property
  def led(self):
    return color_from_int(self._ref.led_fields_[self._field.value])

  @led.setter
  def led(self, value: 'Colorable | None'):
    api.hwCommandSetLed(self._ref, __get_led_value(value), 1, self._field)

  def clear(self):
    api.hwCommandSetLed(self._ref, None, 1, self._field)
