...
[![PyPI Version](https://img.shields.io/badge/v0.36.1-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.36.1,<0.37.0"
```
