...
[![PyPI Version](https://img.shields.io/badge/v0.28.3-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.28.3,<0.29.0"
```
