...
[![PyPI Version](https://img.shields.io/badge/v0.34.0-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.34.0,<0.35.0"
```
