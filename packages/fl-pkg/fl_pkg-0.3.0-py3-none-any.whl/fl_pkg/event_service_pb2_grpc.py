...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEventStream = channel.unary_stream(
                '/event_service.EventService/GetEventStream',
...
def add_EventServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'event_service.EventService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('event_service.EventService', rpc_method_handlers)
