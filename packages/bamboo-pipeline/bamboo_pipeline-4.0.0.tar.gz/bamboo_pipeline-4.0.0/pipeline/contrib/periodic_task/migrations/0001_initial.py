    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "minute",
                    models.CharField(default=b"*", max_length=64, verbose_name="minute"),
                ),
                (
                    "hour",
                    models.CharField(default=b"*", max_length=64, verbose_name="hour"),
                ),
                (
                    "day_of_week",
                    models.CharField(default=b"*", max_length=64, verbose_name="day of week"),
                ),
                (
                    "day_of_month",
                    models.CharField(default=b"*", max_length=64, verbose_name="day of month"),
                ),
                (
                    "month_of_year",
                    models.CharField(default=b"*", max_length=64, verbose_name="month of year"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "ident",
                    models.SmallIntegerField(default=1, unique=True, serialize=False, primary_key=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cron",
                    models.CharField(max_length=128, verbose_name="\u8c03\u5ea6\u7b56\u7565"),
                ),
                (
                    "total_run_count",
                ...
                (
                    "last_run_at",
                    models.DateTimeField(null=True, verbose_name="\u4e0a\u6b21\u8fd0\u884c\u65f6\u95f4"),
                ),
                (
                    "creator",
                    models.CharField(default=b"", max_length=32, verbose_name="\u521b\u5efa\u8005"),
                ),
                (
                    "extra_info",
                    pipeline.models.CompressJSONField(verbose_name="\u989d\u5916\u4fe1\u606f", null=True),
                ),
                (
                    "celery_task",
                    models.ForeignKey(
