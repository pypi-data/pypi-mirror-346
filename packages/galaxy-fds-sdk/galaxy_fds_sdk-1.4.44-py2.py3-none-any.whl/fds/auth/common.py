class Common(object):
  ...
  META_CONTENT_LENGTH = XIAOMI_META_HEADER_PREFIX+CONTENT_LENGTH
  ...
  COPY_SOURCE = XIAOMI_HEADER_PREFIX + "copy-source"
  COPY_SOURCE_RANGE = XIAOMI_HEADER_PREFIX + "copy-source-range"
  HASH_CRC64ECMA = XIAOMI_HEADER_PREFIX + "hash-crc64ecma"
