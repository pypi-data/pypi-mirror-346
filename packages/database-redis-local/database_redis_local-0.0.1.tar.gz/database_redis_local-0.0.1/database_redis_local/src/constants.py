...
CRUD_REDIS_TEST_LOGGER_OBJECT = LOGGER_CRUD_CODE_OBJECT.copy()
CRUD_REDIS_TEST_LOGGER_OBJECT['component_category'] = LoggerComponentEnum.ComponentCategory.Unit_Test.value
