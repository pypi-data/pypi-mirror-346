...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, content_guard=None, base_path=None, pulp_last_updated=None, name=None, pulp_created=None, pulp_labels=None, base_url=None, hidden=False, local_vars_configuration=None):  # noqa: E501
