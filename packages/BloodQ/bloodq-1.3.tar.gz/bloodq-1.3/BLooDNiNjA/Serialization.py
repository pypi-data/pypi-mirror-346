...
from BLooDNiNjA import OutputDirectories
from BLooDNiNjA.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from BLooDNiNjA.Builtins import (
    builtin_anon_codes,
    builtin_anon_values,
...
from BLooDNiNjA.code_generation.Namify import namifyConstant
from BLooDNiNjA.containers.OrderedSets import OrderedSet
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.utils.FileOperations import openPickleFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<BLooDNiNjA.Serialization.BlobData %s>" % self.name
...
class GlobalConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in BLooDNiNjA.Builtins
