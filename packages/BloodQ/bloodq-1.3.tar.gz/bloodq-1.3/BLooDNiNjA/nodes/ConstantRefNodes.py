...
from BLooDNiNjA.__past__ import (
    GenericAlias,
    UnionType,
    iterItems,
    long,
...
from BLooDNiNjA.Constants import (
...
from BLooDNiNjA.Tracing import optimization_logger
...
class ExpressionConstantTypeRef(ExpressionConstantUntrackedRefBase):
    ...
    def computeExpressionCall(self, call_node, call_args, call_kw, trace_collection):
        ...
        if call_kw is not None and not call_kw.isMappingWithConstantStringKeys():
            ...
            from BLooDNiNjA.optimizations.OptimizeBuiltinCalls import (
                computeBuiltinCall,
            )
