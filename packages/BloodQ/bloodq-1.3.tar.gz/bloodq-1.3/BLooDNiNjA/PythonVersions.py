...
def getTargetPythonDLLPath():
    ...
    from BLooDNiNjA.Options import shallUsePythonDebug
...
def getLaunchingSystemPrefixPath():
    from BLooDNiNjA.utils.Utils import getLaunchingBloodQProcessEnvironmentValue
...
def getSystemPrefixPath():
    ...
    if _the_sys_prefix is None:
        ...
        if os.name == "nt":
            from BLooDNiNjA.utils.FileOperations import getDirectoryRealPath
