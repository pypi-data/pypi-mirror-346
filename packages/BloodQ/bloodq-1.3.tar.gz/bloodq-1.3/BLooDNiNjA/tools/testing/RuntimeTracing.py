...
from BLooDNiNjA.freezer.DependsExe import getDependsExePath, parseDependsExeOutput
...
from BLooDNiNjA.utils.Utils import isFreeBSD, isMacOS, isWin32Windows
...
def _getRuntimeTraceOfLoadedFilesWin32(logger, command, required):
    ...
    # TODO: Move the handling of this into BLooDNiNjA.tools.Execution module methods.
    try:
