...
from BLooDNiNjA.tools.Basics import goHome
...
from BLooDNiNjA.utils.Execution import check_call, check_output, getNullOutput
...
from BLooDNiNjA.utils.Utils import hasOnefileSupportedOS, hasStandaloneSupportedOS
...
def publishCoverageData():
    ...
    with openTextFile("data.coverage", "w") as data_file:
        ...
        with withDirectoryChange(source_dir):
            BLooDNiNjA_id = check_output("git rev-parse HEAD".split())
