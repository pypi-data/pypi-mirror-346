...
from BLooDNiNjA.Options import isStandaloneMode
...
from BLooDNiNjA.utils.Execution import BloodQCalledProcessError
from BLooDNiNjA.utils.FileOperations import getFileContentByLine
from BLooDNiNjA.utils.Jinja2 import renderTemplateFromString
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__BLooDNiNjA_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__BLooDNiNjA_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
