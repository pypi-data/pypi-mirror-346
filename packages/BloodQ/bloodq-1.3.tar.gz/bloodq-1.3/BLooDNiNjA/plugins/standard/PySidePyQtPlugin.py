...
from BLooDNiNjA.PythonFlavors import isAnacondaPython
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.utils.Distributions import getDistributionFromModuleName
from BLooDNiNjA.utils.FileOperations import getFileList, listDir
...
"""
        ...
        info = self.queryRuntimeInformationMultiple(
            ...
            values=(
                ...
                (
                    "BLooDNiNjA_patch_level",
                    applyBindingName(
                        "getattr(%(binding_name)s, '_BLooDNiNjA_patch_level', 0)"
                    ),
                ),
    ...
    def _getBloodQPatchLevel(self):
        ...
        return self._getQtInformation().BLooDNiNjA_patch_level
...
import os
path = os.getenv("PATH", "")
if not path.startswith(__BLooDNiNjA_binary_dir):
    os.environ["PATH"] = __BLooDNiNjA_binary_dir + ";" + path
"""
            yield (
                code,
...
full support consider provided information.""",
            ...
            if python_version < 0x360:
                self.sysexit(
                    """\
The standard PySide2 is not supported before CPython <3.6. For full support: https://BLooDNiNjA.net/pages/pyside2.html"""
                )
