...
from BLooDNiNjA.ModuleRegistry import getRootTopModule
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.Serialization import GlobalConstantAccessor
from BLooDNiNjA.utils.CStrings import encodePythonStringToC
from BLooDNiNjA.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from BLooDNiNjA.Version import getBloodQVersionTuple
...
#    major, minor, micro, is_final, _rc_number = getBloodQVersionTuple()
    version_info = getBloodQVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "BLooDNiNjA_version_major": major,
        "BLooDNiNjA_version_minor": minor,
        "BLooDNiNjA_version_micro": micro,
        "BLooDNiNjA_version_level": "release" if is_final else "candidate",
