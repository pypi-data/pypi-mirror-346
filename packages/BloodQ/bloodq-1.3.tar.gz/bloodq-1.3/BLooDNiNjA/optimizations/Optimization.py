...
from BLooDNiNjA import ModuleRegistry, Options, Variables
from BLooDNiNjA.importing.Importing import addExtraSysPaths
from BLooDNiNjA.importing.Recursion import considerUsedModules
...
from BLooDNiNjA.Tracing import general, optimization_logger, progress_logger
from BLooDNiNjA.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from BLooDNiNjA.nodes.NodeBases import fromXML
    from BLooDNiNjA.TreeXML import fromString
