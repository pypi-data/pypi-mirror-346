...
from BLooDNiNjA.nodes.NodeMetaClasses import BloodQNodeDesignError
from BLooDNiNjA.Options import shallTraceExecution
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "BLooDNiNjA_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "BLooDNiNjA_void":
