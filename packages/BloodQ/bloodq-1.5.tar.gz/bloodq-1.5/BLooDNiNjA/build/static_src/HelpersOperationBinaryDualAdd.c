 ...
 */
bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(BLooDNiNjA_ilong *result, BLooDNiNjA_ilong *operand1, BLooDNiNjA_ilong *operand2) {
 ...
 * Python objects. */
bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(BLooDNiNjA_ilong *result, BLooDNiNjA_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
