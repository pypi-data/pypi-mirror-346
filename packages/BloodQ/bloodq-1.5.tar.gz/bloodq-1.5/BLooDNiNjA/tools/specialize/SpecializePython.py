...
import sys
import BLooDNiNjA.Options

BLooDNiNjA.Options.is_full_compat = False
...
import BLooDNiNjA.code_generation.BinaryOperationHelperDefinitions
import BLooDNiNjA.code_generation.CodeGeneration
import BLooDNiNjA.code_generation.ComparisonCodes
import BLooDNiNjA.code_generation.Namify
import BLooDNiNjA.nodes.NetworkxNodes
import BLooDNiNjA.nodes.PackageMetadataNodes
import BLooDNiNjA.nodes.PackageResourceNodes
import BLooDNiNjA.nodes.SideEffectNodes
import BLooDNiNjA.nodes.TensorflowNodes
import BLooDNiNjA.specs.BuiltinBytesOperationSpecs
import BLooDNiNjA.specs.BuiltinDictOperationSpecs
import BLooDNiNjA.specs.BuiltinListOperationSpecs
import BLooDNiNjA.specs.BuiltinStrOperationSpecs
import BLooDNiNjA.specs.BuiltinTypeOperationSpecs
import BLooDNiNjA.specs.HardImportSpecs
import BLooDNiNjA.tree.Building
from BLooDNiNjA.containers.OrderedDicts import OrderedDict
from BLooDNiNjA.containers.OrderedSets import OrderedSet
from BLooDNiNjA.nodes.ImportNodes import hard_modules_non_stdlib
from BLooDNiNjA.nodes.NodeMetaClasses import NodeCheckMetaClass
from BLooDNiNjA.nodes.shapes.BuiltinTypeShapes import (
    tshape_bool,
    tshape_bytes,
    tshape_dict,
    tshape_int,
...
from BLooDNiNjA.utils.Jinja2 import getTemplate
...
def _getMixinForShape(shape):
    ...
    if shape is tshape_str:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionStrShapeExactMixin"
    elif shape is tshape_list:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionListShapeExactMixin"
    elif shape is tshape_tuple:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionTupleShapeExactMixin"
    elif shape is tshape_int:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionIntShapeExactMixin"
    elif shape is tshape_bool:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionBoolShapeExactMixin"
    elif shape is tshape_none:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionNoneShapeExactMixin"
    elif shape is tshape_dict:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionDictShapeExactMixin"
    elif shape is tshape_bytes:
        return "BLooDNiNjA.nodes.ExpressionShapeMixins.ExpressionBytesShapeExactMixin"
    else:
        assert False, shape
...
processTypeShapeAttribute(
    "tshape_dict",
    BLooDNiNjA.specs.BuiltinDictOperationSpecs,
    python2_dict_methods,
    python3_dict_methods,
    ("fromkeys",),
)
...
processTypeShapeAttribute(
    "tshape_str",
    BLooDNiNjA.specs.BuiltinStrOperationSpecs,
    python2_str_methods,
    python3_str_methods,
)
...
processTypeShapeAttribute(
    "tshape_bytes",
    BLooDNiNjA.specs.BuiltinBytesOperationSpecs,
    (),
    python3_bytes_methods,
)
...
processTypeShapeAttribute(
    "tshape_list",
    BLooDNiNjA.specs.BuiltinListOperationSpecs,
    python2_list_methods,
    python3_list_methods,
)
...
processTypeShapeAttribute(
    "tshape_type",
    BLooDNiNjA.specs.BuiltinTypeOperationSpecs,
    python2_type_methods,
    python3_type_methods,
)
...
def emitGenerationWarning(emit, doc_string, template_name):
    ...
    for spec_descriptions in getSpecVersions(BLooDNiNjA.specs.HardImportSpecs):
...
def makeAttributeNodes():
    filename_python = "BLooDNiNjA/nodes/AttributeNodesGenerated.py"
    ...
    with withFileOpenedAndAutoFormatted(
        ...
        emit("from BLooDNiNjA.specs.BuiltinParameterSpecs import extractBuiltinArgs")

        emit("from BLooDNiNjA.nodes.ConstantRefNodes import makeConstantRefNode")
        emit(
            """\
from BLooDNiNjA.nodes.NodeMakingHelpers import (
    ...
    makeRaiseExceptionReplacementExpression
        ...
        emit(
            "from BLooDNiNjA.nodes.KeyValuePairNodes import makeKeyValuePairExpressionsFromKwArgs"
        )

        emit("from BLooDNiNjA.nodes.AttributeNodes import makeExpressionAttributeLookup")

        emit("from BLooDNiNjA.PythonVersions import getDictFromkeysNoArgErrorMessage")
...
def makeBuiltinOperationNodes():
    filename_python = "BLooDNiNjA/nodes/BuiltinOperationNodeBasesGenerated.py"
...
def makeChildrenHavingMixinNodes():
    ...
    filename_python = "BLooDNiNjA/nodes/ChildrenHavingMixins.py"
    filename_python2 = "BLooDNiNjA/nodes/ExpressionBasesGenerated.py"
    filename_python3 = "BLooDNiNjA/nodes/StatementBasesGenerated.py"
    ...
    with withFileOpenedAndAutoFormatted(
        ...
        emit1(
            """
from BLooDNiNjA.nodes.Checkers import (
    checkStatementsSequenceOrNone,
...
def makeHardImportNodes():
    ...
    filename_python = "BLooDNiNjA/nodes/HardImportNodesGenerated.py"
