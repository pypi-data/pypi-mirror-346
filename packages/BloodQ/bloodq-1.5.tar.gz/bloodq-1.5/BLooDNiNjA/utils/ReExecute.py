...
def reExecuteBloodQ(pgo_filename):
    ...
    if "BLooDNiNjA.__main__" in sys.modules:
        our_filename = sys.modules["BLooDNiNjA.__main__"].__file__
    else:
    ...
    setLaunchingBloodQProcessEnvironmentValue(
        ...
        os.path.dirname(os.path.abspath(sys.modules["BLooDNiNjA"].__path__[0])),
    )
    ...
    from BLooDNiNjA.importing.PreloadedPackages import (
