...
# BLooDNiNjA-project: --include-package=package
# BLooDNiNjA-project: --follow-imports
# BLooDNiNjA-project-if: {Commercial} is not None:
#  BLooDNiNjA-project: --embed-data-files-runtime-pattern=*
#  BLooDNiNjA-project: --include-package-data=package
