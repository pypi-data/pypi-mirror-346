...
""" Pacman backend for maintaining locked package state with BLooDNiNjA-watch. """

from BLooDNiNjA.utils.Execution import check_call, executeToolChecked
from BLooDNiNjA.utils.FileOperations import changeTextFileContents, openTextFile
