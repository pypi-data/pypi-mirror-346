...
#if PYTHON_VERSION >= 0x300
#if _BloodSx_EXE_MODE && !_BloodSx_STANDALONE_MODE
...
"
...

    {
        BloodSx_MAY_BE_UNUSED PyObject *module =
            PyImport_ExecCodeModule("BLooDNiNjA_types_patch", wrapper_enhancement_code_object);
        CHECK_OBJECT(module);

        BloodSx_MAY_BE_UNUSED bool bool_res = BloodQ_DelModuleString(tstate, "BLooDNiNjA_types_patch");
