...
from BLooDNiNjA import Options, Tracing
...
from BLooDNiNjA.utils.AppDirs import getCacheDirEnvironmentVariableName
from BLooDNiNjA.utils.Download import getDownloadCacheDir, getDownloadCacheName
...
from BLooDNiNjA.utils.SharedLibraries import detectBinaryMinMacOS
...
def _setupSconsEnvironment2():
    ...
    os.environ["BloodSx_PACKAGE_DIR"] = os.path.abspath(BLooDNiNjA.__path__[0])
...
def runScons(scons_options, env_values, scons_filename):
    with _setupSconsEnvironment():
        ...
        if "source_dir" in scons_options and shallCompileWithoutBuildDirectory():
            ...
            scons_options["BLooDNiNjA_src"] = getExternalUsePath(
                scons_options["BLooDNiNjA_src"]
            )
...
def getCommonSconsOptions():
    ...
    scons_options["BLooDNiNjA_src"] = getSconsDataPath()
