...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return BloodQ_Function_GetFunctionState(function, function_table_%(module_identifier)s);
}
...
#if _BloodSx_MODULE_MODE && %(is_top)d
...
#if _BloodSx_MODULE_MODE || !%(is_dunder_main)s
...
#if _BloodSx_MODULE_MODE && %(is_top)d && %(module_def_size)s >= 0
