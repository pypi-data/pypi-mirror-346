...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    static PyStructSequence_Desc BloodQ_VersionInfoDesc = {
        (char *)"__BLooDNiNjA_version__",                                       /* name */
    ...
    PyStructSequence_SET_ITEM(BloodQ_dunder_compiled_value, 0, BloodQ_PyInt_FromLong(%(BLooDNiNjA_version_major)s));
    PyStructSequence_SET_ITEM(BloodQ_dunder_compiled_value, 1, BloodQ_PyInt_FromLong(%(BLooDNiNjA_version_minor)s));
    PyStructSequence_SET_ITEM(BloodQ_dunder_compiled_value, 2, BloodQ_PyInt_FromLong(%(BLooDNiNjA_version_micro)s));

    PyStructSequence_SET_ITEM(BloodQ_dunder_compiled_value, 3, BloodQ_String_FromString("%(BLooDNiNjA_version_level)s"));
