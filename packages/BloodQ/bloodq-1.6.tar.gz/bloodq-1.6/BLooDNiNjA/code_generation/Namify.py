...
from BLooDNiNjA.__past__ import GenericAlias, UnionType, long, md5, unicode, xrange
from BLooDNiNjA.Builtins import builtin_anon_values, builtin_named_values_list
