...
from BLooDNiNjA.utils.SharedLibraries import getDllSuffix
from BLooDNiNjA.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".BLooDNiNjA-pgo"
