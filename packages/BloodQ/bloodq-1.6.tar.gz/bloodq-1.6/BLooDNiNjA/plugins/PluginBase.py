...
from BLooDNiNjA import Options
from BLooDNiNjA.__past__ import iter_modules, unicode
from BLooDNiNjA.containers.Namedtuples import makeNamedtupleClass
...
from BLooDNiNjA.Tracing import plugins_logger
from BLooDNiNjA.utils.AppDirs import getAppdirsModule
...
from BLooDNiNjA.utils.Importing import (
...
from BLooDNiNjA.utils.SharedLibraries import locateDLL, locateDLLsInDirectory
from BLooDNiNjA.utils.SlotMetaClasses import getMetaClassBase
...
def _getEvaluationContext():
    ...
    if _context_dict is None:
        _context_dict = {
            ...
            "BLooDNiNjA_python": isBloodQPython(),
...
def _getPackageData(package_name, resource, default=None):
    ...
    from BLooDNiNjA.utils.PackageResources import getPackageData
...
class BloodQPluginBase(getMetaClassBase("Plugin", require_slots=False)):
    ...
    What they are can be displayed using "BLooDNiNjA --plugin-list file.py" (filename
...
%(recommendation)s or uninstall it for best compatibility with pure Python execution."""
    ...
    def locateModules(module_name):
        ...
        from BLooDNiNjA.importing.Importing import locateModules
