...
""" Conda backend for maintaining locked package state with BLooDNiNjA-watch. """

from BLooDNiNjA.utils.Execution import check_call, executeToolChecked
from BLooDNiNjA.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "BLooDNiNjA-watch-case-%(python_version)s-%(case)s" % {
