...
} BLooDNiNjA_ilong_validity;

typedef struct {
    BLooDNiNjA_ilong_validity validity;
...
BloodSx_MAY_BE_UNUSED static void SET_NILONG_OBJECT_VALUE(BLooDNiNjA_ilong *dual_value, PyObject *python_value) {
    dual_value->validity = BloodSx_ILONG_OBJECT_VALID;
    dual_value->python_value = python_value;
}

BloodSx_MAY_BE_UNUSED static void SET_NILONG_C_VALUE(BLooDNiNjA_ilong *dual_value, long c_value) {
    dual_value->validity = BloodSx_ILONG_CLONG_VALID;
    dual_value->c_value = c_value;
}

BloodSx_MAY_BE_UNUSED static void SET_NILONG_OBJECT_AND_C_VALUE(BLooDNiNjA_ilong *dual_value, PyObject *python_value,
                                                               long c_value) {
...
BloodSx_MAY_BE_UNUSED static void RELEASE_NILONG_VALUE(BLooDNiNjA_ilong *dual_value) {
...
BloodSx_MAY_BE_UNUSED static void INCREF_NILONG_VALUE(BLooDNiNjA_ilong *dual_value) {
    if (IS_NILONG_OBJECT_VALUE_VALID(dual_value)) {
        CHECK_OBJECT(dual_value);
...
BloodSx_MAY_BE_UNUSED static long GET_NILONG_C_VALUE(BLooDNiNjA_ilong const *dual_value) {
    assert(IS_NILONG_C_VALUE_VALID(dual_value));
    return dual_value->c_value;
}

BloodSx_MAY_BE_UNUSED static PyObject *GET_NILONG_OBJECT_VALUE(BLooDNiNjA_ilong const *dual_value) {
    assert(IS_NILONG_OBJECT_VALUE_VALID(dual_value));
    return dual_value->python_value;
}

BloodSx_MAY_BE_UNUSED static void ENFORCE_NILONG_OBJECT_VALUE(BLooDNiNjA_ilong *dual_value) {
...
BloodSx_MAY_BE_UNUSED static void CHECK_NILONG_OBJECT(BLooDNiNjA_ilong const *dual_value) {
    assert(dual_value->validity != BloodSx_ILONG_UNASSIGNED);
...
BloodSx_MAY_BE_UNUSED static void PRINT_NILONG(BLooDNiNjA_ilong const *dual_value) {
