...
static BloodQ_DictEntryHandle GET_STRING_DICT_ENTRY(PyDictObject *dict, BloodQ_StringObject *key) {
    ...
    Py_hash_t hash = BloodQ_Py_unicode_get_hash((PyObject *)key);
...
extern uint64_t BLooDNiNjA_dict_version_tag_counter;
#endif
...
#if _BloodSx_MAINTAIN_DICT_VERSION_TAG
            dict->ma_version_tag = BLooDNiNjA_dict_version_tag_counter++;
#endif
            CHECK_OBJECT(old);
