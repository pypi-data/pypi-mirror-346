...
#include "BLooDNiNjA/unfreezing.h"
...
#if defined(_WIN32) && _BloodSx_STANDALONE_MODE
...
static PyObject *_BLooDNiNjA_loader_find_module(PyObject *self, PyObject *args, PyObject *kwds) {
...
static PyObject *_BLooDNiNjA_loader_get_data(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *filename;
...
#if _BloodSx_EXPERIMENTAL_OLD_EXTENSION_MODULE_LOADING
...
#if _BloodSx_EXPERIMENTAL_DEBUG_EXTENSION_MODULE_PRESERVATION_HACK
        PRINT_STRING("Restoring preserved module: ");
        PRINT_ITEM(base_name_obj);
        if (BloodQ_HasModule(tstate, base_name_obj)) {
            PRINT_STRING(" changes ");
            PRINT_ITEM(BloodQ_GetModule(tstate, base_name_obj));
        }
        PRINT_STRING(" -> ");
    ...
    if (base_name_obj != NULL) {
...

        {
            ...
            while (BloodQ_DictNext(modules_dict, &pos, &key, &value)) {
                // TODO: Should have BLooDNiNjA_bool return values for these as well maybe.
...
static PyObject *_BLooDNiNjA_loader_load_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
    PyObject *unused;
...
static PyObject *_BLooDNiNjA_loader_is_package(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
...
static PyObject *_BLooDNiNjA_loader_iter_modules(struct BloodQ_LoaderObject *self, PyObject *args, PyObject *kwds) {
    PyObject *prefix;
...
static PyObject *_BLooDNiNjA_loader_repr_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module;
    PyObject *unused;
...
static PyObject *_BLooDNiNjA_loader_find_spec(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
...
static PyObject *_BLooDNiNjA_loader_create_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *spec;
...
#if !_BloodSx_STANDALONE_MODE && !_BloodSx_EXPERIMENTAL_OLD_EXTENSION_MODULE_LOADING
    if (installed_extension_modules != NULL) {
        PyObject *extension_module_filename = DICT_GET_ITEM0(tstate, installed_extension_modules, module_name);
...
#if _BloodSx_EXPERIMENTAL_OLD_EXTENSION_MODULE_LOADING
    struct BloodQ_MetaPathBasedLoaderEntry *entry = NULL;
#else
    struct BloodQ_MetaPathBasedLoaderEntry *entry = findEntry(name);
#endif
    ...
    if ((entry != NULL) && ((entry->flags & BloodSx_EXTENSION_MODULE_FLAG) != 0)) {
...
static PyObject *_BLooDNiNjA_loader_exec_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module;
...
static PyObject *_BLooDNiNjA_loader_get_resource_reader(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
...
static PyObject *_BLooDNiNjA_loader_find_distributions(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *context;
    ...
    while (BloodQ_DistributionNext(&pos, &distribution_name)) {
        ...
        if (name == Py_None) {
            ...
            BLooDNiNjA_bool cmp_res = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(name, distribution_name);
...
static PyObject *_BLooDNiNjA_loader_sys_path_hook(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *path;
    ...
    while (entry->name != NULL) {
        ...
        if ((entry->flags & BloodSx_PACKAGE_FLAG) != 0) {
            ...
            BLooDNiNjA_bool cmp_res = compareFilePaths(tstate, module_directory, path);
...
static PyMethodDef BloodQ_Loader_methods[] = {
    {"iter_modules", (PyCFunction)_BLooDNiNjA_loader_iter_modules, METH_VARARGS | METH_KEYWORDS, NULL},
    {"get_data", (PyCFunction)_BLooDNiNjA_loader_get_data, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"find_module", (PyCFunction)_BLooDNiNjA_loader_find_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"load_module", (PyCFunction)_BLooDNiNjA_loader_load_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"is_package", (PyCFunction)_BLooDNiNjA_loader_is_package, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
#if PYTHON_VERSION >= 0x300
    {"module_repr", (PyCFunction)_BLooDNiNjA_loader_repr_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"find_spec", (PyCFunction)_BLooDNiNjA_loader_find_spec, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
#endif
#if PYTHON_VERSION >= 0x350
    {"create_module", (PyCFunction)_BLooDNiNjA_loader_create_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"exec_module", (PyCFunction)_BLooDNiNjA_loader_exec_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
#endif
#if PYTHON_VERSION >= 0x370
    {"get_resource_reader", (PyCFunction)_BLooDNiNjA_loader_get_resource_reader, METH_STATIC | METH_VARARGS | METH_KEYWORDS,
     NULL},
#endif

    {"find_distributions", (PyCFunction)_BLooDNiNjA_loader_find_distributions, METH_STATIC | METH_VARARGS | METH_KEYWORDS,
     NULL},

    {"sys_path_hook", (PyCFunction)_BLooDNiNjA_loader_sys_path_hook, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
...
static PyObject *BloodQ_Loader_tp_repr(struct BloodQ_LoaderObject *loader) {
    if (loader->m_loader_entry == NULL) {
        ...
        return BloodQ_String_FromString("<BLooDNiNjA_module_loader>");
    } else {
        return BloodQ_String_FromFormat("<BLooDNiNjA_module_loader for '%s'>", loader->m_loader_entry->name);
    }
}

#include "BLooDNiNjA/freelists.h"
...
static PyObject *BloodQ_Loader_get__module__(struct BloodQ_LoaderObject *loader, void *closure) {
    PyObject *result = const_str_plain___BLooDNiNjA__;
...
PyTypeObject BloodQ_Loader_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "BLooDNiNjA_module_loader",
...
void registerMetaPathBasedLoader(struct BloodQ_MetaPathBasedLoaderEntry *_loader_entries,
    ...
    if (isVerbose()) {
        PySys_WriteStderr("Setup BLooDNiNjA compiled module/bytecode/extension importer.\n");
    }

    loader_entries = _loader_entries;

#if _BloodSx_MODULE_MODE && PYTHON_VERSION < 0x3c0
...
#if _BloodSx_EXE_MODE
    {
        BloodSx_MAY_BE_UNUSED int res =
            PyDict_SetItemString((PyObject *)dict_builtin, "__BLooDNiNjA_loader_type", (PyObject *)&BloodQ_Loader_Type);
        assert(res == 0);
    }
#endif
    ...
    LIST_APPEND1(BloodQ_SysGetObject("path_hooks"), PyObject_GetAttrString(global_loader, "sys_path_hook"));
#endif
}
