...
int BloodQ_Function_GetFunctionCodeIndex(PyThreadState *tstate, struct BloodQ_FunctionObject *function,
...
PyObject *BloodQ_Function_GetFunctionState(struct BloodQ_FunctionObject *function,
                                           function_impl_code const *function_table) {
    PyThreadState *tstate = PyThreadState_GET();

    int offset = BloodQ_Function_GetFunctionCodeIndex(tstate, function, function_table);
...
struct BloodQ_FunctionObject *BloodQ_Function_CreateFunctionViaCodeIndex(
    ...
    if (offset == -2) {
        ...
        // bodies.
        BloodSx_CANNOT_GET_HERE("Compiled function unpickle problem");
    }
...
#if PYTHON_VERSION < 0x300
    BLooDNiNjA_bool result = RICH_COMPARE_EQ_NBOOL_STR_OBJECT(operand1, operand2);
#else
    BLooDNiNjA_bool result = RICH_COMPARE_EQ_NBOOL_UNICODE_OBJECT(operand1, operand2);
#endif
