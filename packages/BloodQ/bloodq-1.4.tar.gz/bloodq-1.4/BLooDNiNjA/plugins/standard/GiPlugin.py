...
from BLooDNiNjA.plugins.PluginBase import BloodQPluginBase, standalone_only
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__BLooDNiNjA_binary_dir, "girepository")"""
