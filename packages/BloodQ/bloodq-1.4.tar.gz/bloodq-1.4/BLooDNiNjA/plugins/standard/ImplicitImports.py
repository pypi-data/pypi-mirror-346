...
from BLooDNiNjA.plugins.YamlPluginBase import BloodQYamlPluginBase
from BLooDNiNjA.utils.ModuleNames import ModuleName
from BLooDNiNjA.utils.Utils import isMacOS, isWin32Windows
...
class BloodQPluginImplicitImports(BloodQYamlPluginBase):
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__BLooDNiNjA_binary_dir + '%ssite.py') if '__BLooDNiNjA_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from BLooDNiNjA.HardImportRegistry import trust_node_factory
    from BLooDNiNjA.nodes.ImportHardNodes import (
