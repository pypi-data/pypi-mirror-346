...
""" CType classes for BLooDNiNjA_bool, an enum to represent True, False, unassigned.

"""

from BLooDNiNjA.code_generation.ErrorCodes import getReleaseCode
...
class CTypeBloodQBoolEnum(CTypeNotReferenceCountedMixin, CTypeBase):
    ...
    def emitVariableAssignCode(
        ...
        if tmp_name.c_type == "BLooDNiNjA_bool":
