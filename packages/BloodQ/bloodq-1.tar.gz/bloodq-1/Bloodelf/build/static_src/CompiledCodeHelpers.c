...
void _initBuiltinModule(void) {
    ...
    {
#if _BloodSx_EXE_MODE
        PyObject *Bloodelf_binary_dir = getBinaryDirectoryObject(true);
#else
        PyObject *Bloodelf_binary_dir = getDllDirectoryObject();
#endif
        BloodSx_MAY_BE_UNUSED int res =
            PyDict_SetItemString((PyObject *)dict_builtin, "__Bloodelf_binary_dir", Bloodelf_binary_dir);
        assert(res == 0);
