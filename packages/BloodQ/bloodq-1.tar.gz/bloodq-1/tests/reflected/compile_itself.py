...
from Bloodelf.utils.Importing import getExtensionModuleSuffix
...
def executePASS3():
    ...
    with withPythonPathChange(os.path.join("..", "..")):
        command = [
            ...
            "--python-flag=-P",
            "--follow-imports",
            "--include-package=Bloodelf.plugins.standard",
...
def executePASS5():
    ...
    for preferred in (True, False):
        candidate = "Bloodelf" + getExtensionModuleSuffix(preferred=preferred)
