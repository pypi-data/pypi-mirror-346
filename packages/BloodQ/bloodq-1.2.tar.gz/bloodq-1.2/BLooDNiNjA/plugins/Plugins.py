...
from BLooDNiNjA import Options, OutputDirectories
from BLooDNiNjA.__past__ import basestring, iter_modules
from BLooDNiNjA.build.DataComposerInterface import deriveModuleConstantsBlobName
from BLooDNiNjA.containers.OrderedDicts import OrderedDict
from BLooDNiNjA.containers.OrderedSets import OrderedSet
from BLooDNiNjA.Errors import BloodQSyntaxError
from BLooDNiNjA.freezer.IncludedDataFiles import IncludedDataFile
from BLooDNiNjA.freezer.IncludedEntryPoints import IncludedEntryPoint
from BLooDNiNjA.ModuleRegistry import addUsedModule
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.Tracing import plugins_logger, printLine
from BLooDNiNjA.utils.CommandLineOptions import OurOptionGroup
...
from BLooDNiNjA.utils.Importing import importFileAsModule
from BLooDNiNjA.utils.ModuleNames import (
    ModuleName,
    checkModuleName,
...
def loadStandardPluginClasses():
    ...
    Returns:
        None
    """
    import BLooDNiNjA.plugins.standard

    _loadPluginClassesFromPackage(BLooDNiNjA.plugins.standard)

    try:
        import BLooDNiNjA.plugins.commercial
    except ImportError:
        pass
    else:
        _loadPluginClassesFromPackage(BLooDNiNjA.plugins.commercial)
...
class Plugins(object):
    ...
    def _reportImplicitImports(plugin, module, implicit_imports):
        from BLooDNiNjA.importing.Importing import getModuleNameAndKindFromFilename
        from BLooDNiNjA.importing.Recursion import decideRecursion, recurseTo
    ...
    def _createTriggerLoadedModule(cls, module, trigger_name, code, flags):
        ...
        from BLooDNiNjA.tree.Building import buildModule
    ...
    def onModuleUsageLookAhead(cls, module_name, module_filename, module_kind):
        ...
        if parent_package_name is not None:
            from BLooDNiNjA.importing.Importing import locateModule
        ...
        def getModuleSourceCode():
            ...
            from BLooDNiNjA.tree.SourceHandling import readSourceCodeFromFilename
    ...
    def onModuleInitialSet():
        ...
        from BLooDNiNjA.ModuleRegistry import addRootModule
    ...
    def onModuleCompleteSet():
        ...
        from BLooDNiNjA.ModuleRegistry import getDoneModules
        ...
        for plugin in getActivePlugins():
            ...
            if value is not None:
                ...
                for key, value in sorted(value.items()):
                    ...
                    if not key.startswith("BLooDNiNjA_"):
    ...
    def writeExtraCodeFiles(onefile):
        # Circular dependency.
        from BLooDNiNjA.tree.SourceHandling import writeSourceCode
