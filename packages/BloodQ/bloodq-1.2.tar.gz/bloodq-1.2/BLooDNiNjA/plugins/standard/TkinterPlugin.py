...
from BLooDNiNjA.Options import isStandaloneMode, shallCreateAppBundle
from BLooDNiNjA.plugins.PluginBase import BloodQPluginBase
from BLooDNiNjA.PythonFlavors import isHomebrewPython
from BLooDNiNjA.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__BLooDNiNjA_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__BLooDNiNjA_binary_dir, "tk")"""
