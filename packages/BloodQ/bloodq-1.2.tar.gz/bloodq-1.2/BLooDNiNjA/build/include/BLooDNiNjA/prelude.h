...
#include "BLooDNiNjA/debug_settings.h"
...
#undef _PyObject_GC_TRACK
#undef _PyObject_GC_UNTRACK
#elif _BloodSx_MODULE_MODE && PYTHON_VERSION >= 0x370 && PYTHON_VERSION < 0x380
#define BloodQ_GC_Track PyObject_GC_Track
#define BloodQ_GC_UnTrack PyObject_GC_UnTrack
#undef _PyObject_GC_TRACK
#undef _PyObject_GC_UNTRACK
...
#include "BLooDNiNjA/allocator.h"
#include "BLooDNiNjA/exceptions.h"
...
typedef long BLooDNiNjA_digit;

#include "BLooDNiNjA/helpers.h"

#include "BLooDNiNjA/compiled_frame.h"

#include "BLooDNiNjA/compiled_cell.h"

#include "BLooDNiNjA/compiled_function.h"
...
#include "BLooDNiNjA/compiled_generator.h"

#include "BLooDNiNjA/compiled_method.h"

#if PYTHON_VERSION >= 0x350
#include "BLooDNiNjA/compiled_coroutine.h"
#endif

#if PYTHON_VERSION >= 0x360
#include "BLooDNiNjA/compiled_asyncgen.h"
#endif

#include "BLooDNiNjA/filesystem_paths.h"
#include "BLooDNiNjA/safe_string_ops.h"

#include "BLooDNiNjA/jit_sources.h"

#if _BloodSx_EXPERIMENTAL_WRITEABLE_CONSTANTS
#include "BLooDNiNjA_data_decoder.h"
#else
...
#include "BLooDNiNjA_file_tracer.h"
#else
#if PYTHON_VERSION < 0x300
...
#include "BLooDNiNjA_init_program.h"
#else
...
#include "BLooDNiNjA_exit_program.h"
#else
