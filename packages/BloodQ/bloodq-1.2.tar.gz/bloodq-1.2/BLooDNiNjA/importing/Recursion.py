...
from BLooDNiNjA import ModuleRegistry, Options
from BLooDNiNjA.Errors import BloodQForbiddenImportEncounter
from BLooDNiNjA.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from BLooDNiNjA.importing import ImportCache, StandardLibrary
from BLooDNiNjA.ModuleRegistry import addUsedModule, getRootTopModule
from BLooDNiNjA.pgo.PGO import decideInclusionFromPGO
from BLooDNiNjA.plugins.Plugins import Plugins
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.Tracing import recursion_logger
from BLooDNiNjA.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from BLooDNiNjA.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from BLooDNiNjA.tree.Building import decideCompilationMode
