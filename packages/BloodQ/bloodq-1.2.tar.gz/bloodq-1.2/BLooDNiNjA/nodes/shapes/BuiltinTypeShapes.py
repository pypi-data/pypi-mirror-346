...
from BLooDNiNjA.code_generation.c_types.CTypeBloodQBooleans import (
    CTypeBloodQBoolEnum,
)
from BLooDNiNjA.code_generation.c_types.CTypeBloodQInts import (
    CTypeBloodQIntOrLongStruct,
)
from BLooDNiNjA.code_generation.Reports import onMissingOperation
from BLooDNiNjA.Constants import the_empty_unicode
