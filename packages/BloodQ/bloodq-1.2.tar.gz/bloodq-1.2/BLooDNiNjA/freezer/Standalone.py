...
from BLooDNiNjA.Errors import BloodQForbiddenDLLEncounter, BloodQNotYetSupported
from BLooDNiNjA.importing.Importing import (
...
from BLooDNiNjA.PythonVersions import getSystemPrefixPath
from BLooDNiNjA.Tracing import general, inclusion_logger
from BLooDNiNjA.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from BLooDNiNjA.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
from BLooDNiNjA.utils.Signing import addMacOSCodeSignature
from BLooDNiNjA.utils.Timing import TimerReport
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from BLooDNiNjA import ModuleRegistry
