...
from BLooDNiNjA.Options import getOnefileTempDirSpec, isOnefileTempDirMode
from BLooDNiNjA.OutputDirectories import getResultFullpath
from BLooDNiNjA.plugins.Plugins import Plugins
from BLooDNiNjA.PostProcessing import executePostProcessingResources
from BLooDNiNjA.PythonVersions import (
    getZstandardSupportingVersions,
    python_version,
)
from BLooDNiNjA.Tracing import onefile_logger, postprocessing_logger
from BLooDNiNjA.utils.Execution import withEnvironmentVarsOverridden
...
from BLooDNiNjA.utils.SharedLibraries import cleanupHeaderForAndroid
from BLooDNiNjA.utils.Signing import addMacOSCodeSignature
...
from BLooDNiNjA.utils.WindowsResources import RT_RCDATA, addResourceToFile
...
def runOnefileCompressor(
    ...
    if compressor_python is None or areSamePaths(
        ...
        from BLooDNiNjA.tools.onefile_compressor.OnefileCompressor import (
        ...
        mapping = {
            "BloodSx_PACKAGE_HOME": os.path.dirname(
                os.path.abspath(sys.modules["BLooDNiNjA"].__path__[0])
            )
        }
