...
from BLooDNiNjA.Constants import isConstant
from BLooDNiNjA.nodes.BuiltinOpenNodes import makeBuiltinOpenRefNode
from BLooDNiNjA.nodes.ConstantRefNodes import ExpressionConstantSysVersionInfoRef
from BLooDNiNjA.PythonVersions import (
    getFutureModuleKeys,
    getImportlibSubPackages,
    python_version,
)
from BLooDNiNjA.utils.Utils import isWin32Windows
...
def _addHardImportNodeClasses():
    from BLooDNiNjA.nodes.HardImportNodesGenerated import hard_import_node_classes
