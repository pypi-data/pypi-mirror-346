...
In the "BLooDNiNjA.tree.TreeHelpers" module, the dispatching is happening. One function
...
from BLooDNiNjA import ModuleRegistry, OutputDirectories, SourceCodeReferences
from BLooDNiNjA.__past__ import long, unicode
from BLooDNiNjA.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from BLooDNiNjA.Bytecodes import loadCodeObjectData
from BLooDNiNjA.containers.OrderedSets import OrderedSet
from BLooDNiNjA.Errors import CodeTooComplexCode
from BLooDNiNjA.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from BLooDNiNjA.importing import Importing
from BLooDNiNjA.importing.ImportCache import addImportedModule
from BLooDNiNjA.importing.PreloadedPackages import getPthImportedPackages
from BLooDNiNjA.importing.StandardLibrary import isStandardLibraryPath
...
from BLooDNiNjA.nodes.BuiltinRefNodes import quick_names
from BLooDNiNjA.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from BLooDNiNjA.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from BLooDNiNjA.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from BLooDNiNjA.nodes.ExceptionNodes import StatementRaiseException
from BLooDNiNjA.nodes.FutureSpecs import FutureSpec
from BLooDNiNjA.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from BLooDNiNjA.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from BLooDNiNjA.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from BLooDNiNjA.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from BLooDNiNjA.nodes.ModuleNodes import (
...
from BLooDNiNjA.nodes.OperatorNodes import makeBinaryOperationNode
from BLooDNiNjA.nodes.OperatorNodesUnary import makeExpressionOperationUnary
...
from BLooDNiNjA.nodes.StatementNodes import StatementExpressionOnly
from BLooDNiNjA.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from BLooDNiNjA.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from BLooDNiNjA.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
from BLooDNiNjA.Options import (
...
from BLooDNiNjA.pgo.PGO import decideCompilationFromPGO
from BLooDNiNjA.plugins.Plugins import Plugins
from BLooDNiNjA.PythonVersions import python_version
from BLooDNiNjA.Tracing import (
    general,
    optimization_logger,
    plugins_logger,
    recursion_logger,
...
from BLooDNiNjA.utils import MemoryUsage
from BLooDNiNjA.utils.ModuleNames import ModuleName
from BLooDNiNjA.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_BLooDNiNjA"):
                    raise
