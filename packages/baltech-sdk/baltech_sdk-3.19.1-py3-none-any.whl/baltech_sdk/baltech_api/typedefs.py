...
class BlePeriph_ErrNotInactive(BlePeriphError):
    """
    Must not call _BlePeriph.DefineService_ after calling
    [BlePeriph.Enable(true)](.#BlePeriph.Enable)
    """
    ErrorCode = 0x00014B01
    URL = "https://docs.baltech.de/refman/cmds/bleperiph/index.html#BlePeriph.ErrNotInactive"
...
BlePeriph_GetEvents_EventId = Literal["Connect", "Disconnect", "Write"]
BlePeriph_GetEvents_EventId_Parser = LiteralParser[BlePeriph_GetEvents_EventId, int](
    name='BlePeriph_GetEvents_EventId',
    literal_map={
        'Connect': 1,
        'Disconnect': 2,
        'Write': 3,
...
VhlCfg_File_Iso15ReadCmd_Value = Literal["ReadSingleBlockCmd", "ReadMultipleBlocksCmd"]
VhlCfg_File_Iso15ReadCmd_Value_Parser = LiteralParser[VhlCfg_File_Iso15ReadCmd_Value, int](
    ...
    literal_map={
        'ReadSingleBlockCmd': 0,
        'ReadMultipleBlocksCmd': 1,
    },
)
...
Project_MobileId_RemoteTrigger_Value = Literal["Disabled", "Enabled"]
Project_MobileId_RemoteTrigger_Value_Parser = LiteralParser[Project_MobileId_RemoteTrigger_Value, int](
    name='Project_MobileId_RemoteTrigger_Value',
    literal_map={
        'Disabled': 0,
        'Enabled': 1,
    },
...
class BlePeriph_GetEvents_Events_Entry(NamedTuple):
    EventId: 'EventId'
    CharacteristicNdx: 'int'
    def __repr__(self) -> str:
        non_default_args: List[str] = []
        non_default_args.append(f'EventId={ repr(self.EventId) }')
        non_default_args.append(f'CharacteristicNdx={ repr(self.CharacteristicNdx) }')
        return f'{type(self).__name__}({", ".join(non_default_args)})'
EventId = Literal["Connect", "Disconnect", "Write"]
EventId_Parser = LiteralParser[EventId, int](
    name='EventId',
    literal_map={
        'Connect': 1,
        'Disconnect': 2,
...
ProtocolID = Literal["BrpSerial", "BrpRs485", "BrpHid", "BrpTcp", "DebugInterface", "RawSerial", "Wiegand", "KeyboardEmulation", "LowLevelIoPorts", "ClkData", "Omron", "Snet", "Bpa9", "Ccid", "RawSerial2", "Osdp", "BleHci"]
...
VhlCfg_File_Iso15WriteCmd_Value = Literal["WriteSingleBlockCmd", "WriteMultipleBlocksCmd"]
...
Template_VarDataAlign_Alignment = Literal["Right", "Left"]
Template_VarDataAlign_Alignment_Parser = LiteralParser[Template_VarDataAlign_Alignment, int](
    name='Template_VarDataAlign_Alignment',
    literal_map={
        'Right': 1,
        'Left': 0,
    },
