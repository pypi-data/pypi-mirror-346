...
if (i["i am you"] == True):
    ...
    print("finish .")
                ...
                with resources.files('my_library.assets').joinpath("print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_USD_part_10186.png").open('rb') as f:
                ...
                with resources.files('my_library.assets').joinpath("print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_2000_unity_DZD_part_10176.png").open('rb') as f:
