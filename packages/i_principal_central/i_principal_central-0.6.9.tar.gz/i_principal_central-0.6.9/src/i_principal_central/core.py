    ...
    try:
        ...
        if (i["i_number_of_file-s"] > 0):
            ...
            while (i["i_counter"] < i["i_number_of_file-s"]):
                ...
                if (os.path.exists(i["i_folder_for_receive"] + i["i_v"][0] + "." + i["i_v"][1])):
...
if (i["i am you"] == True):
    ...
    print("finish .")
                ...
                with resources.files('i_principal_central.assets').joinpath("print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_USD_part_10195.png").open('rb') as f:
                ...
                i_self.i["i_file"] = i_self.i["i_cwd"] + "print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_USD_part_10195.png"
                ...
                with resources.files('i_principal_central.assets').joinpath("print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_2000_unity_DZD_part_10176.png").open('rb') as f:
                ...
                with resources.files('i_principal_central.assets').joinpath("print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_EUR_part_10196.png").open('rb') as f:
                ...
                i_self.i["i_file"] = i_self.i["i_cwd"] + "print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_EUR_part_10196.png"
