...
if (i["i am you"] == True):
    ...
    print("finish .")
                ...
                with resources.files('i_principal_central.assets').joinpath("print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_USD_part_10186.png").open('rb') as f:
                    
                    i_self.i["print_personal_account_with_UTF8_Economic_Partner_official_photo_money_quantity_200_unity_USD_part_10186"] = f.read()
