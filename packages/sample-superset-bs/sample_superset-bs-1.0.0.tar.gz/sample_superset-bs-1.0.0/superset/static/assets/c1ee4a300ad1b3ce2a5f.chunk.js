"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[1285],{14693:(e,t,i)=>{i.d(t,{QD:()=>x.Q,Ay:()=>$});var n=i(9063),a=i.n(n),r=i(96540),o=i(98250),l=i(96453),d=i(19129),s=i(62952),c=i(78518),h=i(67073),p=i(2445);const u=l.I4.div`
...
`,u=(0,d.memo)((({title:e,placeholder:t,onSave:i,canEdit:a,label:o})=>{const[l,u]=(0,d.useState)(!1),[g,m]=(0,d.useState)(e||""),b=(0,d.useRef)(null),[f,y]=(0,d.useState)(!1),{width:v,ref:w}=(0,c.uZ)(),{width:x,ref:$}=(0,c.uZ)({refreshMode:"debounce"});(0,d.useEffect)((()=>{m(e)}),[e]),(0,d.useEffect)((()=>{if(l&&null!=b&&b.current&&(b.current.focus(),b.current.setSelectionRange)){const{length:e}=b.current.value;b.current.setSelectionRange(e,e),b.current.scrollLeft=b.current.scrollWidth}}),[l]),(0,d.useLayoutEffect)((()=>{null!=w&&w.current&&(w.current.textContent=g||t)}),[g,t,w]),(0,d.useEffect)((()=>{b.current&&b.current.scrollWidth>b.current.clientWidth?y(!0):y(!1)}),[v,x]);const S=(0,d.useCallback)((()=>{a&&!l&&u(!0)}),[a,l]),Y=(0,d.useCallback)((()=>{if(!a)return;const t=g.trim();m(t),e!==t&&i(t),u(!1)}),[a,g,i,e]),k=(0,d.useCallback)((e=>{a&&l&&m(e.target.value)}),[a,l]),T=(0,d.useCallback)((e=>{var t;a&&"Enter"===e.key&&(e.preventDefault(),null==(t=b.current)||t.blur())}),[a]);return(0,h.FD)("div",{css:p,ref:$,children:[(0,h.Y)(s.m_,{id:"title-tooltip",title:f&&g&&!l?g:null,children:a?(0,h.Y)("input",{className:"dynamic-title-input","aria-label":null!=o?o:(0,r.t)("Title"),ref:b,onChange:k,onBlur:Y,onClick:S,onKeyPress:T,placeholder:t,value:g,css:n.AH`
                cursor: ${l?"text":"pointer"};

                ${v&&v>0&&n.AH`
                  width: ${v+1}px;
                `}
              `}):(0,h.Y)("span",{className:"dynamic-title","aria-label":null!=o?o:(0,r.t)("Title"),ref:b,children:g})}),(0,h.Y)("span",{ref:w,className:"input-sizer","aria-hidden":!0,tabIndex:-1})]})}));var g=i(58132),m=i(94704),b=i(46920);const f=e=>n.AH`
...
`,x=({editableTitleProps:e,showTitlePanelItems:t,certificatiedBadgeProps:i,showFaveStar:n,faveStarProps:d,titlePanelAdditionalItems:s,rightPanelAdditionalItems:c,additionalActionsMenu:p,menuDropdownProps:x,showMenuDropdown:$=!0,tooltipProps:S})=>{const Y=(0,a.DP)();return(0,h.FD)("div",{css:y,className:"header-with-actions",children:[(0,h.FD)("div",{className:"title-panel",children:[(0,h.Y)(u,{...e}),t&&(0,h.FD)("div",{css:v,children:[(null==i?void 0:i.certifiedBy)&&(0,h.Y)(g.A,{...i}),n&&(0,h.Y)(m.A,{...d}),s]})]}),(0,h.FD)("div",{className:"right-button-panel",children:[c,(0,h.Y)("div",{css:w,children:$&&(0,h.Y)(o.ms,{trigger:["click"],dropdownRender:()=>p,...x,children:(0,h.Y)(b.A,{css:f,buttonStyle:"tertiary","aria-label":(0,r.t)("Menu actions trigger"),tooltip:null==S?void 0:S.text,placement:null==S?void 0:S.placement,children:(0,h.Y)(l.F.EllipsisOutlined,{iconColor:Y.colors.primary.dark2,iconSize:"l"})})})})]})]})}},70175:(e,t,i)=>{var n;i.d(t,{Q:()=>n}),function(e){e.Dashboards="dashboards",e.Description="description",e.LastModified="lastModified",e.Owner="owner",e.Rows="rows",e.Sql="sql",e.Table="table",e.Tags="tags"}(n||(n={}))},85955:(e,t,i)=>{i.d(t,{c:()=>r});var n=i(45418),a=i(2445);function r(e){return(0,a.Y)(n.A,{...e})}},86014:(e,t,i)=>{i.r(t),i.d(t,{default:()=>A});var n=i(96540),a=i(17437),r=i(96453),o=i(78518),l=i(33231),d=i(7089),s=i(50217),c=i(25143),h=i(53365),p=i(50455),u=i(2445);const g=r.I4.div`
  text-align: left;
