...
`;function s({children:n}){return(0,t.Y)(r,{role:"navigation",children:n})}s.Next=function({disabled:n,onClick:e}){return(0,t.Y)("li",{className:a()({disabled:n}),children:(0,t.Y)("span",{role:"button",tabIndex:n?-1:0,onClick:l=>{l.preventDefault(),n||e(l)},children:"»"})})},s.Prev=function({disabled:n,onClick:e}){return(0,t.Y)("li",{className:a()({disabled:n}),children:(0,t.Y)("span",{role:"button",tabIndex:n?-1:0,onClick:l=>{l.preventDefault(),n||e(l)},children:"«"})})},s.Item=function({active:n,children:e,onClick:l}){return(0,t.Y)("li",{className:a()({active:n}),children:(0,t.Y)("span",{role:"button",tabIndex:n?-1:0,onClick:e=>{e.preventDefault(),n||l(e)},children:e})})},s.Ellipsis=function({disabled:n,onClick:e}){return(0,t.Y)("li",{className:a()({disabled:n}),children:(0,t.Y)("span",{role:"button",tabIndex:n?-1:0,onClick:l=>{l.preventDefault(),n||e(l)},children:"…"})})};const c=s;var d=l(18575);const p=(0,d.uv)({WrapperComponent:c,itemTypeToComponent:{[d.w$.PAGE]:({value:n,isActive:e,onClick:l})=>(0,t.Y)(c.Item,{active:e,onClick:l,children:n}),[d.w$.ELLIPSIS]:({isActive:n,onClick:e})=>(0,t.Y)(c.Ellipsis,{disabled:n,onClick:e}),[d.w$.PREVIOUS_PAGE_LINK]:({isActive:n,onClick:e})=>(0,t.Y)(c.Prev,{disabled:n,onClick:e}),[d.w$.NEXT_PAGE_LINK]:({isActive:n,onClick:e})=>(0,t.Y)(c.Next,{disabled:n,onClick:e}),[d.w$.FIRST_PAGE_LINK]:()=>null,[d.w$.LAST_PAGE_LINK]:()=>null}})},50217:(n,e,l)=>{l.d(e,{A:()=>i.A,V:()=>i.V});var i=l(54016)},54016:(n,e,l)=>{l.d(e,{A:()=>y,V:()=>i});var i,o=l(2404),a=l.n(o),t=l(96540),r=l(96453),s=l(78518),c=l(32885),d=l(641),p=l(47251),g=l(73204),h=l(2445);!function(n){n.Default="Default",n.Small="Small"}(i||(i={}));const u=r.I4.div`
...
`,x=({columns:n,data:e,pageSize:l,totalCount:o=e.length,initialPageIndex:r,initialSortBy:x=[],loading:y=!1,withPagination:w=!0,emptyWrapperType:f=i.Default,noDataText:v,showRowCount:k=!0,serverPagination:$=!1,columnsForWrapText:P,onServerPagination:S=()=>{},scrollTopOnPagination:Y=!1,...I})=>{const C={pageSize:null!=l?l:10,pageIndex:null!=r?r:0,sortBy:x},{getTableProps:T,getTableBodyProps:N,headerGroups:A,page:E,rows:D,prepareRow:_,pageCount:F,gotoPage:z,state:{pageIndex:R,pageSize:B,sortBy:G}}=(0,c.useTable)({columns:n,data:e,initialState:C,manualPagination:$,manualSortBy:$,pageCount:Math.ceil(o/C.pageSize)},c.useFilters,c.useSortBy,c.usePagination),L=w?E:D;let U;switch(f){case i.Small:U=({children:n})=>(0,h.Y)(h.FK,{children:n});break;case i.Default:default:U=({children:n})=>(0,h.Y)(u,{children:n})}const K=!y&&0===L.length,M=F>1&&w,W=(0,t.useRef)(null);return(0,t.useEffect)((()=>{$&&R!==C.pageIndex&&S({pageIndex:R})}),[R]),(0,t.useEffect)((()=>{$&&!a()(G,C.sortBy)&&S({pageIndex:0,sortBy:G})}),[G]),(0,h.FD)(h.FK,{children:[(0,h.FD)(m,{...I,ref:W,children:[(0,h.Y)(g.A,{getTableProps:T,getTableBodyProps:N,prepareRow:_,headerGroups:A,rows:L,columns:n,loading:y,columnsForWrapText:P}),K&&(0,h.Y)(U,{children:v?(0,h.Y)(d.S,{image:d.S.PRESENTED_IMAGE_SIMPLE,description:v}):(0,h.Y)(d.S,{image:d.S.PRESENTED_IMAGE_SIMPLE})})]}),M&&(0,h.FD)(b,{className:"pagination-container",isPaginationSticky:I.isPaginationSticky,children:[(0,h.Y)(p.A,{totalPages:F||0,currentPage:F?R+1:0,onChange:n=>(n=>{var e;Y&&(null==W||null==(e=W.current)||e.scroll(0,0)),z(n)})(n-1),hideFirstAndLastPageLinks:!0}),k&&(0,h.Y)("div",{className:"row-count-container",children:!y&&(0,s.t)("%s-%s of %s",B*R+(E.length&&1),B*R+E.length,o)})]})]})},y=(0,t.memo)(x)},73204:(n,e,l)=>{l.d(e,{A:()=>d});var i=l(96540),o=l(46942),a=l.n(o),t=l(96453),r=l(67073),s=l(2445);const c=t.I4.table`
