...
class TestWBCoreFilterMixin:
    ...
    @pytest.mark.parametrize("default", ["Foo"])
    ...
    @pytest.mark.parametrize("name, default", [("Foo", "Bar")])
    ...
    @pytest.mark.parametrize("name, default, help_text", [("Foo", "Bar", "Sesquipedalophobie")])
    ...
    @pytest.mark.parametrize("name, default, text", [("Foo", "Bar", "Sesquipedalophobie")])
