...
from .constant import CET_ADDI, CET_MULT, FUN_PROD, FUN_COST, OPT_DEFAULT, RTS_CRS, RTS_VRS1, OPT_DEFAULT, OPT_LOCAL
import time
...
class CNLSG:
    ...
    def __init__(self, y, x, z=None, cet=CET_ADDI, fun=FUN_PROD, rts=RTS_VRS1):
        """CNLSG model
