...
import numpy as np
import pandas as pd
from .utils import weakCNLSxZG1, weakCNLSxZG2, weakCNLSxG1, weakCNLSxG2, sweet, tools
...
class weakCNLSxG:
    ...
    def optimize(self, email=OPT_LOCAL, solver=OPT_DEFAULT):
        ...
        model1 = weakCNLSxZG1.weakCNLSxZG1(
            self.data, self.sent, self.z, self.cutactive, self.cet, self.fun, self.rts,\
        ...
        while self.__convergence_test(self.alpha, self.gamma, self.delta) > 0.0001 \
            ...
            model2 = weakCNLSxZG2.weakCNLSxZG2(
