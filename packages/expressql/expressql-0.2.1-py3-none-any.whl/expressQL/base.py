...
class SubQuery:
    ...
    def __init__(self, placeholder_str: str, parameters: List[Any]):
        self.placeholder_str = placeholder_str
        self.parameters = parameters
    def placeholder_pair(self) -> Tuple[str, List[Any]]:
        return self.placeholder_str, self.parameters
    def __str__(self) -> str:
        return f"SubQuery({self.placeholder_str}, {self.parameters})"
