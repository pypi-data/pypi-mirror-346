...
async def main_async(
    ...
    try:
        ...
        # Check if this is the Rich console error about live displays
        if "Only one live display may be active at once" in str(ex):
            ...
            logger.print("[yellow]Hint: The operation will continue using simple progress indicators instead of live displays.[/yellow]")
            # Continue execution without re-raising
        else:
