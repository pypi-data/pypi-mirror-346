...
class JumpCloudAWSAuth:
    ...
    def check_chromedriver(self):
        ...
        try:
            ...
            if not chromedriver_path:
                ...
                self._show_chromedriver_instructions()
                return False
    ...
    def _show_chromedriver_instructions(self):
        """Show instructions for installing ChromeDriver"""
        system = platform.system()
        print("\nChromeDriver is required but not properly installed or configured.")
        ...
        if system == "Darwin":  # macOS
            ...
            print("  For Linux:")
            print("  apt-get install chromium-chromedriver  # For Debian/Ubuntu")
            print("  yum install chromedriver               # For CentOS/RHEL")
        elif system == "Windows":
            print("  For Windows:")
            print("  1. Download from https://chromedriver.chromium.org/downloads")
            print("  2. Add to your PATH")

        print("\nOption 2: Install ChromeDriver via Python package")
        print("  Try one of these commands:")
        print("  pip install chromedriver-binary-auto")
        print("  # OR")
        print("  pip install webdriver-manager")

        if system == "Darwin":  # macOS SSL issues
            print("\nNote for macOS users:")
            print("If you encounter SSL certificate errors, you may need to run:")
            print("/Applications/Python*/Install\\ Certificates.command")

        print("\nOnce ChromeDriver is installed, try running the command again.")
        print("For more detailed instructions, visit: https://chromedriver.chromium.org/getting-started")
