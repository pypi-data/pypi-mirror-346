...
class Provider(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["id", b"id", "source", b"source"]) -> None: ...
...
class Trigger(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["source", b"source", "text", b"text"]) -> None: ...
