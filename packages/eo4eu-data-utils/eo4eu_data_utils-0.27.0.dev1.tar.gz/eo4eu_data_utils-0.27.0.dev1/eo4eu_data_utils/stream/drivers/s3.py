...
if _s3_module.is_enabled():
    ...
    class S3Driver(Downloader, Uploader, Lister):
        ...
        :type bucket: str
        :param ls_func: An optional function for converting boto3 S3.ServiceResource.ObjectSummary objects to PathSpec objects (default: uses the ``.key`` attribute of the ObjectSummary as both name and path)
        :type ls_func: Callable[[S3.ServiceResource.ObjectSummary],PathSpec]|None
        """
