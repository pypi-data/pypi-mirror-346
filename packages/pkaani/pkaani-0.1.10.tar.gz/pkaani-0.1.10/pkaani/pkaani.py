...
def calculate_pka(pdbfiles,writefile=None):
    ...
    #FEATURES
    tyr_features=joblib.load(files("pkaani").joinpath("models/FTYR.joblib"))
    asp_features=joblib.load(files("pkaani").joinpath("models/FASP.joblib"))
    glu_features=joblib.load(files("pkaani").joinpath("models/FGLU.joblib"))
    lys_features=joblib.load(files("pkaani").joinpath("models/FLYS.joblib"))
    his_features=joblib.load(files("pkaani").joinpath("models/FHIS.joblib"))
    
    #MODELS
    asp_model=joblib.load(files("pkaani").joinpath("models/ASP_ani2x_FINAL_MODEL_F100.joblib"))
    glu_model=joblib.load(files("pkaani").joinpath("models/GLU_ani2x_FINAL_MODEL_F75.joblib"))
    his_model=joblib.load(files("pkaani").joinpath("models/HIS_ani2x_FINAL_MODEL_F100.joblib"))
    lys_model=joblib.load(files("pkaani").joinpath("models/LYS_ani2x_FINAL_MODEL_F25.joblib"))
    tyr_model=joblib.load(files("pkaani").joinpath("models/TYR_ani2x_FINAL_MODEL_F25.joblib"))
