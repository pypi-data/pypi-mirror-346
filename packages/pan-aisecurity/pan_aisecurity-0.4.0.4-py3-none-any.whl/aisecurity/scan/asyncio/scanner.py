...
from aisecurity.generated_openapi_client import AsyncScanObject, AiProfile
...
class Scanner(BaseLogger):
    ...
    async def async_scan(self, async_scan_objects: list[AsyncScanObject]):
        """
    ...
    async def query_by_scan_ids(self, scan_ids: list[str]):
        """
        ...
        scan_id_responses = await self._query_scan_by_scan_ids.get_scan_results(
            scan_ids=scan_ids
        )
    ...
    async def query_by_report_ids(self, report_ids: list[str]):
        """
        ...
        scan_id_responses = await self._query_by_report_ids.get_threat_objects(
