...
def profile(
    ...
    Args:
        ...
        output_file: Path where the HTML report will be saved.
            If None, uses title to generate a filename
    ...
    if output_file is not None:
        ...
        # Generate a filename based on the title if no output_file provided
        default_file = title.replace(" ", "_") + ".html"
        profile.to_file(default_file)
        print(f"Profile report saved to {default_file}")
