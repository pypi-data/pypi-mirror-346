...
@mcp.tool()
def generate_image(prompt: str, style: str, width: int, height: int) -> str:
    """
    根据提示生成图片，prompt提示词 和 style风格参数 必须传入的是英文，width和height必须是整数，返回的url中Expires、AccessKeyId、Signature等参数需要全部返回，否则无法访问
