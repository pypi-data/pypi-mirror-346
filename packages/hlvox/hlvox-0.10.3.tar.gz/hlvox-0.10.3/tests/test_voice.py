...
class TestSayableUnsayable:
    def test_empty_sent(self, voice: hlvox.single_voice.SingleVoice):
        ret_say, ret_unsay = voice.get_sayable_unsayable([])

        assert ret_say == []
        assert ret_unsay == []

    def test_simple_sent(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_duplicates(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_comp_sent(self, voice: hlvox.single_voice.SingleVoice):
        words = [
            Word(word="hello", voice="test"),
            Word(word=",", voice="test", is_punctuation=True),
    ...
    def test_dup_punct(self, voice: hlvox.single_voice.SingleVoice):
        words = [
            Word(word="hello", voice="test"),
            Word(word=".", voice="test", is_punctuation=True),
            Word(word=".", voice="test", is_punctuation=True),
...
class TestSentenceGeneration:
    ...
    def test_unsayable_sent(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_sayable_sent(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_duplicate_sent(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_duplicate_words(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_multiple_sent(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_dry_run(self, voice: hlvox.single_voice.SingleVoice):
        ret = voice.generate_audio("hello", dry_run=True)
        assert ret.audio is None

    def test_one_word(self, voice: hlvox.single_voice.SingleVoice):
        # We don't bother saving single words to the database
        voice.generate_audio("hello")

        assert voice.get_generated_sentences_dict() == {}

    def test_fetch_by_id(self, voice: hlvox.single_voice.SingleVoice):
        sentence = "hello, my name is vox"
...
class TestModifiers:
    def test_basic_modifier(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_invalid_modifier(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_complicated(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_accelerator(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_accelerator_abnormal(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_pitch_change(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_speed_change(self, voice: hlvox.single_voice.SingleVoice):
    ...
    def test_speed_change_abnormal(self, voice: hlvox.single_voice.SingleVoice):
        with pytest.raises(hlvox.voice.ModifierArgumentsInvalid):
            voice.generate_audio("hello|s-1.0 hello|s0.0")


class TestGetGeneratedSentences:
    def test_no_sentences(self, voice: hlvox.single_voice.SingleVoice):
        ret = voice.get_generated_sentences()

        assert ret == []

    def test_single_sentences(self, voice: hlvox.single_voice.SingleVoice):
        voice.generate_audio("hello hello")
    ...
    def test_multiple_sentences(self, voice: hlvox.single_voice.SingleVoice):
        voice.generate_audio("hello hello")
...
def multi_voice_fixture(tmp_path: Path):
    ...
    multi_voice = hlvox.multi_voice.MultiVoice(
        voices=voices,
...
class TestMultiWords:
    def test_normal(self, multi_voice: hlvox.multi_voice.MultiVoice):
...
class TestMultiSayableUnsayable:
    def test_empty(self, multi_voice: hlvox.multi_voice.MultiVoice):
        sayable, unsayable = multi_voice.get_sayable_unsayable(words=[])
        assert not sayable
        assert not unsayable

    def test_all_sayable(self, multi_voice: hlvox.multi_voice.MultiVoice):
        words = [
            Word(word="norm:hello"),
            Word(word="norm:my"),
            Word(word="alph:a"),
    ...
    def test_some_unsayable(self, multi_voice: hlvox.multi_voice.MultiVoice):
        words = words_from_strings(
    ...
    def test_punctuation(self, multi_voice: hlvox.multi_voice.MultiVoice):
        words = [
            Word(word="norm:hello"),
            Word(word=",", is_punctuation=True),
...
class TestMultiWordVoiceAssignment:
    ...
    def test_no_initial_voice(self, multi_voice: hlvox.multi_voice.MultiVoice):
...
class TestMultiCombinedVoiceSentences:
    ...
    def test_single(self, multi_voice: hlvox.multi_voice.MultiVoice):
    ...
    def test_multiple(self, multi_voice: hlvox.multi_voice.MultiVoice):
        voices = multi_voice._voices
...
class TestDifficultSentences:
    def test_ellipse(self, multi_voice: hlvox.multi_voice.MultiVoice):
    ...
    def test_start_ellipse(self, multi_voice: hlvox.multi_voice.MultiVoice):
        sentence = "norm:."
        ret = multi_voice.generate_audio(sentence=sentence)
