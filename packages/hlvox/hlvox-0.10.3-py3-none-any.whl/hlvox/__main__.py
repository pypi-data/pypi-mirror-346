...
from hlvox import Manager, SingleVoice

log = logging.getLogger(__name__)


def single_voice(voice_dir: Path, sentence: str, audio_format: str):
...
def multi_voice(voices_dir: Path, voice: str, sentence: str, audio_format: str):
