...
class TestVoiceImport:
    def test_voice_list(self, manager: hlvox.manager.Manager):
...
class TestGetVoice:
    def test_get_voice(self, manager: hlvox.manager.Manager):
        voice = manager.get_voice("v1")

        assert voice is not None
        assert voice.name == "v1"

    def test_get_wrong_voice(self, manager: hlvox.manager.Manager):
