...
T = TypeVar("T", bound="QueryMonitoringFtpUploadJobs")


@_attrs_define
class QueryMonitoringFtpUploadJobs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_monitoring_ftp_upload_jobs = cls(
            id=id,
            start=start,
            end=end,
            order=order,
        ...
        return query_monitoring_ftp_upload_jobs
