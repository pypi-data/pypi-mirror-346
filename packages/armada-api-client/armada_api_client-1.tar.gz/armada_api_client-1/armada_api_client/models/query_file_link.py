...
T = TypeVar("T", bound="QueryFileLink")
...
class QueryFileLink:
    ...
    Attributes:
        ...
        file_id (Union[None, Unset, list[int]]):
        file_link_id (Union[None, Unset, list[int]]):
    """
    ...
    file_id: Union[None, Unset, list[int]] = UNSET
    file_link_id: Union[None, Unset, list[int]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.file_id, Unset):
            file_id = UNSET
        elif isinstance(self.file_id, list):
        ...
        file_link_id: Union[None, Unset, list[int]]
        if isinstance(self.file_link_id, Unset):
            file_link_id = UNSET
        elif isinstance(self.file_link_id, list):
        ...
        if file_link_id is not UNSET:
            field_dict["fileLinkId"] = file_link_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_file_id(data: object) -> Union[None, Unset, list[int]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                file_id_type_0 = cast(list[int], data)
        ...
        def _parse_file_link_id(data: object) -> Union[None, Unset, list[int]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                file_link_id_type_0 = cast(list[int], data)

                return file_link_id_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, list[int]], data)

        file_link_id = _parse_file_link_id(d.pop("fileLinkId", UNSET))
