...
T = TypeVar("T", bound="QueryEquipmentSetupTemplateConfig")


@_attrs_define
class QueryEquipmentSetupTemplateConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_equipment_setup_template_config = cls(
            id=id,
            start=start,
            end=end,
            order=order,
        ...
        return query_equipment_setup_template_config
