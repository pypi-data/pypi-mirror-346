...
from ..models.e_record_period import ERecordPeriod
...
T = TypeVar("T", bound="QueryDataElement")
...
class QueryDataElement:
    ...
    Attributes:
        ...
        record_conf (Union[None, Unset, str]):
        record_conf_has (Union[ERecordPeriod, None, Unset]):
    """
    ...
    record_conf: Union[None, Unset, str] = UNSET
    record_conf_has: Union[ERecordPeriod, None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        record_conf: Union[None, Unset, str]
        if isinstance(self.record_conf, Unset):
            record_conf = UNSET
        else:
            record_conf = self.record_conf

        record_conf_has: Union[None, Unset, str]
        if isinstance(self.record_conf_has, Unset):
            record_conf_has = UNSET
        elif isinstance(self.record_conf_has, ERecordPeriod):
            record_conf_has = self.record_conf_has.value
        else:
            record_conf_has = self.record_conf_has
        ...
        if record_conf is not UNSET:
            field_dict["recordConf"] = record_conf
        if record_conf_has is not UNSET:
            field_dict["recordConfHas"] = record_conf_has
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_record_conf(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        record_conf = _parse_record_conf(d.pop("recordConf", UNSET))

        def _parse_record_conf_has(data: object) -> Union[ERecordPeriod, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                record_conf_has_type_1 = ERecordPeriod(data)

                return record_conf_has_type_1
            except:  # noqa: E722
                pass
            return cast(Union[ERecordPeriod, None, Unset], data)

        record_conf_has = _parse_record_conf_has(d.pop("recordConfHas", UNSET))

        query_data_element = cls(
            id=id,
            start=start,
            end=end,
            order=order,
            ...
            record_conf_has=record_conf_has,
        )

        return query_data_element
