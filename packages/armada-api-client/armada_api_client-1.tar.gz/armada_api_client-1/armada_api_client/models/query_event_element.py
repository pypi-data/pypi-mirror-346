...
T = TypeVar("T", bound="QueryEventElement")


@_attrs_define
class QueryEventElement:
    """
    Attributes:
        ...
        from_date_time (Union[None, Unset, datetime.datetime]):
        to_date_time (Union[None, Unset, datetime.datetime]):
    """
    ...
    event_type: Union[None, Unset, str] = UNSET
    ...
    from_date_time: Union[None, Unset, datetime.datetime] = UNSET
    to_date_time: Union[None, Unset, datetime.datetime] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from_date_time: Union[None, Unset, str]
        if isinstance(self.from_date_time, Unset):
            from_date_time = UNSET
        elif isinstance(self.from_date_time, datetime.datetime):
            from_date_time = self.from_date_time.isoformat()
        else:
            from_date_time = self.from_date_time

        to_date_time: Union[None, Unset, str]
        if isinstance(self.to_date_time, Unset):
            to_date_time = UNSET
        elif isinstance(self.to_date_time, datetime.datetime):
        ...
        if from_date_time is not UNSET:
            field_dict["fromDateTime"] = from_date_time
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_event_type(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_from_date_time(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                from_date_time_type_0 = isoparse(data)

                return from_date_time_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        from_date_time = _parse_from_date_time(d.pop("fromDateTime", UNSET))

        def _parse_to_date_time(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                to_date_time_type_0 = isoparse(data)

                return to_date_time_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        to_date_time = _parse_to_date_time(d.pop("toDateTime", UNSET))

        query_event_element = cls(
            id=id,
            start=start,
            end=end,
            order=order,
