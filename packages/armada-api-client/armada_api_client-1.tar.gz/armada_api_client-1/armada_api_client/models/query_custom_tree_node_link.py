...
T = TypeVar("T", bound="QueryCustomTreeNodeLink")


@_attrs_define
class QueryCustomTreeNodeLink:
    """
    Attributes:
        ...
        node_id (Union[None, Unset, list[int]]):
        custom_tree_node_link_id (Union[None, Unset, list[int]]):
    ...
    node_id: Union[None, Unset, list[int]] = UNSET
    custom_tree_node_link_id: Union[None, Unset, list[int]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.node_id, Unset):
            node_id = UNSET
        elif isinstance(self.node_id, list):
        ...
        custom_tree_node_link_id: Union[None, Unset, list[int]]
        if isinstance(self.custom_tree_node_link_id, Unset):
            custom_tree_node_link_id = UNSET
        elif isinstance(self.custom_tree_node_link_id, list):
            custom_tree_node_link_id = self.custom_tree_node_link_id
        ...
        if custom_tree_node_link_id is not UNSET:
            field_dict["customTreeNodeLinkId"] = custom_tree_node_link_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_node_id(data: object) -> Union[None, Unset, list[int]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                node_id_type_0 = cast(list[int], data)
        ...
        def _parse_custom_tree_node_link_id(data: object) -> Union[None, Unset, list[int]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                custom_tree_node_link_id_type_0 = cast(list[int], data)

                return custom_tree_node_link_id_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, list[int]], data)

        custom_tree_node_link_id = _parse_custom_tree_node_link_id(d.pop("customTreeNodeLinkId", UNSET))
        ...
        query_custom_tree_node_link = cls(
            id=id,
            start=start,
            end=end,
            order=order,
            ...
            fields=fields,
            node_id=node_id,
            custom_tree_node_link_id=custom_tree_node_link_id,
            equ_id=equ_id,
        )

        return query_custom_tree_node_link
