...
from ...models.equipments_count_by_response_200 import EquipmentsCountByResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/Equipments/countBy/{group_by}",
        "params": params,
    }
...
) -> Optional[Union[EquipmentsCountByResponse200, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = EquipmentsCountByResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[EquipmentsCountByResponse200, ProblemDetails]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[EquipmentsCountByResponse200, ProblemDetails]
    """
