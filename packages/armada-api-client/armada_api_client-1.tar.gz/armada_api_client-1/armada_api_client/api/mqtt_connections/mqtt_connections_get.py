...
from ...models.mqtt_connection import MqttConnection
...
) -> Optional[Union[ProblemDetails, list["MqttConnection"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = MqttConnection.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["MqttConnection"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['MqttConnection']]
    """
