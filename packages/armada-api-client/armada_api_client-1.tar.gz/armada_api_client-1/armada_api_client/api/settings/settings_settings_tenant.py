...
) -> Optional[Union[ProblemDetails, list["TenantSetting"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TenantSetting.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["TenantSetting"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['TenantSetting']]
    """
