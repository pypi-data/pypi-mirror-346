    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[ProblemDetails, list["DataElement"]]]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = DataElement.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["DataElement"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['DataElement']]
    """
