...
def _get_kwargs(
    *,
    ...
    record_conf: Union[Unset, str] = UNSET,
    record_conf_has: Union[Unset, ERecordPeriod] = UNSET,
    ...
    params["recordConf"] = record_conf

    json_record_conf_has: Union[Unset, str] = UNSET
    if not isinstance(record_conf_has, Unset):
        json_record_conf_has = record_conf_has.value

    params["recordConfHas"] = json_record_conf_has
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/DataElements/DistinctEquPathGroupSubGroupName",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        record_conf (Union[Unset, str]):
        record_conf_has (Union[Unset, ERecordPeriod]):
