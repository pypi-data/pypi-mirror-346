...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/AlarmElements/DistinctEquTypeGroupSubGroupName",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[ProblemDetails, list["EquTypeGroupSubGroupName"]]]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = EquTypeGroupSubGroupName.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["EquTypeGroupSubGroupName"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['EquTypeGroupSubGroupName']]
    """
