...
from ...models.path_rel_group_sub_group_name import PathRelGroupSubGroupName
...
def _get_kwargs(
    *,
    ...
    severity_type: Union[Unset, str] = UNSET,
    severity_level: Union[Unset, int] = UNSET,
    gt_start_date_time: Union[Unset, datetime.datetime] = UNSET,
    lt_start_date_time: Union[Unset, datetime.datetime] = UNSET,
    gt_stop_date_time: Union[Unset, datetime.datetime] = UNSET,
    lt_stop_date_time: Union[Unset, datetime.datetime] = UNSET,
    severity_type_min: Union[Unset, str] = UNSET,
    alarm_id: Union[Unset, int] = UNSET,
    ...
    params["severityType"] = severity_type

    params["severityLevel"] = severity_level

    json_gt_start_date_time: Union[Unset, str] = UNSET
    if not isinstance(gt_start_date_time, Unset):
        json_gt_start_date_time = gt_start_date_time.isoformat()
    params["gtStartDateTime"] = json_gt_start_date_time

    json_lt_start_date_time: Union[Unset, str] = UNSET
    if not isinstance(lt_start_date_time, Unset):
        json_lt_start_date_time = lt_start_date_time.isoformat()
    params["ltStartDateTime"] = json_lt_start_date_time

    json_gt_stop_date_time: Union[Unset, str] = UNSET
    if not isinstance(gt_stop_date_time, Unset):
        json_gt_stop_date_time = gt_stop_date_time.isoformat()
    params["gtStopDateTime"] = json_gt_stop_date_time

    json_lt_stop_date_time: Union[Unset, str] = UNSET
    if not isinstance(lt_stop_date_time, Unset):
        json_lt_stop_date_time = lt_stop_date_time.isoformat()
    params["ltStopDateTime"] = json_lt_stop_date_time

    params["severityTypeMin"] = severity_type_min
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/AlarmElements/DistinctEquPathGroupSubGroupName",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[ProblemDetails, list["PathRelGroupSubGroupName"]]]:
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = PathRelGroupSubGroupName.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["PathRelGroupSubGroupName"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        severity_type (Union[Unset, str]):
        severity_level (Union[Unset, int]):
        gt_start_date_time (Union[Unset, datetime.datetime]):
        lt_start_date_time (Union[Unset, datetime.datetime]):
        gt_stop_date_time (Union[Unset, datetime.datetime]):
        lt_stop_date_time (Union[Unset, datetime.datetime]):
        severity_type_min (Union[Unset, str]):
        alarm_id (Union[Unset, int]):
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['PathRelGroupSubGroupName']]
    """
