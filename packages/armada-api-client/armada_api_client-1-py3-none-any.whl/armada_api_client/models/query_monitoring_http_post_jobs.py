...
T = TypeVar("T", bound="QueryMonitoringHttpPostJobs")


@_attrs_define
class QueryMonitoringHttpPostJobs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_monitoring_http_post_jobs = cls(
            id=id,
            start=start,
            end=end,
            order=order,
        ...
        return query_monitoring_http_post_jobs
