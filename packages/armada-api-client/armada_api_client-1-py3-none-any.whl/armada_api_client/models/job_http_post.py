...
class JobHttpPost:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        post_relative_url = self.post_relative_url
        ...
        field_dict.update(
            {
                ...
                "postRelativeUrl": post_relative_url,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_relative_url = d.pop("postRelativeUrl")

        post_content = d.pop("postContent")

        post_response = d.pop("postResponse")
