...
T = TypeVar("T", bound="QueryAlarmElement")


@_attrs_define
class QueryAlarmElement:
    """
    Attributes:
        ...
        severity_type (Union[None, Unset, str]):
        severity_level (Union[None, Unset, int]):
        gt_start_date_time (Union[None, Unset, datetime.datetime]):
        lt_start_date_time (Union[None, Unset, datetime.datetime]):
        gt_stop_date_time (Union[None, Unset, datetime.datetime]):
        lt_stop_date_time (Union[None, Unset, datetime.datetime]):
        severity_type_min (Union[None, Unset, str]):
        alarm_id (Union[None, Unset, int]):
    """
    ...
    severity_type: Union[None, Unset, str] = UNSET
    severity_level: Union[None, Unset, int] = UNSET
    gt_start_date_time: Union[None, Unset, datetime.datetime] = UNSET
    lt_start_date_time: Union[None, Unset, datetime.datetime] = UNSET
    gt_stop_date_time: Union[None, Unset, datetime.datetime] = UNSET
    lt_stop_date_time: Union[None, Unset, datetime.datetime] = UNSET
    severity_type_min: Union[None, Unset, str] = UNSET
    alarm_id: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        severity_type: Union[None, Unset, str]
        if isinstance(self.severity_type, Unset):
            severity_type = UNSET
        else:
            severity_type = self.severity_type

        severity_level: Union[None, Unset, int]
        if isinstance(self.severity_level, Unset):
            severity_level = UNSET
        else:
            severity_level = self.severity_level

        gt_start_date_time: Union[None, Unset, str]
        if isinstance(self.gt_start_date_time, Unset):
            gt_start_date_time = UNSET
        elif isinstance(self.gt_start_date_time, datetime.datetime):
            gt_start_date_time = self.gt_start_date_time.isoformat()
        else:
            gt_start_date_time = self.gt_start_date_time

        lt_start_date_time: Union[None, Unset, str]
        if isinstance(self.lt_start_date_time, Unset):
            lt_start_date_time = UNSET
        elif isinstance(self.lt_start_date_time, datetime.datetime):
            lt_start_date_time = self.lt_start_date_time.isoformat()
        else:
            lt_start_date_time = self.lt_start_date_time

        gt_stop_date_time: Union[None, Unset, str]
        if isinstance(self.gt_stop_date_time, Unset):
            gt_stop_date_time = UNSET
        elif isinstance(self.gt_stop_date_time, datetime.datetime):
            gt_stop_date_time = self.gt_stop_date_time.isoformat()
        else:
            gt_stop_date_time = self.gt_stop_date_time

        lt_stop_date_time: Union[None, Unset, str]
        if isinstance(self.lt_stop_date_time, Unset):
            lt_stop_date_time = UNSET
        elif isinstance(self.lt_stop_date_time, datetime.datetime):
            lt_stop_date_time = self.lt_stop_date_time.isoformat()
        else:
            lt_stop_date_time = self.lt_stop_date_time

        severity_type_min: Union[None, Unset, str]
        if isinstance(self.severity_type_min, Unset):
            severity_type_min = UNSET
        else:
            severity_type_min = self.severity_type_min

        alarm_id: Union[None, Unset, int]
        if isinstance(self.alarm_id, Unset):
            alarm_id = UNSET
        else:
        ...
        if severity_type is not UNSET:
            field_dict["severityType"] = severity_type
        if severity_level is not UNSET:
            field_dict["severityLevel"] = severity_level
        if gt_start_date_time is not UNSET:
            field_dict["gtStartDateTime"] = gt_start_date_time
        if lt_start_date_time is not UNSET:
            field_dict["ltStartDateTime"] = lt_start_date_time
        if gt_stop_date_time is not UNSET:
            field_dict["gtStopDateTime"] = gt_stop_date_time
        if lt_stop_date_time is not UNSET:
            field_dict["ltStopDateTime"] = lt_stop_date_time
        if severity_type_min is not UNSET:
            field_dict["severityTypeMin"] = severity_type_min
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_severity_type(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        severity_type = _parse_severity_type(d.pop("severityType", UNSET))

        def _parse_severity_level(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        severity_level = _parse_severity_level(d.pop("severityLevel", UNSET))

        def _parse_gt_start_date_time(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                gt_start_date_time_type_0 = isoparse(data)

                return gt_start_date_time_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        gt_start_date_time = _parse_gt_start_date_time(d.pop("gtStartDateTime", UNSET))

        def _parse_lt_start_date_time(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                lt_start_date_time_type_0 = isoparse(data)

                return lt_start_date_time_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        lt_start_date_time = _parse_lt_start_date_time(d.pop("ltStartDateTime", UNSET))

        def _parse_gt_stop_date_time(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                gt_stop_date_time_type_0 = isoparse(data)

                return gt_stop_date_time_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        gt_stop_date_time = _parse_gt_stop_date_time(d.pop("gtStopDateTime", UNSET))

        def _parse_lt_stop_date_time(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                lt_stop_date_time_type_0 = isoparse(data)

                return lt_stop_date_time_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, datetime.datetime], data)

        lt_stop_date_time = _parse_lt_stop_date_time(d.pop("ltStopDateTime", UNSET))

        def _parse_severity_type_min(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        severity_type_min = _parse_severity_type_min(d.pop("severityTypeMin", UNSET))

        def _parse_alarm_id(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        alarm_id = _parse_alarm_id(d.pop("alarmId", UNSET))

        query_alarm_element = cls(
            id=id,
            start=start,
            end=end,
            order=order,
            ...
            gt_start_date_time=gt_start_date_time,
            lt_start_date_time=lt_start_date_time,
            gt_stop_date_time=gt_stop_date_time,
            lt_stop_date_time=lt_stop_date_time,
            severity_type_min=severity_type_min,
            alarm_id=alarm_id,
        )

        return query_alarm_element
