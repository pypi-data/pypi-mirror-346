...
T = TypeVar("T", bound="QueryReportAutoSend")


@_attrs_define
class QueryReportAutoSend:
    """
    Attributes:
        ...
        report_id (Union[None, Unset, list[int]]):
    """
    ...
    report_id: Union[None, Unset, list[int]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.report_id, Unset):
            report_id = UNSET
        elif isinstance(self.report_id, list):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_report_id(data: object) -> Union[None, Unset, list[int]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                report_id_type_0 = cast(list[int], data)
        ...
        report_id = _parse_report_id(d.pop("reportId", UNSET))

        query_report_auto_send = cls(
            id=id,
            start=start,
            end=end,
            order=order,
