...
) -> Optional[Union[ProblemDetails, list["MonitoringJobsSummary"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["MonitoringJobsSummary"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """(Auth policies: AdminRead, Common)
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['MonitoringJobsSummary']]
    """
