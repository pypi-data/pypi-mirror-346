...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/EquipmentSetupTemplates/{id}",
        "params": params,
    }
...
) -> Optional[Union[EquipmentSetupTemplate, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[EquipmentSetupTemplate, ProblemDetails]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[EquipmentSetupTemplate, ProblemDetails]
    """
