...
def _get_kwargs(
    *,
    node_link_id: Union[Unset, list[int]] = UNSET,
    ...
    json_node_link_id: Union[Unset, list[int]] = UNSET
    if not isinstance(node_link_id, Unset):
        json_node_link_id = node_link_id

    params["nodeLinkId"] = json_node_link_id
...
) -> Optional[Union[ProblemDetails, list["CustomTreeNodeLink"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["CustomTreeNodeLink"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['CustomTreeNodeLink']]
    """
