...
def _get_kwargs(
    *,
    file_id: Union[Unset, list[int]] = UNSET,
    file_link_id: Union[Unset, list[int]] = UNSET,
    ...
    json_file_id: Union[Unset, list[int]] = UNSET
    if not isinstance(file_id, Unset):
        json_file_id = file_id

    params["fileId"] = json_file_id

    json_file_link_id: Union[Unset, list[int]] = UNSET
    if not isinstance(file_link_id, Unset):
        json_file_link_id = file_link_id

    params["fileLinkId"] = json_file_link_id
...
def sync_detailed(
    *,
    ...
    """Get the count of object filtered by uri query (Auth policies: FileRead)

    Args:
        file_id (Union[Unset, list[int]]):
        file_link_id (Union[Unset, list[int]]):
