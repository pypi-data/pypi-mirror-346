...
from ...models.monitorings_get_count_response_200 import MonitoringsGetCountResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/Monitorings/countBy/{group_by}",
        "params": params,
    }
...
) -> Optional[Union[MonitoringsGetCountResponse200, ProblemDetails]]:
    if response.status_code == 200:
        response_200 = MonitoringsGetCountResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MonitoringsGetCountResponse200, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """(Auth policies: Common, ElementRead)
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[MonitoringsGetCountResponse200, ProblemDetails]
    """
