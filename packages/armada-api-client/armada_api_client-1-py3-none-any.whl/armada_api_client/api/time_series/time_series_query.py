...
from ...models.single_time_series import SingleTimeSeries
...
) -> Optional[Union[ProblemDetails, SingleTimeSeries]]:
    if response.status_code == 200:
        response_200 = SingleTimeSeries.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, SingleTimeSeries]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, SingleTimeSeries]
    """
