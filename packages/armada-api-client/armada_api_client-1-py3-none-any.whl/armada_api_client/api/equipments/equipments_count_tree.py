...
) -> Optional[Union[CountedEquipmentOrderedBy, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CountedEquipmentOrderedBy, ProblemDetails]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CountedEquipmentOrderedBy, ProblemDetails]
    """
