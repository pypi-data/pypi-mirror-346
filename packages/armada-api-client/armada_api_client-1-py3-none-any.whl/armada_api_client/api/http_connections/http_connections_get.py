...
from ...models.http_connection import HttpConnection
...
def _get_kwargs(
    *,
    ...
    monitoring_id: Union[Unset, int] = UNSET,
    ...
    params["monitoringId"] = monitoring_id
...
) -> Optional[Union[ProblemDetails, list["HttpConnection"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = HttpConnection.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProblemDetails, list["HttpConnection"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """(Auth policies: AccountManagerRead)

    Args:
        login (Union[Unset, str]):
        ip_address (Union[Unset, str]):
        monitoring_id (Union[Unset, int]):
...
def sync(
    *,
    ...
    Returns:
        Union[ProblemDetails, list['HttpConnection']]
    """
