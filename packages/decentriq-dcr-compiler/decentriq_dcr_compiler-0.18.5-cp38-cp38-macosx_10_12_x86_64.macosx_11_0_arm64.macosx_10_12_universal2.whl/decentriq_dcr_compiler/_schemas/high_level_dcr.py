...
class DataLabCompute12(
    RootModel[Union[DataLabCompute, DataLabCompute14, DataLabCompute15]]
):
    root: Union[DataLabCompute, DataLabCompute14, DataLabCompute15]


class DataLabComputeOrUnknown(RootModel[Optional[DataLabCompute12]]):
    root: Optional[DataLabCompute12]
...
class DataScienceDataRoomV16(DataScienceDataRoomV03):
    pass
...
class DataScienceDataRoom21(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
