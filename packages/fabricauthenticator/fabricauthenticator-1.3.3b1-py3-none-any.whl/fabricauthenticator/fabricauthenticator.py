...
class FabricAuthenticator(CILogonOAuthenticator):
    ...
    def user_info_to_username(self, user_info):
        username = super(FabricAuthenticator, self).user_info_to_username(user_info=user_info)
        # TODO - Extract FABRIC User ID from Core API
        self.log.info(f"FABRIC user authenticated: {username}")
        return username
