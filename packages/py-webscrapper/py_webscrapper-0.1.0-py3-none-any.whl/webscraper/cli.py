...
def main():
    """
    Main entry point for the webscraper command-line interface
    """
    # Set up argument parser
    parser = argparse.ArgumentParser(
        description='WebScraper - Extract content from web pages',
        epilog='Example: webscraper --url https://example.com --output ./scraped --text --links --docs --images'
    )
    
    parser.add_argument('--version', action='version', version=f'WebScraper {__version__}')
