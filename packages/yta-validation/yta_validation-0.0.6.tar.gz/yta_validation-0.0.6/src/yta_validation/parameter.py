...
class ParameterValidator:
    ...
    def validate_number_between(
        ...
        int, parseable string or numpy) between the also
        provided 'lower_limit' and 'upper_limit' numbers.
        """
        ParameterValidator.validate_number(name, value)
        ParameterValidator.validate_number('lower_limit', lower_limit)
        ParameterValidator.validate_number('upper_limit', upper_limit)
        ...
        if (
            value < lower_limit or
            value > upper_limit
        ):
            raise Exception(ErrorMessage.parameter_is_not_number_between(name, str(lower_limit), str(upper_limit)))
