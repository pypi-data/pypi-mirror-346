...
def update_generic_cloudformation_stack(stack_name: str, template_file_path: str, parameters: List[Dict[str, str]],
    ...
    response = cloudformation_client.update_stack(StackName=stack_name, TemplateBody=template, Parameters=parameters,
                                                  Capabilities=capabilities)
