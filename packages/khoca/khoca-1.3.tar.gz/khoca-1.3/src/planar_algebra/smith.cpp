 ...
 */
bool pari_externally_in_use  = false; // true if cypari or cypari2 is installed
...
void set_pari_active_before(bool pari_active_before) {pari_externally_in_use = pari_active_before;}
